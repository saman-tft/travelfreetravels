...

{
	...
	public function single_table_records_social_login(){

		$query=$this->db->query("select * from social_links where status=1 order by CASE WHEN social = 'facebook' THEN 0

        WHEN social = 'twitter' THEN 1

        WHEN social = 'instagram' THEN 2

        WHEN social = 'youtube' THEN 3

        WHEN social = 'linkedin' THEN 4
