...
$tr='VHCID1420613748';
		...
		MCL.origin=ASM.meta_course_list_fk and ASM.booking_source_fk=BS.origin and MCL.meta_course_list='.$tr.'
...

	{
		...
		if ($count) {
			...
			$query = 'select count(distinct(BD.app_reference)) as total_records 
					...
					where BD.domain_origin='.get_domain_auth_id().' AND BD.booking_source="PTBSID0000000011" and BD.created_by_id ='.$GLOBALS['CI']->entity_user_id.''.$condition;
