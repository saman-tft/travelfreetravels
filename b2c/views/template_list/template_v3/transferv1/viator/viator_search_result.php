...
<div class="rowresult r-r-i col-xs-4">
 <?php
                           ...
                           ?>
	<div class="<?php echo $grid; ?> forhtlpopover " data-key="<?=$product_key?>" data-product-name="<?=$product['ProductName']?>" data-product-code="<?=@$product['ProductCode']?>" data-result-token="<?=$product['ResultToken']?>" >
