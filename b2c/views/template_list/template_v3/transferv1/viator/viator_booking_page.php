...
// debug($pre_booking_params['Price']['AgentCommission']);exit;

/********************************* Convenience Fees *********************************/
/*if($pre_booking_params['Price']['AgentCommission'] >0){
	$trip_total_price +=$pre_booking_params['Price']['AgentCommission'];
}*/
...
// $grand_total += $pre_booking_params['Price']['AgentCommission'];
...
<div class="alldownsectn">
  ...
  <div class="ovrgo sight_book_page">
	<div class="bktab1 xlbox <?=$review_tab_details_class?>">
			  ...
			  <div class="hotelistrowhtl">
				...
				<div class="col-md-12 col-sm-8 col-xs-8 padall10 xcel">
				  ...
				  <?php if($pre_booking_params['GradeDescription']):
				  	$Description=explode('(', $pre_booking_params['GradeDescription']);
				  	if(isset($Description[1])){
				  		$Description=$Description[0];
				  	}else{
				  		$Description=$pre_booking_params['GradeDescription'];
				  	} ?>
				  	 <div class="hotelhed2">Tour Code : <?=$Description?></div>
				  <?php endif;?>
				  <div class="clearfix"></div>
	  ...
	  <div class="fligthsdets" style="margin-right:0px!important;">
		<div class="flitab1">
				<div class="clearfix"></div>
						...
						<div class="col-xs-7 celoty">
							<div class="insidechs">
								...
								<div class="havealrdy">
									...
									<label for="alreadyacnt" class="haveacntd">I have an Alkhaleej Tours password</label>
								</div>
								<div class="clearfix"></div>
								<div class="twotogle">
								<div class="cntgust">
		...
		<div class="col-xs-4 full_room_buk rhttbepa nopad">
	...
	<div class="bktab2 xlbox <?=$travellers_tab_details_class?>">
	  <div class="col-xs-12 col-md-8">
		<div class="col-xs-12 topalldesc nopad">
			<div class="col-xs-12 nopad" style="padding: 0px 4px;">
				<div class="bookcoll">
			  <div class="hotelistrowhtl">
...
<form action="<?=base_url().'index.php/transferv1/pre_booking/'.$search_id?>" method="POST" autocomplete="off">
		...
		<div class="hide">
			...
			<div class="moreflt boksectn">
					<div class="ontyp">
						<div class="labltowr arimobold" style="margin:0px!important;padding:0px!important;">Please enter the customer names.</div>
				...
				<div class="col-xs-12 col-sm-3 col-md-3 nopadding">
				   ...
				   <div class="adltnom">
				   		<?php
				   			...
				   			// debug($title_select_options);exit;
				 ...
				 <div class="inptalbox">
					...
					<div class="col-xs-12 col-md-4 spllty">
						  <input value="<?=@$cur_pax_info['first_name']?>" required="required" type="text" name="first_name[]" id="passenger-first-name-<?=$name_index?>" class="clainput alpha_space no_copy_paste <?=$traveller_class?>"  minlength="2" maxlength="15" placeholder="Enter First Name" data-row-id="<?=($pax_index);?>"/>
						  
					</div>
					<div class="col-xs-12 col-md-4 spllty">
					 	<input value="<?=@$cur_pax_info['last_name']?>" required="required" type="text" name="last_name[]" id="passenger-last-name-<?=$name_index?>" class="clainput alpha_space last_name" minlength="2" maxlength="15" placeholder="Enter Last Name" />
					 </div>
					 <?php 
                    ...
                    <?php foreach($pre_booking_params['BookingQuestions'] as $q_key=>$q_value): $requierd='';?>
                      <?php //debug($q_value); ?>
                        ...
                        <?php
                        	...
                        	if($q_value['stringQuestionId'] =='transfer_air_arrival_airline' || $q_value['stringQuestionId'] =='transfer_air_arrival_flightNo' || $q_value['stringQuestionId'] =='transfer_arrival_time' || $q_value['stringQuestionId'] =='transfer_air_departure_airline' || $q_value['stringQuestionId'] =='transfer_air_departure_flightNo' || $q_value['stringQuestionId'] =='transfer_departure_date' || $q_value['stringQuestionId'] =='transfer_departure_time')
                        	{

                        		if($q_value['stringQuestionId'] =='transfer_departure_time')
                        		{


                        		?>
                        		<input type="hidden" name="question_Id[<?=$q_key?>][]" value="<?=$q_value['questionId']?>">
                        			<input type="hidden" class="form-control <?=$class?> " id=""  name="question[<?=$q_key?>][]" value="20:30">
                        		<?php
                        		}
                        		else
                        		{	
                        		?>
                        		 <input type="hidden" name="question_Id[<?=$q_key?>][]" value="<?=$q_value['questionId']?>">
                        			<input type="hidden" class="form-control <?=$class?> " id=""  name="question[<?=$q_key?>][]" value="test">
                        		<?php
                        		}
                        	}else/*if($q_value['stringQuestionId'] =='transfer_arrival_dropOff')*/
                        	{
                        ?>
...
<div class="clearfix"></div>
									                        ...
									                        <div class="payblnhm singecartpricebuk ritaln">
									                    	 <input type="text" placeholder="Enter Promo" name="code" id="code" class="promocode" aria-required="true" maxlength="15" />
									                          ...
									                          <input type="hidden" name="currency" id="currency" value="<?=@$pre_booking_params['default_currency'];?>" />
									                            <?php $promo_for_city= md5($search_data['destination']);?>
				...
				<div class="contbk">
					...
					<div class="col-xs-4 nopadding">
					<input value="<?=@$lead_pax_details['phone'] == 0 ? '' : @$lead_pax_details['phone'];?>" type="text" name="passenger_contact" id="passenger-contact" placeholder="Mobile Number" class="newslterinput nputbrd _numeric_only"  required="required">
					</div>
					<div class="clearfix"></div>
				...
				<div class="clikdiv">
					 ...
					 <span class="clikagre" id="clikagre">
					 	<a href="<?php echo base_url()?>terms-and-conditions-" target="_blank">
	 	...
	 	<?php if(is_logged_in_user() == true) { ?>
			<div class="col-xs-12 nopadding">
				<div class="insiefare" style="padding: 0px;">
					<div class="farehd arimobold" style="margin-left:0px!important;">Passenger List</div>
					<div class="fredivs" style="margin-left:2px!important;">
						<div class="psngrnote">
							<?php
		...
		<div class="col-xs-4 rhttbepa nopad">
