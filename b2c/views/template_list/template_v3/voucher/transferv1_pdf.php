<?php $booking_details = $data['booking_details'][0];
            ...
            <tr><td style="line-height:6px;">&nbsp;</td></tr>                  
                              ...
                              <td style="padding:0;"><table width="100%" cellpadding="5" style="padding: 10px;font-size: 10pt;padding:5px;">
                                    ...
                                    <tr>
                                       ...
                                       <?php if($attributes['ProductImage']):?>
                                          ...
                                          <td width="26%" style="padding:10px 0"><img style="width:130px; height:107px;" src="<?=$attributes['ProductImage']?>" alt="" /></td>

                                       <?php else:?>

                                          <td style="padding:10px 0"><img style="width:130px; height:107px;" src="<?=$GLOBALS['CI']->template->template_images("no_image_available.jpg");?>" alt="" /></td>
					...
					<td style="padding: 10px;"><table cellpadding="5" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
                           ...
                           <tr>
                              ...
                              <td style="background-color:#00a9d6;border: 1px solid #00a9d6; color:#fff; font-size:10pt; padding:5px; line-height:normal;"><img width="12" src="<?=SYSTEM_IMAGE_DIR.'hotel_v.png'?>" alt=""/> <span style="font-size:10pt;color:#fff;line-height:12px;"> &nbsp;Activity Details</span></td>
                ...
                ?>
                           ...
                           <tr>
                              ...
                              <td style="background-color:#666666;border: 1px solid #666666; color:#fff; font-size:9pt; padding:5px;"><img width="12" style="vertical-align:middle" src="<?=SYSTEM_IMAGE_DIR.'people_group.png'?>" alt="" /> <span style="font-size:9pt;color:#fff;vertical-align:middle;"> &nbsp;Traveller(s) Details</span></td>
                ...
                <td width="100%" style="padding:0"><table width="100%" cellspacing="-9" cellpadding="5" style="padding: 0;font-size: 9pt;">   
