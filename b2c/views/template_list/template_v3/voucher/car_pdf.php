...
<div class="table-responsive" style="background:#ccc; width:100%; position:relative">
<table
	...
	<!-- <tr><td style="padding: 10px;width:65%;"><span style="max-height: 56px" ><img src="<?php echo $booking_details['car_image']?>" width ="100" height="100" alt="" /></span></td></tr> -->
	<tr>
            <td colspan="1" valign="bottom" align="left">
               <img style="width:120px;" src="<?=$GLOBALS['CI']->template->domain_images($data['logo'])?>" /> 
               
            </td><br>
            <td valign="bottom" colspan="1" align="right"><span style="max-height: 56px" ><img style="width:120px;" src="<?php echo $booking_details['car_image']?>" /></span></td>
         </tr>
							...
							<table width="100%" style="border-collapse: collapse;"
								...
								<tr>
									...
									<td width="100%"
										...
										style="padding: 10px; border: 1px solid #cccccc; font-size: 11pt; font-weight: bold;">Reservation Ticket (<?php echo ucfirst($booking_details['departure_from']).' To '.ucfirst($booking_details['arrival_to']);?>)</td>
								...
								<tr>
									...
									<td style="border: 1px solid #cccccc;">
										...
										<table width="100%" cellpadding="5"
											...
											style="padding: 10px; font-size: 11pt;">
...
<?php
if($booking_details['status']=="BOOKING_CANCELLED")
												{
												     $booking_details['status']="REFUND_INPROGRESS";
												}
?>
											...
											switch ($booking_details ['status']) {
                                                ...
                                                case 'REFUND_INPROGRESS': echo 'REFUND_INPROGRESS';break;
								...
								<tr>
									...
									<td
										...
										style="padding: 10px; border: 1px solid #cccccc; font-size: 11pt; font-weight: bold;">Travelers
								...
								<tr>
									...
									<td
										...
										style="padding: 10px; border: 1px solid #cccccc; font-size: 11pt; font-weight: bold;">Rental Price Includes
								...
								<tr>
									...
									<td style="padding: 10px; border: 1px solid #cccccc;font-size: 11pt;">
								...
								<tr>
									...
									<td
										...
										style="padding: 10px; border: 1px solid #cccccc; font-size: 11pt; font-weight: bold;">Payment Details
								...
								<tr>
									...
									<td
										...
										style="padding: 10px; border: 1px solid #cccccc;font-size: 11pt;"><?php echo $attributes['payment_rule'];?>
								...
								<tr>
									...
									<td
										...
										style="padding: 10px; border: 1px solid #cccccc; font-size: 11pt; font-weight: bold;">Cancellatio Policy
								...
								<tr>
									...
									<td
										...
										style="padding: 10px; border: 1px solid #cccccc;font-size: 11pt;">
								...
								<tr>
									...
									<td
										...
										style="padding: 10px; border: 1px solid #cccccc; font-size: 11pt; font-weight: bold;">Pay at Pickup
								...
								<tr>
									...
									<td width="50%"
										...
										style="padding: 10px; border: 1px solid #cccccc; font-size: 11pt; font-weight: bold;">Terms
								...
								<tr>
									...
									<td width="100%" style="border: 1px solid #cccccc;">
										...
										<table width="100%" cellpadding="5"
											...
											style="padding: 10px 20px; font-size: 11pt;">
								...
								<tr>
                        			<td colspan="4" align="right" style="padding-top:10px;font-size:11pt;line-height:20px;"><?=strtoupper($booking_details['domain_name'])?><br>Phone : <?=$data['phone']?><br>Email : <?=$data['email']?><br>Address : <?=STATIC_ADDRESS;?><br><?=STATIC_COUNTRY;?></td>
                     			</tr>
