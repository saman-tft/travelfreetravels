...
<table id="tickect_bus" class="table" cellpadding="0" cellspacing="0" width="100%" style="font-size:13px; font-family: 'Open Sans', sans-serif; width:900px; box-shadow:0 0 5px 0 rgba(0,0,0,.11); margin:30px auto; border-radius:8px;background-color:#fff; padding:50px 45px;">
               ...
               <tbody>
                  ...
                  <tr>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="font-family: 'Open Sans', sans-serif;border-collapse: collapse;">
                           ...
                           <tbody><!-- 
                              ...
                              <tr>
                                 ...
                                 <td align="right" style="line-height:24px;font-size:13px;border-top:1px solid #1FB53A;border-bottom:1px solid #1FB53A;padding: 5px;">Status: <strong class="<?php echo booking_status_label( $booking_details['status']);?>" style=" font-size:14px;">           <?php
                     ...
                     <tr>
                        ...
                        <td style="padding:0"><span style="font-size:16px;color:#2196f3;vertical-align:middle;font-weight: 600;"><?php echo $booking_details['operator'];?></span></td>
                     ...
                     <tr>
                           ...
                           <td width="25%" style="padding:5px 0;text-align: center;"><span style="font-size:14px; border:2px solid #808080; display:block"><span style="color:#2196f3;padding:5px; display:block">PNR No</span><span style="font-size:22px;line-height:35px;padding-bottom: 5px;display:block;font-weight: 600;"><?php echo $booking_details['pnr'];?></span><span style="border-top:2px solid #808080;display:block; padding:5px;">Seat: <?=@$booking_details['seat_numbers']?></span></span></td>
                              ...
                              <tr>
                                 ...
                                 <td style="background-color:#1FB53A;border: 1px solid #1FB53A; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?=SYSTEM_IMAGE_DIR.'bus_v.png'?>" alt=""> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Reservation Ticket (<?php echo ucfirst($booking_details['departure_from']).' To '.ucfirst($booking_details['arrival_to']);?>)</span></td>
                              ...
                              <tr>
                                 ...
                                 <td style="background-color:#666666;border: 1px solid #666666; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?=SYSTEM_IMAGE_DIR.'people_group.png'?>" alt=""> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Traveler(s) Information</span></td>
...
<div class="dwnprnt" style="text-align: center;">
    ...
    <button type="button" onClick="printDiv('tickect_bus')" class="btn btn-orn btfl" >Print</button>
...
<script type="text/javascript">
    ...
    function printDiv(divName) {
     ...
     document.body.innerHTML = printContents;
      ...
      document.title = "Bus Ticket-QuaQua";
