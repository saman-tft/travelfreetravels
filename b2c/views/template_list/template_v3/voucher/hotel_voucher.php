...
<div style="width:100%; position:relative;background-color: #fff" id="tickect_hotel">

    <table cellpadding="0" cellspacing="0" width="100%"
        style="font-size:13px; font-family: 'Open Sans', sans-serif; width:900px; margin:0px auto;background-color:#fff; padding:50px 15px;">
        <tbody>
         <tr>
            <td style="border-collapse: collapse; padding:20px 25px;" >
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
                           ...
                           <tr>
                              <td>
                                 <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                    <td style="padding: 0px;"><img style="width:250px;    margin: 0 0 13px;" src="<?=$GLOBALS['CI']->template->domain_images($data['logo'])?>"></td>
                                       <td style="padding: 0px;">
                                          <table width="100%" style="font-size:13px; font-family: 'Open Sans', sans-serif;border-collapse: collapse;text-align: right; line-height:15px;" cellpadding="0" cellspacing="0" border="0">
                                             ...
                                             <tr>
                                                <td style="padding-bottom:10px;line-height:20px;font-size: 14px;" align="right"><span>Booking Reference: <?php echo $booking_details['app_reference']; ?></span><br><span>Booked Date : <?php echo date("d M Y",strtotime($booking_details['created_datetime'])); ?></span></td>
                                             </tr>
                                          </table>
                                       </td>
                                    </tr>
                           ...
                           <tr>
                              <td align="right" style="line-height:24px;font-size:13px;border-top:1px solid #3e556f;border-bottom:1px solid #3e556f;padding: 5px;">Status: <strong class="<?php echo booking_status_label( $booking_details['status']);?>" style=" font-size:14px;">
                                 <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <table width="100%" cellpadding="5"
                                                style="padding: 10px;font-size: 13px;padding:5px;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="htldefaimg" style="padding:10px 0"><img
                                                                style="width: 160px;height: 140px;object-fit: cover;"
                                                                src="<?=$attributes['HotelImage'];?>" alt="" /></td>

                                                        <?php else:?>

                                                        <td class="htldefaimg" style="padding:10px 0"><img
                                                                style="width: 160px;height: 140px; object-fit: cover;"
                                                                src="<?=$GLOBALS['CI']->template->template_images("default_hotel_img.jpg");?>"
                                                                alt="" /></td>

                                                        <?php endif;?>

                                                        <td valign="top" style="padding:10px;"><span
                                                                style="line-height:30px;font-size:16px;color:#2196f3;vertical-align:middle;font-weight: 600;"><?php echo $booking_details['hotel_name']; ?></span><br><span
                                                                style="display: block;line-height:22px;font-size: 13px;"><?php echo $booking_details['hotel_address']; ?>
                                                            </span><br><span
                                                                style="display: block;line-height:22px;font-size: 13px;"><img
                                                                    style="width:70px;"
                                                                    src="<?php echo $GLOBALS['CI']->template->template_images('star_rating-'.$attributes["StarRating"].'.png'); ?>"
                                                                    alt="" /></span></td>



                                                        <td width="32%" style="padding:10px 0;text-align: center;"><span
                                                                style="font-size:14px; border:2px solid #808080; display:block"><span
                                                                    style="color:#2196f3;padding:5px; display:block;text-transform:uppercase">Booking
                                                                    ID</span><span
                                                                    style="font-size:14px;line-height:35px;padding-bottom: 5px;display:block;font-weight: 600;"><?php echo $booking_details['booking_id']; ?></span></span>
                                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <img style="vertical-align:middle"
                                                src="<?=base_url().SYSTEM_IMAGE_DIR.'hotel_v.png'?>" alt="" /> <span
                                                style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Hotel
                                                Details</span></td>
                                        ...
                                        <td width="100%" style="border: 1px solid #00a9d6; padding:0px;">
                                            ...
                                            <table width="100%" cellpadding="5"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="background-color:#d9d9d9;padding:5px;color: #333333;">
                                                        Check-In</td>
                                                    ...
                                                    <td
                                                        style="background-color:#d9d9d9;padding:5px;color: #333333;text-align:center">
                                                        No of Room's</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding:5px"><span style="width:100%; float:left">
                                                            <?=@date("d M Y",strtotime($itinerary_details['check_in']))?></span>
                                                    </td>

                                                    <td style="padding:5px"><span style="width:100%; float:left">
                                                            <?=@date("d M Y",strtotime($itinerary_details['check_out']))?></span>
                                                    </td>

                                                    <td style="padding:5px" align="center">
                                                        <?php echo $booking_details['total_rooms']; ?></span></td>

                                                    <td style="padding:5px" width="13%">
                                                        <?php echo $itinerary_details['room_type_name']; ?></td>

                                                    <td style="padding:5px" align="center">
                                                        <?php echo $booking_details['adult_count']; ?></td>

                                                    <td style="padding:5px" align="center">
                                                        <?php echo $booking_details['child_count']; ?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            style="background-color:#666666;border: 1px solid #666666; color:#fff; font-size:14px; padding:5px;">
                                            <img style="vertical-align:middle"
                                                src="<?=base_url().SYSTEM_IMAGE_DIR.'people_group.png'?>" alt="" />
                                            <span style="font-size:14px;color:#fff;vertical-align:middle;">
                                                &nbsp;Guest(s) Details</span></td>
                                        ...
                                        <td width="100%" style="border: 1px solid #666666; padding:0px;">
                                            ...
                                            <table width="100%" cellpadding="5" style="padding: 10px;font-size: 13px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="background-color:#d9d9d9;padding:5px;color: #333333;">Sr
                                                        No.</td>
                                                    ...
                                                    <td style="background-color:#d9d9d9;padding:5px;color: #333333;">Age
                                                    </td>
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <img style="vertical-align:middle"
                                                ...
                                                style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Supplier
                                                Details</span></td>
                                    </tr>
                                    <tr>
                                        <td width="100%" style="border: 1px solid #00a9d6; padding:0px;">
                                            <table width="100%" cellpadding="5" style="padding: 10px;font-size: 13px;">
                                                ...
                                                <tr>
                                                    <td style="padding:5px">
                                                        <?php echo $supplier_details[0]['first_name'].' '.$supplier_details[0]['last_name'] ?>
                                                    </td>
                                                    <td style="padding:5px;">
                                                        <?php echo provab_decrypt($supplier_details[0]['email']) ?></td>
                                                    <td style="padding:5px;"><?php echo $supplier_details[0]['phone'] ?>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="50%" style="padding:0;padding-right:14px;">
                                                            ...
                                                            <table cellspacing="0" cellpadding="5" width="100%"
                                                                style="font-size:12px; padding:0;border:1px solid #9a9a9a;">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td
                                                                            ...
                                                                            <span style="font-size:13px">Payment
                                                                                Details</span></td>

                                                                        <td
                                                                            style="border-bottom:1px solid #ccc;padding:5px;">
                                                                            <span style="font-size:11px">Amount
                                                                                (<?=$booking_details['currency']?>)</span>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="padding:5px"><span>Base Fare</span>
                                                                        </td>

                                                                        <td style="padding:5px">
                                                                            <span><?php echo round($booking_details['fare']+$booking_details['admin_markup']+$booking_details['admin_commission']); ?></span>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="padding:5px"><span>Convinence
                                                                                Fee</span></td>

                                                                        <td style="padding:5px">
                                                                            <span><?php echo round($booking_details['convinence_amount']); ?></span>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="padding:5px">
                                                                            <span><?php echo round($itinerary_details['gst']); ?></span>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="padding:5px"><span>Discount</span>
                                                                        </td>

                                                                        <td style="padding:5px">
                                                                            <span><?php echo $booking_details['discount']-$booking_details['reward_amount']; ?></span>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td
                                                                            style="border-top:1px solid #ccc;padding:5px">
                                                                            <span style="font-size:13px">Grand
                                                                                Total</span></td>

                                                                        <td
                                                                            style="border-top:1px solid #ccc;padding:5px">
                                                                            <span
                                                                                style="font-size:13px"><?php echo round($booking_details['grand_total']+$booking_details['admin_commission']-$booking_details['reward_amount']); ?></span>
                                                                        </td>
                                                        ...
                                                        <td width="50%"
                                                            style="padding:0;padding-left:14px; vertical-align:top">
                                                            ...
                                                            <table cellspacing="0" cellpadding="5" width="100%"
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td
                                                                            style="background-color:#d9d9d9;border-bottom:1px solid #ccc;padding:5px; color:#333">
                                                                            <span style="font-size:13px">Room
                                                                                Inclusions</span></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="padding:5px"><span>Room Only</span>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td
                                                                            style="border-top:1px solid #ccc;padding:5px">
                                                                            <span
                                                                                style="font-size:10px; color:#666; line-height:20px;">*
                                                                                Room inclusions are subject to change
                                                                                with Hotels.</span></td>
                                    ...
                                    <tr>
                                        <td align="center" colspan="4"
                                            style="border-bottom:1px solid #999999;padding-bottom:15px"><span
                                                style="font-size:13px; color:#555;">Customer Contact Details | E-mail :
                                                <?=$customer_details[0]['email']?> | Contact No :
                                                <?=$booking_details['phone_code']." ".$customer_details[0]['phone']?></span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4"><span
                                                style="line-height:26px;font-size: 14px;font-weight: bold;">Cancellation
                                                Policy</span></td>
                                    </tr>

                                    <tr>

                                        <td colspan="4" style="line-height:20px; font-size:12px; color:#555">
                                            <?=$booking_details['cancellation_policy'][0]?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4"><span
                                                style="line-height:26px;font-size: 14px;font-weight: bold;">Terms and
                                                Conditions</span></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4"
                                            style="line-height:20px; border-bottom:1px solid #999999; padding-bottom:15px; font-size:12px; color:#555;font-weight: 600;">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4"><span
                                                style="line-height:26px;font-size: 14px;font-weight: bold;">Note:</span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4"
                                            style="border-bottom:1px solid #999999; line-height:20px; font-size:12px; color:#555;font-weight: 600">
                        ...
                        <td colspan="4" style="border-bottom:1px solid #999999; line-height:20px; font-size:12px; color:#555">
                           ...
                           <ul>
                              ...
                              <li>We are a travel agent and all reservations made through our website are as per the terms and conditions of the concerned airlines. All modifications,cancellations and refunds of the airline tickets shall be strictly in accordance with the policy of the concerned airlines and we disclaim all liability in connection thereof.</li>
								...
								<td colspan="4" align="right" style="padding-top:10px;font-size:13px;line-height:20px;"><?=$data['domainname']?><br><?=$data['address']?></td>
...
function printDiv(divName) {
    ...
    document.title = "Hotel Ticket-Travel Free Travels";
