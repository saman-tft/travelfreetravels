	...
	<tbody>
					...
					<tbody>
						...
						<tr>
							...
							<th align="left" scope="col">
								...
								<img src="<?=$GLOBALS['CI']->template->domain_images($domain_details['domain_logo'])?>" alt="" height="70" />
		...
		<tr id="mediaPrint">
			...
			<td align="center" colspan="3"><a style="text-decoration: none"
				...
				width="35px;" src="<?php echo $GLOBALS['CI']->template->template_images('print.png'); ?>" alt=""
