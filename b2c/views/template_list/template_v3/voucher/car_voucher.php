...
<div class="table-responsive" style="width:100%; position:relative;background-color: #fff" id="tickect_hotel">
    <table class="table" cellpadding="0" cellspacing="0" width="100%"
        style="font-size:13px; font-family: 'Open Sans', sans-serif; width:900px; box-shadow:0 0 5px 0 rgba(0,0,0,.11); margin:30px auto; border-radius:8px;background-color:#fff; padding:50px 45px;">
                            ...
                            <td style="padding: 10px;">
                                ...
                                <table cellpadding="5" cellspacing="0" border="0" width="100%"
                                                ...
                                                <tr>
                                                    <td colspan="2" valign="bottom" align="left">
                                                        <img style="width:150px;"
                                                            src="<?=$GLOBALS['CI']->template->domain_images($data['logo'])?>" />

                                                    </td>
                                                    <td valign="bottom" colspan="2" align="right"><span
                                                            style="max-height: 56px"><img style="width:150px;"
                                                                src="<?php echo $booking_details['car_image']?>" /></span>
                                                    </td>
                                                </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td width="50%"
                                            style="padding: 10px; border: 1px solid #00a9d6;background:#00a9d6;color:#fff; font-size: 14px; font-weight: bold;">
                                            Reservation Ticket
                                            (<?php echo ucfirst($booking_details['car_pickup_lcation']).' To '.ucfirst($booking_details['car_drop_location']);?>)
                                        </td>
                                        ...
                                        <td style="border: 1px solid #cccccc;">
                                            ...
                                            <table width="100%" cellpadding="5" style="padding: 10px; font-size: 14px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="30%"><?php echo $booking_details['booking_reference'];?>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="30%"><?php echo $booking_details['car_supplier_name'];?>
                                                    </td>

                                                    <td width="20%"><strong>Supplier Idenfier</strong></td>

                                                    <td width="30%">
                                                        <?php echo $booking_details['supplier_identifier'];?></td>
...
?>
											...
											?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $booking_details['car_from_date'];?>
                                                        <?php echo $booking_details['pickup_time'];?></td>

                                                    <td><strong>Drop Date Time</strong></td>

                                                    <td><?php echo $booking_details['car_to_date'];?>
                                                        <?php echo $booking_details['drop_time'];?></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?=@date("d M Y",strtotime($booking_details['car_from_date']))?>
                                                        <?=get_time($booking_details['pickup_time']);?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 1px solid #cccccc;">
                                            ...
                                            <table width="100%" cellpadding="5" style="padding: 10px; font-size: 14px;">
                                                ...
                                                <tr>
                                                    <td><?php echo $customer_details[0]['title'];?></td>
                                        ...
                                        <td style="border: 1px solid #cccccc;">
                                            ...
                                            <table width="100%" cellpadding="5" style="padding: 10px; font-size: 14px;">
                                                ...
                                                <tr style="font-size: 15px;text-align:center;">
                                                    ...
                                                    <td colspan="5"><strong>Total Fare</strong></td>

                                                    <td><strong><?=@$booking_details['currency']?>
                                                            <?=@$booking_details['grand_total']?></strong></td>
								...
								if((isset($extra_service_details) && valid_array($extra_service_details)) || ($booking_details['oneway_fee']!= 0)){ ?>
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            style="padding: 10px; border: 1px solid #cccccc; font-size: 14px; font-weight: bold;">
                                            Pay at Pickup
    ...
    <table id="printOption"
        ...
        style="border-collapse: collapse; font-size: 14px; margin: 10px auto; font-family: arial;" width="70%"
        cellpadding="0" cellspacing="0" border="0">
...
function printDiv(divName) {
    ...
    document.title = "Car Ticket-Travel Free Travels";
