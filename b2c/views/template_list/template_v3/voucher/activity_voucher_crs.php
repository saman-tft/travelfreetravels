                  ...
                  <tbody>
                     <tr>
                      ...
                      ?></strong>                              </td>
                                 ...
                                 <tr>
                                    <td style="background-color:#00a9d6;border: 1px solid #00a9d6; color:#fff; font-size:14px;"><img src="<?='https://travelfreetravels.com/'.SYSTEM_IMAGE_DIR.'hotel_v.png'?>" /> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Excursion Details</span></td>
                                 </tr>
                                 <tr>
                                ...
                                <tr>
                                       ...
                                       <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;">
                                          <tbody>
                                             <tr>
                                                ...
                                                <td width="50%" style="padding:0;padding-left:14px; vertical-align:top">     <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #9a9a9a;font-size:12px; padding:0;">
                                                      <tbody>
                                                         <tr>
                                 ...
                                 <tr>
                                     <td colspan="4" style="line-height:20px; padding-bottom:15px; font-size:12px; color:#555">
                                        <tr>
                                            <td colspan="4"><span style="line-height:26px;font-size: 15px;font-weight: 500;">Description</span>
                                            </td>
                                        </tr>
                                         <tr>
                                            <td colspan="4" style="line-height:20px; font-size:12px; color:#555"><?=$pack_details->package_description?>
                                            </td>
                                        </tr>
                                 ...
                                 <tr>
                                  ...
                                  <?php } ?>
                                   ...
                                   <?php if($pickup_location != "" && $pickup_location != "-"){ ?>
                                    <tr>
                                    <td colspan="4"><span style="line-height:26px;font-size: 15px;font-weight: 500;">Traveller Pickup Location</span></td>
                                 </tr>
                                 <tr>
                                    <td colspan="4" style="line-height:20px; font-size:12px; color:#555"><?=$pickup_location?></td>
                                 </tr>
                                  <?php } ?>
