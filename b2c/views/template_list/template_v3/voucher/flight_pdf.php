...
if (isset($return_segment_details)) {
    ...
    if (isset($return_segment_details[0]['airline_pnr']) && !empty($return_segment_details[0]['airline_pnr'])) {
        ...
        //changes yaa change gareko pnr ko laagi
        if (isset($itinerary_details[0]['airline_pnr'])) {
...
<!--changes removed previous voucher total display-->
                                            ...
                                            <!--            <?php // number_format((@$booking_details['grand_total'] - $booking_details['segment_discount'] + $booking_details['reward_amount']), 2) ?>-->
                                            <!--        </span>-->
                                            <!--    </td>-->
                                            ...
                                            if (valid_array($segment_details_v) == true) {
                                                ...
                                                ?>
                                                                                                                                                                            ...
                                                                                                                                                                            <tr>
                                                                                                                                                                                ...
                                                                                                                                                                                <td><span><?= @$segment_details_v['airline_name'] ?><br><?php echo $segment_details_v['flight_number']; ?><br>Cabin: <?php echo $booking_details['cabin_class']; ?></span></td>
