...
<div id="printpage" style="width:100%;">
 ...
 <?php if ($booking_details['convinence_amount'] > 0 || $booking_details['pg_convenience'] > 0) { ?>
                                                ...
                                                <?php } ?>
                                                <!-- changes Removed previous calculation of total amount because it didn't accomodate reward points and promocode -->
                                                <!--               <tr>
                                                ...
                                                <td style="border-top:1px solid #ccc"><span style="font-size:13px">
                                                         number_format((@$booking_details['grand_total'] - $booking_details['segment_discount'] + $booking_details['reward_amount']), 2)
                                                    </span>
                                                </td>
