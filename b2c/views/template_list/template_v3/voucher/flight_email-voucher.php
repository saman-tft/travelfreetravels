...
if (isset($return_segment_details)) {
    ...
    if (isset($return_segment_details[0]['airline_pnr']) && !empty($return_segment_details[0]['airline_pnr'])) {
        ...
        //yaa change gareko pnr ko laagi
        if (isset($itinerary_details[0]['airline_pnr'])) {
    ...
    <table class="pag_brk" cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:12px; font-family: 'Open Sans', sans-serif; width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate;color: #000;box-shadow: 0 0 5px 0 rgba(0,0,0,.11);border-radius:8px;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="2" style="padding-bottom:10px"><img style="width:200px;" src="https://drive.google.com/uc?export=download&id=15gR5sTlyufGENXl48E6xNoTPKW1F57WN" alt="TravelFreeTravels" /></td>
            ...
            <tr>
                <td colspan="4" style="font-size: 18px;font-weight: 600;text-align: center;padding: 10px 0 12px;">
                    E-Ticket <?php echo $Onward; ?></td>
            </tr>

            <td align="right" colspan="4" style="line-height:26px; border-top:1px solid #1FB53A; border-bottom:1px solid #1FB53A;"><span style="font-size:12px;">Status: </span><strong class="<?php echo booking_status_label($booking_transaction_details[0]['status']) ?>" style=" font-size:14px;">
            ...
            <tr>
                ...
                <td style="padding:10px 0"><img style="width:60px;" src="<?= base_url() . SYSTEM_IMAGE_DIR . 'airline_logo/' . $itinerary_details[0]['airline_code'] . '.gif' ?>" /></td>

                <td style="padding:10px 0; line-height:25px;"><span style="display: block;"><span style="font-size:14px;"><?= @$itinerary_details[0]['airline_name'] ?></span><br><?php echo $airline_number ?></span></td>

                <td style="padding:10px 0;  line-height:25px;"><span style="font-size:14px; display: block;">Travel Free Travels customer service</span>
                    ...
                    <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="background-color:#2196f3; color:#fff"><img style="vertical-align:middle" src="<?= base_url() . SYSTEM_IMAGE_DIR . 'flight.png' ?>"> &nbsp;<span style="vertical-align:middle;font-size:13px">Onward Flight Details</span></td>
                            ...
                            ?>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><span><?= @$segment_details_v['airline_name'] ?><br><?php echo $segment_details_v['']  . $segment_details_v['flight_number']; ?><br>Cabin: <?php echo $booking_details['cabin_class']; ?></span></td>
...
//changes removed static from here                         
                                        if ($cus_v['title'] == "") {
                                            $cus_v['title'] = 'Mr.';
                                        }
                    ...
                    <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #9a9a9a;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="border-bottom:1px solid #00a9d6;background-color: #00a9d6;color: #fff;"><span style="font-size:11px">Amount (
                                            ...
                                            <?php else : ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <!-- /*$markup_value + $booking_details['agent_markup']*/ <td><span> <?php echo number_format(($Tax + $booking_details['admin_markup'] + $booking_details['agent_markup']) - $booking_details['admin_commission'] + $booking_details['admin_tds'], 2) ?></span></td> -->

                                                    <td><span> <?php
                                                                if ($booking_details['booking_source'] == "PTBSID0000000009") {

                                                                    echo number_format(($Tax + ($booking_details['admin_markup'] * $currency_conversion_rate)), 2);
                                                                } else {
                                                                    //debug($booking_details['booking_source']);
                                                                    if ($booking_details['booking_source'] == "PTBSID0000000002") {

                                                                        echo number_format(($Tax), 2);
                                                                    } else {
                                                                        //debug($booking_details['booking_source']);
                                                                        if ($booking_details['booking_source'] == "PTBSID0000000021") {
                                                                            //  debug($booking_details);

                                                                            echo $Tax + round($booking_details['admin_markup']);
                                                                        } else {
                                                                            echo number_format(($Tax + ($booking_details['admin_markup'] * $currency_conversion_rate)), 2);
                                                                        }
                                                                    }
                              ...
                              <!--changes changed the following if  for convenience fees-->
 <?php if ($booking_details['convinence_amount'] > 0 || $booking_details['pg_convenience'] > 0) { ?>

                                                <tr>

                                   <!--changes changed the following td for convenience fees-->
                                                        <!--<td><span><php echo number_format(($booking_details['convinence_amount'] * $currency_conversion_rate), 2); ?></span></td>-->
                                                         ...
                                                         <td><span><?php echo number_format((($booking_details['convinence_amount'] + @$booking_details
                                                        ['pg_convenience']) * $currency_conversion_rate), 2); ?></span></td>
                                                                                    <!-- <td><span> <?php echo number_format(($booking_details['convinence_amount'] * $currency_conversion_rate), 2) ?></span></td> -->
                                            ...
                                            if ($booking_details['discount'] != 0 || $booking_details['reward_amount'] != 0) {
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span> <?php
                                                                //  debug($booking_details);die;
                                                                if ($booking_details['booking_source'] == "PTBSID0000000009") {
                                                                    echo number_format($booking_details['discount'], 2);
                                                                } else {
                                                                    echo number_format($booking_details['discount'] + $booking_details['reward_amount'], 2);
                                                                }
                                                                ?></span></td>
                                            ...
                                            if ($segment_discount != 0) {
                                                ...
                                                //debug(['discount']*$currency_conversion_rate);exit;
                                            ...
                                            <?php } ?>
                                            <!--changes removed previous voucher total display-->
            ...
            <tr>
                <td colspan="4" align="right" style="padding-top:10px;font-size:13px;line-height:20px;">
                    <img src="https://www.travelsoho.com/travel-free-travels/extras/system/template_list/template_v3/images/order1.jpg" alt="" align="left" style="width:120px;">
