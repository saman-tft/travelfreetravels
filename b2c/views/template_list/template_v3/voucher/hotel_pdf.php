            ...
            <tr><td style="line-height:6px;">&nbsp;</td></tr>                  
					...
					<td style="padding: 10px;"><table cellpadding="5" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
                           ...
                           <tr>
                              ...
                              <td style="background-color:#666666;border: 1px solid #666666; color:#fff; font-size:9pt; padding:5px;"><img width="12" style="vertical-align:middle" src="<?=SYSTEM_IMAGE_DIR.'people_group.png'?>" alt=""/> <span style="font-size:9pt;color:#fff;vertical-align:middle;"> &nbsp;Guest(s) Details</span></td>
                ...
                <td width="100%" style="padding:0"><table width="100%" cellspacing="-9" cellpadding="5" style="padding: 0;font-size: 9pt;"><tbody><tr><td><table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;border:1px solid #9a9a9a;"><tbody><tr><td style="border-bottom:1px solid #ccc;padding:5px;"><span style="font-size:10pt">Payment Details</span></td>
                             ...
                             <!--  <?php if($itinerary_details['gst'] > 0){?> -->
                              ...
                              <tr>
                                ...
                                <td style="padding:5px"><span><?php echo $booking_details['discount']-$booking_details['reward_amount']; ?></span></td>
                              ...
                              <tr>
                                ...
                                <td style="border-top:1px solid #ccc;padding:5px;font-size:10pt;"><span style=""><?php echo round($booking_details['grand_total']-$booking_details['reward_amount']); ?></span></td>
