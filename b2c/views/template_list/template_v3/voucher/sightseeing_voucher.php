...
<div class="table-responsive" style="width:100%; position:relative;background-color: #fff" id="tickect_hotel">
   ...
   <table class="table" cellpadding="0" cellspacing="0" width="100%" style="font-size:13px; font-family: 'Open Sans', sans-serif; width:900px;box-shadow:0 0 5px 0 rgba(0,0,0,.11); margin:30px auto;background-color:#fff; padding:50px 45px;border-radius:8px; " >

      <tbody>

         <tr>

            <td style="border-collapse: collapse; padding:50px 35px;border-top: none;">
                     ...
                     <tr>
                      ...
                      ?></strong>                              </td>
                                          ...
                                          <tbody>
                                             ...
                                             <tr>
                                                ...
                                                <?php if($attributes['ProductImage']):?>
                                                   ...
                                                   <img style="width:160px;height:107px;" src="<?=$attributes['ProductImage']?>" alt="" ></td>

                                                <?php else:?>

                                                     <img style="width:160px;height:107px;" src="<?=$GLOBALS['CI']->template->template_images("no_image_available.jpg");?>" alt=""></td>
                                 ...
                                 <tr>
                                    ...
                                    <td style="background-color:#00a9d6;border: 1px solid #00a9d6; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?=SYSTEM_IMAGE_DIR.'hotel_v.png'?>" alt="" /> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Activity Details</span></td>
...
<script type="text/javascript">
    ...
    function printDiv(divName) {
     ...
     document.body.innerHTML = printContents;
      ...
      document.title = "Activity Ticket-Travel Free Travels";
