...
.bigtimef{font-size: 10px!important;}
...
.priceflights span{font-size: 12px;}
.priceflights strong {
    font-weight: normal;
    margin-right: 3px;
}
...
.priceanbook{padding: 15px 0px;}
.segtwo{background-color: #fafafa;}
.segone{background-color: #ebf6f7;}
...
.centovr {
    background: none repeat scroll 0 0 #2aace0;
    border-radius: 3px;
    color: #fff;
    display: block;
    margin: 0 auto;
...
.col-xs-12{width: 100%;}
.centovr {
    background: none repeat scroll 0 0 #2aace0!important;
    border-radius: 3px;
    font-size: 12px;
    color: #fff;
    display: block;
...
<table width="100%"  cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="header">
    ...
    <tr>
            <td><table width="700" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                <tbody>
                <tr>
                    <td width="100%" style="padding: 10px 10px 0;border-bottom:none">
                        ...
                        <tr>
                            ...
                            <table  width="50%" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                ...
                                <tr>
                                    <td align="right">
                                        <div class="imgpop" style="float: left;padding: 5px 0px 5px 10;width: 100px;object-fit: contain;"><img src="<?php echo base_url();?>/extras/custom/<?php echo CURRENT_DOMAIN_KEY;?>/images/company_logo.png" width="150" height="auto" alt=""></div>
                            ...
                            <table width="100%" height="30" align="right" valign="middle" cellpadding="0" cellspacing="0" border="0" class="devicewidth">
                                <tbody>
                                <tr>
                                    <td height="30" align="center" valign="middle" style="color: #666;font-family: arial;font-size: 16px;font-weight: 600;line-height: 36px;text-align: center;">Flight Details Email</td>
                                </tr>
                            </tbody>
                            </table>
        ...
        $stop_image = 'more_stop.png';
                                                        ...
                                                        <div class="smal_udayp nopad col-xs-3">
                                                            <div class="insidesame">
                                                                ...
                                                                <div class="stop_image">
                                                                    <img src="<?=base_url()?>/extras/system/template_list/template_v3/images/<?=$stop_image?>" width="45px">
                                                                </div>
                                                    ...
                                                    <div class="priceanbook">
                                                           <div class="insidesame">
                                                                <div class="priceflights">
                                                                    ...
                                                                    <span class="f-p"><?=roundoff_number($flight_details['FareDetails']['b2c_PriceDetails']['TotalFare'])?></span>
                                    ...
                                    <div class="tabmarg">
                                        <div class="alltwobnd">
                                                                        ...
                                                                        <div class="flitone"><!--filt first start-->
                                                                            ...
                                                                            <div class="col-xs-7 nopad5">
                                                                                ...
                                                                                <div class="col-xs-4 nopad">
                                                                                    <img src="<?=base_url()?>/extras/system/template_list/template_v3/images/frwdarrow.png" width="26" height="26">
                                                                                </div>
                                                                                <div class="col-xs-4 nopad5">
                                            ...
                                            <?php 
                                             ...
                                             $cur_FareDetails = $flight_details['FareDetails']['b2c_PriceDetails'];
                ...
                <tr>
                    <td width="100%" style="padding: 10px 10px 0; border-left:1px solid #ddd;border-right:1px solid #ddd;">
                        ...
                        <h4 style="font-family: arial,serif;">Fare Details</h4>
                        <tbody>
                          <tr><!-- start -->
                            <td>

                                <table width="700" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner" style="border:1px solid #ccc;">
                                    <!-- <thead>
                                        <tr>
                                            <th style="color: #000;font-family:arial,serif; font-size: 14px;line-height: 24px;text-align: left;background-color: #f7f7f7;padding: 5px 10px;border-bottom:1px solid #ccc;font-weight: 600;"></th>
                                        </tr>
                                    </thead> -->
                                    <tbody style="border: 1px solid #ccc;">
                                    ...
                                    <td style="color: #000;font-family:arial,serif; font-size: 12px;line-height: 24px;text-align: left;border: 1px solid #ddd;">
                                        ...
                                        $rules .= '<td>';
                                            ...
                                            $rules .= '<h4 class="farehdngg" >Fare Rules</h4>';
                                ...
                                <tr>
                                  <td>
                                    ...
                                    <tr>
                                        <td align="left" valign="middle" style="color: #0545b2;font-family: arial;font-size: 12px;padding:22px 10px;text-align: left;" st-content="preheader"><a href="<?=base_url()?>terms" style="text-decoration: underline; color: #0545b2">Terms & Conditions</a> </td>
            ...
            <td><table width="700" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth2">
                ...
                <tr>
                    <td width="100%" style="padding: 10px 10px 0; border:1px solid #ddd; border-top:none">
                        ...
                        <table width="100%" align="left" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td align="left" valign="middle" style="color: #0545b2;font-family: arial;font-size: 12px;padding:22px 10px;text-align: left;" st-content="preheader"><a href="<?=base_url()?>terms-conditions" style="text-decoration: underline; color: #0545b2">Terms & Conditions</a> </td>
...
<!--  <table width="100%"  cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="postfooter" > --> 
     <table width="700" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth2">
        <tbody>
    <tr>
            <td><table width="700" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth2"  bgcolor="#fff">
                <tbody>
                <tr>
                    <td width="100%" style="padding: 10px 10px 0;border-top:none"><table width="700" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                        <tbody>
                        <tr>
                        <td>
                            ...
                            <table width="35%" align="left" cellpadding="0" cellspacing="0" border="0">
                               <tr>
                                    <td align="right">
                                         <div class="imgpop" style="float: left;padding: 5px 0px 5px 10;"><img src="<?php echo base_url();?>/extras/custom/<?php echo CURRENT_DOMAIN_KEY;?>/images/company_logo.png" width="150" height="90" alt=""></div>
                        ...
                        <table width="35%" align="left" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td align="left" valign="middle" style="color: #666;font-family: arial;font-size: 12px;padding:22px 10px;text-align: left;" st-content="preheader"><span style="color: #000">TRAVELFREETRAVELS<br>
                                                                                                                Email:Info@Travelfreetravels.Com<br>
                                                                                                                Address: <?php echo STATIC_ADDRESS?>.</span> </td>
                            
                        </tr>
                        </table>
                        <table  width="30%" align="left" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td align="left" valign="middle" style="color: #666;font-family: arial;font-size: 12px;padding:22px 10px;text-align: left;" st-content="preheader"><span style="color: #000">+977-1-5365553</span>
