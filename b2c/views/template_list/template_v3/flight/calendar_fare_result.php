...
<section class="search-result">
	<div class="container">
		...
		<div class="resultalls">
			<div class="coleft" id="mobilesearch">
			...
			<div class="filter_tab fa fa-filter">
...
<script>
	$(document).ready(function() {
		...
		function load_flight_fare_calendar(date) {
			...
			/*$.each(_active_booking_source, function(k, booking_source_name) {*/
				core_flight_fare_loader(_active_booking_source, date);
			/*});*/
		}
		/**
	...
	$(document).ready(function(){
		$(".close_fil_box").on('click',function(){
			$("#mobilesearch").provabPopup().close();
		})

		$(".filter_tab").on('click',function(){
			$("#mobilesearch").provabPopup().show();
		})
