...
<div class="search-result">
	...
	<div class="bakrd_color">
    	...
    	<div class="cancellation_page">
             ...
             <div class="col-xs-12 nopad">
                ...
                foreach($booking_customer_details as $customer_k => $customer_v) {
	            	...
	            	if($customer_v['status'] == 'BOOKING_CONFIRMED'){
	            		$pax_check_box = '<input type="checkbox" name="passenger_origin[]" class="passenger_fk" value="'.$customer_v['origin'].'" data-type="'.$passenger_type.'" ><span class="checkmark"></span>';
	            	} else {
	            		$pax_check_box = '';
	            	}
                    $i++;
	            ?>
	            	<div class="row_can_table">
	            		<div class="col-xs-2 nopad ffg">
		                	<div class="can_pads can_check fgcheck"><?=($customer_k+1)?>. <?=$pax_check_box?></div>
		                </div>
		            	<div class="col-xs-2 nopad ffg">
            ...
            <div class="clearfix"></div>
            <div class="ritside_can col-xs-10 col-md-4 nopad">
...
<div class="modal fade" tabindex="-1" role="dialog" id="select_passenger">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" style="color:red;">Please select all passenger</h4>
      </div>
...
$(document).ready(function() {
    ...
    // var pax_count_total = $('input:checkbox[name="passenger_origin[]"]').length;
		if(pax_count > 0) {
                var status=false;
