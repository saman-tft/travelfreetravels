...
/*    changes Added new styles for promocode banner in booking page*/
    .promo-code-message-promo {
        padding: 1.5em;
        margin-top: -2em;
    }
...
/*    changes Added styles for promocode text*/
/*        .promo-code-message-promo {
            padding: 1em;
        }
...
*/
/*changes Added styles for promocode banner*/
.promo-code-message-promo {
            padding: 1em;
            margin-top: -2em;
        }
...
/*    changes Added new mediaquery for the new promocode banner*/
...
for ($pax_index = 1; $pax_index <= $total_pax_count; $pax_index++) {//START FOR LOOP FOR PAX DETAILS
    ...
    <?php echo (is_adult($pax_index, $total_adult_count) ? $adult_title_options : $child_title_options) ?>
                                                            ...
                                                            <div class="col-xs-5 spllty">
                                                                <input required value="<?php if(ctype_alpha($cur_pax_info['first_name'])){ echo $cur_pax_info['first_name'];} ?>"  type="text" name="first_name[]" id="passenger-first-name-<?= $pax_index ?>" class="<?= $extract_pax_name_cls ?> clainput   <?= $traveller_class.'_'.$pax_type ?>" maxlength="20" data-id="<?=$pax_type?>" placeholder="Enter First Name" data-row-id="<?= ($pax_index); ?>"/>
                                                            </div>
                                                            <div class="col-xs-4 spllty">
                                                                <input required value="<?php if(ctype_alpha($cur_pax_info['first_name']) && ctype_alpha($cur_pax_info['last_name'])){ echo $cur_pax_info['last_name'];} ?>"  type="text" name="last_name[]" id="passenger-last-name-<?= $pax_index ?>" class="<?= $extract_pax_name_cls ?> clainput  " maxlength="20" placeholder="Enter Last Name" />
                                                            </div>
...
?>
                            ...
                            <!--             <div class="promo-code-message-promo">
                                        <p style="font-weight:600; color:black;">Please <a class="link__login"
                                                    style="color:blue" href="<?php echo base_url() . 'login' ?>"
                                                    class="login-button-promo">login</a> to enjoy discounts
                                                on your ticket by using a <strong>promo code.</strong></p>
                                        </div> -->
                                        <!--changes added entire div for promocode message-->
                                 <!--       <div class="promo-code-message-promo">
                                            <p style="font-weight:600; color:white;">Please <a class="link__login"
                                                    style="color:white" href="<?php echo base_url() . 'login' ?>"
                                                    class="login-button-promo"> <span style="font-weight:800;text-decoration: underline;
    text-decoration-thickness: 3px;">login </span></a> to enjoy discounts
                                                on your ticket by using a <strong>promo code.</strong></p>
                                        </div> -->
                                        <!-- changes Added new promocode banner for booking page -->
                                                  <a href="<?php echo base_url() . 'login' ?>"> 
                                            <div class="promo-code-message-promo">
                                                <img src="<?php echo SYSTEM_IMAGE_DIR . "login_prompt.png" ?>"
...
checked data-toggle="toggle" data-size="mini" name="redeem_points"> <span class="slider_rew
