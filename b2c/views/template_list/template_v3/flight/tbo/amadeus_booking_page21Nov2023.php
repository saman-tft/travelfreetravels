              ...
              <?php if (in_array(PAY_NOW, $active_payment_options)) { ?>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <img src="<?php echo base_url('/extras/system/template_list/template_v3/images/fonepay.png'); ?>" style="width:80px; height:80px;">
                                                        </div>
                                                    </div>
<?php } ?>
<?php if (in_array(PAY_AT_BANK, $active_payment_options)) { ?>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <img src="<?php echo base_url('/extras/system/template_list/template_v3/images/connectips.png'); ?>" style="width:80px; height:80px;">
                                                        </div>
                                                    </div>
<?php } ?>
                                            </div>
   ...
   // debug($ApiPriceDetails);exit;
    ...
    foreach ($PassengerFareBreakdown as $k => $v) {
        ...
        $pax_base_fare_details .= '<div class="reptallt">
                        <div class="col-xs-8 nopadding">
                            <div class="faresty">' . $pax_count . ' ' . $pax_type . '(s) ‎(1 X ' . ($pax_base_fare) . ')</div>
                        </div>
                        <div class="col-xs-4 nopadding">
