            ...
            foreach ($__segment_v as $__stop => $__segment_flight) {
               // debug($__segment_flight);exit;
                ...
                $inner_summary .= '<div class="col-xs-5 nopad5">
                                        ...
                                        <div class="termnl">'.ucwords(strtolower($__segment_flight['DestinationDetails']['AirportName'])).' ('.$__segment_flight['DestinationDetails']['AirportCode'].'
                                        </div>';
                $inner_summary .= '</div>';
                //Between Content -----
...
//print_r($count);
            ...
            //airline
            if($__segment_v['AirlineDetails']['AirlineCode']=="YT")
            {
                 $__segment_v['AirlineDetails']['AirlineName']="Yeti Airlines";
            ...
            $outer_summary .= '<div class="quarter_wdth nopad ' . add_special_class('col-xs-3', 'col-xs-3', $domestic_round_way_flight) . '">
                                        ...
                                        <div class="m-b-0 text-center">
                                            ...
                                            <strong> ' . $__segment_v['AirlineDetails'][''] . ' ' . $__segment_v['AirlineDetails']['FlightNumber'] . ' '.$__segment_v['AirlineDetails']['FareClassCode'].'</strong>
                                        </div>
                                      </div>';
            //depart
        ...
        $outer_summary .= '</div>';
         // changes start session: change 2
                 // change for sess expiry 2 added search_hash after booking_source
        $outer_summary .= '
