...
for ($pax_index = 1; $pax_index <= $total_pax_count; $pax_index++) {//START FOR LOOP FOR PAX DETAILS
    ...
    <?php echo (is_adult($pax_index, $total_adult_count) ? $adult_title_options : $child_title_options) ?>
                                                            ...
                                                            <div class="col-xs-5 spllty">
                                                                <input value="<?php if(ctype_alpha($cur_pax_info['first_name'])){ echo $cur_pax_info['first_name'];} ?>" required type="text" name="first_name[]" id="passenger-first-name-<?= $pax_index ?>" class="<?= $extract_pax_name_cls ?> clainput   <?= $traveller_class.'_'.$pax_type ?>" maxlength="20" data-id="<?=$pax_type?>" placeholder="Enter First Name" data-row-id="<?= ($pax_index); ?>"/>
                                                            </div>
                                                            <div class="col-xs-4 spllty">
                                                                <input value="<?php if(ctype_alpha($cur_pax_info['first_name']) && ctype_alpha($cur_pax_info['last_name'])){ echo $cur_pax_info['last_name'];} ?>" required type="text" name="last_name[]" id="passenger-last-name-<?= $pax_index ?>" class="<?= $extract_pax_name_cls ?> clainput  " maxlength="20" placeholder="Enter Last Name" />
                                                            </div>
