<!-- changes added php code for the promocode carousel -->
...
$promoCodeList = get_active_promocodes();
$locationText = ""; ?>
<!--styles added here-->
<style>
    * {
    ...
    /* changes start of styles for promocode carousel */
    .promo__container h2 {
    ...
    /* changes end of styles for promocode carousel */
</style>
<?php
$total_seg_cnt = 0;
...
?>
<style>
    /*changes Added new styles for displaying promocode message*/
    .promo-code-message-promo {
        padding: 1.5em;
    }

    .promo-code-message-promo img {
        min-width: 100%;
        max-width: 100%;
        height: 6em;
    }
    ...
    /*changes added new media queries to fit the text properly in phones*/
...
<div class="alldownsectn">
    <div class="container">
        ...
        <div class="ovrgo">
            ...
            <!-- <div id="session-remaining-time" class="pull-right" style="display: none;"></div> -->
            ...
            <div class="bktab1 xlbox <?= $review_tab_details_class ?>">
                                        ...
                                        <div class="newloginsectn">
                                            ...
                                            <div class="col-xs-5 celoty nopad">
                                                <div class="insidechs booklogin">
                                                    <div class="leftpul">
                                                        <?php
                                                        //changes removed login with facebook button
                                                        ...
                                                        ?>
                                                        <!-- changes added a new promocode caorusel to display promocodes for non logged in users -->
                                                        <!-- changes start of promocode carousel -->
                                                        <?php if (!empty($promoCodeList) && count($promoCodeList) > 0) { ?>
                                                            <div class="promo__container">
                                                                <h2>Promo Codes</h2>

                                                                <div id="promo-carousel" class="owl-carousel owl-theme">
                                                                    <?php foreach ($promoCodeList as $key => $value) { ?>
                                                                        <?php $discountAmount = $value['value_type'] == 'percentage' ? $value['value'] . ' %' : 'NPR ' . $value['value'];
                                                                        $fromCity = $value['promo_for_city'] != "" ?   $value['promo_for_city'] : "";
                                                                        $toCity = $value['promo_to_city'] != "" ?  $value['promo_to_city'] : "";
                                                                        if (($fromCity == "") || ($fromCity == "")) {
                                                                            if (($value['for_country'] == 'NP' || $value['for_country'] == 'IN') && ($value['to_country'] == 'NP' || $value['to_country'] == 'IN')) {
                                                                                $locationText = "domestic flights";
                                                                            } elseif (($value['for_country'] == '' && $value['for_city'] == '') && ($value['to_country'] == '' && $value['to_city'] == '')) {
                                                                                $locationText = "flights";
                                                                            } else {
                                                                                $locationText = "international flights";
                                                                            }
                                                                        } else {
                                                                            $locationText = "flights from $fromCity to $toCity";
                                                                        }
                                                                        ?>
                                                                        ...
                                                                        <div class="item">
                                                                            <div class="promo__code">
                                                                                <p><?php echo $value['promo_code']; ?></p>
                                                                            </div>
                                                                            <div class="promo__summary">
                                                                                Use above promo-code to get flat <?php echo $discountAmount; ?> discount on your <?php echo $locationText; ?> (for minimum spend of NPR <?php echo $value['minimum_amount']; ?>).
                                                                                <br />
                                                                                <a href="<?php echo base_url() . 'promocodepage#promoterms' ?>">Terms & Conditions</a>
                                                                                <div class="validity__date">
                                                                                    Valid Till: &nbsp;<?php echo $value['expiry_date']; ?>
                                                                                </div>
                                                                            </div>

                                                                            <div class="buttons__container">
                                                                                <a class=" promo__button" href="<?php echo base_url('/promocodepage'); ?>"> Promo Codes</a>
                                                                            </div>
                                                                        </div>
                                                                    <?php } ?>
                                                        ...
                                                        <?php } ?>
                                                        <!-- changes end of promocode carousek -->
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="col-xs-4 nopadding rit_summery">
                    <div class="copy_fare_summery">
                        ...
                        <?php if (is_logged_in_user() == false) { ?>
                            <?php echo get_fare_summary($FareDetails, $PassengerFareBreakdown, $convenience_fees, $insurance_amount, $insurance_status, $org_convience_fee, $ApiPriceDetails, $api_markup_details, $convenience_fees_orginal, $gst_value_conv, $discount, $segmentCount); ?>
                        <?php } ?>
                    </div>
                </div>
                ...
                <div class="padpaspotr">
                    <div class="col-md-8 col-xs-12 nopadding tab_pasnger">
                        ...
                        <div class="fligthsdets">
                            ...
                            //changes start unsetting mstr
                            unset($adult_enum[6]);
                            unset($child_enum[6]);
                            //changes end unsetting mstr
                            //changes start unsetting Ms
                            unset($adult_enum[2]);
                            unset($child_enum[2]);
                            //changes end unsetting Ms  
                            ...
                            ?>
                            <!-- changes: change action url to make_secure_payment -->
                            <form action="<?= base_url() . 'index.php/flight/make_secure_payment/' . $search_data['search_id'] ?>" method="POST" autocomplete="off" id="pre-booking-form">
                                <div class="hide">
                                    <!--changes start session: = change 1-->
                                    <!--change for session expiry 1 added following field-->
                                    <!-- <input type="hidden" required="required" name="search_hash" value="< $session_expiry_details['search_hash']; ?>" /> -->
                                ...
                                <div class="flitab1">
                                                    ...
                                                    <div class="col-xs-11 nopadding full_dets_aps">
                                                        ...
                                                        <div class="inptalbox">
                                                            ...
                                                            <div class="col-xs-5 spllty">
                                                                <input value="<?php if (ctype_alpha($cur_pax_info['first_name'])) {
                                                                                    echo $cur_pax_info['first_name'];
                                                                                } ?>" required type="text" name="first_name[]" id="passenger-first-name-<?= $pax_index ?>" class="<?= $extract_pax_name_cls ?> clainput   <?= $traveller_class . '_' . $pax_type ?>" maxlength="20" data-id="<?= $pax_type ?>" placeholder="Enter First Name" data-row-id="<?= ($pax_index); ?>" />
                                                            </div>
                                                            <div class="col-xs-4 spllty">
                                                                <input value="<?php if (ctype_alpha($cur_pax_info['first_name']) && ctype_alpha($cur_pax_info['last_name'])) {
                                                                                    echo $cur_pax_info['last_name'];
                                                                                } ?>" required type="text" name="last_name[]" id="passenger-last-name-<?= $pax_index ?>" class="<?= $extract_pax_name_cls ?> clainput  " maxlength="20" placeholder="Enter Last Name" />
                                                            </div>
                                                            <?php if ($pax_type == 'infant') { //Only For Infant  
                                                            ?>
                                                                <div class="spllty infant_dob_div">
                                                                    <!-- <div class="col-xs-4 nopadding"><span class="fmlbl">Date of Birth <?= $mandatory_filed_marker ?></span></div> -->
                                                                    <!--id changed here-->
                                                                    <div id="dob__input" class="nopadding">
                                    ...
                                    <!-- added following to display message for non logged in users about promo code -->
                                    <?php
                                    if (!is_logged_in_user()) {
                                    ?>
                                        <!--changes added entire div for promocode message-->
                                        <a href="<?php echo base_url() . 'login' ?>">
                                            <div class="promo-code-message-promo">
                                                <img src="<?php echo SYSTEM_IMAGE_DIR . "login_prompt.svg" ?>" alt="promo-code-banner">
                                            </div>
                                        </a>
                                    ...
                                    <script type="text/javascript">
                                        $('.login-button-promo').click(function() {
                                            $("#signinModal").modal('show');
                                        });
                                    </script>

                                    <!-- this section hides the promo section for non logged in users and disables apply button -->
                                    <div class="ontyp <?php if (!is_logged_in_user()) {
                                                            echo 'hide';
                                                        } ?>">
                                        <div class="kindrest">
                                            <div class="cartlistingbuk">
                                                <div class="cartitembuk">
                                                    <div class="col-md-12">
                                                        <div class="payblnhmxm">Have a Promo-Code or a deal-code ? (Optional)</div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <div class="cartitembuk prompform">
                                                    ...
                                                    //  $promo_from_loc = md5($search_data['from_loc']);
                                                    //  $promo_to_loc = md5($search_data['to_loc']);

                                                    // $promo_from_country = md5(get_country_code_from_city_code($search_data['from_loc']));
                                                    //   $promo_to_country = md5(get_country_code_from_city_code($search_data['to_loc']));
                                                    ?>
                                                    <!--changes start of new code for promocode handle for multitrips-->
                                                    <form name="promocode" id="promocode" novalidate>
                                                        <?php
                                                        $promo_to_location = explode(" ", $search_data['to_city']);
                                                        $promo_for_location = explode(" ", $search_data['from_city']);
                                                        if (is_array($search_data['from_loc'])) {
                                                            foreach ($search_data['from_loc'] as $f_k => $f_v) {
                                                                $promo_from_loc[$f_k] = md5($search_data['from_loc'][$f_k]);
                                                                $promo_to_loc[$f_k] = md5($search_data['to_loc'][$f_k]);
                                                                $promo_from_country[$f_k] = md5(get_country_code_from_city_code($search_data['from_loc'][$f_k]));
                                                                $promo_to_country[$f_k] = md5(get_country_code_from_city_code($search_data['to_loc'][$f_k]));
                                                            }
                                                        } else {
                                                            $promo_from_loc[0] = md5($search_data['from_loc']);
                                                            $promo_to_loc[0] = md5($search_data['to_loc']);
                                                            $promo_from_country[0] = md5(get_country_code_from_city_code($search_data['from_loc']));
                                                            $promo_to_country[0] = md5(get_country_code_from_city_code($search_data['to_loc']));
                                                        }

                                                        $promo_from_loc = implode(',', $promo_from_loc);
                                                        $promo_to_loc = implode(',', $promo_to_loc);
                                                        $promo_from_country = implode(',', $promo_from_country);
                                                        $promo_to_country = implode(',', $promo_to_country);
                                                        // changes end of new code for promocode handle for multitrips
                                                            ...
                                                            <div class="cartprc">
                                                                <div class="payblnhm singecartpricebuk ritaln">
                                                                    ...
                                                                    */ ?>
                                                                    ...
                                                                    <input type="hidden" name="promo_from_country" id="promo_from_country" value="<?= @$promo_from_country ?>" />
                                                                    <input type="hidden" name="promo_to_country" id="promo_to_country" value="<?= @$promo_to_country ?>" />
                                                                    <input type="hidden" name="promo_from_loc" id="promo_from_loc" value="<?= @$promo_from_loc ?>" />
                                                                    <input type="hidden" name="promo_to_loc" id="promo_to_loc" value="<?= @$promo_to_loc ?>" />
                                                        ...
                                                        <div class="col-md-2 col-xs-4 nopadding_left">
                                                            <input type="button" value="Apply" name="apply" id="apply<?php if (!is_logged_in_user()) {
                                                                                                                            echo 'promo';
                                                                                                                        } ?>" class="promosubmit">
                                                        </div>
                                                    </form>
...
<?php $state_list = generate_options($state_list); ?>
                    ...
                    <div class="col-xs-4 nopadding rit_summery a">
                        <!-- changes removed reward points toggle for now removed $reward_usable from  below two if conditions -->
                        <?php if (false) { ?>
...
round"></span> </label>
                            ...
                            <?php if (false) { ?> <div class="col-xs-6">Earning reward</div>
...
function get_fare_summary($FareDetails, $PassengerFareBreakdown, $convenience_fees, $insurance_amount, $insurance_status, $org_convience_fee, $ApiPriceDetails, $api_markup_details, $convenience_fees_orginal, $gst_value_conv = '', $discount = 0, $segmentCount)
{
    ...
    //changes added the span tag below to adjust styling because of removal of reward points checkbox
    $currency = $FareDetails['Currency'];
    $fare_summary = '<div class="insiefare">
                <div class="farehd arimobold"><span style="margin-left:10px;">Fare Summary</span></div>
                <div class="fredivs">';
    ...
    foreach ($PassengerFareBreakdown as $k => $v) {
        ...
        //changes added the following if condition for roundtrip
        if ($segmentCount === 2 && $v['Count'] > 0) {
            $pax_base_fare = $pax_base_fare - $ApiPriceDetails['PriceBreakup']['AgentCommission'];
        }
        $pax_count = $v['Count'];
...
// change 2 for session expiry uncommented the following code
...
?>
<script type="text/javascript">
    // changes start session: updated these session variables
    /*
    ...
    // // var start_time = "<echo $session_expiry_details['session_start_time']; ?>";
    // var start_time1 = "<?php echo $session_expiry_details['session_start_time']; ?>";
    // var add_sess_time = <?php echo $GLOBALS['CI']->config->item('booking_page_add_sess_time'); ?>;
    // start_time = parseInt(start_time1) + parseInt(add_sess_time);
    // var search_id = "<?php echo $search_data['search_id']; ?>";
    ...
    // changes end session: updated these session variables
...
<!-- changes added js for the promocode carousel -->
<script>
