...
<style>
    ...
    .promo-code-message-promo .link__login:hover {
                                        ...
                                        <div class="newloginsectn">
                                            ...
                                            <div class="col-xs-5 celoty nopad">
                                                <div class="insidechs booklogin">
                                                    <div class="leftpul">
                                                        <?php
                                                        // changes removed facebook login button
                                                    ...
                                                    <div class="col-xs-11 nopadding full_dets_aps">
                                                        ...
                                                        <div class="inptalbox">
                                                            ...
                                                            <div class="col-xs-5 spllty">
                                                                <input required value="<?php if (ctype_alpha($cur_pax_info['first_name'])) {
                                                                                            echo $cur_pax_info['first_name'];
                                                                                        } ?>" type="text" name="first_name[]" id="passenger-first-name-<?= $pax_index ?>" class="<?= $extract_pax_name_cls ?> clainput   <?= $traveller_class . '_' . $pax_type ?>" maxlength="20" data-id="<?= $pax_type ?>" placeholder="Enter First Name" data-row-id="<?= ($pax_index); ?>" />
                                                            </div>
                                                            <div class="col-xs-4 spllty">
                                                                <input required value="<?php if (ctype_alpha($cur_pax_info['first_name']) && ctype_alpha($cur_pax_info['last_name'])) {
                                                                                            echo $cur_pax_info['last_name'];
                                                                                        } ?>" type="text" name="last_name[]" id="passenger-last-name-<?= $pax_index ?>" class="<?= $extract_pax_name_cls ?> clainput  " maxlength="20" placeholder="Enter Last Name" />
                                                            </div>
                                    ...
                                    <!--changes added entire div for promocode message-->
                                          <a href="<?php echo base_url() . 'login' ?>"> 
                                            <div class="promo-code-message-promo">
                                                <img src="<?php echo SYSTEM_IMAGE_DIR . "login_prompt.svg" ?>"
                                                            ...
                                                            <div class="col-md-4 col-xs-8 nopadding_right">
                                                                <div class="cartprc">
                                                                    <div class="payblnhm singecartpricebuk ritaln">
                                                                        ...
                                                                        ?>
                                                                        <input type="hidden" name="total_amount_val" id="total_amount_val" class="promocode" value="<?= @$tmt ?>" />
...
<?php echo get_fare_summary($FareDetails, $PassengerFareBreakdown, $convenience_fees, $insurance_amount, $insurance_status, $org_convience_fee, $ApiPriceDetails, $api_markup_details, $convenience_fees_orginal,$gst_value_conv, $discount); ?>
                    ...
                    <?php if (is_logged_in_user() == true) { ?>
                        <div class="col-xs-12 col-md-4 nopadding">
                            <div class="insiefare">
                                <div class="farehd arimobold">Passengers List</div>
                                <div class="fredivs">
                                    <div class="psngrnote">
                                        <?php
                                        if (valid_array($traveller_details)) {
                                            $traveller_tab_content = 'You have saved passengers details in your list,on typing, passengers details will auto populate.';
                                        } else {
                                            $traveller_tab_content = 'You do not have any passengers saved in your list, start adding passengers so that you do not have to type every time. <a href="' . base_url() . 'index.php/user/profile?active=traveller" target="_blank">Add Now</a>';
                                        }
                                        ?>
...
function get_fare_summary($FareDetails, $PassengerFareBreakdown, $convenience_fees, $insurance_amount, $insurance_status, $org_convience_fee, $ApiPriceDetails, $api_markup_details, $convenience_fees_orginal, $gst_value_conv = '', $discount = 0)
{
    ...
    foreach ($PassengerFareBreakdown as $k => $v) {
        ...
        $pax_base_fare_details .= '<div class="reptallt">
                        ...
                        <div class="col-xs-4 nopadding">
                            <div class="amnter"><span class="base_fare_span">' . $currency_symbol . '</span> <span class="base_fare_value' . $i . '">' . ($pax_base_fare * $pax_count) . ' </span></div>
                        </div>
                    </div>';
        $i++;
    }
...
<!--changes added new script for promocode carousel-->
<script>
    $(document).ready(function() {
