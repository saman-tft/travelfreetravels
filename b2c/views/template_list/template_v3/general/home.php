...
var tmpl_imgs = '';
    ...
    <!--changes Added new styles and scripts for popup-->
    <style>
        #popup-container {
            display: none;
            position: fixed;
...
<!--     <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const popupImage = document.querySelector(".coupon-container a")
            const closeBtn = document.querySelector(".coupon-container .close__promo");
            const popupShow = sessionStorage.getItem("popupDisplayed");
            if (!popupShow) {
    ...
    <!--end of changes Added new styles and scripts for popup-->
    <!--changes Added new popup-->
    <div id="popup-container">
        <div class="coupon-container active">
            <div class="close__promo">
            ...
            <a href="<?php echo base_url() . 'promocodepage' ?>"><img class="large-popup" src="<?php echo SYSTEM_IMAGE_DIR . "promo-popup.jpg" ?>" alt="popup image" />
            <a href="<?php echo base_url() . 'promocodepage' ?>"><img class="small-popup" src="<?php echo SYSTEM_IMAGE_DIR . "promo-popup.jpg" ?>" alt="popup image" />
            </a>
            
        </div>
    </div>
    <div class="space__container-home"></div>
    <!--end changes Added new popup-->
<div class="searcharea">
    <div class="srchinarea">
        <div class="container-fluid nopad">
            <!-- Added id here for removing space in mobile -->
            <div id="additional_div" class="captngrp new_txt">
                ...
                <div class="container nopad inspad">
                    <div class="tab_border">
                        ...
                        <ul class="nav nav-tabs tabstab">
                            ...
                            <?php } ?>
                            <!--changes removed the following if condition and added false to remove unnecessary links for now and also commented the li to remove transfers
                            $selected_module=="transfers" -->
<!-- <li class="<?php if(false){ echo "active"; } ?>"><a
   ...
   <!--changes removed the following if condition and added false to remove unnecessary links for now
...
<!-- changes removed echo from the following php tags as there were duplicate form ids and these modules don't currently function that well -->
                            <?php if (is_active_bus_module()) { ?>
                            <div class="tab-pane <?php  set_default_active_tab(META_BUS_COURSE, $default_active_tab)?> buses_modules"
                                id="bus" style="display: none;">
                                <?php  $GLOBALS['CI']->template->isolated_view('share/bus_search')?>
                            </div>
                            <?php } ?>
                            ...
                            <div class="tab-pane <?php  set_default_active_tab(META_CAR_COURSE, $default_active_tab)?> cars_modules"
                                id="car1" style="display: none;">
                                <?php  $GLOBALS['CI']->template->isolated_view('share/car_search')?>
                            </div>
                            <?php } ?>
                            ...
                            <div class="tab-pane <?php echo set_default_active_tab(META_PACKAGE_COURSE, $default_active_tab)?> holidays_modules"
                                ...
                                <?php  $GLOBALS['CI']->template->isolated_view('share/holiday_search',$holiday_data)?>
                            </div>
                            <?php } ?>
                            <div class="tab-pane <?php if($selected_module=="privatecar"){ echo "active"; } ?> private_car_modules"
                                id="privatecar">
                                <?php  $GLOBALS['CI']->template->isolated_view('share/private_car')?>
                            </div>
                            <div class="tab-pane <?php if($selected_module=="transfers"){ echo "active"; } ?> private_transfers_modules"
                                id="privatetransfer">
                                <?php  $GLOBALS['CI']->template->isolated_view('transfer/transfer_search')?>
                            </div>
                            ...
                            <div class="tab-pane <?php echo set_default_active_tab(META_SIGHTSEEING_COURSE, $default_active_tab)?> activities_modules"
                                ...
                                <?php  $GLOBALS['CI']->template->isolated_view('share/activity_search',$holiday_data)?>
                            </div>
                            <?php } ?>
                            <!-- changes removed echo from the following php tags as there were duplicate form ids and these modules don't currently function that well upto here -->
                        </div>
                    </div>
                </div>
            </div>
...
$show="1";
 ?>
 <!--changes removed this if condition from here to not render this section at all: !empty($top_destination_transfercms)-->
<?php if(false){ ?>
<div class="flight_deals_perfect">
    <div class="pagehdwrap">
...
/* end of testimonials carousel */
    /* holiday and top flight carousel changes */
    .owl-next{
        position:absolute;
        top:130px;
        margin:40px;
