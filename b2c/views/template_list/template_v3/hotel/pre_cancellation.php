		...
		<div class="cancellation_page">
			...
			<div class="toprom">
				...
				<div class="col-xs-4 nopad full_room_buk">
					<div class="bookcol">
						<div class="ffty" style="width: 100%;padding-left: 10px;">
						...
						<div class="clearfix"></div>
						<div class="nigthcunt" style="padding-left: 10px;">Night(s) <?=$total_nights?>, Room(s) <?=$total_rooms?></div>
					</div>
				</div>
			</div>
			...
			?>		
				<div class="row_can_table">
					<div class="col-xs-2 nopad ffg">
						<div class="can_pads can_check fgcheck"><?=$i?>.
							<input type="checkbox" name="passenger_origin[]" class="passenger_fk"><span class="checkmark"></span></div>
					</div>
					<div class="col-xs-2 nopad ffg">
