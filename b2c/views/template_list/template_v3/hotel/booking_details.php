...
<?php
	...
	if(intval($rating) == true){
		...
		$star_rating = '<img alt="" src="'.$GLOBALS['CI']->template->template_images('rating/s'.$rating.'.png').'">';		
	...
	<div class="row top20">
		...
		<div class="col-sm-6 font12">
			...
			<h5 class="mb10 mt30  colorgray font12">
				...
				<span class="bold"><img src="<?php echo $GLOBALS['CI']->template->template_images('hotelb.png'); ?>" alt="" /> Hotel in <?php echo $hotel_city;?> </span> 
						...
						<div class="col-md-6 pad0 ">
							...
							<div class="">
								...
								<div class="d1">
									...
									<img src="<?php echo $GLOBALS['CI']->template->template_images('calender.png'); ?>" alt="" class="callndr">
			...
			<ul class="dropdown-menu booking_list1" aria-labelledby="dLabel1">
				...
				<li class="load_mail_ticket_modal" data-reference_id="'.$v['booking_source'].'" data-app_reference="'.$v['app_reference'].'" data-status="'.$v['status'].'" data-customer_email="'.$customer_email.'">
						...
						<div class="img_mb1">
							...
							<img alt="" src="'.$GLOBALS['CI']->template->template_images('icons/email.png').'" />
				...
				<li class="print_ticket" data-reference_id="'.$v['booking_source'].'" data-app_reference="'.$v['app_reference'].'" data-status="'.$v['status'].'">
						...
						<div class="img_mb1">
							...
							<img alt="" src="'.$GLOBALS['CI']->template->template_images('icons/print.png').'" />
