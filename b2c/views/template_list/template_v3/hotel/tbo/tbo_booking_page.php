...
?>
										...
										<div class="cartlistingbuk">
													...
													<div class="cartitembuk prompform">
														<form name="promocode" id="promocode" novalidate>
														    <?php $promo_for_city= md5($search_data['city_name']);?>
				...
				<div class="clikdiv">
					 ...
					 <span class="clikagre">
					 	<a target="_blank" href="<?=base_url()?>index.php/terms-and-conditions-">Terms and Conditions</a>
					 </span>
				</div>
				<div class="clearfix"></div>
				<div class="loginspld">
...
$("#redeem_points").change(function(){
        ...
        //alert(amount);
        var available_reward=$("#reward_usable").val();
        var div = $('#prompform');
    if($(this). prop("checked") == true){
      ...
      $(".discount_total").text('<?php echo ($price ['api_total_display_fare_with_rewards']); ?>');
      ...
      $(".discount_total").text('<?php echo ($price['api_total_display_fare']); ?>');
