				...
				<div class="smldescrptn">
					...
					<div class="col-sm-7 col-xs-10 nopad">
						...
						<div class="col-xs-3 boxpad none_boil">
							...
							<div class="boxlabl"><span class="faldate fal fa-calendar"></span>Check In</div>
						...
						<div class="col-xs-3 boxpad none_boil">
							...
							<div class="boxlabl"><span class="faldate fal fa-calendar"></span>Check Out</div>
					...
					<div class="col-sm-5 col-xs-2 nopad">
						...
						<div class="col-xs-3 boxpad pull-right">
							...
							<a id="modidown" class="modifysrch" data-toggle="collapse" data-target="#modify"><span class="mdyfydsktp">Modify Search</span><i class="fa fa-angle-down modu mobresdv" aria-hidden="true"></i></a>
