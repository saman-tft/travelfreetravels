    ...
    var load_hotels = function (loader, offset, filters) {
        ...
        _lazy_content = $.ajax({
            ...
            // url: app_base_url + 'index.php/ajax/hotel_list/' + offset + '?booking_source=<?= $active_booking_source[0]['source_id'] ?>&search_id=<?= $hotel_search_params['search_id'] ?>&op=load' + url_filters,
             url: app_base_url + 'index.php/ajax/hotel_list/' + offset + '?booking_source=<?= $current_booking_source ?>&search_id=<?= $hotel_search_params['search_id'] ?>&op=load' + url_filters,
                ...
                if(firstcount==0){
                    ...
                    if(res.data !=""){
                        ...
                        $.ajax({
                            ...
                            url: app_base_url + 'index.php/ajax/hotel_list_check_amenities/' + offset + '?booking_source=<?= $current_booking_source ?>&search_id=<?= $hotel_search_params['search_id'] ?>&op=load' + url_filters,
...
<span class="hide">
    ...
    <input type="hidden" id="api_booking_source" value="<?= $current_booking_source ?>">
...
$loading_image = '<div class="text-center loader-image hide" style="display:none;"><img src="' . $GLOBALS['CI']->template->template_images('loader_v1.gif') . '" alt="Loading........"/></div>';
										...
										<!-- <div class="panel panel-default">
                                            ...
                                            <div class="panel-heading">
                                                ...
                                                <h4 class="panel-title">
                                                    ...
                                                    <a data-toggle="collapse" href="#collapseFive"><span class="glyphicon glyphicon-chevron-down"></span>Reservation Type</a>
                                                            ...
                                                            <ul class="locationul">
																...
																<li>
																	...
																	<div class="squaredThree">
																	   ...
																	   <input type="checkbox"  value="" class="" id="squaredThreea1">

																		<label for="squaredThreea1"></label>

																	</div>

																	<label for="squaredThreea1" class="lbllbl">Refundable</label>
																...
																<li>
																	...
																	<div class="squaredThree">
																	   ...
																	   <input type="checkbox"  value="" class="" id="squaredThreea2">

																		<label for="squaredThreea1"></label>

																	</div>

																	<label for="squaredThreea2" class="lbllbl">Non-Refundable</label>
                                            ...
                                            <div class="insidemyt">
                                                ...
                                                <ul class="sortul">
                                                    ...
                                                    <li class="sortli threonly" data-sort="sr">
                                                        ...
                                                        <a class="sorta star-l-2-h asc" data-order="asc"><!-- <i class="starup"><img src="/extras/system/template_list/template_v3/images/starup.png" width="16" height="16"></i> --> <strong>Rating</strong></a>

                                                        <a class="sorta star-h-2-l hide  des" data-order="desc"><!-- <i class="stardown"><img src="/extras/system/template_list/template_v3/images/stardown.png" width="16" height="16"></i>  --><strong>Rating</strong></a>
                                ...
                                <div class="mapviw noviews">
                                    ...
                                    <div class="mapviwlist nopad noviews reswd">
                                        ...
                                        <div class="rit_view">
                                            ...
                                            <a class="view_type list_click active hide" id="list_clickid" onclick="showhide()"><span class="fa fa-list"></span></a> 
                                    ...
                                    <div class="mapviwhtl nopad noviews reswd">
                                        ...
                                        <div class="rit_view">
                                            ...
                                            <a class="view_type map_click" id="map_clickid" onclick="showhide()"><span class="fal fa-map-marker"></span></a> 
...
<script type="text/javascript">
    ...
    $(window).scroll(function(){
            ...
            $('#hotel_destination_search_name').blur();
