...
.pack_price { font-size: 15px; color:#009edb;  }
  ...
  <div class="container">
    <div class="staffareadash1">
      <div class="tab-content">
          ...
          <div class="trvlwrap">
                ...
                <option value="male" <?php if($gender == "male") echo "selected"; ?>>Male</option>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                          ...
                          <div class="plcetogo datemark sidebord">
                            <input  type="text" class="form-control b-r-0" data-date="true" readonly name="date_of_travel" id="date_of_travel"  placeholder="Date of travel" required />
                          </div>
                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12">
           ...
           <span class="clikagre">
            <a href="<?=base_url ()?>terms-conditions" target="_blank">Terms and Conditions</a>
                  ...
                  <input type="hidden" placeholder="no_adults" name="no_adults" value="<?php echo  $booking['no_adults']; ?>" />
                  <input type="hidden" placeholder="no_child" name="no_child" value="<?php echo  $booking['no_child']; ?>" />
                  <input type="hidden" placeholder="no_infant" name="no_infant" value="<?php echo  $booking['no_infant']; ?>" />
                  <input type="hidden" placeholder="total" class="grandtotal" name="total" value="<?php echo  $grand_total ?>" />
                  <input type="hidden" placeholder="con_fee" class="convenience_fees" name="convenience_fees" value="<?php echo  $convenience_fee ?>" />
                  <input type="hidden" placeholder="prom_value" name="prom_value" id="promo_code_discount_val"/>
                  <input type="hidden" placeholder="promocode_val" name="promocode_val" id="promocode_val"/>
                  <input type="hidden" placeholder="booking_source" name="booking_source" value="<?php echo PACKAGE_BOOKING_SOURCE ?>" />
              <input type="hidden" placeholder="payment_method" name="payment_method" value="<?php echo PAY_NOW ?>" />
        ...
        <tbody>
          <tr class="rmdtls"><th> Activity Details</th><td></td></tr>
          <tr><th>No of Pax</th><td><?=$no_adults+$no_child+$no_infant?></td> </tr>  
