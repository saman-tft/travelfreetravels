...
$_Markup=0;
 ...
 { 
    if(isset($formated_data[$key]['Price']))
    {
      ...
      $ConvinienceFee=$formated_data[$key]['Price']['ConvinienceFee']*($search_data['adult']+$search_data['child']);       
...
.confirm_bboki { background-color: #007dc6 !important;
    ...
    border:1px solid #007dc6 !important;float: left;margin-bottom: 20px; } 
.hotel {
  color: #fff;
  font-size: 18px;
}
...
.blu{color: #009edb!important;text-align: left!important;}
.sidebuki{margin-top: 20px;}
.actipre{margin-top: 20px;}
.drkblue{background-color: #fff!important;}
  </style>                          
  <div class="prebook">
  <div class="container">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12 nopad bookdetails">
                ...
                <h2>Booking Details</h2>
                 ...
                 <div class="col-md-8 actipre">
                  ...
                  <div class="hotel blu"><?php echo  $package->package_name; ?></div>
                </div>
            ...
            <div class="row <?=$payment_option_visibility?>">
              ...
              <!-- Personal Information--> 
                  ...
                  <div class="col-md-4 nopad sidebuki frmbl sticky_div" style="background: #fff;min-height: 342px;">
                    <div id="nxtbarslider" class="nopad"><!-- style="width: 370px; top: 0px;" -->
...
$(document).ready(function() {
 ...
 $("#apply").click(function(){
  console.log($("#total_amount_val").val());
