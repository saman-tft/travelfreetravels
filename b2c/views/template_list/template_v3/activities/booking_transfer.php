...
<div class="loginspld">
<div>
<form id="form_logged" action="<?=base_url()?>index.php/activities/pre_booking/<?=$package->package_id?>" method="post">
...
<div class="insidechs">
<div class="mailenter">
<form id="form_user_submit" action="<?=base_url()?>index.php/activities/pre_booking/<?=$package->package_id?>" method="post">
...
<label for="alreadyacnt" class="haveacntd">I have Wise Travel account</label>
</div>
<div class="clearfix"></div>
<div class="twotogle">
<div class="cntgust">
...
<option value="Malaysia" +60="" selected="">Malaysia +60</option>
