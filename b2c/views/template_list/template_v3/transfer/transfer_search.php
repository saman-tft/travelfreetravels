...
<form autocomplete="off" name="trasfer" id="trasfer" action="<?=base_url()?>index.php/general/pre_transfer_search"
 ...
 oninput="setCustomValidity('')"   class="normalsel normalinput holyday_selct" id="native_country"  name="native_country"
                            onchange="get_visa_country(visa_country.value,this.value);" required>
...
else
{
                ...
                <div class="col-md-6 col-xs-12 nopad placerows">
                    ...
                    <div class="col-md-6 col-xs-12 padfive"> 
                        <div class="lablform">From</div>
                        <div class="plcetogo plcemark sidebord"><!-- deprtures -->
                    ...
                    <div class="col-md-6 col-xs-12 padfive">
                        <div class="lablform">To</div>
                        <div class="plcetogo plcemark sidebord"><!-- destinatios -->
                ...
                <div class="col-md-3 col-xs-12 secndates padfive">
                    <!-- <div class="col-xs-6 padfive"> -->
                    <div class="lablform">Departure Date</div>
            ...
            <div class="col-md-4 col-xs-12 nopad srch">
                                            ...
                                            <div class="input-group countmore pax-count-wrapper adult_count_div">
                                                <span class="input-group-btn">
                                                    <button data-field="adult" data-type="minus"
                                                        ...
                                                        onclick="total_count_transfer('trasfer','minus','adult');"> <span
                                                ...
                                                <span class="input-group-btn">
                                                    <button data-field="adult" data-type="plus"
                                                        ...
                                                        data-id="OWT_transfer_adult"
                                                        onclick="total_count_transfer('trasfer','plus','adult');"> <span
                                            ...
                                            <div class="input-group countmore pax-count-wrapper child_count_div">
                                                <span class="input-group-btn">
                                                    <button type="button"
                                                        ...
                                                        onclick="total_count_transfer('trasfer','minus','child');"> <span
                                                            class="fa fa-minus"></span> </button>
                                                </span>
                                                ...
                                                <span class="input-group-btn">
                                                    <button type="button"
                                                        ...
                                                        onclick="total_count_transfer('trasfer','plus','child');"> <span
                                                            class="fa fa-plus"></span> </button>
                                                </span>
                                            </div>
                                        </div>
                ...
                <!--<div class="col-xs-4 padfive">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-7 mobile_width padfive" style="padding: 0 1px;display:none">
                        <div class="lablform">Markup Type</div>

                        <div class="plcetogo selctmark sidebord">
                            <select class=" inpu normalsel arimo" id="markup_type" name="markup_type"
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-5 mobile_width padfive" style="display:none">
                        <div class="lablform">Value</div>
                        <div class="">
                            <input type="text" id="markup_value" name="markup_value" maxlength="5"
                                class="normalinput inpu form-control numeric" onpaste="return false;" />
                        </div>
                    </div>


                </div>-->
                <div class="col-md-5 col-xs-12 padfive">
...
function total_count_transfer(form_id, type, pass_type) {
