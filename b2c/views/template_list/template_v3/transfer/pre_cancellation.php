					...
					<div class="bookcol">
						<div class="hotelistrowhtl">
							<div class="col-md-4 nopad">
								<div class="imagehotel"><img src="<?php echo $path.$ProductImage; ?>" alt="ProductImage"></div>
							</div>
							<div class="col-md-8 padall10 ">
								<div class="hotelhed"><?=$itinerary_details[0]['transfer_name']?></div>
								<div class="clearfix"></div>
  ...
  <div class="modal-dialog">
	<div class="modal-content">
	  ...
	  <div class="modal-footer">
		...
		<form method="get" action="<?=base_url().'index.php/transfer/cancel_full_booking/'.$app_reference.'/'.$booking_source?>">
