		      	...
		      	<div class="light-border-t mbl">
		            <div class="line light-border-b option-row">
		             <?php
		               ...
		               <?php if($t_value['gradeDepartureTime']):?>
		               		 <p class="mhs mvs green-color">Departure Time : <?=$t_value['gradeDepartureTime']?></p>
		               <?php endif;?>
		            ...
		            <?php endif;?>
		               ...
		               <div class="txtR mas line">
		                 ...
		                 <div class="h2 strong"><span class="ttlfnt">Total:</span> <?php echo $currency_obj->get_currency_symbol($currency_obj->to_currency); ?>  <?=$t_value['Price']['TotalDisplayFare']?></div>
