		...
		<div class="row">
			...
			<div class="col-sm-<?php echo $col_md;?>">
				...
				<div class="row mt20 mb10 font12 bold">
						...
						<div class="col-md-9"><img src="<?php echo $GLOBALS['CI']->template->template_images('icons/bus.png'); ?>" alt="">  <?php echo $source_name; ?> <i class="fa fa-long-arrow-right"></i> <?php echo $destination_name;?>: <span class="fn seater"><?php echo $journey_date;?> (<?php echo $total_duration['hours'].'hr '.$total_duration['minutes'].'m'; ?> )</span></div>
							...
							<div class="col-md-6">
								...
								<div class="row">
									...
									<div class="col-md-3">
										...
										<img src="<?php echo $GLOBALS['CI']->template->template_images('icons/bus.png'); ?>" alt="">
	...
	$supports = '<div class="row pay_summary_details font12">
						...
						<div class="col-sm-12 p20 blue bold lh35">
							...
							<div class="col-sm-6">
								...
								<img class="support-icons" alt="" src="'.$GLOBALS['CI']->template->template_images('icons/service.png').'">

								<span> customercare@proapp.com</span>

								<br>

								<img class="support-icons" alt="" src="'.$GLOBALS['CI']->template->template_images('icons/call-proapp.png').'">
							...
							<div class="col-sm-6">
								...
								<img class="support-icons" alt="" src="'.$GLOBALS['CI']->template->template_images('icons/faq.png').'">
