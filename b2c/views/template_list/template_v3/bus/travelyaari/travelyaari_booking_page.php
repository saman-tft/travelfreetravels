...
/*if($CUR_Route['CommAmount'] >0)

{

	$base_fare +=$CUR_Route['CommAmount'];

	$total_fare +=$CUR_Route['CommAmount'];

	$markup_total_fare +=$CUR_Route['CommAmount'];
...
// debug($Markup);exit;
     ...
     $convenience_details = $GLOBALS['CI']->custom_db->single_table_records('convenience_fees', '*', array('module' => 'bus'));

     // debug($convenience_details);exit;

     if($convenience_details !="")

     {

     	if($convenience_details['data'][0]['value_type']=="plus")

     	{

     		$con_amt=$convenience_details['data'][0]['value'];
...

     	{
     		...
     		$con_amt=($convenience_details['data'][0]['value']/100)*$total_fare;
     	...
     	if($convenience_details['data'][0]['convenience_fee_currency'])

     	$currency_obj = new Currency(array('module_type' => 'bus', 'from' =>$convenience_details['data'][0]['convenience_fee_currency'], 'to' => get_application_currency_preference()));

     	$convenience_fees=get_converted_currency_value($currency_obj->force_currency_conversion($con_amt));
				...
				<!-- Fare Summary  Starts-->
					...
					<div class="col-xs-4 nopadding rit_summery">
						...
						<div class="insiefare">
							...
							<div class="fredivs">
							   ...
							   <div class="reptalltftr">
									...
									<div class="col-xs-4 nopadding">
										...
										<div class="amnterbus arimobold"><?=$default_currency_symbol?> <?=roundoff_number($base_fare)?> </div>
								...
								<div class="clearfix"></div>
								 ...
								 <div class="reptalltftr">
									...
									<div class="col-xs-4 nopadding">
										...
										<div class="amnterbus arimobold"><?=$default_currency_symbol?> <?=roundoff_number($convenience_fees)?> </div>
								...
								<div class="reptalltftr">
									...
									<div class="col-xs-4 nopadding">
										...
										<div class="amnterbus arimobold"><?=$default_currency_symbol?> <?=roundoff_number($gst_value_conv)?> </div>
							...
							<div class="farestybus">Promo Code Discount</div>

						</div>

						<div class="col-xs-4 nopadding promo_code_discount hide">

							<div class="amnterbus arimobold promo_discount_val"> </div>
								...
								<div class="reptalltftr">
									...
									<div class="col-xs-4 nopadding">
										...
										<div class="amnterbus arimobold grandtotal"><?=$default_currency_symbol?> <?=roundoff_number($markup_total_fare+$gst_value_markup+$gst_value_conv+$convenience_fees)?> </div>
				...
				<div class="padpaspotr">
					...
					<div class="col-xs-4 nopadding rit_summery">
						...
						<div class="insiefare">
							...
							<div class="farestybus" style="text-transform: uppercase;">Promo Code Discount</div>
			 ...
			 <div class="flitab1">
					...
					<div class="ontyp">
					  ...
					  <div class="labltowr arimobold"><?=ucfirst($CUR_Route['From'])?> to <?=ucfirst($CUR_Route['To'])?><strong>(<?=get_time_duration_label(calculate_duration($CUR_Route['DepartureTime'], $CUR_Route['ArrivalTime']))?>)</strong></div>
						...
						<div class="pasngrinput_enter">
								...
								<div class="pad_psger">
									...
									<span class="seat_number"> Seat <strong><?=$i_seat['seat_no']?></strong></span>
										...
										<div class="pad_psger">
												...
												<input value="<?=@$cur_pax_info['first_name']?>" type="text" maxlength="40" id="contact-name"  name="contact_name[]" class="clainput  alpha_space no_copy_paste <?=$traveller_class?>" required placeholder="Name" data-row-id="<?=($i);?>">
							...
							$dynamic_params_url['gst_value'] = $gst_value_markup+$gst_value_conv;
				...
				<div class="ontyp">
					...
					<div class="cartlistingbuk">
				                      ...
				                      <div class="cartprc">
				                        ...
				                        <div class="payblnhm singecartpricebuk ritaln">
				                    	 ...
				                    	 <input type="text" placeholder="Enter Promo" name="code" id="code" class="promocode" aria-required="true" maxlength="15" />
				                          ...
				                          <input type="hidden" name="total_amount_val" id="total_amount_val" class="promocode" value="<?=@$subtotal+$gst_value_markup;?>" />
								...
								<div class="loading hide" id="loading"><img src="<?php echo $GLOBALS['CI']->template->template_images('loader_v3.gif')?>" alt="Book a tour to India"></div>
				...
				<div class="clikdiv">
					...
					<span class="clikagre" id="clikagre">
						...
						<a target="_blank" href="<?=base_url()?>terms-conditions">Terms and Conditions</a>
