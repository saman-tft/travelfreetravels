	                            ...
	                            <div class="col-xs-12 nopad">
	                                <div class="insidemyt">
										<ul class="sortul">
											...
											<li class="sortli threonly"><a class="sorta name-l-2-h loader asc"><i class="fa fa-sort-alpha-asc"></i> <strong>Alphabetical Order</strong></a><a
												class="sorta name-h-2-l hide loader des"><i class="fa fa-sort-alpha-desc"></i> <strong>Alphabetical Order</strong></a></li>
...
<section class="search-result tour_search_results sghtseen">
	<div class="container-fluid"  id="page-parent">
		...
		<div class="container">
		<div class="resultalls open layout_upgrade activity-search">
			<div class="coleft">
									...
									<div class="filterforallnty" id="top-sort-list-wrapper">
										<div class="topmistyhtl" id="top-sort-list-1">
											<div class="col-xs-12 nopad">
												<div class="insidemyt">
													<ul class="sortul">
														<li class="sortli sortli-alpbet threonly-alpbet" data-sort="hn">
															<a class="sorta name-l-2-h asc" data-order="asc"><!-- <i class="fa fa-sort-alpha-asc"></i> --> <strong>Alphabetical Order</strong></a>
															<a class="sorta name-h-2-l hide des" data-order="desc"><!-- <i class="fa fa-sort-alpha-desc"></i> --> <strong>Alphabetical Order</strong></a>
														</li>
