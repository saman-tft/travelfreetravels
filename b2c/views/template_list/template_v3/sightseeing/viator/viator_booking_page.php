...
<div class="alldownsectn">
  ...
  <div class="ovrgo sight_book_page">
	<div class="bktab1 xlbox <?=$review_tab_details_class?>">
		<div class="col-xs-12 col-md-8 toprom nopad activextr">
	  ...
	  <div class="fligthsdets">
		...
		<div class="col-xs-4 full_room_buk nopad rhttbepa">
...
<!--col8 start to move-->
		...
		<div class="col-xs-12 col-md-12 padpaspotr marrev nopad">
		<div class="col-xs-12 nopadding">
		<div class="fligthsdets nomar">
		<?php
/**
...
<!-- Booking Question  Start-->
		 <?php if(valid_array($pre_booking_params['BookingQuestions'])):?>
                    <?php foreach($pre_booking_params['BookingQuestions'] as $q_key=>$q_value): $requierd='';?>
                      <?php //debug($q_value); ?>
                        ...
                        <?php
                        	...
                        	if($q_value['stringQuestionId'] =='transfer_air_arrival_airline' || $q_value['stringQuestionId'] =='transfer_air_arrival_flightNo' || $q_value['stringQuestionId'] =='transfer_arrival_time' || $q_value['stringQuestionId'] =='transfer_air_departure_airline' || $q_value['stringQuestionId'] =='transfer_air_departure_flightNo' || $q_value['stringQuestionId'] =='transfer_departure_date' || $q_value['stringQuestionId'] =='transfer_departure_time')
                        	{
                        		...
                        		<?php
                        	}elseif($q_value['stringQuestionId'] =='transfer_arrival_dropOff')
                        	{
                        ?>
                      ...
                      <?php }
                      elseif($q_value['stringQuestionId'] =='transfer_departure_pickUp')
                        	{
                        ?>
		                        <div class="pasngrinput _passenger_hiiden_inputs">
		                             <div class="col-md-8 nopad">
...
<div class="clearfix"></div>
	 	...
	 	<?php if(is_logged_in_user() == true) { ?>
			<div class="col-xs-12 nopadding" style="margin-bottom: 15px;">
				<div class="insiefare mart" style="padding: 0px;">
...
<!--col8 start to move-->
	...
	<!--side clo start-->
		<div class="col-xs-4 rhttbepa">
			   <div id="nxtbarslider" style="width:360px;">
			 	<table class="table table-condensed tblemd">
				 	<tbody>
				 	  <tr class="rmdtls">
				        <th>Activity Details</th>
