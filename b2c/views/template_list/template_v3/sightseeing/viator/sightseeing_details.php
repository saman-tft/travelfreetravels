...
<div class="container">
  ...
  <?php foreach($product_details['ProductPhotos'] as $photos):?>
    ...
    <?php endif; ?>                                                                                                  
        ...
        <?php 
            $image_path = $GLOBALS['CI']->template->template_images();
            if(strpos($image_path, '//alkhaleej_tours') !== false){
              $image_path = str_replace('//alkhaleej_tours', '', $image_path);
            }
        ...
        <li><img src="<?php echo $image_path.'free_cancellation.svg';
        //$GLOBALS['CI']->template->template_images('free_cancellation.svg'); ?>" alt="icon" />Free Cancellation - <?=$product_details['Cancellation_day']?> days prior</li>
        <?php else:?>
          <li><img src="<?php echo $image_path.'non-refundable.svg';
          //$GLOBALS['CI']->template->template_images('non-refundable.svg'); ?>" alt="icon" />Non Refundable</li>
        <?php endif;?>
        <?php if($product_details['VoucherOption']):?>
          <li><img src="<?php echo $image_path.'show_mobile.svg';
          //$GLOBALS['CI']->template->template_images('show_mobile.svg'); ?>" alt="icon" /> <?=$product_details['VoucherOption']?></li>
        <?php endif;?>
        <?php if($product_details['Duration']):?>
          <li><img src="<?php echo $image_path.'duration.svg';
          //$GLOBALS['CI']->template->template_images('duration.svg'); ?>" alt="icon" /><?php echo $product_details['Duration']?> Duration</li>
        <?php endif;?>
        <?php if($product_details['Product_Tourgrade'][0]['langServices']):?>
          <?php if(valid_array($product_details['Product_Tourgrade'])):?>
            ...
            <li><img src="<?php echo $image_path.'language.svg';
            //$GLOBALS['CI']->template->template_images('language.svg'); ?>" alt="icon" /><?=$lan_val?></li>
          <?php endforeach;?>
          <?php endif;?>
        <?php endif;?>
        <?php if($product_details['MaxTravellerCount']):?>          
           <li><img src="<?php echo $image_path.'join_group.svg';
           //$GLOBALS['CI']->template->template_images('join_group.svg'); ?>" alt="icon" /> Maximum Traveller - <b style="color:#0096ce"><?=$product_details['MaxTravellerCount']?></b></li>
        <?php endif;?>
           ...
           <div class="booking-price">
             ...
             <span class="currency-sign"><?php echo $currency_obj->get_currency_symbol($currency_obj->to_currency); ?></span>
               ...
               <div class="datediv">           
                ...
                <?php if($product_details['Cancellation_available']):?>
                    <li><img src="<?php echo $GLOBALS['CI']->template->template_images('free_cancellation.svg'); ?>" alt="icon" />Free Cancellation - <?=$product_details['Cancellation_day']?> days prior</li>
                    <?php else:?>
...
$(document).ready(function(){
    ...
    $(".total_pax_count").text(total_pax);
    ...
    $('html,body').animate({
        scrollTop: $(".actimgdiv").offset().top},
        'slow');
   });
