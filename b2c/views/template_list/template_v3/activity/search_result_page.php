...
var load_products = function(loader, offset, filters) {
    ...
    _lazy_content = $.ajax({
        type: 'GET',
        url: app_base_url + 'index.php/ajax/activity_list/' + offset +
            '?booking_source=<?=$active_booking_source[0]['source_id']?>&search_id=<?=$sight_seen_search_params['search_id']?>&op=load' +
            url_filters + '&enquiry_origin=<?= $enquiry_origin;?>',
        async: true,
        cache: true,
        dataType: 'json',
...
<span class="hide">
    ...
    <input type="hidden" id="pri_app_pref_currency"
        value='<?=$this->currency->get_currency_symbol(get_application_currency_preference())?>'>
...
<?php
    ...
    ?>
<section class="inner-searchpanel">
    <div class="container-fluid">
        <?php echo $GLOBALS['CI']->template->isolated_view('share/activity_search_inner',$holiday_data) ?>
    </div>
</section>
<section class="search-result tour_search_results sghtseen">
            ...
            <div class="resultalls open">
                <div class="coleft">
                    <div class="flteboxwrp">
                        <div class="filtersho">
                            <div class="avlhtls"><strong id="filter_records"></strong> <span class="hide"> of <strong
                                        id="total_records"><?php echo $mini_loading_image?></strong> </span> Excursions
                                found
                        ...
                        <div class="fltrboxin">
                            ...
                            <div class="celsrch refine">
                                <div class="row_top_fltr">
                                    <a class="pull-right reset_filter" id="reset_filters" style="font-size: 12px;">RESET
                                        ALL</a>
                                </div>
                                <!--  <div class="rangebox sight_modify">
                                    <button data-target="#b2b_act_modify" data-toggle="collapse" class="collapsebtn refine-header" type="button">
                                    Modify Search
                                    </button>
                                    <div id="b2b_act_modify" class="in">
                                        <div id="modify" class="">
                                            <div class="insplarea">
                                ...
                                <div class="rangebox">
                                    <button data-target="#price-refine" data-toggle="collapse"
                                        class="collapsebtn refine-header" type="button">
                                        Price
                                    </button>
                                ...
                                <div class="rangebox">
                                    <button data-target="#hotelsearch-refine" data-toggle="collapse"
                                        class="collapsebtn refine-header" type="button">
                                        Search Excursions
                                    </button>
                                    <div id="hotelsearch-refine" class="in">
                                        <div class="boxins">
                                            <div class="relinput">
                                                <input type="text" class="srchhtl form-control"
                                                    placeholder="Excursions Names" id="tour-name" />
        ...
        <div id="accordion" class="panel-group category-list">
                ...
                <div id="demo" class="panel-collapse collapse in">
                                        ...
                                        <div class="boxins sight_seen_types">
                                            <ul class="" id="hotel-amenitie-wrapper">
                                               <li>
                                                  ...
                                                  <label class="lbllbl" for="wifi-hotels-view">Excursions Types</label></li>
                                ...
                                <div class="rangebox hide">
                                    <button data-target="#collapse2" data-toggle="collapse" class="collapsebtn"
                                        type="button">
                                        Star Rating
                                    </button>
                                                ...
                                                <div class="insidemyt">
                                                    <ul class="sortul">
                                                        <li class="sortli threonly" data-sort="hn">
                                                            <a class="sorta name-l-2-h asc" data-order="asc"><i
                                                                    class="fa fa-user"></i> <strong>Name</strong></a>
                                                            <a class="sorta name-h-2-l hide des" data-order="desc"><i
                                                        ...
                                                        <li class="sortli threonly" data-sort="p">
                                                            <a class="sorta price-l-2-h asc" data-order="asc"><i
                                                                    class="fa fa-tag"></i> <strong>Price</strong></a>
                                                            <a class="sorta price-h-2-l hide  des" data-order="desc"><i
                                                                    class="fa fa-tag"></i> <strong>Price</strong></a>
                                                        </li>
                                                        <!--    <li class="sortli threonly" data-sort="p">
                                ...
                                <div class="col-xs-3 mobile_none nopad">
                                    <div class="mapviw noviews">
                                        ...
                                        <div class="mapviwlist nopad noviews reswd">
                                            <div class="rit_view">
                                                <a class="view_type list_click active" id="list_clickid"><span
                        ...
                        <div class="allresult">
                            ...
                            <div id="empty_tour_search_result" style="display:none">
                                <div class="noresultfnd">
                                    <div class="imagenofnd"><img src="<?=$template_images?>empty.jpg" alt="Empty" />
                                    </div>
    ...
    <div id="empty-search-result" class="jumbotron container" style="display:none">
        ...
        <p>No excursions were found in this location today.</p>
        <p>
            Search results change daily based on availability.If you have an urgent requirement, please get in touch
            with our call center using the contact details mentioned on the home page. They will assist you to the best
            of their ability.
        </p>
    </div>
</section>

<div class="modal fade bs-example-modal-lg" id="map-box-modal" tabindex="-1" role="dialog"
