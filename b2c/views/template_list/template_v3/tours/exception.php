...
<p>
	<!-- <a class="btn btn-primary btn-lg" href="<?php //echo base_url()?>index.php/general/index/hotel/?default_view=<?php //echo META_ACCOMODATION_COURSE?>"

	role="button">Click Here To Start New Search</a> -->
