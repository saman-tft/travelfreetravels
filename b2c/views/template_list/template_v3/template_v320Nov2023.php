...
<body class="<?php echo (isset($body_class) == false ? 'index_page' : $body_class) ?>">
    ...
    <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-KSWVGZ0WZM'); </script>
                ...
                <div class="container">
                    ...
                    <div class="menuandall">
                        ...
                        <div class="ritsude">
                            ...
                            <div class="sidebtn">
                                ...
                                <a class="topa logindown" data-toggle="modal" data-target="#show_log">
                                    <div class="reglog">
                                        ...
                                        <div class="userorlogin">SignUp / Login <i class="fal fa-angle-down cartt"></i>
                                        </div>
                                    </div>
                                </a>
                                <?php } else { ?>
                            ...
                            <div class="sidebtn flgsidebtn flagss">
                                    ...
                                    <div class="frtbest">
                                        <ul id="accordionfot2" class="accordionftr">
                                            ...
                                            <ul class="submenuftr1">
                                                <li class="frteli"><a href="#"> Address: Sahamati Marga, House no. 17
                                                        Gairidhara, Kathmandu-02</a></li>
                                                <li class="frteli"><a href="#"> Email: info@travelfreetravels.com</a>
                                                </li>
                                                <li class="frteli"><a href="#"> Phone: +977-1-5365553/54</a></li>
                                                <li class="frteli"><a href="tel: +977-9810133660"> Phone:
                                                        +977-9860000111</a>
