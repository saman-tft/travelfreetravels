...

{
	...
	if($status == 'BOOKING_CONFIRMED') {
		...
		$cancel_ticket .= '<button class="btn btn-info btn-block send_sms" id="id_'.$app_reference.'" booking_source="'.$booking_source.'" app_reference="'.$app_reference.'">Send SMS</button>';
