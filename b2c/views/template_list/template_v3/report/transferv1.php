										...
										<div class="remful">
											...
											<div class="xlbook col-sm-2 col-xs-3 htlimage_xl">
												...
												<div class="imghtlflt">
													...
													<img src="<?=$GLOBALS['CI']->template->domain_upload_pckg_images($transfer_image)?>" alt="ProductImage" />

												</div>

											</div>

											<div class="xlbook col-sm col-xs-2 htlimage_xl ">
											...
											<?php 
												...
												$booking_amount = roundoff_number($parent_v['product_total_price']+ $parent_v['convinence_amount']+$parent_v['gst']-$parent_v['discount']);
...

{
	...
	$ticket_details = '<a href="'.base_url().'index.php/voucher/transfer_crs/'.$app_reference.'/PTBSID0000000008" class="viwedetsb">View</a>';
