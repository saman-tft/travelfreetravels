										...
										<div class="remful">
											...
											<div class="xlbook col-xs-7">
												...
												<div class="htlfltr">
													...
													<h3 class="shtlname"><?=app_friendly_datetime($departure_date)?></h3>
													...
													<div class="bokdby">Lead Pax:<strong><?=$lead_guest_title?> <?=$lead_guest_first_name?> <?=$lead_guest_last_name?> </strong></div>

													<div class="bokdby">Booked On<strong><?=date('d-M-Y',strtotime($booked_datetime))?></strong></div>
...

{
	...
	$ticket_details = '<a href="'.base_url().'index.php/voucher/holiday/'.$app_reference.'/'.$booking_source.'" class="viwedetsb">View</a>';
	...
	if($status == 'BOOKING_CONFIRMED') {
		...
		$cancel_ticket = '<form action="" method="POST" name="shareemail-form">
														...
														<input type="hidden" value="holiday" name="module" />

														<input type="submit" value="Send Email" class="btn btn-sm btn-warning share_sub viwedetsb holi-sendmail" />
