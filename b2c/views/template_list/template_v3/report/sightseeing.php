					...
					<div class="trvlwrap">
						...
						if(valid_array($table_data['booking_details']) == true) {
							...
							foreach($booking_details as $parent_k => $parent_v) { 
								...
								extract($parent_v);
///debug($parent_v);
$pack_details = $this->activity_model->getPackage($package_type);
//debug($pack_details);
								...
								<div class="full_bkingg">
									...
									<div class="bookrow">
										...
										<div class="remful">
											...
											<div class="xlbook col-sm-2 col-xs-3 htlimage_xl">
												...
												<div class="imghtlflt">
													...
													<img src="<?='https://travelfreetravels.com/extras/custom/TMX3644721637051232/uploads/activity'.$pack_details->image?>" alt="HotelImage" />
										...
										//	debug($parent_v);exit;
												...
												$booking_amount = roundoff_number($parent_v['agent_buying_price']+ $parent_v['convinence_amount']+$parent_v['gst']-$parent_v['discount']);
...

{
	...
	$ticket_details = '<a href="'.base_url().'index.php/voucher/activity_crs/'.$app_reference.'/'.$booking_source.'" class="viwedetsb">View</a>';

	if($status == 'BOOKING_CONFIRMED') {

		$cancel_booking = '<a href="'.base_url().'index.php/activities/pre_cancellation/'.$app_reference.'/'.$booking_source.'" class="viwedetsb">Cancel</a>';
