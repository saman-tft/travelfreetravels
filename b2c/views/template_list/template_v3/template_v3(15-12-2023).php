                ...
                <div class="container">
                    ...
                    <div class="menuandall">
                        ...
                        <div class="ritsude">
                            ...
                            <div class="sidebtn">
                                <?php if (is_logged_in_user() == false) { ?>
                                   ...
                                   <a href="<?php echo base_url('/newpage')?>"> <button style="background:transparent;outline:none; border:none;" class="topa logindown" >
                                        ...
                                        <a style=" background:text-decoration:none;color:white;text-align:center;font-size:14px;" href="<?php echo base_url('/login')?>"><div>SignUp / Login  </a>
                                            </div>
                                        </div>
                                            </button>
                                    </a>
                            ...
                            <!-- reduce the button size in  mobile  view -->
<style>
...
#smallflag
    display:none !important;
                            ...
                            <div class="sidebtn flgsidebtn flagss" id = "smallflag">
