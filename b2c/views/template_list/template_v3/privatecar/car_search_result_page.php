...
<div class="car_sec">
 ...
 if($booking_source=="PTBCSID00000000017")       
{
       for($i=0;$i<=count($car_details['PricedCoverage']);$i++)

        {
  $offer_Includes_html .= '<div class="carprc clearfix">

                                   <button type="button" class="sumtab"  id="carnect'.$car_key.'"><b>'.$car_details['PricedCoverage'][$i]['CoverageType'].'</b></button>
                                 ...
                                 <div id="agelmt'.$car_key.''.$pan.'">
                                  ...
                                  <p style="padding-left: 17px;">'. $car_details['PricedCoverage'][$i]['Desscription'].'</p>
...
?>
            <form method="post" action="<?php echo base_url().'index.php/'.$url.'/car_details/'.($search_id)?>" name="form_transfer_">
             ...
             <input type="hidden" value="<?php echo $car_details['car_id'] ?>" name="car_id" class="operation">
