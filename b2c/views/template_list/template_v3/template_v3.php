...
<head>
    ...
    <meta name="facebook-domain-verification" content="8r3p1gz109slgrmtme8kgod1aklqnj" />
 ...
 -->
    ...
    <!--changes added script for confetti-->
    <script src="https://cdn.jsdelivr.net/npm/js-confetti@latest/dist/js-confetti.browser.js"></script>
    <!--end of changes added script for confetti-->
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-2006552456483075" crossorigin="anonymous"></script>
...
<body class="<?php echo (isset($body_class) == false ? 'index_page' : $body_class) ?>">
    ...
    <!-- added google tag manager -->
    <!-- Google Tag Manager (noscript) -->
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K4PP7X5J" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    ...
    <body class="<?php echo (isset($body_class) == false ? 'index_page' : $body_class) ?>">
        ...
        <!-- <script async src="https://www.googletagmanager.com/gtag/js?id=G-KSWVGZ0WZM"></script>
        <script>
  ...
  gtag('config', 'AW-11441192494');
        ...
        <div class="allpagewrp">
            ...
            <header>
                ...
                <!--changes New notification style-->
                <style>
                    /*start of styles for mobile promocode notifications*/
                    .topsection {
                        max-height: 80px;
                        /*font-family: 'Lato', sans-serif;*/
                        color: rgba(255, 255, 255, 1);
                        background: rgba(88, 191, 231, 1) !important;
                        display: flex;
                    ...
                    .topsection .top__container .image {
                        background: url('<?php echo SYSTEM_IMAGE_DIR . "giftbox.png" ?>');
                    ...
                    /*end of style for mobile promocode notification */
                    /*start of style for larger screens notification*/
                    .topsection {
                        display: none;
                    }
                    ...
                    .topsection-large .top__container {
                    ...
                    .topsection-large .top__container .image {
                        background: url('<?php echo SYSTEM_IMAGE_DIR . "giftbox.png" ?>');
                        background-size: contain;
                        background-position: center;
                        background-repeat: no-repeat;
                    ...
                    .topsection-large .top__container a .top__container-content {
                        margin-left: -15px;
                    ...
                    .topsection-large .top__container .top__container-content p {
                    ...
                    .topsection-large .top__container .top__container-content span {
                    ...
                    .topsection-large .text .bold-text {
                        margin-top: -14px;
                        font-size: 3vw;
                    }

                    .topsection-large .notification__button {
                        /* background: white; */
                        background: linear-gradient(90deg, #cce6eb, #4FD3C4);
                        text-align: center;
                        color: black;
                        padding: 0.5em 1em;
                    ...
                    @media only screen and (min-width: 480px) and (max-width: 536px) {
                    ...
                    @media only screen and (min-width: 768px) and (max-width: 1180px) {
                        ...
                        .topsection-large .top__container .top__container-content {
                            margin-top: 0;
                        }
                    ...
                    /*end of style for larger screens notification*/
                </style>
                <!--end of changes new notificaiton style-->
                <div class="clearfix"></div>
                <!--changes new promocode notification for mobile-->
                <a href="<?php echo base_url() . 'promocodepage'; ?>">
                    <div class="topsection" style="min-height:40px;background:#fff;">
                        ...
                        <div class="text">Upto &nbsp; <span class="bold-text"> 10% </span> &nbsp; off.</div>

                    </div>
                </a>
                <!--changes end of  new promocode notification for mobile-->
                <!--changes new promocode notification for larger screens-->
                <div class="topsection-large" style="min-height:40px;background:#fff;">
                    <div class="top__container">
                        <div class="image">

                        </div>
                        <a href="<?php echo base_url() . 'promocodepage'; ?>">
                            <div class="top__container-content">
                                <p>Get amazing discounts
                                    <span style="display:block;">Checkout our best deals and offers</span>
                                </p>
                            </div>
                        </a>
                    </div>
                    <div class="text"> Upto &nbsp; <span class="bold-text"> 10% </span> &nbsp; off in your flight tickets.</div>
                    <a href="<?php echo base_url() . 'promocodepage'; ?>" class="notification__button">Checkout Promocodes Now</a>
                </div>
                <!--changes end of  new promocode notification for larger screens-->
                <!--changes removed id fixed for sticky navbar without flicker-->
                <div class="topssec">
                    ...
                    <div class="container" id="full__container">
                        ...
                        <a class="logo" style="mix-blend-mode:multiply;" href="<?php echo base_url() ?>">
                            ...
                            <!-- Added styles here for large screen logos 2023/12/15 --> <img width="250" class="ful_logo" style="margin-top:-2em;" src="<?php echo $GLOBALS['CI']->template->domain_images($GLOBALS['CI']->template->get_domain_logo()); ?>" alt="Book a tour to India" />
                        </a>
                        <!-- <div>
                                    ...
                                    <?php if (is_logged_in_user() == false) { ?>
                                        ...
                                        <a href="<?php echo base_url('/newpage') ?>"> <button style="background:transparent;outline:none; border:none;" class="topa logindown">
                                                <div class="reglog">
                                                    ...
                                                    <a style=" background:text-decoration:none;color:white;text-align:center;font-size:14px;" href="<?php echo base_url('/login') ?>">
                                                        <div id="signup-text">SignUp / Login
                                                    </a>
                                                </div>
                                </div>
                                </button>
                            ...
                            <?php } else { ?>
                                ...
                                <div class="dropdown-menu mysign exploreul logdowndiv">
                                    <div class="signdiv">
                                        <div class="clearfix">
                                            <ul>
                                                <li><a href="<?= base_url() ?>user/profile/<?= @$GLOBALS['CI']->name ?>">My
                                                        Account</a>
                                                </li>
                                                <li class="divider"></li>
                                                <?php if (true) { ?>
                            ...
                            <ul class="exploreall">
                                ...
                                if ($geturl == '') { ?>
                                    ...
                                    ?>
                                                ...
                                                <li class="<?php echo 'at_' . $v ?> <?= ((@$default_view == $k || $default_view == $v) ? 'active' : '') ?>">
                                    ...
                                    <li class="">
                                        <a href="<?php echo base_url()?>agent/index.php/general/index" id="c">
                                            <span class="sprte cmnexplor "></span>
                                            <strong> Agent </strong>
                                        </a>

                                    </li>
                                    <!-- changes removed supplier module for now -->
                                    <!--            <li class="">
        ...
        <!-- Body Printed Here -->
        <!--changes added a container for the top margin for space-->
        <div class="container" id="space_container"></div>
        <!-- changes Added class set_up for navbar flicker-->
        <div class="fromtopmargin set_up">
            <?= $body ?>
        </div>
        <div class="clearfix"></div>
        <!-- changes removed following duplicate newsletter for console errors fixing -->
<!--         <div class="subscribe">
            <div class="container">
                        ...
                        <div class="col-md-12 col-xs-12 nopad">
                            <div class="subsc_sec">
                                ...
                                <div class="signfomup">
                                    ...
                                    <span class="msgNewsLetterSubsc12"><b>Please Provide Valid Email ID</b></span> <span class="succNewsLetterSubsc"><b>Thank you for your subscription!We will keep you
                                            informed of our activities.</b></span> <span class="msgNewsLetterSubsc"><b>You are already subscribed to Newsletter
                                            feed.</b></span> <span class="msgNewsLetterSubsc1"><b>Activated to
                                            Newsletter feed.Thank you</b></span>
                                </div>
                                <div class="form_new"><button type="button" class="btn btn_sub subsbtm" onclick="check_newsletter()"><i class="fa fa-paper-plane"></i></button></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Footer Start -->
        <!--removed old footer code-->
        <!-- Footer End -->

        <!--added new footer code-->
        ...
        <footer>
            <div class="fstfooter">
                <div class="reftr">
                    <div class="container">
                        <div class="clearfix"></div>
                        <div class="row ftrsec1">
                            <div class="col col-md-3">
                                <div class="row text-center" style="display:flex; flex-direction:column; justify-content:center;align-items:center;">
                                    <a href="<?= base_url() ?>">
                                        <img src="<?php echo $GLOBALS['CI']->template->domain_images($GLOBALS['CI']->template->get_domain_logo()); ?>" alt="Please wait" class="text-center foot_logo" />
                                    </a>
                                    <ul class="frtbest">
                                        <?php
                                ...
                                <div class="frtbest">
                                    <ul class="accordionftr">
                                        ...
                                        <ul class="submenuftr1">
                                            <li class="frteli"><a href="https://www.google.com/maps/place/Travel+Free+Travels,+Sumangal+Niwas,+Opp.+Prime+Minister+Qarter,+Gate.1,+Pandol+Marga+03,+Kathmandu+44600/@27.7274148,85.3278573,17z/data=!4m6!3m5!1s0x39eb1943abdeb8d3:0xd519207a9c9fa312!8m2!3d27.7274148!4d85.3278573!16s%2Fg%2F11gxnpn0cr"> Address: <?= STATIC_ADDRESS ?></a></li>
                                            <li class="frteli"><a href="mailto:info@travelfreetravels.com"> Email: <span style=" text-transform:lowercase !important;">info@travelfreetravels.com</span></a></li>
                                            <li class="frteli"><a href="tel:+977-1-5365553"> Phone: +977-1-5365553/54</a></li>
                                            <li class="frteli"><a href="tel:+977-9860000111"> Phone: +977-9860000111</a>
                                        </ul>
                                    </ul>
                                </div>
                            </div>
                            <div class="ftrsec2 col col-md-6">
                                <div class="frtbest">
                                    <ul class="accordionftr">
            ...
            <div class="btmfooternw">
                <div class="container">
                    <div class="row footer-logo">
                        <div class="col-md-6">
                            <div class="order1">
                                <img src="<?php echo base_url() ?>extras/system/template_list/template_v3/images/logos-payments/order1.png" alt="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="order2">
                                <img src="<?php echo base_url() ?>extras/system/template_list/template_v3/images/logos-payments/order2.png" alt="">
                            </div>
                        </div>
                    </div>
        ...
        <script>
            //changes removed follwing timer script as it is not needed and is throwing errors for front end errors
...
<!--Added new style for the google sign in to appear on top-->
<style>
    #credential_picker_container {
        z-index: 999999999999999999999 !important;
    }
