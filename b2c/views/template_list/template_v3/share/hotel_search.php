...
<form name="hotel_search" id="hotel_search" autocomplete="on" action="<?php echo base_url().'general/prehotelsearch' ?>">
	...
	<div class="tabspl forhotelonly">
       ...
       <div class="col-md-2 col-xs-12 padfive">
                    ...
                    <div class="plcemarkk nationlty sidebord"><!-- selectedwrap -->
                        <select   oninvalid="this.setCustomValidity('Please select Nationality')"
 oninput="setCustomValidity('')"  class=" normalinput holyday_selct" name="nationality"
                            required>
			...
			<div class="col-lg-2 col-md-2 col-sm-6 col-xs-5 padfive full_clear">
							...
							?>
								...
								<div class="mobile_adult_icon">Travellers<i class="fa fa-male"></i></div>
									...
									<div class="roomrow">
										...
										<div class="celroe col-xs-8"><i class="fal fa-male"></i>Adults<span class="agemns">(12+)</span></div>
									...
									<div class="roomrow">
										...
										<div class="celroe col-xs-8"><i class="fal fa-child"></i>Children<span class="agemns">(0-12)</span></div>
