...
?>
<form autocomplete="off" name="flight" id="flight_form" action="<?php echo base_url();?>general/pre_flight_search" method="get" class="activeForm oneway_frm form mainsearchform" style="">
	<div class="tabspl">
           ...
           <div class="whitebgrad">
				...
				<div class="col-md-7 nopad placerows">
					<div class="col-xs-6 padfive">
						...
						<div class="plcetogo deprtures sidebord">
							<input type="text" autocomplete="off" name="from" class="normalinput clearable auto-focus valid_class fromflight form-control b-r-0 brleft30" id="from" placeholder="Type Departure City" value="<?php @$onw_rndw_segment_search_params['from'] ?>" required />
					...
					<div class="col-xs-6 padfive">
						...
						<div class="plcetogo destinatios sidebord">
							<input type="text" autocomplete="off" name="to"  class="normalinput auto-focus valid_class departflight form-control b-r-0" id="to" placeholder="Type Destination City" value="<?php   @$onw_rndw_segment_search_params['to'] ?>" required/>
				...
				<div class="col-md-5 nopad secndates">
					<div class="col-md-6 col-xs-12 padfive"  id="departure__container">
						...
						<div class="plcetogo datemark sidebord datepicker_new1" >
							<input type="text" readonly class="normalinput auto-focus hand-cursor form-control b-r-0" id="flight_datepicker1" placeholder="Select Date" value="<?php  @$onw_rndw_segment_search_params['depature'] ?>" name="depature" required/>
						</div>
					...
					<div class="col-md-6 col-xs-12 padfive date-wrapper" id="return__container">
						...
						<div class="plcetogo datemark sidebord datepicker_new2" >
							<input type="text" readonly class="normalinput auto-focus hand-cursor form-control b-r-0" id="flight_datepicker2" name="return" placeholder="Select Date" value="<?php @$onw_rndw_segment_search_params['return'] ?>" <?php (@$onw_rndw_segment_search_params['trip_type'] != 'circle' ? 'disabled="disabled"' : '')?> />
						</div>
			...
			<div class="col-md-4 col-xs-12 nopad thrdtraveller" id="travellers__container">
				...
				<div class="form__button__container__large">
						<input type="submit" name="search_flight" id="flight-form-submit" class="form__button__submit__large" value="Search" />
					</div>
				</div>
                <div class="clearfix"></div>
                <div class="col-xs-6 padfive">
...
if(isset($flight_search_params['country']))
{
	...
	{
					?>
					<option  <?php if($flight_search_params['country'] == $cl_v['name']){ 'selected="selected"'; } ?>  value="<?=$cl_v['name']?>"><?=$cl_v['nationality']?></option>
			<?php	
		}
	...
	<?php
			...
			?>
		       ...
		       <div class="form__button__container__small">
						<input type="submit" name="search_flight-small" id="flight-small" class="form__button__submit__small" value="Search"/>
					</div>
		</div>
	</div>
<!--<div class="form__button__container__small">-->
