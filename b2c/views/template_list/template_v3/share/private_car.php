...
// debug($car_search_params);exit;
	...
	$car_datepicker = array(array('car_datepicker3', FUTURE_DATE_DISABLED_MONTH), array('car_datepicker4', FUTURE_DATE_DISABLED_MONTH));
...
<form id="trasfer" name="car" autocomplete="off" action="<?=base_url()?>general/precarcrssearch">
	<div class="tabspl forbusonly car_form only_for_car" id="car_form">
		<div class="clearfix"></div>
		<div class="outsideserach custom_divclass">
			<div class="clearfix"></div>
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 nopad cr_plce">
			<div class="col-sm-12 col-xs-12 padfive mobile_width">
				<div class="marginbotom10">
                    ...
                    <span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span>
						<input type="text" value="<?php echo @$car_search_params['car_from'] ?>" placeholder="From, Airport, City" name="car_from" id="car_from" class="b-r-0 hotelin normalinput fromcar ui-autocomplete-input" required="" autocomplete="off">
			...
			<div class="clearfix"></div>
			        <div class="pull-left diff_loc">
					 <div class="squaredThree2">
						<input type="checkbox" name="diff_loc" id='diff_loc_private'>
						<label for="diff_loc_private"></label>
					 </div>
					 <label for="diff_loc_private" class="lbllbl">Return to a different location</label>
					</div>
	    <div class="clearfix"></div>				

			<div class="col-sm-12 col-xs-12 padfive mobile_width droppriv" id="Drop-of" style="display: none">
				<div class="marginbotom10">
					...
					<div class="relativemask plcemark">  <span class="maskimg hfrom"></span> <span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span>
						<input type="text" value="<?php echo @$car_search_params['car_to'] ?>" placeholder="To, Airport, City" id="car_to" name="car_to" class="b-r-0 departcar hotelin pcar_to normalinput ui-autocomplete-input" aria-required="true" autocomplete="off">
					...
					<div class="alert-box" id="car-alert-box-car_to"></div>
				</div>
			</div>
			</div>
			<?php
			...
			<div class="col-md-6 col-xs-12 nopad">
				<div class="col-xs-8 padfive">					
						...
						<div class="relativemask datemark pkupdt"> <span class="maskimg caln"></span>
							<input type="text" readonly placeholder="Depature Date" value="<?php echo @$depature; ?>" class="b-r-0 forminput date_picker normalinput"  id="car_datepicker3" name="depature" required/>
						</div>
						<div class="alert-box" id="car-alert-box-pickup-date"></div>
				</div>
				<div class="col-xs-4 col-xs-12 nopad">					
			  ...
			  <div class="col-md-6 col-xs-12 nopad">
				<div class="col-xs-8 padfive">
						...
						<div class="relativemask datemark retdt"> <span class="maskimg caln"></span>
							<input type="text" readonly placeholder="Return Date" value="<?php echo @$return; ?>" class="b-r-0 forminput date_picker normalinput" id="car_datepicker4" name="return" required/>
						</div>
						<div class="alert-box" id="car-alert-box-return-date"></div>
				</div>
				<div class="col-xs-4 col-xs-12 nopad">					
						<span class="formlabel">&nbsp;</span>
						<div class="relativemask selctmark"> <span class="maskimg caln"></span>
				...
				<div class="col-md-6 col-xs-12 nopad marginbotom10 aftremarg">
					<div class="pull-left remove_age" id="remove_age_private">
					 <div class="squaredThree2">
					 <!-- <input name="AGE" style="color:#000" id="driver_age" value="16" type="number" placeholder="Select your age" min="16" max="100"> -->
						<input type="checkbox" id='driver_age_privatefinal' checked="checked">
						<label for="driver_age_privatefinal"></label>
					 </div>
					 <label for="driver_age" class="lbllbl">Driver's age between 30 - 65</label>
					</div>
					<div id='add_age_privates' class="pull-left" style="display: none;">
					<div class=" padfive">
					<span class="formlabel">Driver's Age</span>
						<input type="text" name="driver_age" id="driver_age_in_private" placeholder=" " value="<?php if(empty($car_search_params['driver_age']) == false){ echo @$car_search_params['driver_age']; }else{echo 35; } ?>" class="input_form martp7 numeric normalinput" />
					</div>
					</div>
				</div>

				<div class="col-md-6 col-xs-12 padfive nationality">					
...
<script>
	...
	$(function () {
        $("#diff_loc_private").click(function () {
            if ($(this).is(":checked")) {
                $(".droppriv").show();
    ...
    $(function () {
        $("#driver_age_privatefinal").click(function () {
            console.log("test");
            if ($(this).is(":not(:checked)")) {
                $("#add_age_privates").show();
            } else {
                $("#add_age_privates").hide();
            }
          $("#remove_age_private").hide();
        });
    });
