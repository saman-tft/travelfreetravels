...
<style type="text/css">
	...
	.datemark::before,.plcemark::before{
		    width: 32px;
	}
	.normalinput {
...
.normalsel{
	background: #fff;
}.holyday_selct,.totlall{font-size: 13px}
button.searchsbmt.srchbutn.comncolor {
    height: 41px;margin: 0px!important;
}
.inner-searchpanel .outsideserach .formlabel {
    color: #fff!important;
}
.inner-searchpanel{ background: rgba(45, 62, 82, 0.5)!important;}
#activity_search .tabspl{
...
<form name="activity_search" id="activity_search" autocomplete="on" action="<?php echo base_url().'index.php/general/pre_activity_search' ?>">
	<div class="intabs tabspl">
		<div class="outsideserach" style="float: left; width: 100%; margin-bottom: 15px;">
			...
			<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 fiveh padfive">
				...
				<div class="relativemask plcemark"> <span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span>
					...
					--><input type="text" id="activity_destination_search_name" class="ft activity_city normalinput form-control b-r-0" placeholder="Enter city" name="city" required value="<?php echo @$activity_search_params['destination']?>"/>
					<input class="hide loc_id_holder" id="activity_loc_id" name="activity_destination" type="hidden" value="<?=@$activity_search_params['destination_id']?>" >
				</div>
			</div>
            <div class="col-lg-9 col-md-6 col-sm-6 col-xs-12 nopad aftremarg padfive">
			<div class="col-md-6 col-xs-12 nopad padfive">
			...
			<div class="col-md-3 col-xs-12 padfive">
				<span class="formlabel lbbck">Nationality</span>
                   <select class="normalsel holyday_selct trtext"  id="nationality" name="nationality" required>
						...
						?>
						<option value="<?php echo $country['isocode']; ?>" <?php if($activity_search_params['nationality']==$country['isocode']){ echo "selected";}else{ echo "";} ?>><?php echo $country['name']; ?>
			...
			<div class="col-md-2 col-sm-2 col-xs-12 mobile_width padfive " style="display:none">
				...
				<div class="col-md-1 col-sm-1 col-xs-3 mobile_width padfive " style="display:none">
			...
			<div class="col-md-2 col-sm-2 col-xs-12 fiveh padfive pull-right">
