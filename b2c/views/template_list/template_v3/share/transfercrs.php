...
<form action="<?php echo base_url();?>index.php/general/pre_transfercrsv1_search" 
      ...
      <div class="col-md-offset-2 col-md-8 col-sm-12 col-xs-12 nopad">
        <div class="col-md-8 col-sm-8 col-xs-7 padfive full_smal_tab mobile_width">
          ...
          <div class="plcetogo plcemark sidebord">           
            ...
            <input type="text" id="transfer_destination_search_name" class="fromactivity normalinput form-control b-r-0" placeholder="Location" name="from" required value="<?php echo @$destination;?>"/>
