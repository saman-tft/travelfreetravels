                     ...
                     <td style="padding: 0px;">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
                              ...
                              <td>
                                 ...
                                 <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tr>
                                       ...
                                       <td style="padding: 0px;"><img style="width:200px;" src="<?=base_url().'extras/custom/'.CURRENT_DOMAIN_KEY.'/images/logo1.png'?>" alt=""></td>
                           ...
                           <tr>
                              ...
                              <td align="right" style="line-height:24px;font-size:13px;border-top:1px solid #1FB53A;border-bottom:1px solid #1FB53A;padding: 5px;">Status: <strong class="<?php echo booking_status_label( $booking_details['status']);?>" style=" font-size:14px;">
                                 ...
                                 <table width="100%" cellpadding="5" style="padding: 10px;font-size: 13px;padding:5px;">
                                    ...
                                    <tr>
                                       ...
                                       <?php if($attributes['HotelImage'] != '/'):?>
                                          ...
                                          <td style="padding:10px 0"><img style="width:160px;" src="<?=$attributes['HotelImage'];?>" alt=""/></td>

                                       <?php else:?>

                                          <td style="padding:10px 0"><img style="width:160px;" src="<?=$GLOBALS['CI']->template->template_images("default_hotel_img.jpg");?>" alt=""/></td>
                           ...
                           <tr>
                              ...
                              <td style="background-color:#1FB53A;border: 1px solid #1FB53A; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?=base_url().SYSTEM_IMAGE_DIR.'hotel_v.png'?>" alt=""/> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Hotel Details</span></td>

                           </tr>

                           <tr>

                              <td  width="100%" style="border: 1px solid #1FB53A; padding:0px;">
...
<script type="text/javascript">
    ...
    function printDiv(divName) {
     ...
     document.title = "Hotel Ticket-QuaQua";
