...
<form id="trasfer" name="car" autocomplete="off" action="<?=base_url()?>general/pre_car_search">
			  ...
			  <div class="col-md-6 col-xs-12 nopad">
				...
				<div class="col-md-6 col-xs-12 nopad marginbotom10 aftremarg">
					...
					<span class="formlabel">Driver's Age</span>
						<input type="text" name="driver_age" id="driver_age_in" placeholder=" " value="<?php if(empty($car_search_params['driver_age']) == false){ echo @$car_search_params['driver_age']; }else{echo 35; } ?>" class="input_form martp7 numeric normalinput" />
					</div>
					</div>
				</div>
