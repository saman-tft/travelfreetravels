										...
										<div class="remful">
											...
											<div class="xlbook col-xs-7">
												...
												<div class="htlfltr">
													...
													<div class="bokdby">Lead Pax:<strong><?=$lead_guest_title?> <?=$first_name?> <?=$last_name?> </strong></div>

													<div class="bokdby">Booked On<strong><?=date('d-M-Y',strtotime($booked_date))?></strong></div>
...

{
	...
	$ticket_details = '<a href="'.base_url().'index.php/voucher/activity/'.$app_reference.'/'.$booking_source.'" class="viwedetsb">View</a>';
