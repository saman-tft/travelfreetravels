...
#holiday_load_new .owl-carousel{display: block!important;}

#holiday_load_new .owl-buttons {
    text-align: right;
    margin-right: 20px;
}
...
#holiday_load_new .owl-theme .owl-prev:before {
    /* position: absolute; */
    font-size: 16px;
...
#holiday_load_new .owl-theme .owl-next {
    right: 13px;
}

#holiday_load_new .owl-theme .owl-next:before {
    /* position: absolute; */
    font-size: 16px;
...
#holiday_load_new .owl-theme .owl-next span{
    font-size: 0;
}
#holiday_load_new .owl-nav {
    margin-top: 5px;
}
...
<script src="<?php echo $GLOBALS['CI']->template->template_js_dir('jquery.provabpopup.js') ?>" type="text/javascript">
</script>
<script src="<?php echo $GLOBALS['CI']->template->template_js_dir('page_resource/thumbnail-slider.js') ?>"
    type="text/javascript"></script>
<script src="<?php echo $GLOBALS['CI']->template->template_js_dir('jquery.carouFredSel-6.2.1-packed.js') ?>"
    type="text/javascript"></script>
      ...
      ?>
         ...
         ?>
                      ...
                      <strong><?php echo $this->lang->line('hotel_view_map');?></strong>
                                    ...
                                    <h3 class="nyt1"><?=($tour_data['duration']+1);?> Days /
                                        <?=$tour_data['duration'];?>
                                        <?=($tour_data['duration']==1)? 'Night': 'Nights';?></h3>
                                    <a class="noover hide" href="#price_detail_tab" id="price_table"
                                        onclick="price_tableclick()" data-toggle="modal">
                                        <h4>&nbsp;&nbsp;&nbsp;Price Table</h4>
                                    </a>
                                </div>
                                <div class="clearfix"></div>
                                <div class="alltripstatus">
                                    ...
                                    <div class="cc-selector">
                                        ...
                                        <input class="dynamicPriceBreakdown" checked="checked" id="star_1" type="radio"
                                            name="hotel_type" value="star_rating_1" data-type="hotel"
                                            data-priceTitle="budget_hotel_price"
                                            data-price="<?=$tour_price['0']['budget_hotel_price'];?> ">
                                        <label class="drinkcard-cc star_rating_1" for="star_1"
                                            style="text-align: center;"><br>Budget<br><span
                                                id="sprice1"><?=get_application_display_currency_preference();?>&nbsp;<?=$tour_price['0']['budget_hotel_price'];?>
                                            </span>
                                            <!-- <p style="font-weight: 200;font-size: 10px;">per person</p> --></label>
                                        <?php } ?>
                                        <?php if($tour_price['0']['standard_hotel_price']>0){ ?>
                                        <input class="dynamicPriceBreakdown" id="star_2" type="radio" name="hotel_type"
                                            value="star_rating_2" data-type="hotel"
                                            data-priceTitle="standard_hotel_price"
                                            data-price="<?=$tour_price['0']['standard_hotel_price'];?>">
                                        <label class="drinkcard-cc star_rating_2" for="star_2"
                                            style="text-align: center;"><br>Standard<br><span
                                                id="sprice2"><?=get_application_display_currency_preference();?>&nbsp;<?=$tour_price['0']['standard_hotel_price'];?></span>
                                            <!-- <p style="font-weight: 200;font-size: 10px;">per person</p> --></label>
                                        <?php } ?>
                                        <?php if($tour_price['0']['deluxe_hotel_price']>0){ ?>
                                        <input class="dynamicPriceBreakdown" id="star_3" type="radio" name="hotel_type"
                                            value="star_rating_3" data-type="hotel" data-priceTitle="deluxe_hotel_price"
                                            data-price="<?=$tour_price['0']['deluxe_hotel_price'];?>">
                                        <label class="drinkcard-cc star_rating_3" for="star_3"
                                            style="text-align: center;"><br>Deluxe<br><span
                                                id="sprice3"><?=get_application_display_currency_preference();?>&nbsp;<?=$tour_price['0']['deluxe_hotel_price'];?></span>
                                            <!-- <p style="font-weight: 200;font-size: 10px;">per person</p> --></label>
                                        <?php } ?>
                                        <?php  if($tour_price['0']['4_star_hotel_price']>0){ ?>
                                        <input class="dynamicPriceBreakdown" id="star_4" type="radio" name="hotel_type"
                                            value="star_rating_4" data-type="hotel" data-priceTitle="4_star_hotel_price"
                                            data-price="<?=$tour_price['0']['4_star_hotel_price'];?>">
                                        <label class="drinkcard-cc star_rating_4" for="star_4"
                                            style="text-align: center;"><br>4 Star<br><span
                                                id="sprice4"><?=get_application_display_currency_preference();?>&nbsp;<?=$tour_price['0']['4_star_hotel_price'];?></span>
                                            <!-- <p style="font-weight: 200;font-size: 10px;">per person</p> --></label>
                                        <?php } ?>
                      ...
                      ?>
                                <div class="alltripstatus car_status">
                                    ...
                                    <div class="cc-selector">
                                        ...
                                        <input class="dynamicPriceBreakdown" checked="checked" id="visa" type="radio"
                                            name="car_type" value="Hatchback" data-type="car"
                                            data-priceTitle="standard_car_price"
                                            data-price="<?=$tour_price['0']['standard_car_price'];?>">
                                        <label class="drinkcard-cc hatchback" for="visa">Standard</label>&nbsp;
                                        <?php } if($tour_price['0']['deluxe_car_price']>0){ ?>
                                        <input class="dynamicPriceBreakdown" id="mastercard" type="radio"
                                            name="car_type" value="Sedan" data-type="car"
                                            data-priceTitle="deluxe_car_price"
                                            data-price="<?=$tour_price['0']['deluxe_car_price'];?>">
                                        <label class="drinkcard-cc sedan" for="mastercard">Deluxe</label>&nbsp;
                                        <?php } if($tour_price['0']['suv_car_price']>0){ ?>
                                        <input class="dynamicPriceBreakdown" id="suv" type="radio" name="car_type"
                                            value="SUV" data-type="car" data-priceTitle="suv_car_price"
                                            data-price="<?=$tour_price['0']['suv_car_price'];?>">
                                        <label class="drinkcard-cc suv" for="suv">SUV</label>&nbsp;
                                        <?php } if($tour_price['0']['temp_traveller_price']>0){ ?>
                                        <input class="dynamicPriceBreakdown" id="temp_traveller" type="radio"
                                            name="car_type" value="SUV" data-type="car"
                                            data-priceTitle="temp_traveller_price"
                                            data-price="<?=$tour_price['0']['temp_traveller_price'];?>">
                                        <label class="drinkcard-cc tempo-ico" for="temp_traveller">Temp
                                            Traveller</label>&nbsp;
                                        <?php } if($tour_price['0']['bus_price']>0){ ?>
                                        <input class="dynamicPriceBreakdown" id="bus" type="radio" name="car_type"
                                            value="SUV" data-type="car" data-priceTitle="bus_price"
                                            data-price="<?=$tour_price['0']['bus_price'];?>">
...
//                      exit;
                        ?>
                                <div class="alltripstatus">
                                    ...
                                    <h4><span class="city-dtl">Start City: </span> <span
                                            class="ststus_color"><?=$start_city?></span></h4>
                                </div>
                                <div class="clearfix"></div>
                                <div class="alltripstatus">
                                    <h4><span class="city-dtl">End City: </span> <span
                                            class="ststus_color"><?=$end_city?></span></h4>
                                </div>
                                <!--   <div class="clearfix"></div>
                    <div class="alltripstatus">
                  ...
                  -->
                    ...
                    <div class="col-xs-12 list4 nopad">
                            ...
                            <form action="<?=base_url()?>index.php/tours/pre_booking/<?=$tour_id?>" method="POST"
                                name="checkout-apartment" id="pre_booking_form" autocomplete="off">
                                ...
                                <input class="package_origional_price" name="package_origional_price" type="hidden"
                                    value="<?=($tour_price[0]['convt_adult_airliner_price'])?>" />
                                    ...
                                    <div class="credit_item col-md-12 nopad">
                                        ...
                                        <div class="col-md-6 col-xs-4 nopad">
                                            <div class="input-group countmore pax-count-wrapper adult_count_div">
                                                ...
                                                <input type="text" id="no_adults" name="no_adults"
                                                    class="form-control input-number centertext valid_class pax_count_value"
                                                    value="1" min="1" max="9" readonly=""
                                                    onchange="roomcountcalculation()"><span class="input-group-btn">
                                                    <button type="button" class="btn btn-default btn-number"
                                                        data-type="plus" data-field="adult"> <span
                                    ...
                                    <div class="credit_item col-md-12 col-xs-12 nopad">
                                        ...
                                        <div class="col-md-6 col-xs-4 nopad">
                                            <div class="input-group countmore pax-count-wrapper adult_count_div">
                                                ...
                                                <input type="text" id="no_child" name="no_child"
                                                    class="form-control input-number centertext valid_class pax_count_value"
                                                    value="0" min="1" max="9" readonly=""
                                                    onchange="roomcountcalculation()"><span class="input-group-btn">
                                                    <button type="button" class="btn btn-default btn-number"
                                                        data-type="plus" data-field="child"> <span
                                                            class="glyphicon glyphicon-plus"></span> </button></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="credit_item col-md-12 col-xs-12 nopad">
                                        ...
                                        <div class="col-md-6 col-xs-4 nopad">
                                            <div class="input-group countmore pax-count-wrapper adult_count_div">
                                                ...
                                                <input type="text" id="no_infant" name="no_infant"
                                                    class="form-control input-number centertext valid_class pax_count_value"
                                                    value="0" min="1" max="9" readonly=""
                                                    onchange="roomcountcalculation()"><span class="input-group-btn">
                                                    <button type="button" class="btn btn-default btn-number"
                                                        data-type="plus" data-field="infant"> <span
                                                            class="glyphicon glyphicon-plus"></span> </button></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 nopad">
                                            <div class="plcetogo datemark n-transfer sidebord">
                                                <input type="number" min="1" oninput="validity.valid||(value='');"
                                                    class="form-control b-r-0 normalinput" data-date="true"
                                                    name="no_of_transfer" id="no_of_transfer"
                                                    placeholder="Number of transfer" onkeyup="roomcountcalculation()"
                                                    value="1" required />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6 nopad">
                                            <div class="plcetogo datemark rooms-no sidebord">
                                                <input type="number" oninput="validity.valid||(value='');" min="1"
                                                    class="form-control b-r-0 normalinput" data-date="true"
                                                    name="no_of_room" id="no_of_room" onkeyup="dynamicPriceBreakdown()"
                                                    placeholder="Number of Room" value="1" required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="credit_item col-md-12 nopad">
                                        ...
                                        <div class="col-md-6 nopad">
                                            <div class="plcetogo datemark xtra-bed sidebord">
                                                <input type="text" class="form-control b-r-0 normalinput"
                                                    data-date="true" name="no_of_extrabed" id="no_of_extrabed"
                                                    readonly="" placeholder="Enter the number of Room" value="0"
                                                    required onchange="hidebook()" />
                                            </div>
                                        </div>
                                    </div>
                                    <?php } ?>
                                    <div class="credit_item col-md-12 nopad">
                                        ...
                                        <div class="col-md-6 col-xs-6 nopad">
                                            <div class="plcetogo datemark sidebord dtaln">
                                                ...
                                                <input type="text" class="form-control  " name="date_of_travel"
                                                    id="date_of_travel" placeholder="Date of Travel" min="1" max="100"
  ...
  ?>
                                ...
                                <!-- disabled book now button for now -->
             ...
             if(!empty($min_price))
             {
              ?>
                            ...
                            <div style="display:none;" class="col-xs-12 trs-hotel list3">
                                <h4>Hotel :</h4>
                                <h4 class="num1 pull-left"><?=get_application_display_currency_preference();?> <span
                                        class="price"><?=$tour_price['0']['budget_hotel_price']?></span></h4>
                            ...
                            <div style="display:none;" class="col-xs-12 trs-car list3">
                                <h4>Car :</h4>
                                <h4 class="num1 pull-left"><?=get_application_display_currency_preference();?> <span
                                        class="price"><?=$tour_price['0']['standard_car_price']?> </span></h4>
                                <!-- <h4 class="prce1 pull-left">starting Price</h4> -->
                            </div>
                            <?php } ?>
                            ...
                            <div class="col-xs-12 trs-total list3">
                                ...
                                <h5 class="num1 pull-left">
                                    <?=$this->currency->get_currency_symbol($currency_obj->to_currency);?> <span
                                        class="price tprice"><?php echo isset($min_price)? number_format($min_price,0):0; ?></span>
                                </h5>
              ...
              ?>
                            <div class="col-xs-12 trs-total list3">
                                ...
                                <h5 class="num1 pull-left">
                                    <?=$this->currency->get_currency_symbol($currency_obj->to_currency);?> <span
                                        class="price tcon"><?php echo isset($convenience_fees)? number_format($convenience_fees,0):0; ?></span>
                                </h5>
            ...
            ?>
                            <div class="col-xs-12 trs-total list3">
                                ...
                                <h5 class="num1 pull-left">
                                    <?=$this->currency->get_currency_symbol($currency_obj->to_currency);?> <span
                                        class="price"><?php echo isset($gst_value_conv)? number_format($gst_value_conv, 0):0; ?></span>
                                </h5>
                            ...
                            <div class="col-xs-12 trs-total list3">
                                ...
                                <h4 class="num1 pull-left str">
                                    <?=$this->currency->get_currency_symbol($currency_obj->to_currency);?> <span
                                        class="price num22"><?php echo isset($grand_total)? number_format($grand_total, 0):0; ?></span>
                                </h4>
     ...
     text-align: center;">
                            ...
                            <div id="alertp" class="hide text-success">
                                <div class="confirm-span" style="text-align: center;">Your request has been submitted
                                    successfully!</div>
                            </div>

                            <form id="tour_enquiry_form" action="javascript:void(0);">
                                <div class="modal-body">
                                    <h3 class="gateway" style="text-align: center;"><?=$tour_data['package_name']; ?>
                                    </h3>
                                    <div class="form-group modl">
                                        <label class="control-label col-md-4 col-xs-4" for="user_name">Title : <strong
                                                class="text-danger"></strong></label>
                                        <div class="col-md-7 col-xs-8">
                                            <i style="visibility: hidden;" class="fa fa-user" aria-hidden="true"></i>
                                            <select class="form-control mntxt" name="title" id="tour_title"
                                    ...
                                    <div class="form-group modl"><label class="control-label col-md-4 col-xs-4"
                                            for="user_name">First Name : <strong class="text-danger"></strong></label>
                                        <div class="col-md-7 col-xs-8"><i style="visibility: hidden;" class="fa fa-user"
                                                aria-hidden="true"></i><input type="text"
                                                class="form-control mntxt alpha_space" name="ename" id="tour_ename"
                                                placeholder="" aria-required="true" required="required"
                                                value="<?=$this->entity_first_name?>"
                                                style="text-transform: capitalize !important;"></div>
                                    </div>
                                    <div class="form-group modl"><label class="control-label col-md-4 col-xs-4"
                                            for="user_name">Last Name : <strong class="text-danger"></strong></label>
                                        <div class="col-md-7 col-xs-8"><i style="visibility: hidden;" class="fa fa-user"
                                                aria-hidden="true"></i><input type="text"
                                                class="form-control mntxt alpha_space" name="elname" maxlength="50"
                                                id="tour_elname" placeholder="" aria-required="true" required="required"
                                                value="<?=$this->entity_last_name?>"
                                                style="text-transform: capitalize !important;"></div>
                                    </div>

                                    <div class="form-group modl contct">
                                        <label class="control-label col-md-4 col-xs-4" for="user_mobile"> Country Code
                                            :</label>
                                        <div class="col-md-7 col-xs-8">
                                            <?php
           ...
           {
             ?>
                                            <div class="selectedwrap"><select name="pn_country_code"
                                                    id="tour_pn_country_code" required="" aria-required="true"
                                    ...
                                    <div class="form-group modl contct">
                                        <label class="control-label col-md-4 col-xs-4" for="user_mobile"> Phone Number
                                            :</label>
                                        <div class="col-md-7 col-xs-8">
                                            <i style="font-size: 25px;" class="fas fa-mobile-alt"
                                                aria-hidden="true"></i>
                                            <input type="text" class="form-control mntxt mobile _numeric_only"
                                                name="emobile" id="tour_emobile" minlength="10" maxlength="15"
                                                placeholder=""
                                                value="<?php if($this->entity_phone != 0){echo $this->entity_phone;}?>">
                                        </div>
                                    </div>
                                    <div class="form-group modl">
                                        <label class="control-label col-md-4 col-xs-4" for="user_email"> Departure Date
                                            : <strong class="text-danger"></strong>
                                        </label>
                                        <!--AB removed class form tour_departure_date eml n_psngr -->
                                        <div class="col-md-7 col-xs-8">
                                            <i class="fal fa-calendar-alt" aria-hidden="true"
                                                style="right: 20px; left: inherit !important;"></i>
                                            <input type="text" class="form-control mntxt" id="tour_departure_date"
                                                name="departure_date" placeholder="" aria-required="true"
                                    ...
                                    <div class="form-group modl"><label class="control-label col-md-4 col-xs-4"
                                            for="user_name">Number of passengers : <strong
                                                class="text-danger"></strong></label>
                                        <div class="col-md-7 col-xs-8"><i class="fa fa-user"
                                                aria-hidden="true"></i><input type="text"
                                                class="form-control mntxt _numeric_only" maxlength="3"
                                                name="number_of_passengers" id="tour_number_of_passengers"
                                                placeholder="" aria-required="true" required="required"></div>
                                    </div>
                                    <div class="form-group modl"><label class="control-label col-md-4 col-xs-4"
                                            for="user_name">Duration : <strong class="text-danger"></strong></label>
                                        <div class="col-md-7 col-xs-8"><i class="fa fa-clock"
                                                aria-hidden="true"></i><input type="text" class="form-control mntxt"
                                                name="durations" id="tour_durations"
                                                value="<?php echo ($tour_data['duration']+1)." Days ".($tour_data['duration'])." Nights"; ?>"
                                                placeholder=""></div>
                                    </div>

                                    <div class="form-group modl"><label class="control-label col-md-4 col-xs-4"
                                            for="user_email"> Email : <strong class="text-danger"></strong></label>
                                        <div class="col-md-7 col-xs-8 eml"><i class="fa fa-envelope"
                                                aria-hidden="true"></i><input type="email" class="form-control mntxt"
                                                name="eemail" id="tour_eemail" placeholder="" aria-required="true"
                                                required="required" value="<?=$this->entity_email?>"></div>
                                    </div>
                                    <div class="form-group modl"><label class="control-label col-md-4 col-xs-4"
                                            for="comment"> Details : <strong class="text-danger"></strong></label>
                                        <div class="col-md-7 col-xs-8"><i class="fa fa-pencil-square-o"
                                                aria-hidden="true"></i><textarea rows="3" cols="40"
                                                class="form-control mntxt" name="ecomment" id="tour_ecomment"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <input type="submit" class="btn btn-default" id="send_enquiry_button_tour"
                                        value="Send" />
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="detailtab">
                            <div class="holidays_tab">
                                <ul class="nav nav-tabs trul">
                                    <li class=""><a href="#tab_Overview" data-toggle="tab">
                                            <!-- <span><img src="<?=$GLOBALS['CI']->template->template_images('overview.png'); ?>"></span> --><strong>Overview</strong>
                                        </a></li>

                                    <li class="active trooms"><a href="#tab_Itinerary" data-toggle="tab">
                                            <!-- <span><img src="<?=$GLOBALS['CI']->template->template_images('itinerary.png'); ?>"></span> --><strong>
                                                Itinerary</strong>
                                        </a></li>


                                    <li class="tfacility"><a href="#tab_inclusions" data-toggle="tab">
                                            <!-- <span><img src="<?=$GLOBALS['CI']->template->template_images('inclusions.png'); ?>"></span> --><strong>Inclusions
                                                &amp; Exclusions</strong>
                                        </a></li>

                                    <li class="tfacility"><a href="#tab_Terms" data-toggle="tab">
                                            <!-- <span class="fal fa-file-alt"></span> --><strong>Terms &amp;
                                                Conditions</strong>
                                        </a></li>

                                    <li class="tfacility"><a href="#optionals" data-toggle="tab">
                                            <!-- <span><img src="<?=$GLOBALS['CI']->template->template_images('inclusions.png'); ?>"></span> --><strong>Optional
                                                Tours</strong>
                                        </a></li>
                                     ...
                                     if(html_entity_decode($v['hotel_name'])!='') {
                                      ?>
                                                                    <div class="htl_inf">
                                                                        <i class="fa fa-bed" aria-hidden="true"></i>
                                                                        <strong>Hotel Name :
                                                                        </strong><?=html_entity_decode($v['hotel_name'])?>
                                                                        <?php 
                                       if ($v['rating']) {
                                        ?>
                                                                        <span class="star_detail">
                                                                            <span class="stra_hotel"
                                                                                data-star="<?=$v['rating']?>">
                                                                                <span class="fa fa-star"></span>
                                                                                <span class="fa fa-star"></span>
                                                                                <span class="fa fa-star"></span>
...
{ 
 ?>
                                            <div class="table-responsive col-xs-12 col-md-10 col-md-offset-1 dep_dates hide"
                                                id="departure_date_list_ul">
                                                <h4 style="margin-left:5px;font-size: 16px;width:100%;margin-top:0;">
                                                    DEPARTURE DATES</h4>
                                                <div class="in_depdat">
                                                    <ul>
                                                        <?php 
...
?>
     ...
     ?>
        ...
        <div class="modal fade" id="myModal" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <p id="alertp" class="hide text-success">Thank you for choosing Ziphop.com. <br>One of our travel
                        experts will contact you soon to discuss your travel plans</p>
                    <form id="enquiry_form" action="javascript:void(0);">
                        <div class="modal-body">
                            <div class="form-group modl">
                                ...
                                <div class="col-md-7 col-xs-8">
                                    <i style="visibility: hidden;" class="fa fa-user" aria-hidden="true"></i>
                                    <select class="form-control mntxt" name="title" id="title" aria-required="true"
                                        required="required">
                                        <?=generate_options(get_enum_list('title'),(array)$this->entity_title)?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group modl"><label class="control-label col-md-4 col-xs-4"
                                    for="user_name">First Name1 : <strong class="text-danger"></strong></label>
                                <div class="col-md-7 col-xs-8"><i style="visibility: hidden;" class="fa fa-user"
                                        aria-hidden="true"></i><input type="text" class="form-control mntxt"
                                        name="ename" id="ename" placeholder="" aria-required="true" required="required"
                                        value="<?=$this->entity_first_name?>"></div>
                            </div>
                            <div class="form-group modl"><label class="control-label col-md-4 col-xs-4"
                                    for="user_name">Last Name : <strong class="text-danger"></strong></label>
                                <div class="col-md-7 col-xs-8"><i style="visibility: hidden;" class="fa fa-user"
                                        aria-hidden="true"></i><input type="text" class="form-control mntxt"
                                        name="elname" id="elname" placeholder="" aria-required="true"
                                        required="required" value="<?=$this->entity_last_name?>"></div>
                            </div>
      ...
      { 
       ?>
                                    <div class="selectedwrap"><select name="pn_country_code" id="pn_country_code"
                                            required="" aria-required="true" class="mySelectBoxClass flyinputsnor">
        ...
        foreach($country_code as $c__k => $__country) 
        {
         ?>
                                            <option value="<?=@$c__k?>"
                                                <?php  if($c__k == $this->entity_phone_code) {echo 'selected';} ?>>
                                                <?=$__country?></option>
                                            <?php 
       }
       ?>
   ...
   ?>
                            ...
                            <div class="form-group modl contct">
                                ...
                                <div class="col-md-7 col-xs-8">
                                    ...
                                    <input type="text" class="form-control mntxt mobile" name="emobile" id="emobile"
                                        placeholder="" value="<?=$this->entity_phone?>">
                                </div>
                            </div>
                            <div class="form-group modl">
                                <label class="control-label col-md-4 col-xs-4" for="user_email"> Approximate Departure
                                    Date : <strong class="text-danger"></strong>
                                </label>
                                <div class="col-md-7 col-xs-8 eml n_psngr">
                                    <i class="fa fa-calendar" aria-hidden="true"
                                        style="right: 20px; left: inherit !important;"></i>
                                    <input type="text" class="form-control mntxt" id="departure_date"
                                        name="edeparture_date" placeholder="" aria-required="true" required="required"
                                        readonly="readonly">
                                </div>
                            </div>
                            <div class="form-group modl"><label class="control-label col-md-4 col-xs-4"
                                    for="user_name">Number of passengers : <strong class="text-danger"></strong></label>
                                <div class="col-md-7 col-xs-8"><i class="fa fa-user" aria-hidden="true"></i><input
                                        type="text" class="form-control mntxt" name="number_of_passengers"
                                        id="number_of_passengers" placeholder="" aria-required="true"
                                        required="required"></div>
                            </div>
                            <div class="form-group modl"><label class="control-label col-md-4 col-xs-4"
                                    for="user_name">Duration : <strong class="text-danger"></strong></label>
                                <div class="col-md-7 col-xs-8"><i class="fa fa-clock-o" aria-hidden="true"></i><input
                                        type="text" class="form-control mntxt" name="durations" id="durations"
                                        placeholder=""></div>
                            </div>

                            <div class="form-group modl"><label class="control-label col-md-4 col-xs-4"
                                    for="user_email"> Email ID : <strong class="text-danger"></strong></label>
                                <div class="col-md-7 col-xs-8 eml"><i class="fa fa-envelope"
                                        aria-hidden="true"></i><input type="email" class="form-control mntxt"
                                        name="eemail" id="eemail" placeholder="" aria-required="true"
                                        required="required" value="<?=$this->entity_email?>"></div>
                            </div>
                            <div class="form-group modl"><label class="control-label col-md-4 col-xs-4" for="comment">
                                    Tell us about your trip plans : <strong class="text-danger"></strong></label>
                                <div class="col-md-7 col-xs-8"><i class="fa fa-pencil-square-o"
                                        aria-hidden="true"></i><textarea rows="3" cols="40" class="form-control mntxt"
                                        name="ecomment" id="ecomment" placeholder="" aria-required="true"
        ...
        <div id="subtqry" class="wellme minwnwidth" style="display: none;">
            ...
            <button type="button" class="close log_close close_with_reset holiclose" data-dismiss="modal"
                style="font-size: 14px!important;">X</button>
            <div class="pophed"> Send Enquiry For <?=$tour_data['package_name']; ?></div>
            <div class="signdiv">
                <form action="" method="post" id="tourenquiry">
                    <input type="hidden" class="fulwishxl" id="package_id" name="package_id"
                        value="<?=$tour_data['id']; ?>" />
                    ...
                    <div class="rowlistwish">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="fulwishxl _numeric_only" maxlength='13' id="phone" name="phone"
                                required="" />
                            <span id="verificationCodeErr" style="color:red; font-size: small"></span>
                        </div>
                    </div>
                    ...
                    <div class="rowlistwish">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="fulwishxl" id="departure_date12" name="departure_date" required
                                readonly="" />
                            <span id="verificationCodeErr" style="color:red; font-size: small"></span>
                        </div>
                    </div>
                    ...
                    <div class="downselfom">
                        <div class="col-md-9 col-xs-12 col-md-offset-4">
                            <div class="col-md-4 col-xs-6 nopad"><input type="cancel" value="Cancel"
                                    class="btn  closequery" id="hideCancelPopup" readonly /></div>
                            <div class="col-md-4 col-xs-6"><button type="submit" value="Send Enquiry"
                                    class="btn colorsave colorcancel" id="startCancelProc">Send Enquiry</button></div>
                        </div>
                    </div>
                </form>
            </div>
  ...
  $("#subtqry").hide();
            ...
            $('input:radio').change(
                function() {
                    ...
                    $.ajax({
                        ...
                        success: function(msg) {
                            $('#msg_pak').show();
                            $('#msg_pak').text('Thank you for rating this package').css('color',
                                'green').fadeOut(3000);
                        },
                        error: function() {}
                    });
        ...
        $(document).ready(function() {
            ...
            $('#send_enquiry_button_tour').on('click', function() {
                ...
                if ($ename == '' || $eemail == '' || $ecomment == '' || $number_of_passengers == '' ||
                    $number_of_passengers == 0 || $departure_date == '' || $emobile.length < 10) {
                    alert("Kindly fill all the fields!!");
                    return false;
                }
                $.post('<?=base_url();?>index.php/tours/ajax_enquiry', {
                    'title': $title,
                    'ename': $ename,
                    'elname': $elname,
                    ...
                    'ecomment': $ecomment,
                    'tour_id': $tour_id,
                    'tours_itinerary_id': $tours_itinerary_id,
        ...
        <script src="<?=base_url()?>extras/system/template_list/template_v1/javascript/page_resource/lightslider.js">
        </script>
        <script>
        $(document).ready(function() {
        ...
        function dynamicPriceBreakdown1() {
            $('.dynamicPriceBreakdown:checked').each(function() {
                ...
                var total_price = parseInt($('.trs-hotel').find('.price').text()) + parseInt($('.trs-car').find(
                    '.price').text()) + parseInt($('.package_origional_price').val());
        ...
        function dynamicPriceBreakdown() {
            $('.dynamicPriceBreakdown:checked').each(function() {
                ...
                var category_hotel = $(".select_hotel").find(".dynamicPriceBreakdown:checked").attr(
                    'data-priceTitle');
                var category_transfer = $(".select_transfer").find(".dynamicPriceBreakdown:checked").attr(
                    'data-priceTitle');
                ...
                if (no_of_transfer == null || no_of_transfer == "" || no_of_transfer == 0) {
                    no_of_transfer = 1;
                }
                if (no_of_hotel_room == null || no_of_hotel_room == "" || no_of_hotel_room == 0) {
                    no_of_hotel_room = 1;
                }
                ...
                var ht_price = parseInt($('.trs-hotel').find('.price').text() * parseInt(no_of_hotel_room)) +
                    parseInt($('.trs-car').find('.price').text() * parseInt(no_of_transfer));
                // }
                $.ajax({
                    type: 'POST',
                    async: false,
            ...
            while (loop <= end) {
                ...
                for (var i = 0; i < tour_price_list.length; i++) {
                    ...
                    if (check >= from && check <= to) {
                        tour_price =
                            '<?=$this->currency->get_currency_symbol(get_application_display_currency_preference());?> ' +
                            tour_price_list[i]['price'];
                    }
        ...
        function ViewCustInGoogleMap() {
            ...
            visited_city.forEach(function(entry) {
                ...
                $.getJSON(
                    "https://maps.googleapis.com/maps/api/geocode/json?key=AIzaSyBeYTHE-zI8GJwbtgrfTv_FWHFMRwyagjk&address=" +
                    ...
                    function(val) {
                        ...
                        if (val.results.length) {
                            ...
                            mark_data += '{ "DisplayText": "' + entry + '", "LatitudeLongitude": "' +
                            ...
                            if (k == (visited_city.length - 1)) {
                                ...
                                var mapOptions = {
                                    center: new google.maps.LatLng(location.lat, location
                                    .lng), // Coimbatore = (11.0168445, 76.9558321)
                                    zoom: 7,
        ...
        function PackagePriceCalculator(adultCount, childCount, infantCount, date) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    'infantprice': parseInt(infantPrice),
                ...
                success: function(msg) {
                    ...
                    if (msg) {
                        ...
                        // alert(data.grandtotal);
                         ...
                         var adultc=$('#no_adults').val();
                          var childc=$('#no_child').val();
                           var infantc=$('#no_infant').val();
                         
                           
                           var tpax=parseInt(adultc)+parseInt(childc)+parseInt(infantc);
var tcs=convenience_fees*parseInt(tpax);                         
                       //  alert(tcs);
                    $(".tcon").text(tcs);
