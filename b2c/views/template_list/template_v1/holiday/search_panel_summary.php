...
.searchsbmtfot input.searchsbmt,
.searchsbmtfot button.searchsbmt {
...
i.fa.fa-angle-down.mobresdv.modu {
    position: relative;
    top: 5px;
}
.modfictions{background-color: #7d7878;}
.modifdrp{padding: 0px!important;}
</style>
                ...
                <div class="smldescrptn">
                    ...
                    <div class="col-sm-10 col-xs-10 nopad">
                     ...
                     <h3 class="placenameflt"><?=$location?> <span class="close_fil_box"><i class="fas fa-times"></i></span></h3>
                        ...
                        <div class="col-xs-12 col-md-3 boxpad none_boil mobhide">
                        ...
                        <div class="col-xs-12 col-md-3 boxpad none_boil mobview">
                            ...
                            <h3 class="placenameflt">
                                <?php if($tour_search_params['city_name'] !=""){ echo $tour_search_params['city_name']; }else{ echo "All Destination"; } ?>
                            </h3>
                        ...
                        <div class="col-xs-12 col-md-3 boxpad none_boil mobhide">
                            ...
                            <div class="mdityp">
                                ...
                                <h3 class="placenameflt">
                                    <?php if($tour_search_params['duration'] !=""){ echo $tour_search_params['duration']; }else{ echo "All Durations"; }?>
                                </h3>
                 ...
                 <div class="col-xs-8 boxpad none_mody">
                    ...
                    <div class="col-xs-2 boxpad pull-right">

                        <a id="modidown" class="modifysrch collapsed" data-toggle="collapse" data-target="#modify"
                            aria-expanded="false"> <span class="mdyfydsktp">Modify Search</span>

                            <i class="fa fa-angle-down mobresdv modu" aria-hidden="true"></i> </a>
            ...
            <div class="splmodify">
                ...
                <div class="container">
				   ...
				   ?>
                                            ...
                                            <div class="col-md-3 col-sm-6 col-xs-12 mobile_width padfive">
                          ...
                          <?php } } ?>
                                                ...
                                                <input type="text" id="country"
                                                    class="fromholiday1 normalinput form-control b-r-0 brleft30"
                                                    placeholder="All Destination" name="city"
                                                    value="<?php echo @$scountry;?>" />
                                                ...
                                                <input class="hide loc_id_holder" name="destination_id" type="hidden"
                                                    id="destination_id" value="<?=@$scountry?>">
                                            ...
                                            <div class="col-md-2 col-sm-6 col-xs-12 bpd mobile_width padfive">
                                                ...
                                                <select class="normalsel form-control normalinput padselct arimo"
                          ...
                          if(!empty($holiday)){ ?>
                                                    ...
                                                    <option value="<?php echo $package_type->id; ?>"
                                                        <?php if(isset($tour_search_params['package_type'])){ if($tour_search_params['package_type'] == $package_type->id) echo "selected"; } ?>>
                                            ...
                                            <div class="col-md-2 col-sm-6 bpd col-xs-12 mobile_width padfive">
                                                ...
                                                <select class="normalsel padselct normalinput arimo form-control "
                                                    id="duration" name="duration">

                                                    <option value="">All Durations</option>

                                                    <option value="1-3"
                                                        <?php if(isset($tour_search_params['duration'])){ if($tour_search_params['duration'] == '1-3') echo "selected"; } ?>>
                                                        1-3</option>

                                                    <option value="4-7"
                                                        <?php if(isset($tour_search_params['duration'])){ if($tour_search_params['duration'] == '4-7') echo "selected"; } ?>>
                                                        4-7</option>

                                                    <option value="8-12"
                                                        <?php if(isset($tour_search_params['duration'])){ if($tour_search_params['duration'] == '8-12') echo "selected"; } ?>>
                                                        8-12</option>

                                                    <option value="12"
                                                        <?php if(isset($tour_search_params['duration'])){ if($tour_search_params['duration'] == '12') echo "selected"; } ?>>
                                                        12</option>
                        ...
                        $(document).ready(function() {
                            ...
                            $(".fromholiday1").catcomplete({
                                ...
                                source: function(request, response) {
                                    ...
                                    $.getJSON(app_base_url + "index.php/ajax/get_holiday_city_list",
                                        request,
                                ...
                                select: function(event, ui) {
                                    ...
                                    $.ajax({
                                        ...
                                        url: app_base_url +
                                            "index.php/ajax/get_ss_category_list",
                                        ...
                                        success: function(cate_res) {
                                            ...
                                            var check_list_cate = cat_str
                                                .cate_check_list;

                                            //var option_list =option_cate_list.replace(/\\/g, "");

                                            var cate_list = check_list_cate.replace(
                                                /\\/g, "");
                                ...
                                var auto_suggest_value = highlight_search_text(this.term.trim(), item.value,
                                    item.label);
                                ...
                                if (count > 0) {
                                    ...
                                    hotel_count = '<span class="hotel_cnt">(' + parseInt(item.count) + ' ' +
                                        h_lab + ')</span>'

                                }

                                return $("<li class='custom-auto-complete'>").append(
                                    '<a> <span class="fal fa-map-marker-alt"></span> ' +
                                    auto_suggest_value + ' ' + hotel_count + '</a>').appendTo(ul)
