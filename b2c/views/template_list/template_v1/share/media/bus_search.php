<div class="hide">
	...
	<audio id="pre-load">
		<source src="<?=$GLOBALS['CI']->template->template_audio_dir('ogg/bus-pre-load.ogg')?>" type="audio/ogg">
		<source src="<?=$GLOBALS['CI']->template->template_audio_dir('mp3/bus-pre-load.mp3')?>" type="audio/mpeg">
	</audio>
	<audio id="post-load">
		<source src="<?=$GLOBALS['CI']->template->template_audio_dir('ogg/bus-post-load.ogg')?>" type="audio/ogg">
		<source src="<?=$GLOBALS['CI']->template->template_audio_dir('mp3/bus-post-load.mp3')?>" type="audio/mpeg">
	</audio>
	<audio id="empty-load">
