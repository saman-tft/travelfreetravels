...
<style>
    ...
    display: block;
    max-width: 600px;
    background: none repeat scroll 0 0 #ffffffbf;
...
#cspio-page {
    ...
    padding-right: 10px;
    min-height: 100%;
    background: url(https://www.alkhaleejtours.com/extras/system/template_list/template_v1/images/ptransfers-bg.jpg);
...
<div class="cruise">
	<div id="cspio-page">
		<div id="cspio-content">
			...
			<img id="cspio-logo" src="https://www.alkhaleejtours.com/extras/custom/TMX9604421616070986/images/TMX1512291534825461logo-loginpg.png">
