...
//debug($search_response_array);die
                 ...
                 //   {
                         $search_response = $this->tripxml_to_tmx_formatversion2($search_response_array,$search_data['data']);
                   // }
                    //else
                   // {
...
*/
 ...
 function tripxml_to_tmx_formatversion2($search_response,$search_data){
    //debug($search_response);die;
        $flights =$search_response['Flightavailability']['Outbound']['Availability'];
...
//debug($pax_ticket_ids);exit;
                ...
                if ($cancel_booking_request['status']) {
                  ...
                  //  $cancel_response_format = Converter::createArray ( $send_change_response );
                     debug($send_change_response); die;
     ...
     * return booking form
     */
    function booking_form($isDomestic, $token = '', $token_key = '', $search_access_key = '', $promotional_plan_type = '', $booking_source = PLAZMA_BOOKING_SOURCE) {
        $booking_form = '';
        ...
        if ($module == 'b2c') {
          ...
          //debug($flight_details['FareDetails']);die;
           ...
           // echo $o_Total_Fare;exit;
            $b2c_price_details['BaseFare'] = $flight_details['FareDetails']['BaseFare'];
...
//echo json_encode($page_params);die;
           ...
           // echo $o_Total_Fare;exit;
            ...
            $b2c_price_details['TotalTax'] =round($o_Total_Tax);
            $b2c_price_details['TotalFare'] =round($o_Total_Fare);
            $b2c_price_details['Currency'] = $api_price_details['Currency'];
            $b2c_price_details['CurrencySymbol'] = $currency_symbol;
            $b2c_price_details['_GST'] = $admin_price_details['_GST'];
