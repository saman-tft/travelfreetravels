...
ini_set('display_errors', '1');
	...
	//	debug(	$hotels['hotel_types_list'] );exit;
		$country_nationality = $this->hotels_model->get_country_list(); 
			...
			$this->template->view('hotel/search_result_page', array('hotel_search_params' => $safe_search_data['data'], 'active_booking_source' => $active_booking_source,'current_booking_source'=>$current_booking_source,'hotel_types_list'=>$room_type,'country_nationality'=>$country_nationality,'nationality_name'=>$nationality_name));
		} else {
