...
?>
	<form autocomplete="off" name="bus" id="bus_form" action="<?php echo base_url();?>index.php/general/pre_search" method="get" class="activeForm oneway_frm" style="">
		<div class="row">
			<div class="col-md-6">
		...
		<div class="clearfix">
			...
			<div class="pull-right">
				<input type="hidden" style="width:0px" name="type" value="<?php echo $this->encrypt->encode(META_BUS_COURSE)?>" />
	...
	$(document).ready(function(){
		...
		$(".bus-station").autocomplete({
			source:  function( request, response ) {
				...
				$.getJSON( "<?php echo base_url()?>index.php/ajax/bus_stations", request, function( data, status, xhr ) {
					cache[ term ] = data;
					response( data );
				});
			},
