<div class="panel panel-primary clearfix">
	...
	<a class="btn btn-sm btn-danger" id="roe-auto-update" href="<?php echo base_url().'utilities/auto_currency_converter'?>">
...
$(document).ready (function () {
	$('.updateButton').on('click', function () {
		var thisRef = this;
		$.post('<?php echo base_url(); ?>index.php/utilities/currency_converter/'+parseFloat($(this).closest('td').siblings().children('[name="value"]').val())+'/'+$(this).closest('td').siblings().children('[name="value"]').attr('id'), function (response) {
