...
?>
<form name="hotel_search" id="hotel_search" autocomplete="off" action="<?php echo base_url().'index.php/general/pre_search' ?>">
	<div class="row">
		<div class="col-md-6">
	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group">
				<input type="text" id="" class="hotel_city form-control b-r-0" placeholder="Region, City, Area (Worldwide)" name="city" required value="<?php echo @$hotel_search_params['location']?>"/>
			</div>
		</div>
		<div class="col-md-3">
			<div class="form-group">
	...
	<div class="clearfix">
		<div class="pull-right">
			<input type="hidden" style="width:0px" name="type" value="<?php echo $GLOBALS['CI']->encrypt->encode(META_ACCOMODATION_COURSE)?>" />
			<input type="submit" class="btn btn-lg btn-i b-r-0" value="Search Hotels" />
		</div>
	</div>
</form>
	...
	$(document).ready(function(){
		...
		$(".hotel_city").autocomplete({
			source:  function( request, response ) {
				...
				$.getJSON( "<?php echo base_url()?>index.php/ajax/get_hotel_city_list", request, function( data, status, xhr ) {
					cache[ term ] = data;
					response( data );
				});
			},
