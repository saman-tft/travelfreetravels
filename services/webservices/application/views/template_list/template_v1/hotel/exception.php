...
?>
<p><a class="btn btn-primary btn-lg" href="<?php echo base_url()?>general/index/hotel/?default_view=<?php echo META_ACCOMODATION_COURSE?>"
...
$(document).ready(function() {
	$.getJSON("http://ip-api.com/json", function(json) {
		$.post("<?php echo base_url().'index.php/ajax/log_event_ip_info/'.$eid?>", json);
	});
});
</script>
<?php
