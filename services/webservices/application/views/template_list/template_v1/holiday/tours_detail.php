...
<script src="<?php echo $GLOBALS['CI']->template->template_js_dir('owl.carousel.min.js') ?>" type="text/javascript"></script>
...
<div id="subtqry" class="wellme minwnwidth" style="display: none;">
    ...
    <div class="signdiv">
      <form action="<?php echo base_url(); ?>tours/enquiry" method="post">
