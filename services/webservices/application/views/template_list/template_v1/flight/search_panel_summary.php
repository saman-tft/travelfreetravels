			...
			<div class="panel panel-default b-r-0">
				<div class="panel-body p-0">
					<div class="row m-0 lg-flex">
						<div class="col-lg-2 col-md-4 col-sm-6 p-tb-5 lg-text-center b-r">
						...
						<div class="col-lg-3 col-md-4 col-sm-6 p-tb-5 b-r">
						...
						<div class="col-lg-1 col-md-4 col-sm-6 p-tb-5 b-r">
							<h2 class="h4">Class</h2>
							<h3 class="h5"><?php echo $flight_search_params['v_class'] ?></h3>
						</div>
						<div class="clearfix visible-sm-block"></div>
						<div class="col-lg-2 col-md-4 col-sm-6 p-tb-5 b-r">
