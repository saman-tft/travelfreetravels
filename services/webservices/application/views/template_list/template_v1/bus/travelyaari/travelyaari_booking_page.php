...
foreach ($pre_booking_params['seat'] as $k => $v) {
	if (isset($bus_seats[$v]) == false || $bus_seats[$v]['IsAvailable'] != 'true' ) {
		...
		$temp_currency = $currency_obj->get_currency($bus_seats[$v]['Fare']);
				...
				<div class="panel panel-default b-r-0 m-0">
					...
					<table class="table">
						<tbody>
							...
							<tr>
								<td>Grand Total</td>
								<td class="text-right"><?=$temp_currency['default_currency']?> <span class="h4 text-i"><?=$markup_total_fare?></span></td>
							</tr>
						</tbody>
					</table>
				</div>
				<div class="panel panel-default b-r-0 m-0">
					...
					<table class="table text-center">
						<tbody>
							...
							<tr>
								<td><?=$CUR_Route['BusLabel']?></td>
							</tr>
							<tr>
								<td>Departure : <?=local_date($CUR_Route['DepartureTime'])?>(<?=get_duration_label(calculate_duration($CUR_Route['DepartureTime'], $CUR_Route['ArrivalTime']))?> Journey)</td>
							</tr>
							<tr>
				...
				<div class="panel panel-default b-r-0">
					<div class="panel-body">
						<form action="<?php echo base_url().'index.php/bus/pre_booking/'.$search_data['search_id'] ?>" autocomplete="off" method="POST">
							<div class="clearfix">
								<div class="pull-left">
									<h1 class="h3 m-t-0"><img src="<?=$template_images?>icons/angle-arrow-down.png" alt="Angle Arrow Down Icon"> Passenger Information</h1>
								</div>
							...
							<div class="row">
								<div class="col-md-2">
									...
									$i_seat_title[] = ' @ '.$pre_booking_params['default_currency'].' '.$i_seat['Markup_Fare'];
								...
								<div class="col-md-10">
									<div class="row">
										...
										<div class="col-md-4">
											<div class="form-group">
												<input type="text" maxlength="45" id="contact-name"  name="contact_name[]"class="form-control b-r-0" required placeholder="Name">
											</div>
										</div>
										<div class="col-md-3">
											<div class="form-group">
										...
										<div class="col-md-3">
											<div class="form-group">
												<input type="text" maxlength="3" max="100" id="age-<?=($i);?>" name="age[]" placeholder="Age" class="form-control b-r-0 numeric" required>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="hide">
								...
								<input type="hidden" required="required" name="booking_source"	value="<?=$pre_booking_params['booking_source']?>" readonly="readonly">
							</div>
							<hr>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="email" maxlength="45" name="contact_email" placeholder="To Send E-Ticket" class="form-control b-r-0" id="contact-email" required="required">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label for="passenger-contact">Mobile <sup class="text-danger">*</sup></label>
										<input type="text" maxlength="10" name="passenger_contact" placeholder="To Send Confirmation Number" class="form-control b-r-0 numeric " id="passenger-contact" required="required">
									</div>
								</div>
							</div>
							<div class="row">
