...
<table class="table table-striped">
	...
	<tr>
		<th>Bus Type</th>
		<td><?=get_bus_type($details['HasAC'], $details['HasNAC'], $details['HasSeater'], $details['HasSleeper'], $details['IsVolvo'])?></td>
	</tr>
	<tr>
		<th>Departure</th>
	...
	<tr>
		...
		<td><?=get_duration_label($details['DepartureTime'], $details['ArrivalTime'])?></td>
	</tr>
	<tr>
		<th>Fare</th>
