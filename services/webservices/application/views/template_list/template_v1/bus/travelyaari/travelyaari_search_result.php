<?php
include_once 'process_travelyaari_response.php';
...
$busses = '<div class="result-wrapper-group">';
	...
	<div class="panel-body p-0 result-row-index">
		<div class="row lg-flex">
			...
			<div class="col-md-3 col-sm-6 p-tb-10">
				<div class="media">
					...
					<div class="media-body">
						...
						<span class="hide bus-type-count">'.(get_bus_type_count($__bv['HasAC'], $__bv['HasNAC'], $__bv['HasSeater'], $__bv['HasSleeper'], $__bv['IsVolvo'])).'</span>
						...
						<p class="m-0 duration" data-duration="'.$s2s_duration.'"><small>Duration - '.get_duration_label($s2s_duration).'</small></p>
			...
			<div class="col-md-1 col-sm-6 b-r text-center">
				<h6 class="">
				'.get_bus_type($__bv['HasAC'], $__bv['HasNAC'], $__bv['HasSeater'], $__bv['HasSleeper'], $__bv['IsVolvo']).'
				</h6>
			</div>
			<div class="clearfix visible-sm-block"></div>
