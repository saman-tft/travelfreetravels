...
class Provab_private extends Common_Api_Grind {
	...
	function credentials($service) {
		switch ($service) {
				case 'Authenticate' :				
				$this->service_url ='http://test.services.travelomatix.com/webservices/transferv1/service/Authenticate';			
				break;
			case 'CategoryList':
				$this->service_url ='http://test.services.travelomatix.com/webservices/transferv1/service/CategoryList';
				break;
			case 'Search':
				$this->service_url ='http://test.services.travelomatix.com/webservices/transferv1/service/Search';
				break;
			case 'ProductDetails':
				$this->service_url = 'http://test.services.travelomatix.com/webservices/transferv1/service/ProductDetails';
				break;
			case 'TripList':
				$this->service_url ='http://test.services.travelomatix.com/webservices/transferv1/service/TripList';
				break;
			case 'BlockTrip':
				$this->service_url = 'http://test.services.travelomatix.com/webservices/transferv1/service/BlockTrip';
				break;
			case 'Book':
				$this->service_url ='http://test.services.travelomatix.com/webservices/transferv1/service/CommitBooking';
				break;
			case 'CancelBooking':
				$this->service_url = 'http://test.services.travelomatix.com/webservices/transferv1/service/CancelBooking';
				break;
			case 'UpdateHoldBooking':
				$this->service_url = 'http://test.services.travelomatix.com/webservices/transferv1/service/UpdateHoldBooking';
				break;
			case 'CancellationRefundDetails':
				$this->service_url = 'http://test.services.travelomatix.com/webservices/transferv1/service/CancellationRefundDetails';
				break;
		}
	}
