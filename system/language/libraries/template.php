	...
	public function template_images($file_name='')
	{
		...
		if (empty($file_name) == true) {
			if (file_exists(SYSTEM_TEMPLATE_LIST_RELATIVE_PATH.'/'.$this->get_application_template().TEMPLATE_IMAGE_DIR)) {
				return $burl1.SYSTEM_TEMPLATE_LIST.'/'.$this->get_application_template().TEMPLATE_IMAGE_DIR;
			} else {
				return $burl1.SYSTEM_TEMPLATE_LIST.'/'.DEFAULT_TEMPLATE.TEMPLATE_IMAGE_DIR;
			}

		} else {
			if (file_exists(SYSTEM_TEMPLATE_LIST_RELATIVE_PATH.'/'.$this->get_application_template().TEMPLATE_IMAGE_DIR.$file_name)) {
				return $burl1.SYSTEM_TEMPLATE_LIST.'/'.$this->get_application_template().TEMPLATE_IMAGE_DIR.$file_name;
			} else {
				return $burl1.SYSTEM_TEMPLATE_LIST.'/'.DEFAULT_TEMPLATE.TEMPLATE_IMAGE_DIR.$file_name;
			}
		}
	}
