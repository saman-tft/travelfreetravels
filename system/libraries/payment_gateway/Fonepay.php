...
class Fonepay {
	...
	function initialize($data)
	{
		...
		//Server: https://clientapi.fonepay.com
			self::$PID = 'MEWH';
			self::$sharedSecretKey = '8b040428a1c2410ba02b2afdc351e752';
			self::$url = 'https://dev-clientapi.fonepay.com/api/merchantRequest';
			...
			self::$PID = 'MEWH';
			self::$sharedSecretKey = '8b040428a1c2410ba02b2afdc351e752';
			self::$url = 'https://clientapi.fonepay.com/api/merchantRequest';
