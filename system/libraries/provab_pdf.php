...
class Provab_Pdf extends TCPDF {
   ...
   public function __construct($orientation='P', $unit='mm', $format='A4', $unicode=true, $encoding='UTF-8', $diskcache=false)
   {
	 ...
	 */
    //added new pge orientation param for user export
	public function create_pdf($data,$view = 'show', $file_name='', $pdf_page_orientation = "P")
	{
		...
		// debug($output_pdf);exit;
		$title = domain_name();
        //changed following from constant to variable for user export
