...
class Activity extends CI_Controller {
	...
	public function delete_package($id) {
		...
		redirect ( 'activity/view_with_price' );
	}
...
//debug($week_days);exit;
	...
	//		debug($this->input->post());die;
		$transfer_option=$this->input->post ( 'transfer_option_'.$j);
			$nationality_option=$this->input->post ( 'nationality'.$j);
				$nationality_option_arr=array_values(array_filter($nationality_option));
		$transfer_option_ary = array_values(array_filter($transfer_option));
	//	debug($nationality_option_arr );die;
		...
		$transfer_option_array = array (
				'activity_id' => $package,
				'nationality_id' =>  $nationality_option_arr[$k],
				'duration' => $season_array[$i],
...
error_reporting(E_ALL);
	...
	public function update_top_destination($package_id, $status) {
		...
		redirect ( 'activity/view_with_price/', 'refresh' );
	}
