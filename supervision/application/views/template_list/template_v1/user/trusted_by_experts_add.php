...
<ul class="nav nav-tabs" role="tablist" id="myTab">
	...
	<li role="presentation" >
		<a  href="<?=base_url().'user/trusted_by_experts_images'?>" ><button class="btn btn-primary btn-sm pull-right amarg">Manage Trusted By Experts List</button></a>
	</li>
...
<div class="tab-content">
   <div id="fromList" class="clearfix tab-pane  active " role="tabpanel">
      <div class="panel-body">
         <form class="form-horizontal" role="form" id="promo_codes_form_edit" enctype="multipart/form-data" method="POST" action="<?=base_url().'user/add_trusted_by_experts_action'?>" autocomplete="off" name="promo_codes_form_edit">
            <fieldset form="promo_codes_form_edit">
               <legend class="form_legend">Add Trusted By Experts</legend>
               ...
               <div class="form-group">
                  <label form="promo_codes_form_edit" for="module" class="col-sm-3 control-label">Trusted By Experts Image</label>
                  <div class="col-sm-6">
