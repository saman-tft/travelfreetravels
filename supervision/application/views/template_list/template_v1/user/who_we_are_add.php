...
<ul class="nav nav-tabs" role="tablist" id="myTab">
	...
	<li role="presentation" >
		<a  href="<?=base_url().'user/who_we_are_images'?>" ><button class="btn btn-primary btn-sm pull-right amarg">Manage Who We Are List</button></a>
	</li>
...
<div class="tab-content">
   <div id="fromList" class="clearfix tab-pane  active " role="tabpanel">
      <div class="panel-body">
         <form class="form-horizontal" role="form" id="promo_codes_form_edit" enctype="multipart/form-data" method="POST" action="<?=base_url().'user/add_who_we_are_action'?>" autocomplete="off" name="promo_codes_form_edit">
            <fieldset form="promo_codes_form_edit">
               <legend class="form_legend">Add Who We Are</legend>
               ...
               <div class="form-group">
                  <label form="promo_codes_form_edit" for="module" class="col-sm-3 control-label">Who We Are Image</label>
                  <div class="col-sm-6">
