...
<a href="<?php echo base_url(); ?>index.php/general/export_subscribed_emails_report/excel<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>">subscribed email report</a>
		...
		<div class="panel-body"><!-- PANEL BODY START -->
            ...
            <div role="tabpanel" class="clearfix tab-pane active nopad" id="tableList">
               <div class="panel <?=PANEL_WRAPPER?>" style="margin-top:60px;">
   ...
   <form method="GET" role="search">
      <div class="form-group">
         <div class="input-group">
            <input type="text" placeholder="'.get_app_message('AL004').'" class="form-control heinpu" name="email">
