                        ...
                        <tr>
                            ...
                            <td colspan="4" style="line-height:20px; border-bottom:1px solid #999999; padding-bottom:15px; font-size:12px; color:#555">
                                ...
                                <?php echo $data['note']; ?>
                                 ...
                                 <tr>
                                    <td colspan="4" align="right" style="padding-top:10px;font-size:13px;line-height:20px;"><?php echo strtoupper($data['domainname']) ?><br>Email : <?php echo $data['voucher_email'] ?><br>Phone : <?php echo $data['voucher_phone'] ?><br>Address : <?php
