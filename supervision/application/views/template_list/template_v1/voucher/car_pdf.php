...
<table
	style="border-collapse: collapse; background: #ffffff; font-size: 11pt; margin: 0 auto; font-family: arial;"
					...
					<tr>
						<td style="padding: 10px;">
							<table cellpadding="5" cellspacing="0" border="0" width="100%"
								...
								<tr>
						<td
							style="font-size: 13pt; line-height: 30px; width: 100%; display: block; font-weight: 600; text-align: center">Car Voucher</td>
					</tr>
					...
					<tr>
						<td>
							<table width="100%" style="border-collapse: collapse;"
								...
								<tr>
									<td width="50%"
										style="padding: 10px; border: 1px solid #cccccc; font-size: 11pt; font-weight: bold;">Reservation Ticket (<?php echo ucfirst($booking_details['car_pickup_lcation']).' To '.ucfirst($booking_details['car_drop_location']);?>)</td>
								</tr>
								<tr>
								...
								<tr>
                        <td colspan="4" align="right" style="padding-top:10px;font-size:11pt;line-height:20px;"><?=strtoupper($data['domainname'])?><br>Phone : <?=$data['phone']?><br>Email : <?=$data['email']?><br>Address : <?=STATIC_ADDRESS;?><br><?=STATIC_COUNTRY;?></td>
                     </tr>
							</table>
						</td>
					</tr>
...
<table id="printOption"
	...
	style="border-collapse: collapse; font-size: 11pt; margin: 10px auto; font-family: arial;"
