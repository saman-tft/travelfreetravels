...
<section class="invoice">
        ...
        <div class="col-sm-4 invoice-col">
            ...
            <address>
               ...
               <!--  <b>Email :</b> info@sunango.com<br>  -->
                <?=$admin_details[$mainkey]['address']?>,<br>
                <br>
        ...
        <!-- <div class="col-sm-6 invoice-col" style="width:50%">
            ...
            <address>              
                <table>
                    ...
                    <?php if ($admin_details[$mainkey]['state'] == "Karnataka") { ?>
    ...
    if ($admin_details['state'] == "Karnataka") {
        ?>
                        ...
                        <?php } ?>
                        <tr><td><?php
                    if ($admin_details[$mainkey]['state'] == "Karnataka") {
                        $TotalGST = $cdst + $sgst;
                    } else {
                        $TotalGST = $igst;
                    }
    ...
    if($record_num=='4')
    {
         $TotalDisplayFare =(($booking_details['fare']+$booking_details['admin_markup']+$booking_details['agent_markup'])-$booking_details['discount']);
         $total = $TotalDisplayFare+$TotalGST+$booking_details['convinence_amount'];
        ...
        $negative_markup =0;
         ...
         // debug($gst_details);exit;
                          $markup=$booking_details['admin_markup'];
                          $markup_gst=0;
                          if($gst_details['status'] == true){
                              if($gst_details['data'][0]['gst'] > 0){
                                
                                  $markup=($booking_details['admin_markup']/(100+$gst_details['data'][0]['gst']))*100;
                                  $markup_gst=$booking_details['admin_markup']-$markup;
                              }
                          }
                          
                       $ugst=$TotalGST+$markup_gst;
        ?>
         <div class="col-sm-6 invoice-col" style="width:50%">
            <b>Fare Details</b>
            <address>              
        ...
        <div class="col-sm-6 invoice-col" style="width:50%">
            ...
            <address>              
                <table>
                    <tr><td><?php echo number_format(($booking_details['fare']), 2, '.', ''); ?></td></tr>
                    <tr><td><?php
                            
                                echo number_format(($markup+$booking_details['convinence_amount']), 2, '.', '');
                        
                    ?></td></tr>
                    <tr><td><?php echo number_format($ugst, 2, '.', ''); ?></td></tr>
                    <tr><td><?=$booking_details['discount']?></td></tr>  
                    <tr><td><?php echo number_format(($total + $negative_markup), 2, '.', ''); ?></td></tr>
                    <tr><td><?=round($total + $negative_markup)?></td></tr>
