           ...
           <tr>
            ...
            <tr><td style="line-height:6px;">&nbsp;</td></tr>                  
                ...
                ?>
                           ...
                           <tr><td style="line-height:2px;">&nbsp;</td></tr>
							<tr>
                <td width="100%" style="padding:0"><table width="100%" cellspacing="-7" cellpadding="5" style="padding: 0;font-size: 9pt;">   
                    <tbody>
                      <tr>
                        ...
                        <td><table cellpadding="5" width="100%" style="border:1px solid #9a9a9a;font-size:10pt; padding:0;">
             ...
             <tr>
              ...
              <tr>
                <td align="right" style="padding-top:10px;font-size:9pt;line-height:16px"><?php echo strtoupper($data['domainname']) ?><br>Email : <?php echo $data['voucher_email'] ?><br>Phone : <?php echo $data['voucher_phone'] ?><br>Address : <?php
