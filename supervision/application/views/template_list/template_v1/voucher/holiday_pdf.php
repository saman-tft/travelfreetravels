...
<?php } ?>
  <table class="table" bgcolor="#fff" style="border-collapse: collapse; background: #f5f5f5; border: 15px solid #fff; font-size: 12px; line-height: 18px; margin: 0 auto; font-family: arial; max-width:900px"
      ...
      <tr>
        <td style="padding:0px;">
          <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
                    ...
                    <tr bgcolor="#fff">
                    <td colspan="4" style="padding:5px 9px;" class="logocvr"><img style="width: 130px;text-align: left;"
                          src="<?php
                          ...
                          ?>"></td> 
                            ...
                            <br><br>
                            <span style="margin: 0px; margin-top: 30px; font-size:9px; font-weight: 500;"><?=strtoupper($data['domainname'])?></span><br>
                            <span style="margin: 0px; font-size:9px; color: #333;">Phone : <?=$data['phone']?></span><br>
                            <span style="margin: 0px; font-size:9px; color: #333;">Email : <?=$data['email']?></span><br>
                            <span style="color: #333; margin-top: 9px; font-size: 9px; margin-bottom: 0px;">Address : <?=STATIC_ADDRESS;?></span>
                            <span style="color: #333; margin-top: 9px; font-size: 9px; margin-bottom: 0px;"><?=STATIC_COUNTRY;?></span>
                  ...
                  <td bgcolor="#00a9d6" colspan="4" style="padding:5px 0px;" align="right" class="logocvr">
                  ...
                  <tr>
                     ...
                     if($booking_details['status'] == 'BOOKING_CONFIRMED')
                     {
                      ?>
                      <tr>
                       <td colspan="8" align="left" class="logocvr" style="padding: 14px 14px; color: #374c5d; margin: 0px; font-size:9pt; line-height: 20px; text-align: left; font-weight: bold; border-bottom: 2px solid #fff;">BOOKING CONFIRMATION</td>
                     </tr>
                     <tr>
         ...
         <tr>
          <td colspan="6" style="padding: 10px 14px;margin-top: 0px;width: 100%;font-size:9pt;color: #374c5d;line-height: 20px;">
           <span style="margin:0px; margin-bottom: 4px; font-weight: bold; font-size: 14px;">Package Name: <?=$tours_details['package_name']?></span>
           <br>
           ...
           <tr>
            ...
            <td colspan="6" style="padding: 8px 14px; border-top:1px solid #fff; font-size: 9px;">
             <table width="100%" cellspacing="0" cellpadding="0" border="0" style="font-size:9px; color: #374c5d; ">
              <tbody>
              <tr>
                              <td style="background-color: #00a9d6;border: 1px solid #00a9d6; color:#fff; font-size:9pt; padding:5px;"><span style="font-size:10pt;color:#fff;vertical-align:middle;padding:10px;"> &nbsp;Customer Details</span></td>
                           </tr>
                    <?php //debug(($attributes));
                                       ...
                                       ?>
                                     <tr>
                                       <td style="width:25%;padding: 10px;border: 1px solid #cccccc; font-size:9pt; font-weight: bold;line-height:20px;">Number of Adult</td>
                                       <td style="width:25%;padding: 10px;border: 1px solid #cccccc; font-size:9pt; font-weight: bold;line-height:20px;"><?php echo $adult_count; ?></td>
                                        <td style="width:50%;padding: 10px;border: 1px solid #cccccc; font-size:9pt; font-weight: bold;line-height:20px;">
                                            <?php
                                             $get_adult=0;
                                               foreach($attributes1->passenger_type as $pt)
                                               {
                                       ...
                                       <tr>
                                       <td style="width:25%;padding: 10px;border: 1px solid #cccccc; font-size:9pt; font-weight: bold;line-height:20px;">Number of Child</td>
                                       <td style="width:25%;padding: 10px;border: 1px solid #cccccc; font-size:9pt; font-weight: bold;line-height:20px;"> <?php echo $child_count; ?>
                                       </td>
                                        <td style="width:50%;padding: 10px;border: 1px solid #cccccc; font-size:9pt; font-weight: bold;line-height:20px;">
                                            <?php
                                             $get_child=0;
   ...
   <tr><td style="line-height:2px;">&nbsp;</td></tr>  
      ...
      <tr>
        <td colspan="6" width="100%">
                ...
                <tr>
                              <td style="background-color: #00a9d6;border: 1px solid #00a9d6; color:#fff; font-size:9pt; padding:5px;"><span style="font-size:10pt;color:#fff;vertical-align:middle;padding:10px;"> &nbsp;Itinerary Details</span></td>
                           </tr>
                </table>
              </td>
            </tr>
        ...
        ?>
          ...
          <!--  <span style="margin:0;">Overnight at hotel <?=$itinary['hotel_name']?></span><br>-->
            <span>
              ...
              {
                ?>
                <img src="http://www.Tripmia.com/extras/custom/keWD7SNXhVwQmNRymfGN/images/star_rating_<?=$itinary['rating']?>.png">
                <?php
              }
              ?>
            </span><br>
        ...
        <table width="100%" border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse; font-size: 9px; color: #374c5d; ">
            <tbody>
                ...
                ?>
                  ...
                  {
                    $discount_value=round($booking_details['discount']);
                 ...
                 // $base_fare=$base_fare-$gst_value;
                  ...
                  <?php if($booking_details['user_type']!=3) {?>
                   <tr>
                    ...
                    <tr>
                      <td ><strong>Convinence Fee</strong></td>
                       <td >
                           <?php
                           $convenience_fee=round($attributes['convenience_fee']);
                             echo number_format( $convenience_fee,2);
...
<tr>
  <td>
      ...
      <?php if($tours_details['inclusions']){ ?>
        <tr>
          <td style="text-align:left; font-size:9px; color:#374c5d;font-weight: bold; padding: 0px 14px;border-bottom: 1px solid #ffffff;line-height: 30px;">Tour Inclusions</td></tr>
            <tr>
    <td style="line-height: 5px;">&nbsp;</td>
  </tr>
    ...
    <td style="line-height: 5px;">&nbsp;</td>
        ...
        <tr>
           <td style="text-align:left; font-size:9px; padding: 0px 14px; color:#374c5d;font-weight: bold;border-bottom: 1px solid #ffffff;line-height: 30px;">Tour Exclusions</td>
          </tr>
          <tr>
    <td style="line-height: 5px;">&nbsp;</td>
  </tr>
 ...
 <tr>
           <td style="text-align:left; font-size:9px; padding: 0px 14px; color:#374c5d;font-weight: bold;border-bottom: 1px solid #ffffff;line-height: 30px;">Note</td>
          </tr>
          <tr>
    <td style="line-height: 5px;">&nbsp;</td>
  </tr>
            <tr>
              <td style="text-align:left; font-size:9px; color:#374c5d; padding: 0px 14px;"><?php echo htmlspecialchars_decode($data['note']);?>
          </td>
        </tr>
            <tr>
                  ...
                  <td colspan="7" width="100%" style="text-align:left; font-size:9px; padding: 0px 14px; color:#374c5d;font-weight: bold;border-bottom: 1px solid #ffffff;line-height: 30px;">Contact Information
                   ...
                   <tr>
                    <td width="100%" colspan="7">
                     ...
                     <tbody>
                  <tr>
                     <td style="text-align:left; color: #374c5d; font-size: 9px;border-collapse: collapse;padding:0px;">For any questions or inquiries please email us at <?=$data['voucher_email']?> or contact our 24/7 Help Desk at <span style="color:#ff9a03; "><?=$data['voucher_phone']?></span> our dedicated and well experienced staff will assist you all the way.</td>
                  </tr>
