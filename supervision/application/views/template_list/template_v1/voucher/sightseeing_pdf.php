...
<table style="background: #ffffff;font-size: 12pt; margin: 0 auto; font-family: arial;" width="100%" cellpadding="0" cellspacing="0" border="0">
  <tbody>
   <tr>
            ...
            <tr><td style="line-height:6px;">&nbsp;</td></tr>                  
             ...
             <tr>
              ...
              <tr>
                  ...
                  <td colspan="4"><span style="font-size: 11pt;line-height:12px;font-weight: 500;color:#333">Note:</span></td></tr>

              <tr>

                  <td colspan="4" style="border-bottom:1px solid #999999; padding-bottom:15px; font-size:9pt; color:#555;line-height:16px">
              ...
              <tr>
                <td align="right" style="padding-top:10px;font-size:9pt;line-height:16px"><?=$data['domainname']?><br>ContactNo :<?=$data['voucher_phone']?><br>Email : <?=$data['voucher_email']?><br>Address : <?php
