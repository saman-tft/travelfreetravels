   ...
   <td style="border-collapse: collapse; padding:10px 20px 20px" ><table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
           ...
           <tr>
            ...
            <tr><td style="line-height:6px;">&nbsp;</td></tr>                  
                ...
                <td width="100%" style="padding:0"><table width="100%" cellspacing="-9" cellpadding="5" style="padding: 0;font-size: 9pt;"><tbody><tr><td><table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;border:1px solid #00a9d6;"><tbody><tr><td style="border-bottom:1px solid #00a9d6;padding:5px;background-color: #00a9d6;color: #fff"><span style="font-size:10pt">Payment Details</span></td>

                                <td style="border-bottom:1px solid #00a9d6;padding:5px;background-color: #00a9d6;color: #fff"><span style="font-size:9pt">Amount (<?=$booking_details['currency']?>)</span></td>
            ...
            <tr>
                    ...
                    <td colspan="4"><span style="font-size: 10pt;line-height:12px;font-weight: 500;">Note:</span></td></tr>

                <tr>

                    <td colspan="4" style="border-bottom:1px solid #999999; padding-bottom:15px; font-size:9pt; color:#555;line-height:16px;font-weight: 600;">
