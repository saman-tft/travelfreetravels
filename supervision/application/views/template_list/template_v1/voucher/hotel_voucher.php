...
<div class="table-responsive" style="width:100%; position:relative" id="tickect_hotel">
   <table class="table" cellpadding="0" cellspacing="0" width="100%" style="font-size:13px; font-family: 'Open Sans', sans-serif; width:900px; margin:0px auto;background-color:#fff; padding:50px 45px;box-shadow: 1px 1px 4px 3px #ddd;">
      <tbody>
         <tr>
            <td style="border-collapse: collapse; padding:10px 15px;" >
               <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
                           ...
                           <tr>
                              <td>
                                 <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                       <td style="padding: 0px;"><img style="width:120px;" src="<?=$GLOBALS['CI']->template->domain_images($data['logo'])?>"></td>
                                       <td style="padding: 0px;">
                                 ...
                                 <table width="100%" cellpadding="5" style="padding: 10px;font-size: 13px;padding:5px;">
                                    ...
                                    <tr>
                                       <?php if($attributes['HotelImage'] !='/'):?>
                                          <td style="padding:0px 0"><img style="width:130px;height:90px;object-fit:cover;" src="<?=$attributes['HotelImage'];?>" /></td>
                                       <?php else:?>
                                          <td style="padding:0px 0"><img style="width:130px;height:90px;object-fit:cover;" src="<?=$GLOBALS['CI']->template->template_images("default_hotel_img.jpg");?>" /></td>
                                       <?php endif;?>
                                       <td valign="top" style="padding:0px;"><span style="line-height:30px;font-size:16px;color:#00a9d6;vertical-align:middle;font-weight: 600;"><?php echo $booking_details['hotel_name']; ?></span><br><span style="display: block;line-height:22px;font-size: 13px;"><?php echo $booking_details['hotel_address']; ?> </span><br><span style="display: block;line-height:22px;font-size: 13px;"><img style="width:70px;" src="<?php echo $GLOBALS['CI']->template->template_images('star_rating-'.$attributes["StarRating"].'.png'); ?>" /></span></td>

                                       <td width="32%" style="padding:0px 0;text-align: center;"><span style="font-size:14px; border:2px solid #808080; display:block"><span style="color:#00a9d6;padding:5px; display:block;text-transform:uppercase">Booking ID</span><span style="font-size:14px;line-height:35px;padding-bottom: 5px;display:block;font-weight: 600;"><?php echo $booking_details['booking_id']; ?></span></span></td>
                                    </tr>
                                    </tbody>
                                 </table>
                              </td>
                                 ...
                                 <table width="100%" cellpadding="5" style="padding: 10px;font-size: 13px;padding:5px;">
                                   ...
                                   <td style="background-color:#d9d9d9;padding:5px;color: #333333;">Check-In</td>
                                    ...
                                    <tr>
                                       ...
                                       <td style="padding:5px"  width="30%"><?php echo $itinerary_details['room_type_name']; ?></td>
                           ...
                           <tr><td style="line-height:12px;">&nbsp;</td></tr>
                           <tr>
                              <td style="background-color:#00a9d6;border: 1px solid #00a9d6; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?=SYSTEM_IMAGE_DIR.'people_group.png'?>" /> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Guest(s) Details</span></td>
                           </tr>
                           <tr>
                              <td  width="100%" style="border: 1px solid #00a9d6; padding:0px;">
											...
											<tr>
												<td width="50%" style="padding:0;padding-right:14px;">
													<table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #00a9d6;">
														<tbody>
															<tr>
																<td style="border-bottom:1px solid #00a9d6;padding:5px;color: #fff;background-color: #00a9d6;"><span style="font-size:13px">Payment Details</span></td>
																<td style="border-bottom:1px solid #00a9d6;padding:5px;color: #fff;background-color: #00a9d6;"><span style="font-size:11px">Amount (<?=$booking_details['currency']?>)</span></td>
															</tr>
															<tr>
                                            ...
                                            <!-- <?php } ?> -->
												...
												<td width="50%" style="padding:0;padding-left:14px; vertical-align:top">
													<table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #00a9d6;font-size:12px; padding:0;">
														...
														<tbody>
															<tr>
																<td style="background-color:#00a9d6;border-bottom:1px solid #00a9d6;padding:5px; color:#fff"><span style="font-size:13px">Room Inclusions</span></td>
															</tr>
                     ...
                     <tr>
                            ...
                            <td colspan="4"><span style="line-height:26px;font-size: 14px;font-weight: 500;">Note:</span></td></tr>
                     ...
                     <tr>
                        <td colspan="4" style="border-bottom:1px solid #999999; line-height:20px; font-size:12px; color:#555">
                           <ul>
							...
							<tr>
								<td colspan="4" align="right" style="padding-top:10px;font-size:11px;line-height:20px;"> <!--  <img src="https://www.travelsoho.com/travel-free-travels/extras/system/template_list/template_v3/images/order1.png" alt="" width="300" align="left"> --> 
                                        <?=strtoupper($data['domainname'])?><br>Phone : <?=$data['voucher_phone']?><br>Email : <?=$data['voucher_email']?><br>Address : <?=STATIC_ADDRESS;?><br><?=STATIC_COUNTRY;?>
                                     </td>
							</tr>
