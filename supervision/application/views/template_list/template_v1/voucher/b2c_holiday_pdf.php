        ...
        <td style="padding:0px;">
          <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
                    ...
                    <tr bgcolor="#f5f5f5">
                            ...
                            <br><br>
                            <span style="margin: 0px; margin-top: 30px; font-size:9px; font-weight: 500;">Alkhaleej Travels</span><br>
...
?></span><br>
                           <!--  <span style="margin: 0px; font-size:9px; color: #dfdfdf;">TICO #4631677</span><br> -->
                            ...
                            src="https://<?php echo $_SERVER['HTTP_HOST'];?><?=$GLOBALS['CI']->template->domain_images($GLOBALS['CI']->template->get_domain_logo())?>"
                            alt="" /></td>
                            </tr>
       ...
       <tr>
        ...
        <td style="font-size:9px; padding:0px; width: 40%; text-align: right; vertical-align: top; font-weight:normal;line-height:18px;">
         ...
         echo "<span style='margin:0px;'>Base Fare: ".$base_fare."</span><br>";
                     ...
                     if($attributes['promocode_discount']=='')
                      echo "<span style='margin:0px;'>Discount: 0</span><br>";
                    else
                      echo "<span style='margin:0px;'>Discount: ".$attributes['promocode_discount']."</span><br>";
                      ?>
                      <?php 
      ...
      if($tours_details['inclusions']){ ?>
       ...
       <!--  <tr>
        ...
        <tr style="border-bottom:1px solid #fff; color:#374c5d;">
                  ...
                  <tr>
                     <td style="text-align:left; color: #374c5d; font-size: 9px;border-collapse: collapse;padding:0px;">We at Alkhaleej are here to make your travel worry free and always enjoy the journey!   </td>
                  </tr>
                </tbody>
                     </table>
                  </td>
