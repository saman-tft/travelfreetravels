...
<section class="invoice">
    ...
    <div class="row invoice-info">
        ...
        <div class="col-sm-4 invoice-col">
            ...
            <address>              
                <table>
                    <tr><td><b>User name :</b> <?php echo $data[$mainkey]['domainname']; ?></td></tr>
                    <tr><td><b>Address :</b> <?php echo $data[$mainkey]['address']; ?></td></tr>

                    <?php if (isset($data['state'])) { ?>
                        <tr><td><b>State :</b> <?php echo $data[$mainkey]['state']; ?></td></tr>
                    <?php } ?>
                     <?php if (isset($data['domaincountry'])) { ?>
                        <tr><td><b>Country :</b> <?php echo $data[$mainkey]['domaincountry']; ?></td></tr>
                    <?php } ?>
                    <tr><td></td></tr>
            ...
            <?php } else { ?>
                <address>              
                    <table>
                        ...
                        if(round($booking_details[$mainkey]['gst'])>0){
...
?></td></tr>
                    ...
                    <tr><td><?php echo number_format($Agent_tds,2,'.','')?></td></tr>
                     <?php if($booking_details['convinence_amount'] >0){?>
                      <tr>
                         <td><?=$booking_details['convinence_amount']?></td>
                      </tr>
                    <?php } ?>
                    <tr><td>0.00</td></tr>
