    ...
    <table cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:9pt;font-family: 'Open Sans', sans-serif; max-width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate; color: #000;">
        <tbody>
            ...
            <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                 <tr>
                    <td style="padding: 10px;width:65%;"><img style="width:100px;" src="https://www.travelsoho.com/travel-free-travels/extras/custom/TMX1512291534825461/images/TMX1512291534825461logo-loginpg.png"></td>
            ...
            <?php if ($investor_record ['id'] != '') { ?>
                <!-- <tr>
                    <td colspan="4" style="font-size: 15pt;font-weight: 600;text-align: center;padding: 10px 0 0; line-height:35px;">E-Ticket </td>
                </tr> -->
            <tr>
                ...
                ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="line-height: 13px;"><span> <img src="<?php echo 'https://www.alkhaleejtours.com'.$GLOBALS['CI']->template->domain_images($GLOBALS['CI']->template).$investor_record['passid']; ?>" height="50px" width="100px" class="img-thumbnail"></span></td>
                                            </tr>
                                            <tr>
                                                <td style="line-height: 13px;"><span>Passport Copy</span></td>
                                                <td style="line-height: 13px;"><span> <img src="<?php echo 'https://www.alkhaleejtours.com'.$GLOBALS['CI']->template->domain_images($GLOBALS['CI']->template).$investor_record['passcopy']; ?>" height="50px" width="100px" class="img-thumbnail"></span></td>
                                            </tr> 
                                            <tr>
