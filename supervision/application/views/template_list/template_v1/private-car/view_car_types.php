			...
			<div class="panel-title">
				<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
					...
					<li role="presentation" class="active"><a href="#fromList"
						aria-controls="home" role="tab" data-toggle="tab"><h1>Vendor</h1></a></li>
						...
						<div class='row'>
							<div class='' style='margin-bottom: 0;'>
								<div class=''>
									<div class='actions'>
										<a
											href="<?php echo base_url(); ?>index.php/privatecar/add_car_type">
											<button class='btn btn-primary' style='margin-bottom: 5px'>
												<i class='icon-male'></i> + Add Vendor
											</button>
								...
								<div class=''>
											...
											<table
												...
												<thead>
													<tr>
														...
														<th>Phone</th>
														<th>Email</th>
														<th>Terms-condition(Pdf)</th>
														<th>Pre-Payment Rule</th>
														<th>Logo</th>
														<th>Actions</th>
													</tr>
												</thead>
                                   ...
                                   //   debug($k);
                                      ...
                                      <tr>
														...
														<td><?=$k->email;?></td>
														<td><?=$k->phone;?></td>
															<td><?php echo $k->termsconditions;?></td>
														<td><?php echo $k->prepaymentRule	;?></td>
														<td><?=$k->logo;?></td>
														<td>
															<div class=''>
																<a class="btn btn-primary btn-xss has-tooltip"
																	data-placement="top" title=""
																	href="<?php echo base_url(); ?>index.php/privatecar/add_car_type/<?php echo $k->vendorid; ?>"
																	...
																	href='<?php echo base_url(); ?>index.php/privatecar/delete_car_type/<?=$k->vendorid;?>'>
