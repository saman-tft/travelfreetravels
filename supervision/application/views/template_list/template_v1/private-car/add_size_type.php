								...
								<div class=''>
									...
									<div class=''>
										<form class='form form-horizontal validate-form'
											...
											action="<?php echo base_url(); ?>index.php/privatecar/save_size_type"
											method="post" name="frm1" enctype="multipart/form-data">
											<div class='form-group'>
												<label class='control-label col-sm-2' for='validation_name'>Size
													Type</label>
												<div class='col-sm-3 controls'>
													<input type="hidden" name="c_size_id"
														value="<?=@$pack_data[0]->c_size_id;?>"> <input
														class='form-control' data-rule-minlength='2'
														data-rule-required='true' id='pname' name='name'
														value="<?=@$pack_data[0]->car_size;?>"
											...
											<div class='form-actions' style='margin-bottom: 0'>
												<div class='row'>
													<div class='col-sm-9 col-sm-offset-2'>
														<a
															href="<?php echo base_url(); ?>index.php/privatecar/view_size_types">
