            ...
            <form method="POST" id="offline_booking" autocomplete="off"
                ...
                <div class="onward_flight_details">
                    ...
                    <div class="onward_flight_row" data-count="<?= @$sect_num_onward; ?>">
                        <?php
                       /* for($ds=0;$ds<20;$ds++){
                            $page_datepicker[] = array('dep_date_onward_'.$ds, FUTURE_PAST_DATE);
                            $page_datepicker[] = array('arr_date_onward_'.$ds, FUTURE_PAST_DATE);

                            $page_datepicker[] = array('dep_time_onward_'.$ds, TIMEPICKER_24H);
                            $page_datepicker[] = array('arr_time_onward_'.$ds, TIMEPICKER_24H);

                            $page_datepicker[] = array('dep_date_onward_'.$ds, FUTURE_DATE);
                            $page_datepicker[] = array('arr_date_onward_'.$ds, FUTURE_DATE);
                        }*/
                        for ($i = 0; $i < @$sect_num_onward; $i++):
                            ...
                            <div class="clearfix form-group">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control text-uppercase" name="airline_pnr_onward[]" value="<?= @$airline_pnr_onward[$i]; ?>" placeholder="Arline PNR">
                                </div>              
                            </div>
                        <?php endfor; ?>
                    </div>
                ...
                <div class="adult_info">
                    ...
                    <div class="clearfix form-group">
                        ...
                        <div class="col-md-2 passport hide">
                            <label>Pass Port No.</label>
                        </div>
                        <div class="col-md-2 passport hide">
                            <label>PPExpiry</label>
                        </div>
                        <div class="col-md-1 ticket_number hide">
                ...
                <div class="clearfix form-group">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="purchase_price" name="purchase_price" max="0" value="<?= intval(@$purchase_price); ?>">
                        <label>Markup</label>
                        <input type="text" class="form-control" id="markup" name="markup" max="0" value="<?= intval(@$markup); ?>">

                        <label>Grand Total</label>
                        <input type="text" class="form-control" id="agent_buying_price" readonly="readonly" name="agent_buying_price" max="0" value="<?= intval(@$agent_buying_price); ?>">
                    </div>
                   <!--  <div class="col-md-4">
                        <label>Total Fare</label>
...
<script>
    $(document).ready(function(){
        ...
        $('[name="is_lcc"]').on('change',function(){
            if($(this).val() == 'lcc'){
                $('.ticket_number').addClass('hide');
            }else{
                $('.ticket_number').removeClass('hide');
            }
        });
    ...
    $(document).ready(function () {
        ...
        $('#purchase_price, #markup').keyup(function(){
            ...
            var total = parseFloat(purchase_price) + parseFloat(markup);
            $('#agent_buying_price').val(total);
        });
