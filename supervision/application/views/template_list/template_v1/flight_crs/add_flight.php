...
.ui-datepicker-title{
    ...
    top: -2px!important;color:#fff!important;;
...
<link rel="stylesheet" type="text/css" href="<?php echo $GLOBALS['CI']
    ->template
    ->template_css_dir('page_resource/wickedpicker.css'); ?>">
<!-- <link rel="stylesheet" type="text/css" href="<?php echo $GLOBALS['CI']
    ->template
    ->template_css_dir('page_resource/timepicker.css'); ?>"> -->
         ...
         <div class="panel panel-primary">
            ...
            <div class="panel-body ad_flt">
               ...
               <fieldset>
                  ...
                  <form action="<?php echo base_url(); ?>index.php/flight_crs/save_crs_flight_details" enctype="multipart/form-data" class="form-horizontal" method="POST" autocomplete="off">

                     <div class="col-xs-12 form-group nopad hide">
                        ...
                        <div class="col-sm-4">
                           ...
                           <label class="radio-inline">
                              ...
                              <input type="radio" class="crs_is_domestic" name="is_domestic" checked value="1">International
                        ...
                        <div class="col-sm-4 hide" id="triptype" style="display: none;">
               ...
               <fieldset>
                  ...
                  <div class="col-xs-12 con_flt con_flight_1"><h4>Connecting Flight 1</h4>
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-6 nopad control-label">Departure Airport Code</label>       
...
?>
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-6 nopad control-label">Arrival Airport Code</label>       
...
?>
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-6 nopad control-label">Departure Dates</label> 
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-6 nopad control-label">Arrival Dates</label>
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-6 nopad control-label">Departure Time</label>       

                        <div class="col-sm-6 nopad">

                        <!-- <input type="time" class="form-control" placeholder="12:50:00 24 hour format" name="departure_time[]" required/> -->

                        <!-- <input type="number" name="departure_time[]" class="timepicker-24 form-control" placeholder="12:50:00 24 hour format"/> -->
                        <input type="text" id="timepicker-24" name="departure_time[]" placeholder="13:50 24 hour format" class="timepicker-24 form-control">
                        </div>
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-6 nopad control-label">Arrival Time</label>       

                        <div class="col-sm-6 nopad">

                        <!-- <input type="time" class="form-control" placeholder="15:50:00 24 hour format" name="arrival_time[]" required/> -->                        

                        <input type="text" name="arrival_time[]" class="timepicker-24 form-control" placeholder="15:50 24 hour format"/>
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-6 nopad control-label">Flight Number</label>       
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-6 nopad control-label">Operating Airline Code</label>      


                        <div class="col-sm-6 nopad">

                        <input type="text" class="form-control getAirlinelist" id="operating_air_code" placeholder="SG" name="carrier_code[]" required/>
...
{ ?>
                           ...
                           <option value="NA">Select Airline Code</option>

                           <?php

    foreach ($airline_list as $k => $v)
    {
        //echo "string";exit();
        

        echo '<option value="' . $v['airline_code'] . '" >' . $v['airline_city'] . '</option>';
...
?>
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-6 nopad control-label">AirLine Name</label>       
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-6 nopad control-label">Class Type</label>       
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-6 nopad control-label">Cabin Bagaage | Check-in</label>       

                        <div class="col-sm-6 nopad">

                        <!-- <input type="time" class="form-control" placeholder="15:50:00 24 hour format" name="arrival_time[]" required/> -->                        
 <div class="col-sm-6 nopad">
                        <input type="text" name="baggage[]" class="form-control" placeholder="6"/>
                      </div>
                       <div class="col-sm-6 nopad">
                        <input type="text" name="checkin_baggage[]" class="form-control" placeholder="10"/>
                       </div>
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-6 nopad control-label">Meals</label>       
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-6 nopad control-label">Extra</label>       
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-6 nopad control-label">Departure Terminal</label>       

                        <div class="col-sm-6 nopad">

                        <!-- <input type="time" class="form-control" placeholder="15:50:00 24 hour format" name="arrival_time[]" required/> -->                        

                        <input type="text" name="dep_terminal[]" class="form-control" placeholder="Terminal 1"/>
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-6 nopad control-label">Arrival Terminal</label>       

                        <div class="col-sm-6 nopad">

                        <!-- <input type="time" class="form-control" placeholder="15:50:00 24 hour format" name="arrival_time[]" required/> -->                        

                        <input type="text" name="arr_terminal[]" class="form-control" placeholder="Terminal 2"/>
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <div class="col-sm-9 ad_pad nopad">                        
...
{ ?>
                              ...
                              <select class="form-control" name="destination[]" id="destination_1">
...
?>
                        ...
                        <input type="text" class="form-control" name="dep_date[]" id="dep_date2" name="DepartureDate[]" required/>
                        ...
                        <div class="col-xs-12 form-group nopad">
                           ...
                           <input type="text" class="form-control" name="arr_date[]" id="arr_date2" required/>
                        ...
                        <div class="col-xs-12 form-group nopad">
                           ...
                           <input type="text" name="departure_time[]" class="timepicker-24 form-control" placeholder="15:50 24 hour format"/>
 ...
 <div class="col-sm-6 nopad">
                       ...
                       <div class="col-sm-6 nopad">
                        <input type="text" name="check_baggage[]" class="form-control" placeholder="10"/>
                       </div>
                        </div>
...
?>
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <input type="text" name="departure_time_1[]" class="timepicker-24 form-control" placeholder="15:50 24 hour format"/>
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <input type="text" name="arrival_time_1[]" class="timepicker-24 form-control" placeholder="15:50 24 hour format"/>
...
?>
                  ...
                  <legend class="sm_titl">Fare Information</legend>                   
                     ...
                     <!-- <div class="col-xs-12 col-sm-6 nopad col-sm-offset-3">

                                   <div class="col-xs-12 form-group nopad">

                                      <label form="user" for="title" class="col-sm-6 nopad control-label">Seats Available</label>       
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-12 control-label">Seats Available</label>       
                      ...
                      <!--   <label form="user" for="title" class="col-sm-12 control-label">Enter PNR</label>       
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-12 control-label nopad">Adult</label>    

                        <label form="user" for="title" class="col-sm-6 nopad control-label">Purchase Price</label>       

                        <div class="col-sm-6 nopad">

                        <input type="number" class="form-control" placeholder="5050" name="adult_basefare">
                      ...
                      <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-6 nopad control-label">Selling Price</label>       

                        <div class="col-sm-6 nopad">

                        <input type="number" class="form-control" placeholder="5050" name="adult_selling_fare">
                      ...
                      <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-6 nopad control-label">Service Fee</label>       

                        <div class="col-sm-6 nopad">

                        <input type="number" class="form-control" placeholder="500" name="adult_tax">
                   ...
                   <div class="col-xs-12 col-sm-3">
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-12 control-label nopad">Child</label>    

                        <label form="user" for="title" class="col-sm-6 nopad control-label">Purchase Price</label>       

                        <div class="col-sm-6 nopad">

                        <input type="number" class="form-control" placeholder="5050" name="child_basefare">
                      ...
                      <div class="col-xs-12 form-group nopad">
                        ...
                        <input type="number" class="form-control" placeholder="5050" name="child_selling_fare">
                      ...
                      <div class="col-xs-12 form-group nopad">
                        ...
                        <input type="number" class="form-control" placeholder="500" name="child_tax">
                     ...
                     <div class="col-xs-12 form-group nopad">
                        ...
                        <label form="user" for="title" class="col-sm-12 control-label nopad">Infant</label>    

                        <label form="user" for="title" class="col-sm-6 nopad control-label">Purchase Price</label>       

                        <div class="col-sm-6 nopad">

                        <input type="number" class="form-control" placeholder="1250" name="infant_basefare">
                        ...
                        <input type="number" class="form-control" placeholder="5050" name="infant_selling_fare">
                        ...
                        <input type="number" class="form-control" placeholder="0" name="infant_tax">
...
<script>
  ...
  $(document).ready(function(){
      ...
      $(".getAirlinelist").autocomplete({
         source: app_base_url+"index.php/flight_crs/get_airline_suggestions",
         minLength: 2,//search after two characters
         autoFocus: true, // first item will automatically be focused
         select: function(event,ui){
             //var inputs = $(this).closest('form').find(':input:visible');
     ...
     $("#sel1").change(function(){
      ...
      $('#operating_air_code').change(function(){
         ...
         $.ajax({url: app_base_url + "index.php/flight/get_flight_fair_rule/"+airline_code[1]+"/"+is_domestic, success: function(result){
            //console.log(result);
            var obj = JSON.parse(result);
            //console.log(obj);
            if (obj.status == true) {
