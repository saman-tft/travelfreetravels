  ...
  function flight_passenger_email($origin)
{
  ...
  return '<a class="btn btn-sm btn-primary send_email_voucher" data-origin="'.$origin.'"><i class="fa fa-envelope-o"></i> Email Passenger Details</a>';
}
//end
?>
<style type="text/css">
            ...
            <!--    <hr> -->
               <form method="POST" autocomplete="off" action="<?php echo base_url();?>index.php/flight/save_update_flight_details">
                  <div class="clearfix form-group">
                     ...
                     <div class="col-xs-3 list"><label>Airline Name: <?php echo $update_details['airline_name'];?></label></div>
                     <div class="col-xs-3 list"><label>Flight Number: <?php echo $update_details['flight_num'];?></label></div>
                     <div class="col-xs-3 list"><label>Carrier Code: <?php echo $update_details['carrier_code'];?></label></div>
                     <div class="col-xs-3 list"><label>Class Type: <?php echo $update_details['class_type'];?></label></div>
                     <div class="col-xs-3 list"><label>No of stops: <?php echo $update_details['no_of_stops'];?></label></div>
                  </div>
                  <div class="col-xs-12 updte hide"><label onclick="$('#details').toggle();" class="btn btn-default mb10">Update Details <i class="fa fa-angle-down" aria-hidden="true"></i></label></div>
          ...
          $total_child_price = 0;
					...
					?>
                     <tr>
                        ...
                        <?php if(check_user_previlege('p60')){?>
      					        <input type="text" class="form-control wdt80 text-uppercase" placeholder="PNR"  style="width: 100px;" name="pnr[]" id="pnr_<?=$i?>" value="<?php 
                        ...
                        <div class=" form-group">	
                        <?php if(check_user_previlege('p60')){?>
				                <input style ="min-width: 60px;" type="text" class="wdt60 form-control numeric" name="seat[]" id="seat_<?=$i?>" value="<?php 
                        ...
                        <div class=" form-group">
                        <?php if(check_user_previlege('p60')){?>
                        <input type="text" class="form-control max_wdt numeric adult_selling" name="adult_selling[]"  id="adult_selling_<?=$i?>" value="<?php 
                        if(isset($update_flight_details[$i]['adult_selling'])){
                          echo $update_flight_details[$i]['adult_selling'];
                          $total_adult_price +=$update_flight_details[$i]['adult_selling'];
                        }
                        else{
                          echo $update_details['adult_selling_fare'];   
                          $total_adult_price +=$update_details['adult_selling_fare'];
                        }
                        ?>" maxlength = "6">
                         <?php }else{
                                 if(isset($update_flight_details[$i]['adult_selling'])){
                       ...
                       <span id="adult_total_<?=$i?>" class="exct_wdt adult_total" ><?=$total_adult_price?></span>
                        ...
                        <div class=" form-group">
                        <?php if(check_user_previlege('p60')){?>
                        <input type="text" class="form-control max_wdt numeric child_base" name="child_base[]"  id="child_base_<?=$i?>" value="<?php 
                        if(isset($update_flight_details[$i]['child_base'])){
                          ...
                          echo $update_details['child_basefare'];   
                          //$total_child_price +=$update_details['child_basefare'];
                        }
                        ?>" maxlength = "6">
                         <?php }else{
                                 if(isset($update_flight_details[$i]['child_base'])){
                        ...
                        <div class=" form-group">
                        <?php if(check_user_previlege('p60')){?>
                        <input type="text" class="form-control max_wdt numeric child_selling" name="child_selling[]"  id="child_selling_<?=$i?>" value="<?php 
                        if(isset($update_flight_details[$i]['child_selling'])){
                          echo $update_flight_details[$i]['child_selling'];
                          $total_child_price +=$update_flight_details[$i]['child_selling'];
                        }
                        else{
                          echo $update_details['child_selling_fare'];   
                          $total_child_price +=$update_details['child_selling_fare'];
                        }
                        ?>" maxlength = "6">
                         <?php }else{
                                 if(isset($update_flight_details[$i]['child_selling'])){
                                echo $update_flight_details[$i]['child_selling'];
                                $total_adult_price +=$update_flight_details[$i]['child_selling'];
                              }
                              else{
                                echo $update_details['child_selling_fare'];   
                                $total_child_price +=$update_details['child_selling_fare'];
                        ...
                        <div class=" form-group">
                        <?php if(check_user_previlege('p60')){?>
                        <input type="text" class="exct_wdt form-control max_wdt numeric child_tax" name="child_tax[]"  id="child_tax_<?=$i?>" value="<?php 
                        if(isset($update_flight_details[$i]['child_tax'])){
                          ...
                          echo $update_details['child_tax']; 
                          $total_child_price +=$update_details['child_tax'];
                        }
                        ?>" maxlength = "6"> 
                         <?php }else{
                                   if(isset($update_flight_details[$i]['child_tax'])){
                       ...
                       <span id="child_total_<?=$i?>" class="exct_wdt child_total" ><?=$total_child_price?></span>
                        ...
                        <div class=" form-group">
                        <?php if(check_user_previlege('p60')){?>
				                <input type="text" class="form-control max_wdt numeric infant_base" name="infant_base[]"  id="infant_base_<?=$i?>" value="<?php 
                        if(isset($update_flight_details[$i]['infant_base'])){
                          echo $update_flight_details[$i]['infant_base'];
                          //$total_infant_price +=$update_flight_details[$i]['infant_base'];
                        }
                        else{
                          echo $update_details['infant_basefare'];   
                          //$total_infant_price +=$update_details['infant_basefare'];
                        }
                        ?>" maxlength = "6">
                         <?php }else{
                                  if(isset($update_flight_details[$i]['infant_base'])){
                        ...
                        <div class=" form-group">
                        <?php if(check_user_previlege('p60')){?>
                        <input type="text" class="form-control max_wdt numeric infant_selling" name="infant_selling[]"  id="infant_selling_<?=$i?>" value="<?php 
                        if(isset($update_flight_details[$i]['infant_selling'])){
                          echo $update_flight_details[$i]['infant_selling'];
                          $total_infant_price +=$update_flight_details[$i]['infant_selling'];
                        }
                        else{
                          echo $update_details['infant_selling_fare'];   
                          $total_infant_price +=$update_details['infant_selling_fare'];
                        }
                        ?>" maxlength = "6">
                         <?php }else{
                                 if(isset($update_flight_details[$i]['infant_selling'])){
                        ...
                        <div class=" form-group">
                         <?php if(check_user_previlege('p60')){?>
				                <input type="text" class="form-control exct_wdt max_wdt numeric infant_tax" name="infant_tax[]" id="infant_tax_<?=$i?>"  value="<?php 
                        if(isset($update_flight_details[$i]['infant_tax'])){
                          echo $update_flight_details[$i]['infant_tax'];
                          $total_infant_price +=$update_flight_details[$i]['infant_tax'];
                        }
                        else{
                          echo $update_details['infant_tax']; 
                          $total_infant_price +=$update_details['infant_tax'];
                        }
                        ?>" maxlength = "6">
                         <?php }else{
                                   if(isset($update_flight_details[$i]['infant_tax'])){
                           ...
                           <td>
                       <div class=" form-group">
                       <span id="infant_total_<?=$i?>" class="exct_wdt infant_total"><?=$total_infant_price?></span>                   
                       </div>
                       </td>
       
                       <?php /*debug(check_user_previlege('p60'));
exit;*/
                   ...
                   <!--    <button type="button" class="btn btn-sm btn-toggle stus dyna_status <?=($update_flight_details[$i]['b2c_status'] == 1)?'active' : '' ?> act-<?=$update_flight_details[$i]['origin']?>" data-toggle="button" aria-pressed="<?=($update_flight_details[$i]['b2c_status'] == 1)?'true' : 'false' ?>" data-origin="<?=$update_flight_details[$i]['origin']?>" data-status_type="b2c" data-status="<?=$update_flight_details[$i]['b2c_status']?>" autocomplete="off">
                        <div class="handle"></div>
                                        ...
                                        <div class="checkbox">
          <label>
            <input type="checkbox" <?php if($update_flight_details[$i]['b2c_status'] == 1) echo "checked"; ?> class="stus dyna_status <?=($update_flight_details[$i]['b2c_status'] == 1)?'active' : '' ?> act-<?=$update_flight_details[$i]['origin']?>"  aria-pressed="<?=($update_flight_details[$i]['b2c_status'] == 1)?'true' : 'false' ?>" data-origin="<?=$update_flight_details[$i]['origin']?>" data-status_type="b2c" data-status="<?=$update_flight_details[$i]['b2c_status']?>" autocomplete="off">
                       ...
                       <!--  <button type="button" class="btn btn-sm btn-toggle stus dyna_status <?=($update_flight_details[$i]['b2b_status'] == 1)?'active' : '' ?> act-<?=$update_flight_details[$i]['origin']?>" data-toggle="button" aria-pressed="<?=($update_flight_details[$i]['b2b_status'] == 1)?'true' : 'false' ?>" data-origin="<?=$update_flight_details[$i]['origin']?>"  data-status_type="b2b" data-status="<?=$update_flight_details[$i]['b2b_status']?>" autocomplete="off">
                        <div class="handle"></div>
                                                          ...
                                                          <div class="checkbox">
          <label>
            <input type="checkbox" <?php if($update_flight_details[$i]['b2b_status'] == 1) echo "checked"; ?> class="stus dyna_status <?=($update_flight_details[$i]['b2b_status'] == 1)?'active' : '' ?> act-<?=$update_flight_details[$i]['origin']?>" data-toggle="button" aria-pressed="<?=($update_flight_details[$i]['b2b_status'] == 1)?'true' : 'false' ?>" data-origin="<?=$update_flight_details[$i]['origin']?>"  data-status_type="b2b" data-status="<?=$update_flight_details[$i]['b2b_status']?>" autocomplete="off">
                         ...
                         <td>
                       <!--  <button type="button" class="btn updt btn-sm btn-toggle stus dyna_status <?=($update_flight_details[$i]['completed_status'] == 1)?'active' : '' ?> act-<?=$update_flight_details[$i]['origin']?>" data-toggle="button" aria-pressed="<?=($update_flight_details[$i]['completed_status'] == 1)?'true' : 'false' ?>" data-origin="<?=$update_flight_details[$i]['origin']?>" data-status_type="completed" data-status="<?=$update_flight_details[$i]['completed_status']?>" autocomplete="off">
                        <div class="handle"></div>
                        </button> -->
                         ...
                         <div class="checkbox">
          <label>
            <input type="checkbox" <?php if($update_flight_details[$i]['completed_status']  == 1) echo "checked"; ?> class=" updt stus dyna_status <?=($update_flight_details[$i]['completed_status'] == 1)?'active' : '' ?> act-<?=$update_flight_details[$i]['origin']?>" data-toggle="button" aria-pressed="<?=($update_flight_details[$i]['completed_status'] == 1)?'true' : 'false' ?>" data-origin="<?=$update_flight_details[$i]['origin']?>" data-status_type="completed" data-status="<?=$update_flight_details[$i]['completed_status']?>" autocomplete="off">
              ...
              <!-- Dinesh  Export button Starts -->
                  <a href = "<?php echo base_url(); ?>index.php/flight_crs/export_passenger_details/excel?fl_details_id=<?= $update_flight_details[$i]['origin'];?>" class="btn btn-primary">Export to Excel</a>
                <!-- #####  Export button End -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="row">
          <form action="<?php echo base_url();?>index.php/flight_crs/flight_passenger_details" method="post" enctype="multipart/form-data" id="fileinfo">
          <div class="form-group">
      ...
      <div class="col-md-12 nopad mb10">
              <!-- <input type="submit" value="SEND >" class="btn btn-success" id="send_mail_btn"> -->
              <input type="checkbox" value="" class="" id="passenger_details_html" name=""> Check if you want to send Passenger list Html content via email.
            </div>
...
jQuery(document).ready(function($) {
  ...
  $(document).on('change, keyup', '.adult_base,.adult_selling, .adult_tax', function(){
    var thisss = $(this);
    var thisssRow = $(this).closest('tr');
    
    var basefare = thisssRow.find('.adult_base').val();
    var tax = thisssRow.find('.adult_tax').val();
    var selling = thisssRow.find('.adult_selling').val();
    var amount = calculateTotalFare(basefare, selling,tax);

    thisssRow.find('.adult_total').html(parseInt(amount));
  });
  $(document).on('change, keyup', '.child_base,.child_selling, .child_tax', function(){
    var thisss = $(this);
    var thisssRow = $(this).closest('tr');
    
    var basefare = thisssRow.find('.child_base').val();
    var tax = thisssRow.find('.child_tax').val();
    var selling = thisssRow.find('.child_selling').val();
    var amount = calculateTotalFare(basefare, tax , selling);

    thisssRow.find('.child_total').html(parseInt(amount));
  });
  ...
  $(document).on('change, keyup', '.infant_base, .infant_tax', function(){
    ...
    var selling = thisssRow.find('.infant_selling').val();
    var amount = calculateTotalFare(basefare, tax , selling);

    thisssRow.find('.infant_total').html(parseInt(amount));
  });

  function calculateTotalFare(basefare, tax , selling){
    return parseInt(basefare)+parseInt(tax)+parseInt(selling);
  }
...
$(document).on('click', '.dyna_status', function(){
  ...
  if(parseInt(status) == parseInt(1)){
    ...
    $.ajax({
        url: "<?=base_url();?>index.php/flight_crs/update_per_date_flight_status/"+origin+"/"+status+"/"+status_type, 
        async:false, 
  ...
  function seat_details(origin,id)
  {
    ...
    $.ajax(
      {
        url: "<?php echo base_url();?>index.php/flight_crs/seat_details",
        type: 'POST',
        data: {id:date_id},
        success: function(result) {
          /*  alert(result);
return false;*/
	...
	function func(id)
	{
		...
		$.ajax(
			{
  			url: "<?php echo base_url();?>index.php/flight_crs/delete_update_flight_details",
  			type: 'POST',
  			data: info,
  			success: function(result) {
  				if(result)
  ...
  function update_flight_data_per_date(origin,id,booked_seat)
  {
   ...
   var infant_base = $('#infant_base_'+id).val();
   var infant_tax = $('#infant_tax_'+id).val();
   var adult_selling = $('#adult_selling_'+id).val();
   var child_selling = $('#child_selling_'+id).val();
   var infant_selling = $('#infant_selling_'+id).val();
  ...
  /*  alert(pnr);
    ...
    $.ajax(
      {
        url: "<?php echo base_url();?>index.php/flight_crs/update_flight_data_per_date",
        type: 'POST',
        data: { origin: origin,pnr: pnr,  avail_seat:  avail_seat, dep_time: dep_time, arr_time: arr_time, adult_base: adult_base, adult_tax: adult_tax, child_base: child_base, child_tax: child_tax, infant_base:infant_base,infant_selling:infant_selling,child_selling:child_selling ,adult_selling:adult_selling, infant_tax:infant_tax},
        success: function(result) {
  ...
  function func1(id)
  {
    ...
    // {
      ...
      $.ajax(
        {
          url: "<?php echo base_url();?>index.php/flight_crs/update_seat_details",
          type: 'POST',
...
$(document).on('click', '.pass_update_btn', function(){
  ...
  $.post("<?= base_url();?>index.php/flight_crs/update_passenger_details/"+pax_id, {first_name: first_name, title:title,last_name:last_name,pax_id:pax_id,mailing_status:user_mailing_status}, function(result){
           // alert(result);
          toastr.info('Please Wait!!!');
          if(result)
          {
...
// Dinesh 7-feb-2018
  ...
  $('.send_email_voucher').on('click', function(e) {
    ...
    $("#send_mail_btn").off('click').on('click',function(e){
      ...
      var passenger_details_is_checked = $('input[id=passenger_details_html]:checked').length;
      var send_html = parseInt(0);
      if (passenger_details_is_checked == true) {
          send_html = parseInt(1);
      }
      
      /*if (typeof(passenger_details_html) != "undefined" && passenger_details_html != "") {
        if ($(passenger_details_html)) {}
      }*/
      ...
      if(email != ''){
        if(!emailReg.test(email)){
          ...
          var _opp_url = app_base_url+'index.php/flight_crs/flight_passenger_details/';
         ...
         //console.log($('#file')[0].files[0].name);
          ...
          formData.append('send_html', send_html);
          $.ajax({
           url: app_base_url+'index.php/flight_crs/flight_passenger_details/',
           type: 'POST',
           data : formData,
           ...
           success : function(data) {
                ...
                if(jsondata.status==1){
                  ...
                  $('#mail_voucher_error_message').empty();
                  toastr.info(msg);
                  $("#send_mail_btn").closest('form').find("input[type=text], textarea,input[type=email]").val("");
                } else {
...
$('.ml_updt').on('click', function(e) {
          ...
          var _opp_url = app_base_url+'index.php/flight_crs/update_mailing_status/';
