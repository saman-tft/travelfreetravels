...
<!--                    
                ...
                <?php /*<div class="child_info" <?= @$child_count <= 0 ? 'style="display:none;"' : '' ?>>
                    <h4>Child Info</h4>
                    <div class="clearfix form-group">
                        <div class="col-md-1">
                            <label>Title</label>							
                    ...
                    <div class="child_row" data-count="<?= @$child_count ?>">
                        ...
                        for ($i = $adult_count; $i < @$adult_count + @$child_count; $i++):
                            ...
                            <div class="clearfix form-group">
                                ...
                                <div class="col-md-2">
                                    <input type="text" class="form-control" id="BaseFare<?= ($i - @$adult_count + @$child_count); ?>" name="pax_base_fare[]" value="<?= @$base_fare[$i]; ?>" placeholder="BaseFare">
                                </div>
                                <div class="col-md-1">
               ...
               <?php /* <h4>Passenger Fare Breakup</h4>
                <div class="clearfix form-group">					
                    <div class="col-md-4">
                        <label>Type</label>							
                    </div>
                ...
                <div class="clearfix form-group pax_fare_adult">
                    ...
                    <div class="pax-fare-row">
                        ...
                        <div class="col-md-2">
                            <input type="number" class="form-control" name="pax_basic_fare_onward[]" value="<?= intval(@$pax_basic_fare_onward[$c]) > 0 ? $pax_basic_fare_onward[$c] : ''; ?>" min= "1" placeholder="Basic" required>
                        </div>
                        <!--div class="col-md-1"-->
                            <input type="hidden" class="form-control" name="pax_yq_onward[]" value="<?= intval(@$pax_yq_onward[$c]); ?>" placeholder="YQ">
                        <!--/div-->
                        <div class="col-md-2">
                            <input type="number" class="form-control" name="pax_other_tax_onward[]" value="<?= intval(@$pax_other_tax_onward[$c]) > 0 ? $pax_other_tax_onward[$c] : ''; ?>" min = "1" placeholder="Other TAX" required>
                        </div>	
                        <div class="col-md-1"><input type="number" name="pax_type_count_onward[]" value="<?= intval(@$adult_count); ?>"  class="form-control" readonly></div>
                        <div class="col-md-2">
                            <input type="number" class="form-control" name="pax_total_fare_onward[]" value="<?= intval(@$pax_total_fare_onward[$c]) > 0 ? $pax_total_fare_onward[$c] : ''; ?>" min= "1" placeholder="Total" required>
                        </div>
                    </div>
                    <div class="pax-fare-row trip_circle" <?= @$trip_type != 'circle' ? 'style="display:none;"' : '' ?>>					
                        ...
                        <div class="col-md-2">
                            <input type="number" class="form-control" name="pax_basic_fare_return[]" value="<?= intval(@$pax_basic_fare_return[$c]); ?>" placeholder="Basic" <?= @$trip_type != 'circle' ? 'disabled' : '' ?> required>
                        </div>
                        <div class="col-md-1">
                            <input type="number" class="form-control" name="pax_yq_return[]" value="<?= intval(@$pax_yq_return[$c]); ?>" placeholder="YQ" <?= @$trip_type != 'circle' ? 'disabled' : '' ?>>
                        </div>
                        <div class="col-md-2">
                            <input type="number" class="form-control" name="pax_other_tax_return[]" value="<?= intval(@$pax_other_tax_return[$c]); ?>" placeholder="Other TAX" <?= @$trip_type != 'circle' ? 'disabled' : '' ?> required>
                        </div>	
                        <div class="col-md-1"><input type="number" name="pax_type_count_return[]" value="<?= intval(@$pax_type_count_return[$c]); ?>" class="form-control" readonly <?= @$trip_type != 'circle' ? 'disabled' : '' ?>></div>
                        <div class="col-md-2">
                            <input type="number" class="form-control" name="pax_total_fare_return[]" value="<?= intval(@$pax_total_fare_return[$c]); ?>" placeholder="Total" <?= @$trip_type != 'circle' ? 'disabled' : '' ?> required>
                        </div>
                    </div>
                </div>
                <div class="clearfix form-group pax_fare_child" <?= @$child_count <= 0 ? 'style="display:none;"' : '' ?>>
                    ...
                    <div class="pax-fare-row">
                        ...
                        <div class="col-md-2">
                            <input type="number" class="form-control" name="pax_basic_fare_onward[]" value="<?= intval(@$pax_basic_fare_onward[$c]); ?>" placeholder="Basic">
                        </div>
                        <!--div class="col-md-1"-->
                            <input type="hidden" class="form-control" name="pax_yq_onward[]" value="<?= intval(@$pax_yq_onward[$c]); ?>" placeholder="YQ">
                        <!--/div-->
                        <div class="col-md-2">
                            <input type="number" class="form-control" name="pax_other_tax_onward[]" value="<?= intval(@$pax_other_tax_onward[$c]); ?>" placeholder="Other TAX">
                        </div>	
                        <div class="col-md-1"><input type="number" name="pax_type_count_onward[]" value="<?= intval(@$child_count); ?>" class="form-control" readonly></div>
                        <div class="col-md-2">
                            <input type="number" class="form-control" name="pax_total_fare_onward[]" value="<?= intval(@$pax_total_fare_onward[$c]); ?>" placeholder="Total">
                        </div>
                    </div>
                    <div class="pax-fare-row trip_circle" <?= @$trip_type != 'circle' ? 'style="display:none;"' : '' ?>>
                        <div class="col-md-2"></div>							
                        ...
                        <div class="col-md-1"><input type="number" name="pax_type_count_return[]" value="<?= intval(@$pax_type_count_return[$c]); ?>" class="form-control" readonly <?= @$trip_type != 'circle' ? 'disabled' : '' ?>></div>
                        <div class="col-md-2">
                            <input type="number" class="form-control" name="pax_total_fare_return[]" value="<?= intval(@$pax_total_fare_return[$c]); ?>" placeholder="Total" <?= @$trip_type != 'circle' ? 'disabled' : '' ?>>
                        </div>
                    </div>					
                </div>
                <div class="clearfix form-group pax_fare_infant" <?= @$infant_count <= 0 ? 'style="display:none;"' : '' ?>>
                    ...
                    <div class="pax-fare-row">
                        ...
                        <div class="col-md-1"><input type="number" name="pax_type_count_onward[]" value="<?= intval(@$infant_count); ?>" class="form-control" readonly></div>
                        <div class="col-md-2">
                            <input type="number" class="form-control" name="pax_total_fare_onward[]" value="<?= intval(@$pax_total_fare_onward[$c]); ?>" placeholder="Total">
                        </div>
                    </div>
                    <div class="pax-fare-row trip_circle" <?= @$trip_type != 'circle' ? 'style="display:none;"' : '' ?>>							
                        ...
                        <div class="col-md-2">
                            <input type="number" class="form-control" name="pax_basic_fare_return[]" value="<?= intval(@$pax_basic_fare_return[$c]); ?>" placeholder="Basic" <?= @$trip_type != 'circle' ? 'disabled' : '' ?>>
                        </div>
                        <div class="col-md-1">
                            <input type="number" class="form-control" name="pax_yq_return[]" value="<?= intval(@$pax_yq_return[$c]); ?>" placeholder="YQ" <?= @$trip_type != 'circle' ? 'disabled' : '' ?>>
                        </div>
                        <div class="col-md-2">
                            <input type="number" class="form-control" name="pax_other_tax_return[]" value="<?= intval(@$pax_other_tax_return[$c]); ?>" placeholder="Other TAX">
                        </div>
                        <div class="col-md-1"><input type="number" name="pax_type_count_return[]" value="<?= intval(@$pax_type_count_return[$c]); ?>" class="form-control" readonly <?= @$trip_type != 'circle' ? 'disabled' : '' ?>></div>
                        <div class="col-md-2">
                            <input type="number" class="form-control" name="pax_total_fare_return[]" value="<?= intval(@$pax_total_fare_return[$c]); ?>" placeholder="Total" <?= @$trip_type != 'circle' ? 'disabled' : '' ?>>
                ...
                <div class="clearfix form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" name="hc_comm" value="<?= intval(@$hc_comm); ?>" placeholder="Handling Charge">
                    </div>					
                </div>
                <div class="clearfix form-group">
                    <div class="col-md-4">
                        <label>Admin Markup(+)</label> 
                        <input type="number" class="form-control" name="admin_markup"  value="<?= intval(@$admin_markup); ?>" placeholder="Admin Markup">
                    </div>					
                    <div class="col-md-4">
                        <label>Agent Markup(+)</label> 
                        <input type="number" class="form-control" name="agent_markup" value="<?= intval(@$agent_markup); ?>" placeholder="Agent Markup">
                    </div>					
                </div>*/?>
                <h4>Grand Total</h4>
                <div class="clearfix form-group">
                ...
                <div class="clearfix form-group">
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" name="api_total_basic_fare"  value="<?= intval(@($flight_info[0]['adult_base'])); ?>" placeholder="Basefare">
                    </div>
                   ...
                   <!--  <div class="col-md-4">
                    ...
                    <?/*<div class="col-md-4">
                        <label>YQ</label> 
                        <input type="number" class="form-control" name="api_total_yq" value="<?= intval(@$other_fare); ?>" placeholder="YQ">
                    </div>
                    <div class="col-md-4">
                        <label>GST</label> 
                        <input type="number" class="form-control" name="service_tax" value="<?= intval(@$service_tax); ?>" placeholder="Service Tax">
                    </div>
                    <div class="col-md-4">
                        <label>Commission</label> 
                        <input type="number" class="form-control" name="commission" value="<?= intval(@$commission); ?>" placeholder="Commission">
                    </div>
                    <div class="col-md-4">
                        <label>TDS</label> 
                        <input type="number" class="form-control" name="tds" value="<?= intval(@$tds); ?>" placeholder="TDS">
                    </div>					
                </div>*/?>
                <div class="clearfix form-group">
                    <?php /*<div class="col-md-4">
                        <label>Total Agent Buying Fare</label>
                        <input type="number" class="form-control" id="agent_buying_price" name="agent_buying_price" max="0" value="<?= intval(@$agent_buying_price); ?>" readonly>
                    </div>*/?>
