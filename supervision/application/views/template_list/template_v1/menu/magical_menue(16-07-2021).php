...
<li class="treeview">
		...
		<!-- <li><a href="#"><i class="far fa-circle"></i> B2C</a> -->
				...
				<?php if (check_supplier_previlege('1')) { ?>
				...
				<?php if (check_supplier_previlege('2')) { ?>
				   <!-- <li class="<?php if($fun_name=="holiday") echo "active";?>" ><a href="<?php echo base_url().'index.php/report/b2c_package_report/';?>"><i class="fa fa-binoculars"></i> Activity CRS</a></li> -->
					<?php } ?>		

				<?php if (check_supplier_previlege('4')) { ?>
				   <!-- <li class="<?php if($fun_name=="holiday") echo "active";?>" ><a href="<?php echo base_url().'index.php/report/b2c_transfers_crs_report/';?>"><i class="fa fa-taxi"></i> Transfers CRS</a></li> -->
				<?php } ?>
...
<?php 
	...
	if(check_supplier_previlege('1'))
	{
		?>

	
<li class="treeview">
			<a href="#"> <i class="fa fa-umbrella"></i> <span>
...
<!--			<i class="fas fa-circle-notch"></i>Unapproved Holiday List </a></li>-->
			<?php /*<li class=""><a href="<?php echo base_url().'index.php/tours/tours_enquiry';?>">
			...
			<i class="fas fa-circle-notch"></i> Theme </a></li>
			<li class=""><a href="<?php echo base_url().'index.php/tours/tour_region'?>">
			<i class="fas fa-circle-notch"></i> Region </a></li>
			...
			<li class=""><a href="<?php echo base_url().'index.php/management/bank_account_details'?>">
			<i class="fas fa-circle-notch"></i> Bank account details </a></li> 
</ul>
		</li>
<?php
	}
