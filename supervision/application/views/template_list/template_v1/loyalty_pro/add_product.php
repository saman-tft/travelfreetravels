             ...
             <div class="clearfix form-group">
              <div class="col-xs-4">
                  ...
                  <select class="form-control" name="type" required="">
                     ...
                     <option value="1">TFT Product</option>
              ...
              <div class="col-xs-4">
                  <label>Name</label>
                  <input type="text" placeholder="Name" value="<?=@$get_edit_product['name']?>" name="name" class="search_filter form-control" required="">
              </div>
              <div class="col-xs-4">
                  <label>Image</label>
                  <input type="file" placeholder="image" value="" name="image" class="search_filter form-control" required="">
              </div>
               <div class="clearfix form-group">
              <div class="col-xs-4">
                  <label>Description</label>
                  <input type="text" placeholder="Description" value="<?=@$get_edit_product['description']?>" name="description" class="search_filter form-control" required="">
              </div>
               <!--<div class="col-xs-4">
                  <label>Country</label>
              ...
              <div class="col-xs-4">
                  <label>Point</label>
                  <input type="text" placeholder="Point" value="<?=@$get_edit_product['point']?>" name="point" class="search_filter form-control" required="">
              </div>
