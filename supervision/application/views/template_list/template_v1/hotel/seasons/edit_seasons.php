	...
	<div class="panel panel-default clearfix">
		...
		<!-- PANEL HEAD START -->
			...
			<div class="panel-body">
				<form method="post" id="post_form" name="tax" action="<?php echo site_url()."index.php/hotel/update_seasons/".$data->seasons_details_id; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
					<fieldset form="user_edit">
				<legend class="form_legend">Update Season</legend>
			
						
							    <input type="hidden" name="hotel_details_id"  id="hotel_details_id" value="<?=$data->hotel_details_id?>">

								<div  class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Season Name</label>									
									<div class="col-sm-4"> 
										 <input type="text" class="form-control" name="seasons_name" id="seasons_name" data-validate="required" data-message-required="Please Enter the Seasons Name" value="<?=$data->seasons_name?>"/>
								...
								<div class="form-group">
									...
									<div class="col-sm-4"> 
										 <input type="text" class="form-control" id="seasons_start" name="seasons_from_date" readonly value="<?=date("d/m/Y", strtotime($data->seasons_from_date))?>"  data-validate="required" data-message-required="Please Select the Date Range"  />
								...
								<div class="form-group">
									...
									<div class="col-sm-4"> 
										 <input type="text" class="form-control" id="seasons_end" name="seasons_to_date" readonly value="<?=date("d/m/Y", strtotime($data->seasons_to_date))?>"  data-validate="required" data-message-required="Please Select the Date Range"  />
								...
								<div class="form-group">
									...
									<div class="col-sm-5"> 	
										...
										<a href="<?=base_url("index.php/hotel/season_list/{$data->hotel_details_id}")?>" class="btn btn-danger">Back</a>&nbsp;&nbsp;
										<a id="check" class="btn btn-success">Update Season</a>
									</div>
								</div>
				</form>
			</div>
...
$(document).ready(function () {
		...
		$("#check").click(function(){
			     ...
			     var id = "<?=$data->seasons_details_id?>";
			 ...
			 $.ajax({
                ...
                type: "post",
                dataType: "html" ,
                data: {start:start,end:end,id:id,hotel_id} ,
