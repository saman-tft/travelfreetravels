	...
	<div class="panel panel-default clearfix">
		...
		<div class="panel-heading">
			...
			<div class="panel-title">
				<i class="fa fa-credit-card"></i> Edit Room Meal Type
			</div>
		</div>
		<!-- PANEL HEAD START -->
			...
			<div class="panel-body">
				<form method="post" id="hotel_ammenity" name="hotel_ammenity" action="<?php echo site_url()."index.php/hotels/update_room_meal/".base64_encode(json_encode($meal_list[0]->id)); ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
					<fieldset form="user_edit">
				<legend class="form_legend">Room Meal Type</legend>
				<input name="user_id" id="user_id" class=" user_id hiddenIp" required="" value="1128" type="hidden">
				<div class="form-group">
					<label class="col-sm-3 control-label" for="title" form="user_edit">Room Meal Type Name<span class="text-danger">*</span></label>
					<div class="col-sm-6">
						<input type="text" class="form-control" required id="" name="hotel_meal_name" value="<?php echo $meal_list[0]->name; ?>" data-validate="required" data-message-required="Please enter the Room Meal Type Name">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label">Room Meal Type Status</label>									
					<div class="col-sm-5">
						<div id="label-switch" class="make-switch" data-on-label="Active" data-off-label="InActive">
							<input type="checkbox" name="status" value="<?php echo $meal_list[0]->status; ?>" id="status" <?php if($meal_list[0]->status == "ACTIVE"){ echo "checked"; } ?>>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-5">
						<button type="submit" class="btn btn-success">Update Room Meal Type</button>
					</div>
				</div>
				</form>
			</div>
