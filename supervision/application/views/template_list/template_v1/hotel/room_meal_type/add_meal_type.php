	...
	<div class="panel panel-default clearfix">
		...
		<div class="panel-heading">
			...
			<div class="panel-title">
				<i class="fa fa-credit-card"></i> Add Room Meal Type
			</div>
		</div>
		<!-- PANEL HEAD START -->
			...
			<div class="panel-body">
				<form method="post" id="hotel_meal" name="hotel_meal" action="<?php echo site_url()."index.php/hotels/save_room_meal_data"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" required class="form-control" id="" name="hotel_meal_name" placeholder="Room Meal Type Name" data-validate="required" data-message-required="Please enter the Room Meal Type Name">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<button type="submit" class="btn btn-success">Add Meal Type</button>
					</div>
				</div>
				</form>
			</div>
