...
<div class="bodyContent">
	<div class="panel panel-primary clearfix">
		...
		<a style="margin-top: 10px;"href="<?php echo site_url()."index.php/hotel/add_board_types"; ?>" class="btn btn-primary addnwhotl pull-right">Add Board Type</a>
						...
						<tr>
							...
							<td class="center">
								...
								if($list->status == "ACTIVE")
									{ 
								?>
									<a href="<?php echo site_url()."index.php/hotel/inactive_board_types/".base64_encode(json_encode($list->id)); ?>" class="btn btn-orange btn-sm btn-icon icon-left my-inactve"><i class="entypo-eye"></i>InActive</a>
								<?php 
								}
								else
								{ ?>
									<a href="<?php echo site_url()."index.php/hotel/active_board_types/".base64_encode(json_encode($list->id)); ?>" class="btn btn-green btn-sm btn-icon icon-left my-actve"><i class="entypo-check"></i>Active</a>
								<?php 
								} 
								?>
								<a href="<?php echo site_url()."index.php/hotel/edit_board_types/".base64_encode(json_encode($list->id)); ?>" class="btn btn-default btn-sm btn-icon icon-left"><i class="entypo-pencil"></i>Edit</a>	
