	...
	<div class="panel panel-default clearfix">
		...
		<!-- PANEL HEAD START -->
			...
			<div class="panel-body">
				<form method="post" name="room_type" id="room_type" action="<?php echo site_url()."index.php/hotel/update_room_types/".base64_encode(json_encode($room_types_list[0]->id)); ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
					<fieldset form="user_edit">
				<legend class="form_legend">Edit Room Type</legend>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" id="field-1" name="room_type_name" value="<?php echo $room_types_list[0]->name; ?>" data-validate="required" data-message-required="Please enter the Room Type Name">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-5">
						<div id="label-switch" class="make-switch" data-on-label="Active" data-off-label="InActive">
							<input type="checkbox" name="status" value="<?php echo $room_types_list[0]->status; ?>" id="status" <?php if($room_types_list[0]->status == "ACTIVE"){ echo "checked"; } ?>>
						</div>
					</div>
				</div>
				<div class="form-group">
