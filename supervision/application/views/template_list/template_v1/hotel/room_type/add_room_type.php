	...
	<div class="panel panel-default clearfix">
		...
		<!-- PANEL HEAD START -->
			...
			<div class="panel-body">
				<form method="post" name="room_type" id="room_type" action="<?php echo site_url()."index.php/hotel/save_room_type_data"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">		
