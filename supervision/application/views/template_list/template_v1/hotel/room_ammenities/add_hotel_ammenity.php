	...
	<div class="panel panel-default clearfix">
		...
		<div class="panel-heading">
			...
			<div class="panel-title">
				<i class="fa fa-credit-card"></i> Add Room Amenity
			</div>
		</div>
		<!-- PANEL HEAD START -->
			...
			<div class="panel-body">
				<form method="post" id="hotel_ammenity" name="hotel_ammenity" action="<?php echo site_url()."index.php/hotel/save_room_amenities_data"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" required class="form-control" id="" name="hotel_ammenity_name" placeholder="Room Amenity Name" data-validate="required" data-message-required="Please enter the Room Amenity Name">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<button type="submit" class="btn btn-success">Add Room Amenity</button>
					</div>
				</div>
				</form>
			</div>
