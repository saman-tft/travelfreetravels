...
<div class="bodyContent">
    ...
    <a href="<?php echo site_url()."index.php/hotel/room_crs_list/{$hotel_id}"; ?>" class="btn btn-primary addnwhotl pull-right">Back</a>
  </div>
		<!-- PANEL HEAD START -->
          ...
          <div class="clearfix"></div>
				<form method="post"  id="hotel" name="hotel" action="<?php echo site_url()."index.php/hotel/save_room_details_data"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                     <select id="room_type_id" name="nationality" class="form-control" data-validate="required" data-message-required="Please Select the Nationality">                    
                       <option value="0">Select</option>
                        <?php
                        ...
                        {
                           $selected_national="";
                           if($hotel_search_params['nationality'] == $c_value->iso_country_code)
                           {
                              if($c_value->iso_country_code !="")
                              {
                                 $selected_national="selected";
                              }
                           }
                           echo '<option value="'.$c_value->iso_country_code.'" '.$selected_national.'>'.$c_value->name.'</option>';
                        }
                     ?>
                ...
                <div class="form-group">
                  <label for="field-1" class="col-sm-3 control-label">Board Type<span class="text-danger">*</span></label>                 
                  <div class="col-sm-5">
                     <select id="board_type" name="board_type" class="form-control" data-validate="required" data-message-required="Please Select the Board Type">                    
                      ...
                      <?php } ?>
						...
						<div class="form-group">
									...
									<div class="col-sm-5">
										<select id="max_stay" name="max_stay" class="form-control" data-validate="required" data-message-required="Please Select maximum passengers capacity">
											 <option value="">Select</option>
												...
												<option value="6" data-iconurl="">6</option> -->
				...
				<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select id="extra_bed" name="extra_bed" class="form-control" data-validate="required" data-message-required="Please Select the Extra Bed Availability">
												...
												<option value="Y" data-iconurl="">Available</option>
												<option value="N" data-iconurl="">Not Available</option>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<textarea style="min-height:150px;" id="room_description" name="room_description" class="form-control" data-validate="required" data-message-required="Room description required"></textarea>
									</div>
								</div>
			...
			<div class="form-group">
									...
									<div class="col-sm-5">
										<textarea style="min-height:150px;" id="room_policy" name="room_policy" class="form-control" data-validate="required" data-message-required="Room policy required"></textarea>
									</div>
								</div>
							  <div class="form-group">							  	   	
                <label for="field-1" class="col-sm-3 control-label">Room Meal Type<span class="text-danger">*</span></label>									
                <div class="col-sm-5">
                    <select id="meal_type" name="room_meal" class="form-control"  style="width:484px" data-validate="required" data-message-required="Please enter the meal type">										 



                        <?php
                        $am = explode(",", $data->meal_list);
                        foreach ($meal_list as $type) {
                            ?>
                            <option value="<?php echo $type->id; ?>" <?= in_array($ame->id, $am) ? 'selected' : '' ?> data-iconurl=""><?php echo $type->name; ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
								...
								<div class="form-group">							  	   	
									...
									<div class="col-sm-5">
										 <select id="ammenities" name="room_amenities[]" class="ddssselect2" multiple style="width:484px" data-validate="required" data-message-required="Please enter the amenities">										 
											<?php foreach ($ammenities_list as $ame){ ?>
												<option value="<?php echo $ame->id; ?>" data-iconurl=""><?php echo $ame->name; ?></option>
											<?php } ?>
										</select>
									</div>
								</div>	
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select id="star_rating" name="status" class="form-control" data-validate="required" data-message-required="Please Select the Status">
												...
												<option value="INACTIVE" data-iconurl="">INACTIVE</option>
