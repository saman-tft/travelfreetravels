...
<div class="bodyContent">
    ...
    <a href="<?php echo site_url()."index.php/hotel/room_crs_list/{$data->hotel_id}"; ?>" class="btn btn-primary addnwhotl pull-right">Back</a>
		...
		<!-- PANEL HEAD START -->
          ...
          <div class="clearfix"></div>
				<form method="post"  id="hotel" name="hotel" action="<?php echo site_url()."index.php/hotel/update_room/{$data->id}"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                     <select id="nationality" name="nationality" class="form-control" data-validate="required" data-message-required="Please Select the Nationality">                    
                       <option value="0">Select</option>
                        <?php
                        ...
                        {
                           $selected_national="";
                           if($data->nationality == $c_value->iso_country_code)
                           {
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                     <select id="board_type" name="board_type" class="form-control" data-validate="required" data-message-required="Please Select the Board Type">                    
                       <option value="0">Select</option>
                       <?php foreach ($board_types_list as $type){ ?>
                        <option value="<?php echo $type->id; ?>" <?php echo $type->id == $data->board_type ? 'selected':''; ?> data-iconurl=""><?php echo $type->name; ?></option>
                      <?php } ?>
	...
	<div class="form-group">
			...
			<div class="form-group">
								...
								<div class="form-group">							  	   	
                <label for="field-1" class="col-sm-3 control-label">Room
...
foreach ($meal_list as $type) {
                            ?>
                            <option value="<?php echo $type->id; ?>" <?=($type->id==$data->room_meal_type) ? 'selected' : '' ?> data-iconurl=""><?php echo $type->name; ?></option>
<?php } ?>
                    </select>
                </div>
            </div>	
