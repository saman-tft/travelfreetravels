...
<div class="bodyContent">
	<div class="panel panel-default clearfix">
		...
		<!-- PANEL HEAD START -->
          ...
          <div class="clearfix"></div>
				<form method="post"  id="hotel" name="hotel" action="<?php echo site_url()."index.php/hotel/save_room_price_data"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
				...
				<legend class="form_legend">Add Room Price Info</legend>
                    ...
                    <option value="0">Select Nationality Group</option>
                                <?php foreach ($nationality_group as $coun) {
                                  ...
                                  ?>
                                <option value="<?php echo $coun->origin; ?>"  data-cur="<?php echo $coun->currency; ?>"><?php echo $coun->name; ?></option>
                                <?php }?>
                              </select>
									</div>
								</div>
