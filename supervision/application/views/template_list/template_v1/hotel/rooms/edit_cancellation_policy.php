	...
	<div class="panel panel-default clearfix">
		...
		<div class="panel-heading">
			...
			<div class="panel-title">
				<i class="fa fa-credit-card"></i> Update Cancellation Policy
			</div>
		</div>
    <a href="<?php echo site_url()."index.php/hotel/room_cancellation_list/{$data->hotel_id}/{$data->room_id}"; ?>" class="btn btn-primary addnwhotl pull-right">Back</a>
		<!-- PANEL HEAD START -->
		
		

          <div class="clearfix"></div>
				<form method="post"  id="hotel" name="hotel" action="<?php echo site_url()."index.php/hotel/update_cancellation_policy_data/{$data->id}"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
					<fieldset form="user_edit">
				<legend class="form_legend">Update Cancellation policy </legend>
							...
							<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">From before (Days)<span class="text-danger">*</span></label>									
									<div class="col-sm-5">
									<input type="text" name="cancel_before" value="<?php echo $data->cancel_before; ?>"   class="form-control numeric" data-validate="required" data-message-required="Feild Required"  />	
									</div>
								</div>		
							<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">To before (Days)<span class="text-danger">*</span></label>									
									<div class="col-sm-5">
									<input type="text" name="cancel_to"  value="<?php echo $data->cancel_to; ?>"  class="form-control numeric" data-validate="required" data-message-required="Feild Required"  />	
									</div>
								</div>	
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Penalty Type<span class="text-danger">*</span></label>									
									<div class="col-sm-5">
										<select id="" name="penality_type" class="form-control" data-validate="required" data-message-required="">

												<option value="1" <?php echo $data->penality_type == 1 ? "selected" : ""; ?> data-iconurl="">Amount</option>
												<option value="2" <?php echo $data->penality_type == 2 ? "selected" : ""; ?> data-iconurl="">Percentage</option>
							...
							<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Penalty <span class="text-danger">*</span></label>									
									<div class="col-sm-5">
									<input type="text" name="penality" value="<?php echo $data->penality; ?>" class="form-control numeric" data-validate="required" data-message-required="Feild Required"  />	
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select id="star_rating" name="status" class="form-control" data-validate="required" data-message-required="Please Select the Status">
												...
												<option value="ACTIVE" <?php echo $data->status =='ACTIVE' ? 'selected' : ''; ?> data-iconurl="">ACTIVE</option>
												<option value="INACTIVE"<?php echo $data->status =='INACTIVE' ? 'selected' : ''; ?>  data-iconurl="">INACTIVE</option>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<a href="<?=base_url("hotels/room_cancellation_list/{$data->hotel_id}/{$data->room_id}")?>" class="btn btn-success" >Back</a>
