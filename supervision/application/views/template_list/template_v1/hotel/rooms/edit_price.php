...
<div class="bodyContent">
  <div class="panel panel-default clearfix">
    ...
    <div class="panel-heading">
      <!-- PANEL HEAD START -->
      <div class="panel-title" style="padding-left: 0px;">
        <i class="fa fa-credit-card"></i> Edit Price Info
      </div>
    </div>
    <!-- PANEL HEAD START -->
      ...
      <div class="panel-body">
        ...
        <div class="col-md-12 hide">
          ...
          <div class="clearfix"></div>
        <form method="post"  id="hotel" name="hotel" action="<?php echo site_url()."index.php/hotel/update_room_price_data/".$data->id; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
          <fieldset form="user_edit">
        <legend class="form_legend">Edit Room Price Info</legend>

              <input type="hidden" name="hotel_id" id="hotel_id" value="<?php echo $data->hotel_id; ?>" />
              <input type="hidden" name="room_id" id="room_id" value="<?php echo $data->room_id; ?>" />
          ...
          <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <select id="star_rating" name="season" class="form-control" data-validate="required" data-message-required="Please Select the Season">
                                                ...
                                                {
                                                ?>
                        <option value="<?=$season->seasons_details_id?>" <?=$season->seasons_details_id==$data->season? "selected":""?> data-iconurl=""><?=$season->seasons_name?></option>
                        <?php
                        }}
                        ?>
                ...
                <div class="form-group">
                  <label for="field-1" class="col-sm-3 control-label">Nationality<span class="text-danger">*</span></label>                  
                  <div class="col-sm-5">
                  ...
                  <select class='form-control'  name='nationality' id="nationality"  required> 
                    ...
                    <option value="0">Select Nationality Group</option>
                                <?php foreach ($nationality_group as $coun) {
                                     if($data->nationality==$coun->origin)
                                     {
                                         $selected='selected';
                                     }
                                     else
                                  ...
                                  ?>
                                <option value="<?php echo $coun->name; ?>"  data-cur="<?php echo $coun->currency; ?>" <?php if($data->nationality==$coun->name){ echo "selected"; }else{  echo ""; } ?>><?php echo $coun->name; ?></option>
                                <?php }?>
                              </select>
                  </div>
                </div>
                <div class="form-group">
                  <label for="field-1" class="col-sm-3 control-label">Currency<span class="text-danger">*</span></label>                  
                  <div class="col-sm-5">
                        <input id="currency" name="currency" class="form-control" data-validate="required" data-message-required="Please Select the Currency"  value="<?php echo $data->currency; ?>" readonly />
                    <!--<select id="currency" name="currency" class="form-control" data-validate="required" data-message-required="Please Select the Currency">
                    </select>-->
                  </div>
                </div>
            <!--<div class="form-group">
                  ...
                  <div class="col-sm-5">
                  <input type="text" name="date_from"  value="<?php echo $data->date_from; ?>" id="datepickerform" class="form-control" data-validate="required" data-message-required="Please Select the from date" readonly />  
                  </div>
                </div>
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-5">
                  <input type="text" name="date_to" value="<?php echo $data->date_to; ?>" id="datepickerto" class="form-control" data-validate="required" data-message-required="Please Select the to date" readonly /> 
                  </div>
                </div>-->
                
            <div class="form-group">
                  <label for="field-1" class="col-sm-3 control-label">1 Adult Price <span class="text-danger">*</span></label>                 
                  <div class="col-sm-5">
                  <input type="text" name="one_adult" id="one_adult" value="<?php echo $data->one_adult; ?>" class="form-control numeric" data-validate="required" data-message-required="Please Select 1 adult price" /> 
                  </div>
                </div>

              
            <div class="form-group">
                  <label for="field-1" class="col-sm-3 control-label">2 Adult Price <span class="text-danger">*</span></label>                 
                  <div class="col-sm-5">
                  <input type="text" name="two_adult" id="two_adult" value="<?php echo $data->two_adult; ?>" class="form-control numeric" data-validate="required" data-message-required="Please Select 2 adult price" /> 
                  </div>
                </div>

              
            <div class="form-group">
                  <label for="field-1" class="col-sm-3 control-label">3 Adult Price <span class="text-danger">*</span></label>                 
                  <div class="col-sm-5">
                  <input type="text" name="three_adult" id="three_adult"  value="<?php echo $data->three_adult; ?>" class="form-control numeric" data-validate="required" data-message-required="Please Select 3 adult price" />  
                  </div>
                </div>
                <div class="form-group">
                  <label for="field-1" class="col-sm-3 control-label">Child Price <span class="text-danger">*</span></label>                 
                  <div class="col-sm-5">
                  <input type="text" name="child_price" id="child_price" value="<?php echo $data->child_price; ?>"  class="form-control numeric" data-validate="required" data-message-required="Please Select  child price" /> 
                  </div>
                </div>
          ...
          <div class="form-group">
                  ...
                  <div class="col-sm-5">
                      <div class="switchToggle">
                                            <input type="checkbox" id="switch" class="bfst_chk" data-id="one_adult_breakfast" <?=$data->one_adult_breakfast > 0 ? 'checked' : ''?>/>
                                            <label for="switch">Toggle</label>
                                        </div>
                  <!--<input type="checkbox" class="bfst_chk" data-id="one_adult_breakfast" <?=$data->one_adult_breakfast > 0 ? 'checked' : ''?> />--><br><br>  
                  <input type="text" name="one_adult_breakfast" id="one_adult_breakfast" class="form-control numeric <?=$data->one_adult_breakfast>0 ? '' : 'hide'?>"  value="<?=$data->one_adult_breakfast?>"/>  
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                      <div class="switchToggle">
                                            <input type="checkbox" id="switch1" class="bfst_chk" data-id="two_adult_breakfast" <?=$data->two_adult_breakfast>0 ? 'checked' : ''?> />
                                            <label for="switch1">Toggle</label>
                                        </div>
                  <!--<input type="checkbox" class="bfst_chk" data-id="two_adult_breakfast" <?=$data->two_adult_breakfast>0 ? 'checked' : ''?> />--><br><br>  
                  <input type="text" name="two_adult_breakfast" id="two_adult_breakfast" class="form-control numeric <?=$data->two_adult_breakfast>0 ? '' : 'hide'?>"  value="<?=$data->two_adult_breakfast?>"/>  
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                      <div class="switchToggle">
                                            <input type="checkbox" id="switch2" class="bfst_chk" data-id="three_adult_breakfast" <?=$data->three_adult_breakfast>0 ? 'checked' : ''?> />
                                            <label for="switch2">Toggle</label>
                                        </div>
                  <!--<input type="checkbox" class="bfst_chk" data-id="three_adult_breakfast" <?=$data->three_adult_breakfast>0 ? 'checked' : ''?> />--><br><br>  
                  <input type="text" name="three_adult_breakfast" id="three_adult_breakfast"  class="form-control numeric  <?=$data->three_adult_breakfast>0 ? '' : 'hide'?>"  value="<?=$data->three_adult_breakfast?>"/>  
                  </div>
                </div>
...
<div class="form-group">
                  <label for="field-1" class="col-sm-3 control-label">Extra bed Size </label>                 
                  <div class="col-sm-5">
          ...
          <div class="col-sm-5">
          <input type="text" name="extrabed_price" id=""  class="form-control numeric"  value="<?=$data->extrabed_price?>" /> 
          </div>
        </div>
                <div class="form-group">
          ...
          <div class="col-sm-5">
              <div class="switchToggle">
                                            <input type="checkbox" id="switch3" class="bfst_chk" data-id="child_breakfast_age"  <?=$data->child_breakfast>0 ? 'checked' : ''?> />
                                            <label for="switch3">Toggle</label>
                                        </div>
          <!--<input type="checkbox" class="bfst_chk1" data-id="child_breakfast"  <?=$data->child_breakfast>0 ? 'checked' : ''?> />-->
          <div id="child_breakfast_age" class="<?=$data->child_breakfast>0 ? '' : 'hide'?>">
          <label>Child Age</label>
          <input type="text"  class="form-control "  value="<?=$data->child_breakfast_age?>" name="child_breakfast_age" /><br>
          <label>Price</label>
          <input type="text" name="child_breakfast" id="child_breakfast"  class="form-control numeric "  value="<?=$data->child_breakfast?>" /> 
          </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-5">
              <div class="switchToggle">
                                            <input type="checkbox" id="switch4" class="bfst_chk" data-id="vat" <?=$data->vat>0 ? 'checked' : ''?> />
                                            <label for="switch4">Toggle</label>
                                        </div>
          <!--<input type="checkbox" class="bfst_chk" data-id="vat" <?=$data->vat>0 ? 'checked' : ''?> />--><br><br>  
          <input type="text" name="vat" id="vat"  class="form-control numeric <?=$data->vat>0 ? '' : 'hide'?>" value="<?=$data->vat?>" /> 
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-5">
              <div class="switchToggle">
                                            <input type="checkbox" id="switch5" class="bfst_chk" data-id="service_charge" <?=$data->service_charge>0 ? 'checked' : ''?> />
                                            <label for="switch5">Toggle</label>
                                        </div>
          <!--<input type="checkbox" class="bfst_chk" data-id="service_charge" <?=$data->service_charge>0 ? 'checked' : ''?> />--><br><br>  
          <input type="text" name="service_charge" id="service_charge"  class="form-control numeric <?=$data->service_charge>0 ? '' : 'hide'?>"  value="<?=$data->service_charge?>" />  
          </div>
        </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <select id="star_rating" name="status" class="form-control" data-validate="required" data-message-required="Please Select the Status">
                        ...
                        <option value="ACTIVE" data-iconurl="" <?php echo $data->status =="ACTIVE" ? "selected" :""; ?>>ACTIVE</option>
                        <option value="INACTIVE" data-iconurl="" <?php echo $data->status =="INACTIVE" ? "selected" :""; ?>>INACTIVE</option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    ...
                    <a href="<?=base_url("index.php/hotels/room_crs_list/{$data->hotel_id}")?>"  class="btn btn-primary" >Back to Room List</a>
...
$("#thumb_image").change(function(e) {
    ...
    function select_city(country_id){
     ...
     if (country_id != '') {            
          ...
          $.ajax({
            url: '<?php echo site_url(); ?>/hotels/get_city_name/'+country_id,
    ...
    function select_location(city_id){         
     if (city_id != '') {             
          ...
          $.ajax({
            url: '<?php echo site_url(); ?>/hotels/get_location_name/' + city_id,
            success: function (data, textStatus, jqXHR) {                                   
