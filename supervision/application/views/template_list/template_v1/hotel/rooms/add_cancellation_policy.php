	...
	<div class="panel panel-default clearfix">
		...
		<div class="panel-heading">
			...
			<div class="panel-title">
				<i class="fa fa-credit-card"></i> Add Cancellation Policy
			</div>
		
    <a href="<?php echo site_url()."index.php/hotel/room_cancellation_list/{$hotel_id}/{$room_id}"; ?>" class="btn btn-primary addnwhotl pull-right">Back</a>
</div>
		<!-- PANEL HEAD START -->
          ...
          <div class="clearfix"></div>
				<form method="post"  id="hotel" name="hotel" action="<?php echo site_url()."index.php/hotel/save_cancellation_policy_data"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
					<fieldset form="user_edit">
				<legend class="form_legend">Add Cancellation policy</legend>
							...
							<div class="form-group">
									...
									<div class="col-sm-5">
									<input type="text" name="cancel_before"  class="form-control numeric" data-validate="required" data-message-required="Feild Required"  />	
									</div>
								</div>		
							<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">To before (Days)<span class="text-danger">*</span></label>									
									<div class="col-sm-5">
									<input type="text" name="cancel_to"  class="form-control numeric" data-validate="required" data-message-required="Feild Required"  />	
									</div>
								</div>	
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select id="" name="penality_type" class="form-control" data-validate="required" data-message-required="">
												...
												<option value="1" data-iconurl="">Amount</option>
												<option value="2" data-iconurl="">Percentage</option>
							...
							<div class="form-group">
									...
									<div class="col-sm-5">
									<input type="text" name="penality" class="form-control numeric" data-validate="required" data-message-required="Feild Required"  />	
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<input type="submit" name="submit"  class="btn btn-primary btn btn-success" value="Save">
										<a href="<?=base_url("hotels/room_cancellation_list//{$hotel_id}/{$room_id}")?>" class="btn btn-success btn btn btn-warning " >Back</a>
