						...
						<div class=''>
							...
							<div class=''>
								<form class='form form-horizontal validate-form'
									...
									action="<?php echo base_url(); ?>index.php/hotel/save_nationalityCountries"
									...
									<div class='form-group'>
										...
										<input type="hidden" name="pack_id" value="<?=$id ?>">
											<input class='form-control' data-rule-minlength='2'
												...
												placeholder='Excursion Type' type='text' required> <span id="pacname"
												style="color: #F00; display: none;">Please enter Price
												Type</span>
										</div>
									</div>
 <div class="form-group">
                  <label for="field-1" class="control-label col-sm-2">Currency<span class="text-danger">*</span></label>                  
                  <div class="col-sm-3 eml n_psngr">
                    <select id="currency" name="currency_sel" class="form-control" data-validate="required" data-message-required="Please Select the Currency">
                                               <?php
                                foreach($currency_nat_price as $currency_key => $currency_value)
                                {
                                    if($edit_notionality_country[0]['currency']==$currency_value['country'])
                                    {
                                         $setty='selected';
                                    }
                                    else
									...
									<div class='form-actions' style='margin-bottom: 0'>
										<div class='row'>
											<div class='col-sm-9 col-sm-offset-4'>
												<a
													href="<?php echo base_url(); ?>index.php/activity/view_packages_types">
