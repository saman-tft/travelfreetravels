...
<div class="bodyContent">
	<div class="panel panel-default clearfix">
		...
		<!-- PANEL HEAD START -->
          ...
          <div class="clearfix"></div>
				<form method="post"  id="hotel" name="hotel" action="<?php echo site_url()."index.php/hotel/save_hotel_data"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
					<fieldset form="user_edit">
				<legend class="form_legend">Add Hotel</legend>
				<?php if($supplier_rights == 1) { ?>
							...
							<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="hotel_name" maxlength="30" name="hotel_name" placeholder="Hotel Name" data-validate="required" data-message-required="Please enter the Hotel Name">
									</div>
								</div>
									<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Contract Expire Date<span class="text-danger">*</span></label>									
									<div class="col-sm-5">
									<input type="text" class="form-control logpadding dateFrom" id="datepickerform" name="exclude_checkout_date" value="" id="exclude_checkout_date" data-min-date="<?php echo date('m-d-Y');?>" data-validate="required" data-message-required="Please Select the Contract Expire Date" readonly />										
									</div>
								</div>
						<div class="form-group">
									...
									<div class="col-sm-5">
										<select id="star_rating" name="star_rating" class="form-control" data-validate="required" data-message-required="Please Select the Star Rating">
											 <option value="">Select Rating</option>
												...
												<option value="1" data-iconurl="">1</option>
												<option value="2" data-iconurl="">2</option>
												<option value="3" data-iconurl="">3</option>
												<option value="4" data-iconurl="">4</option>
												<option value="5" data-iconurl="">5</option>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<textarea class="form-control" id="hotel_description" name="hotel_description" placeholder="Hotel Description" data-message-required="Please enter the Hotel Description" data-validate="required" data-message-required="Please Enter Hotel Description"></textarea>
									</div>
								</div>
								<div class="form-group">							  	   	
									<label for="field-1" class="col-sm-3 control-label">Amenities<span class="text-danger">*</span></label>									
									<div class="col-sm-5">
										 <select style="width:484px;" id="ammenities" name="ammenities[]" class="ddssselect2" multiple  data-validate="required" data-message-required="Please enter the amenities">										 
											<?php 
                      foreach ($hotel_amenities_list as $j => $list) {
                        # code...
                    ?>
												<option value="<?php echo $list->id; ?>" data-iconurl="" 
												<?php if(isset($sel_ammenities)){ if(count($sel_ammenities) > 0){
													if(in_array($list->id,$sel_ammenities)){
														echo "selected";
													}
												} }
												?>
								...
								<div class="form-group">
                                        ...
                                        <div class="col-sm-5">                                            
                                            <select name="country" id="country" onchange="select_city(this.value)" class="form-control" data-validate="required" data-message-required="Please Select the Country">
                                                <option value="">Select Country</option>                                                    
                                               <?php for ($c = 0; $c < count($country); $c++) { ?>
                                                    <option value="<?php echo $country[$c]->country_name; ?>" data-iconurl=""><?php echo $country[$c]->country_name; ?></option>
                                                <?php } ?>
                                            </select>
                                ...
                                <div class="form-group" id="api">
									...
									<div class="col-sm-5">                                      
										<select name="city_name"  class="form-control" id="city_name" data-validate="required" data-message-required="Please Select the City">											
                    ...
                    <?php echo form_error('city_name',  '<span for="field-1" class="validate-has-error">', '</span>'); ?>
                                ...
                                <div class="form-group">                                    
									...
									<div class="col-sm-5">
										<textarea class="form-control" id="hotel_address" name="hotel_address" placeholder="Hotel Address" data-validate="required" data-message-required="Please enter the Hotel Address" id="hotel_address" rows="7" readonly="true"></textarea>
									</div> 								
								</div>
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Latitude<span class="text-danger">*</span></label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" name="latitude" onblur="getmap()" placeholder="Latitude" data-validate="required" data-message-required="Please enter the Latitude of Hotel" id="lat" readonly="true">
									</div>
								</div>
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Longitude<span class="text-danger">*</span></label>									
									<div class="col-sm-5">
										<input type="text" class="form-control" name="longitude" onblur="getmap()" placeholder="Longitude" data-validate="required" data-message-required="Please enter the Longitude of Hotel" id="lng" readonly="true">
									</div>
								</div>
								<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Postal Code<span class="text-danger">*</span></label>									
									<div class="col-sm-5">										
										<input type="text" class="form-control numeric"   name="postal_code">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control numeric"  id="phone_number" name="phone_number" maxlength="15" placeholder="Phone Number" data-validate="required" placeholder="Postal Code" data-rule-number="true" data-message-required="Please enter the Phone Number">
									</div>
								</div>
                <div class="form-group">
                  <label for="field-1" class="col-sm-3 control-label">Fax Number</label>                  
                  <div class="col-sm-5">
                    <input type="text" class="form-control numeric"   name="fax_number" maxlength="15" placeholder="Fax Number"  >
                  </div>
                </div>
								<div class="form-group">
                  <label for="field-1" class="col-sm-3 control-label">Email<span class="text-danger">*</span></label>                 
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="email" name="email"  onBlur="checkUniqueEmail(this.value)" placeholder="Email Address" data-validate="email,required" data-message-required="Please enter the Valid Email Id"/>
							...
							<!--</div>-->
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<a href="<?=base_url('index.php/hotels/hotel_crs_list')?>"   class="btn btn-danger" >Close</a>
									</div>
								</div>
				</form>
			</div>
      ...
      uploadField.onchange = function() {
		...
		function select_city(country_id){
		 ...
		 if (country_id != '') {         	  
          ...
          $.ajax({
            url: '<?php echo site_url(); ?>index.php/hotel/get_city_name/'+country_id,
		...
		function select_location(city_id){				 
		 if (city_id != '') {         	  
          ...
          $.ajax({
            url: '<?php echo site_url(); ?>index.php/hotel/get_location_name/' + city_id,
            success: function (data, textStatus, jqXHR) {                                   
