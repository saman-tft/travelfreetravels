		...
		case 'EID008' : //Transaction
			...
			switch($type){
				...
				case 'bus';
					...
					break;
					case 'Holiday';
					$action_function = '/report/'.$module.'_package_report/';
					break;
					case 'sightseeing';
					$action_function = '/report/'.$module.'_activities_report/';
					break;
					case 'transferv1';
					$action_function = '/report/'.$module.'_transfers_report/';
					break;
					case 'car';
					$action_function = '/report/'.$module.'_car_report/';
					break;
			}
			$notification_action_url = base_url().'index.php'.$action_function.'?'.$action_query_string;
			break;
