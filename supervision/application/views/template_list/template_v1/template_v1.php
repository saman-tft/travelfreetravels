          ...
          <div class="navbar-custom-menu">
            ...
            <?php endif; ?>
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="https://www.travelfreetravels.com/extras/system/template_list/template_v3/images/face.png" class="user-image" alt="User Image"/>
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <?php //debug($GLOBALS['CI']);exit;?>
              <img src="https://www.travelfreetravels.com/extras/system/template_list/template_v3/images/face.png" class="img-circle" alt="User Profile Image" />
            </div>
