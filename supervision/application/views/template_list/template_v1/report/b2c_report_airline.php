...
<!-- new styles and modal for invoice form filter -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <form action="<?php echo base_url() ?>index.php/voucher/all_flight_invoice_GST/<?php echo B2C_USER; ?><?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>" method="POST"target="_blank">>
                    ...
                    <div class="row">
                        <form action="<?php echo base_url() ?>index.php/voucher/all_flight_invoice_GST/<?php echo B2C_USER; ?><?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>" method="POST">
                            <div class="row invDownloadType">
      ...
      <?php if ($total_records > 0) { ?>
        ...
        <div class="dropdown col-xs-1">
          ...
          <ul class="dropdown-menu" aria-labelledby="excel_imp_drop">
            <li>
              ...
              <a href="<?php echo base_url(); ?>index.php/report/export_booking_airline_report/excel/all/download/b2c<?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>">All Booking download</a>
            </li>
            <li>
            ...
            <li>
                <!-- changes action url changed -->
              <a href="<?php echo base_url(); ?>index.php/report/export_booking_airline_report/excel/confirmed/download/b2c<?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>">Confirmed Booking download</a>
            </li>
            ...
            <li>
                <!-- changes action url changed -->
              <a href="<?php echo base_url(); ?>index.php/report/export_booking_airline_report/excel/cancelled/download/b2c<?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>">Cancelled Booking download</a>
            </li>
            <li>
        ...
        <div class="dropdown col-xs-1">
          ...
          <ul class="dropdown-menu" aria-labelledby="pdf_imp_drop">
            <li>
                <!-- changes action url changed -->
              <a href="<?php echo base_url(); ?>index.php/report/export_booking_airline_report/pdf/all/download/b2c<?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>">All Booking download</a>
            </li>
            <li>
            ...
            <li>
                <!-- changes action url changed -->
              <a href="<?php echo base_url(); ?>index.php/report/export_booking_airline_report/pdf/confirmed/download/b2c<?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>">Confirmed Booking download</a>
            </li>
            <li>
            ...
            <li>
                <!-- changes action url changed -->
              <a href="<?php echo base_url(); ?>index.php/report/export_booking_airline_report/pdf/cancelled/download/b2c<?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>">Cancelled Booking download</a>
            </li>
            <li>
        ...
        <div class="dropdown col-xs-1">
          ...
          <ul class="dropdown-menu" aria-labelledby="csv_imp_drop">
            <li>
                <!-- changes action url changed -->
              <a href="<?php echo base_url(); ?>index.php/report/export_booking_airline_report/csv/all/download/b2c<?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>">All Booking download</a>
            </li>
            <li>
            ...
            <li>
                <!-- changes action url changed -->
              <a href="<?php echo base_url(); ?>index.php/report/export_booking_airline_report/csv/confirmed/download/b2c<?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>">Confirmed Booking download</a>
            </li>
            <li>
            ...
            <li>
                <!-- changes action url changed -->
              <a href="<?php echo base_url(); ?>index.php/report/export_booking_airline_report/csv/cancelled/download/b2c<?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>">Cancelled Booking download</a>
            </li>
            <li>
        ...
        <!-- <a href="<?php echo base_url(); ?>index.php/voucher/all_flight_invoice_GST/<?php echo B2C_USER; ?><?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>" class="btn btn-success">30 Invoice download</a> -->
         <a href="#" class="btn btn-success" id="invDownoadBtn"><i class="fa fa-download" aria-hidden="true"></i> Invoice download</a>
    ...
    <div id="excelallmodal" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
                <!-- changes action url changed -->
            <form action="<?= base_url() ?>index.php/report/export_booking_airline_report/excel/all/mail/b2c<?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>" method="post">
    ...
    <div id="pdfallmodal" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
                <!-- changes action url changed -->
            <form action="<?= base_url() ?>index.php/report/export_booking_airline_report/pdf/all/mail/b2c<?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>" method="post">
              <div class="form-group">
                <input type="text" class="form-control mfc" id="email" placeholder="Enter email" name="email" required="">
                <p>provide multiple email separated by(,)abc@gmail.com,xyz@gmail.com</p>
                <span id="errormsg"></span>
    ...
    <div id="csvallmodal" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
                <!-- changes action url changed -->
            <form action="<?= base_url() ?>index.php/report/export_booking_airline_report/csv/all/mail/b2c<?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>" method="post">
              <div class="form-group">
                <input type="text" class="form-control mfc" id="email" placeholder="Enter email" name="email" required="">
                <p>provide multiple email separated by(,)abc@gmail.com,xyz@gmail.com</p>
                <span id="errormsg"></span>
    ...
    <div id="excelconfirmmodal" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
                <!-- changes action url changed -->
            <form action="<?= base_url() ?>index.php/report/export_booking_airline_report/excel/confirmed/mail/b2c<?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>" method="post">
              <div class="form-group">
                <input type="text" class="form-control mfc" id="email" placeholder="Enter email" name="email" required="">
                <p>provide multiple email separated by(,)abc@gmail.com,xyz@gmail.com</p>
                <span id="errormsg"></span>
    ...
    <div id="excelecancelmodal" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
                <!-- changes action url changed -->
            <form action="<?php echo base_url(); ?>index.php/report/export_booking_airline_report/excel/cancelled/mail/b2c<?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>" method="post">
              <div class="form-group">
    ...
    <div id="pdfconfirmmodal" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
                <!-- changes action url changed -->
            <form action="<?= base_url() ?>index.php/report/export_booking_airline_report/pdf/confirmed/mail/b2c<?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>" method="post">
              <div class="form-group">
                <input type="text" class="form-control mfc" id="email" placeholder="Enter email" name="email" required="">
                <p>provide multiple email separated by(,)abc@gmail.com,xyz@gmail.com</p>
                <span id="errormsg"></span>
    ...
    <div id="pdfcancelmodal" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
                <!-- changes action url changed -->
            <form action="<?php echo base_url(); ?>index.php/report/export_booking_airline_report/pdf/cancelled/mail/b2c<?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>" method="post">
              <div class="form-group">
                <input type="text" class="form-control mfc" placeholder="Enter email" name="email" required="">
                <p>provide multiple email separated by(,)abc@gmail.com,xyz@gmail.com</p>
                <span id="errormsg"></span>
    ...
    <div id="csvconfirmmodal" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
                <!-- changes action url changed -->
            <form action="<?= base_url() ?>index.php/report/export_booking_airline_report/csv/confirmed/mail/b2c<?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>" method="post">
              <div class="form-group">
                <input type="text" class="form-control mfc" id="email" placeholder="Enter email" name="email" required="">
                <p>provide multiple email separated by(,)abc@gmail.com,xyz@gmail.com</p>
                <span id="errormsg"></span>
    ...
    <div id="csvcancelmodal" class="modal fade" role="dialog">
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
                <!-- changes action url changed -->
            <form action="<?php echo base_url(); ?>index.php/report/export_booking_airline_report/csv/cancelled/mail/b2c<?= !empty($_SERVER["QUERY_STRING"]) ? '?' . $_SERVER["QUERY_STRING"] : '' ?>" method="post">
              <div class="form-group">
                <input type="text" class="form-control mfc" placeholder="Enter email" name="email" required="">
                <p>provide multiple email separated by(,)abc@gmail.com,xyz@gmail.com</p>
                <span id="errormsg"></span>
        ...
        <tbody>
          ...
          ?>
            ...
            foreach ($booking_details as $parent_k => $parent_v) {
              //changes start for pg convenience fee display report
              ...
              if ($parent_v['booking_transaction_details'][0]['status_description'] != "") {
                ...
                if (
                  $convDetailsType == 'percentage'
                ) {
                  $convDetailsValue = ($convDetailsValue / (float) 100) * $totalAmount;
                }
              }
              //changes end for pg convenience fee display report
              extract($parent_v);
              //debug($parent_v);exit;
              $action = '';
              $cancellation_btn = '';
            ...
            ?>
              <tr>
                ...
                <td>
                  ...
                  Financial Comment By <?= $booking_attributes_remarks->fin_remarks_user_name; ?><br />
                  Remarks By <?= $booking_attributes_remarks->oth_remarks_user_name; ?>
                </td>
                <!--upto here-->
                <td>
                  <?php
                ...
                <td><?= $admin_markup ?></td>
                <td><?php echo $gst; ?></td>
                <td><?= $convinence_amount + $convDetailsValue ?></td>
