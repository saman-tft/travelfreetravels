            ...
            <table class="table table-condensed table-bordered example3" id="b2c_report_airline_table">
                <thead>					
                    <tr>
                        ...
                        <th style="min-width: 200px; max-width: 200px;">Remarks Updated<br/>Date</th>
                        <th>Supplier Name</th>
                        <th>Booked Via</th>
...
// echo $pdf_btn;exit;
              ...
              //  debug($attributes);die;
                            ...
                            <tr>
                                ...
                                <td>
                                    Updated: <?= $booking_attributes_remarks->remarks_updated; ?><br />
                                    Updated by:<br />
                                    Financial: <?= $booking_attributes_remarks->fin_remarks_user_name; ?><br />
                                    Other: <?= $booking_attributes_remarks->oth_remarks_user_name; ?>
                                </td>
                                <!--upto here-->
                                <td>
                                    <?php 
