  ...
  <div class="bodyContent col-md-12">
    <div class="panel panel-default clearfix">
      ...
      <div class="panel-body">
        ...
        <h4>Search Panel</h4>
        <hr>
        <form action="<?=base_url().'index.php/report/b2c_package_report/'.$module_type?>" method="GET" autocomplete="off"> 
            ...
            <div class="clearfix"></div>
                <div class="dropdown col-xs-1">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="excel_imp_drop">
                      <li >
                            <a href="<?php echo base_url(); ?>index.php/report/export_all_booking_holiday_report/excel<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>">All Booking download</a>
                        </li>
                        <li >
                            <a href="" data-toggle="modal" data-target="#excelallmodal">All Booking email</a>
                        </li>
                        <li >
                            <a href="<?php echo base_url(); ?>index.php/report/export_confirmed_booking_holiday_report/excel<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>">Confirmed Booking download</a>
                        </li>
                        <li >
                            <a href="" data-toggle="modal" data-target="#excelconfirmmodal">Confirmed Booking email</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url(); ?>index.php/report/export_cancelled_booking_holiday_report/excel<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>">Cancelled Booking download</a>
                        </li>
                         <li>
                ...
                <div class="dropdown col-xs-1">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="pdf_imp_drop">
                      <li >
                            <a href="<?php echo base_url(); ?>index.php/report/export_all_booking_holiday_report/pdf<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>">All Booking download</a>
                        </li>
                        <li>
                            <a href="" data-toggle="modal" data-target="#pdfallmodal">All Booking email</a>
                        </li>
                        <li >
                            <a href="<?php echo base_url(); ?>index.php/report/export_confirmed_booking_holiday_report/pdf<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>">Confirmed Booking download</a>
                        </li>
                        <li >
                            <a href="" data-toggle="modal" data-target="#pdfconfirmmodal">Confirmed Booking email</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url(); ?>index.php/report/export_cancelled_booking_holiday_report/pdf<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>" >Cancelled Booking download</a>
                        </li>
                        <li>
                ...
                <div class="dropdown col-xs-1">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="csv_imp_drop">
                      <li >
                            <a href="<?php echo base_url(); ?>index.php/report/export_all_booking_holiday_report/csv<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>">All Booking download</a>
                        </li>
                        <li>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?=base_url()?>index.php/report/export_all_booking_holiday_report_email/excel<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>" method="post">
...
<div id="pdfallmodal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?=base_url()?>index.php/report/export_all_booking_holiday_report_email/pdf<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>" method="post">
            <div class="form-group">
             <input type="text" class="form-control mfc" id="email" placeholder="Enter email" name="email" required="">
            <p>provide multiple email separated by(,)abc@gmail.com,xyz@gmail.com</p>
             <span id="errormsg"></span>
...
<div id="csvallmodal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?=base_url()?>index.php/report/export_all_booking_holiday_report_email/csv<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>" method="post">
            <div class="form-group">
             <input type="text" class="form-control mfc" id="email" placeholder="Enter email" name="email" required="">
            <p>provide multiple email separated by(,)abc@gmail.com,xyz@gmail.com</p>
             <span id="errormsg"></span>
...
<div id="excelconfirmmodal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?=base_url()?>index.php/report/export_confirmed_booking_holiday_report_email/excel<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>" method="post">
            <div class="form-group">
             <input type="text" class="form-control mfc" id="email" placeholder="Enter email" name="email" required="">
            <p>provide multiple email separated by(,)abc@gmail.com,xyz@gmail.com</p>
             <span id="errormsg"></span>
...
<div id="excelecancelmodal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url(); ?>index.php/report/export_cancelled_booking_holiday_report_email/excel<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>" method="post">
            <div class="form-group">
...
<div id="pdfconfirmmodal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?=base_url()?>index.php/report/export_confirmed_booking_holiday_report_email/pdf<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>" method="post">
            <div class="form-group">
             <input type="text" class="form-control mfc" id="email" placeholder="Enter email" name="email" required="">
            <p>provide multiple email separated by(,)abc@gmail.com,xyz@gmail.com</p>
             <span id="errormsg"></span>
...
<div id="pdfcancelmodal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url(); ?>index.php/report/export_cancelled_booking_holiday_report_email/pdf<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>" method="post">
            <div class="form-group">
             <input type="text" class="form-control mfc" placeholder="Enter email" name="email" required="">
            <p>provide multiple email separated by(,)abc@gmail.com,xyz@gmail.com</p>
             <span id="errormsg"></span>
...
<div id="csvconfirmmodal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?=base_url()?>index.php/report/export_confirmed_booking_holiday_report_email/csv<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>" method="post">
            <div class="form-group">
             <input type="text" class="form-control mfc" id="email" placeholder="Enter email" name="email" required="">
            <p>provide multiple email separated by(,)abc@gmail.com,xyz@gmail.com</p>
             <span id="errormsg"></span>
...
<div id="csvcancelmodal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url(); ?>index.php/report/export_cancelled_booking_holiday_report_email/csv<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>" method="post">
            <div class="form-group">
             <input type="text" class="form-control mfc" placeholder="Enter email" name="email" required="">
            <p>provide multiple email separated by(,)abc@gmail.com,xyz@gmail.com</p>
             <span id="errormsg"></span>
      ...
      <div id="tableList"  class="clearfix table-responsive">
        ...
        <table class="table table-condensed table-bordered print-area" id="holiday_table">
          ...
          <tbody>
           ...
           // $user_attr=json_decode($table_data['user_attributes'],true);
          // debug($user_attr);exit();
            if (isset ( $table_data ) == true) {
             $segment = $GLOBALS ['CI']->uri->segment ( 3 );
              ...
              foreach ( $table_data as $key => $data ) 
              {
                ...
                $total_fare=($base_fare+$aed_attributes->aed_convenience_fee+$gst_value)-$discount_value;
              ...
              // debug($data['pax_details']);exit;
                ...
                $user_attr=json_decode($data['booking_details']['user_attributes'],true);
                // debug($user_attr);exit();
                $action = '';
                $email = '';
                $action .= '';
                  ...
                  $action .= '<a href="#" data-toggle="modal" data-target="#package'.$key.'"><i class="fal fa-umbrella-beach"></i> Tour</a>';
                  ...
                  $action .= '<a href="'.base_url().'index.php/voucher/holiday/'.$data['booking_details']['app_reference'].'" ><i class="fal fa-file"></i> Voucher</a></br>';
                  $action .= '<a href="'.base_url().'index.php/voucher/holiday/'.$data['booking_details']['app_reference'].'/'.$data['booking_details']['status'].'/download_pdf" ><i class="fal fa-file"></i> Download PDF</a> </br>';
                  $action .= '<a href="'.base_url().'index.php/voucher/holiday/'.$data['booking_details']['app_reference'].'/'.$data['booking_details']['status'].'/show_pdf" ><i class="fal fa-file"></i> View PDF</a></br>';

                  $action.='<a class="send_email_voucher" data-app-status="'.$data['booking_details']['status'].'"   data-app-reference="'.$data['booking_details']['app_reference'].'" data-booking-source="'.$booking_source.'"data-recipient_email="'.$user_attr['billing_email'].'" id=""><i class="far fa-envelope"></i> Email Voucher</a>';
          ...
          echo $packagehtml;
                ...
                <tr>
                    ...
                    <td>
                      <?php
                        ...
                        if(!empty($data['payment_details']))
                        {
                            ...
                            $payment_id1=json_decode($data['payment_details'][0]['response_params'],true);
                  ...
                  <?php  $conveince_fee=round($aed_attributes->aed_convenience_fee); ?>
                 
                 
                  <td><?php  echo isset($conveince_fee)? number_format($conveince_fee,2):0; ?></td>
                    ...
                    echo number_format($gst_value,2);
                     ?></td>
                    ...
                    <td>
                        ...
                        <!--<?=
                        $data['booking_details']['currency_code'] 
                        ?>-->
                         <?=
    ...
    $('.send_email_voucher').on('click', function(e) {
      ...
      $("#send_mail_btn").off('click').on('click',function(e){
        ...
        if(email != ''){ 
          ...
          var _opp_url = app_base_url+'index.php/voucher/holiday/';
