                                    ...
                                    <td>
										<div class="dropdown">
											 ...
											 <div class="dropdown-content">
												<?= '<a target="_blank" href="' . base_url() . 'index.php/flight/ticket_cancellation_details?app_reference=' . $data['app_reference'] . '&booking_source=' . $data['booking_source'] . '&status=' . $data['status'] . '" class="btn"><i class="fa fa-info"></i> <small>Cancellation Details</small></a>'; ?>
											 </div>
											</div>
