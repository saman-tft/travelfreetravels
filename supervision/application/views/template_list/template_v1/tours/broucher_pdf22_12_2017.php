...
<?php } ?>
  <table cellspacing="0" cellpadding="10" border="0" style="border-collapse: collapse; background: #ffffff; border: 1px solid #ddd; font-size: 14px; line-height: 20px; width: 100%; max-width: 600px; margin: 0px auto; font-family: Aller, sans-serif; color:#405364;">
  <tbody>
  <tr>

        <td style="padding:10px 10px 0px 0px;">
         
          <span style="float: right;"><img style="margin-bottom:10px; height:150px;" src="http://www.ziphop.com/extras/custom/keWD7SNXhVwQmNRymfGN/images/keWD7SNXhVwQmNRymfGN192.168.0.25logo_voucher.png" alt="logo"></span>
      ...
      <tr>
       ...
       <tr>
        ...
        <span style="width:100%; float:left"><img  style="width:290px; height:160px;" src="http://www.ziphop.com/extras/custom/keWD7SNXhVwQmNRymfGN/images/<?=$tour_data['banner_image']?>" alt="img" /></span>
        </td>
      </tr>
      <?php 
