	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
					...
					<div role="tabpanel" class="tab-pane active" id="add_package">
						   <div class="col-md-12">
							<div class='form-group'>
								<label class='control-label col-sm-3' for='validation_current'>Choose Continent
								</label>
         ...
         ?>
			...
			<table class="table table-bordered sstabl">
			<thead>
				<tr>
					<th>Sl.No</th>
					<th>Tour Region</th>
        ...
        echo '<td class="center">
              ...
              <a class="" data-placement="top" href="'.base_url().'index.php/tours/delete_tour_country/'.$data['id'].'"
              data-original-title="Edit Tour Destination"> <i class="glyphicon glyphicon-pencil"></i> Delete
              </a>
              </td>
              </tr>';
        $sn++;
