                            ...
                            <div class='form-group'>
                                ...
                                <div class='col-sm-8 controls'>
                                    <input type="text" name="tour_region" id="tour_region"
                                           ...
                                           class='form-control add_pckg_elements' required value="<?php echo string_replace_encode($tour_region_details[0]['name']);?>">
                                </div>
                            </div>
                            ...
                            <div class='' style='margin-bottom: 0'>
                                <div class='row'>
                                    <div class='col-sm-9 col-sm-offset-3'>  
                                        <input type="hidden" name="id" value="<?= $tour_region_details[0]['id'] ?>">                       
                                        <button class='btn btn-primary' type='submit'>Save</button>
                                        <a href="<?php echo base_url(); ?>index.php/tours/tour_region" class='btn btn-primary' style="color:white;">Package Region</a>
