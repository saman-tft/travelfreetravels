                                            ...
                                            foreach ($tour_visited_cities as $tvcKey => $tvcValue) {
                                                ...
                                                for ($i = 0; $i < $tvcValue['no_of_nights']; $i++) {
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8 controls">
                                                            <textarea name="program_des[<?= $id?>][]" data-rule-required="true" class="form-control ckeditor" data-rule-required="true" cols="70" rows="5" placeholder="Description"><?=string_replace_encode($itinerary[$i]['program_des']) ?></textarea>
                                                        </div>
                                                    </div>
                                                    <!-- <div class="form-group">
                                                ...
                                                <div class='row'>
                                                    <div class='col-sm-9 col-sm-offset-3'>
                                                        ...
                                                        if($this->session->userdata('edit_itinary')){
                                                            ?>
                                                            <a class="btn btn-primary" href="<?=base_url()?>index.php/tours/tour_list">Go Back to Holiday List </a>
                                                            <?php 
                                                        }
                                                        ?>
