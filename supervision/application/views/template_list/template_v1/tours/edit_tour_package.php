			...
			<div class="panel-title">
				<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
					...
					<li role="presentation" class="active" id="add_package_li"><a
						...
						data-toggle="tab">Update Tour  Manager </a></li>					
				</ul>
			</div>
		</div>
		<!-- PANEL HEAD START -->
		<div class="panel-body">
			<!-- PANEL BODY STARTonsubmit="return validation();" -->
			<form
				...
				class='form form-horizontal validate-form'>
						    <div class='form-group'>
								<label class='control-label col-sm-3' for='validation_current'>Tour ID
								</label>
							...
							<div class='form-group'>
								...
								<input type="hidden" name="package_name_org" id="package_name_org" value="<?=string_replace_encode($tour_data['package_name'])?>" >
							</div>
							<div class='form-group'>
							...
							<div class='form-group ' id="select_date">
								<label class='control-label col-sm-3' for='validation_current'>Start Date 132 <span style = "color:red">*</span>
								</label>
								<div class='col-sm-4 controls'>
								<input type="text" name="tour_start_date" id="tour_start_date" class="form-control" value="<?=string_replace_encode($tour_data['start_date'])?>" placeholder="Choose Date" data-rule-required='true'  readonly> 
								</div>
							</div>
							<div class='form-group ' id="select_date">
 ...
 -->
 						...
 						<!-- 	<div class='form-group'>
							...
							<div class='form-group'>
								...
								<div class='col-sm-4 controls'>
								<select class='select2 form-control' name='tours_continent' id="tours_continent"  disabled>
       ...
       <?php */ ?>
         ...
         ?>
						   ...
						   <!-- <div class='form-group'>
								...
								<div class="org_row">
								<div class='col-sm-6'>
								<input class='form-control numeric'  name='sim_quantity' id="sim_quantity" required type="number"  min="1" max="99" value="<?=$tour_data['sim_quantity']?>" />
							 ...
							 <div class='form-group'>
								...
								<div class='col-sm-12'>
								 <select name="sim_type" class="form-group" id="sim_type" onchange="return sim_price_check();">
								 	...
								 	<option value="Paid" selected>Paid Sim</option>
								 		';
								 	}
							...
							<div class='form-group' style="display: none;" id="sim_price_div">
								...
								<div class="org_row">
								<div class='col-sm-6'>
								<input class='form-control'  name='sim_price' id="sim_price" required type="text"  value="0.00" />                                                          
								<input class='form-control numeric'  name='sim_quantity' id="sim_quantity"  value="0" /> 
								<input class='form-control numeric'  name='sim_type'  value="0" /> 
						    ...
						    <div class="form-group">
								...
								<div class="col-sm-8 controls">
								<textarea name="highlights" class="form-control ckeditor" cols="70" rows="5" placeholder="Tour Highlights"><?=string_replace_encode($tour_data['highlights'])?></textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-8 controls">
								<textarea name="inclusions" class="form-control ckeditor" cols="70" rows="5" placeholder="Tour Inclusions"><?=string_replace_encode($tour_data['inclusions'])?></textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-8 controls">
								<textarea name="exclusions" class="form-control ckeditor" cols="70" rows="5" placeholder="Tour Exclusions"><?=string_replace_encode($tour_data['exclusions'])?></textarea>
								</div>
							</div>
							<div class="form-group">
								<label class="control-label col-sm-3" for="validation_current">Terms & Conditions
								</label>
								<div class="col-sm-8 controls">Inclusions
								<textarea name="terms" class="form-control ckeditor" cols="70" rows="5" placeholder="Terms & Conditions"><?=string_replace_encode($tour_data['terms'])?></textarea>
								</div>
							</div>	

								<div class="form-group">
								<label class="control-label col-sm-3" for="validation_current">Optional Tours
								</label>
								<div class="col-sm-8 controls">
								<textarea name="optional_tours" class="form-control ckeditor" cols="70" rows="5" placeholder="Optional Tours"><?=string_replace_encode($tour_data['optional_tours'])?></textarea>
								</div>
							</div>	
        ...
        <div class="col-sm-8 controls">
        <textarea name="canc_policy" class="form-control ckeditor" cols="70" rows="5" placeholder="Cancellation Policy"><?=string_replace_encode($tour_data['canc_policy'])?></textarea>
        </div>
       </div>
       <div class="form-group">
								...
								<div class="col-sm-8 controls">
								<textarea name="trip_notes" class="form-control ckeditor" cols="70" rows="5" placeholder="Trip Notes"><?=string_replace_encode($tour_data['trip_notes'])?></textarea>
								</div>
							</div>	
							...
							<div class='form-group'>
                                ...
                                <div class='col-sm-4 controls'>
                                       <input type="checkbox" name="inclusions_checks[]" value="Hotel" <?php if(in_array('Hotel',$inclusions_checks)){ echo 'checked';}?> >  Hotel  <br>  
                                       <input type="checkbox" name="inclusions_checks[]" value="Flight" <?php if(in_array('Flight',$inclusions_checks)){ echo 'checked';}?> >  Flight  <br> 
                                             <input type="checkbox" name="inclusions_checks[]" value="accomodation" <?php if(in_array('accomodation',$inclusions_checks)){ echo 'checked';}?> >  accomodation  <br>
                                               <input type="checkbox" name="inclusions_checks[]" value="Park Fees" <?php if(in_array('Park Fees',$inclusions_checks)){ echo 'checked';}?> >  Park Fees  <br> 
                                                <input type="checkbox" name="inclusions_checks[]" value="Game Drives" <?php if(in_array('Game Drives',$inclusions_checks)){ echo 'checked';}?> >  Game Drives  <br> 
...
echo '<img class="banner_imgs" src="'.$this->template->domain_images( $tour_data['banner_image']) . '" style="width:100%">';
}
?>										
                                </div>
                            </div>
                            ...
                            <div class='form-group'>
                                <label class='control-label col-sm-3' for='validation_current'>Video
                                </label>
                                <div class='col-sm-9 controls'>
                                    <?php
                                    $gallery = $tour_data['video'];
                                    ...
                                    for ($g = 0; $explode[$g] != ''; $g++) {
                                      ...
                                      //  debug($tour_data); exit();
                                        //$path = $this->template->domain_image_upload_path().$explode[$g];
                                        $galleryImages .= '<td id = "gal_img'.$g.'"> <a href = "javascript:void(0)" onclick="deletevideo('.$tour_data['id'].',\''.$explode[$g].'\',\'gal_img'.$g.'\')">X</a> &nbsp;&nbsp; <video width="320" height="240" controls class="gal_img" >
                                        	<source src="'.$this->template->domain_images( $explode[$g] )  . '" >
                            ...
                            <div class='form-group'>
                                ...
                                <div class='col-sm-4 controls'>
                                    <input type="file" name="video[]" id="video" multiple class='form-control'>	
...
function deletevideo(image_id,image_name,tag_id)
    {
      var image_id = image_id;
      var image_name = image_name;
  // alert(image_name);
  ...
  if (answer)
  {
    $.ajax({
      type: "POST",
      url: "<?php echo site_url('tours/tours_delete_video_id');?>",
      data: {"image_id" : image_id , "image_name" : image_name},
      success: function (response) {
        if (response == 1) {
                    // $(".imagelocation"+image_id).remove(".imagelocation"+image_id);
