                            ...
                            <div class='form-group'>
                                ...
                                <div class='col-sm-8 controls'>
                                    <input type="text" name="tour_subtheme" id="tour_subtheme"
                                           ...
                                           class='form-control add_pckg_elements' required value="<?php echo string_replace_encode($tour_subtheme_details[0]['tour_subtheme']);?>">
                                    <input type="hidden" name="tour_subtheme_org" id="tour_subtheme_org"
                                           placeholder="" data-rule-required='true'
                                           class='form-control add_pckg_elements' required value="<?php echo string_replace_encode($tour_subtheme_details[0]['tour_subtheme']);?>">
                                </div>
                            </div>
                            ...
                            <div class='' style='margin-bottom: 0'>
                                <div class='row'>
                                    <div class='col-sm-9 col-sm-offset-3'>  
                                        <input type="hidden" name="id" value="<?= $tour_subtheme_details[0]['id'] ?>">                       
