            ...
            <div class="panel-title">
                <ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
                    ...
                    <li role="presentation" class="active" id="add_package_li"><a
                            ...
                            data-toggle="tab">Edit Holiday Package Theme </a></li>			
                </ul>
            </div>
        </div>
        <!-- PANEL HEAD START -->
                    ...
                    <div role="tabpanel" class="tab-pane active" id="add_package">
                        <div class="col-md-12">
                            ...
                            <div class='form-group'>
                                <label class='control-label col-sm-3' for='validation_current'>Holiday Package Theme
                                </label>
                            ...
                            <div class='' style='margin-bottom: 0'>
                                <div class='row'>
                                    <div class='col-sm-9 col-sm-offset-3'>	
                                        ...
                                        <a href="<?php echo base_url(); ?>index.php/tours/tour_type" class='btn btn-primary' style="color:white;">Package Theme</a>
