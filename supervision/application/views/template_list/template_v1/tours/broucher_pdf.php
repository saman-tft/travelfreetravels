...
//$mascot = $this->template->template_images('mascot.png');
 ...
 // $data1 = json_decode($booking_details['attributes']);
 // debug($data);exit();
      ...
      <tr style="border-bottom:3px solid #b2b2b2;">
        ...
        <td style="">
         <span style="width:100%; float:left">
          <img  style="width:100%; height: 250px; max-width: 580px !important" src="<?=$this->template->domain_images($tour_data[0]->banner_image);?>" alt="img" /></span>
      ...
      <tr>
        <td style="padding-left:50px">
          <h2 style="margin:15px 0 0;font-size: 16.5px; text-decoration: underline; line-height:20px; font-weight:600">
            ...
            <b>Package Name:</b> <?=$tour_data[0]->package_name; ?></h2>
