			...
			<div class="panel-title">
				<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
					...
					<li role="presentation" class="active" id="add_package_li"><a
						...
						data-toggle="tab">Tour Descriptions [ Tour Name : <?=string_replace_encode($tour_data['package_name'])?> ]</a></li>
					...
					<div role="tabpanel" class="tab-pane active" id="add_package">
						   ...
						   <!--div class='form-group'>
							...
							<div class="form-group">
								...
								<div class="col-sm-8 controls">
								<textarea name="inclusions" class="form-control ckeditor" cols="70" rows="5" placeholder="Tour Inclusions" id="inclusions"><?=string_replace_encode($tour_data['inclusions'])?></textarea>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-8 controls">
								<textarea name="terms" class="form-control ckeditor" cols="70" rows="5" placeholder="Terms & Conditions"><?=string_replace_encode($terms_n_Conditions[0]['terms_n_conditions'])?></textarea>
								</div>
							</div>
								<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-8 controls">
								<textarea name="canc_policy" class="form-control ckeditor" cols="70" rows="5" placeholder="Cancellation Policy"><?=string_replace_encode($tour_data['terms'])?></textarea>
								</div>
							</div>	
							<div class="form-group">
						    ...
						    <div class='' style='margin-bottom: 0'>
								<div class='row'>
									<div class='col-sm-9 col-sm-offset-3'>	
										...
										<button class='btn btn-primary' type="submit" id="subbtn">Save</button>
									</div>
								</div>
							</div> 
						</div>							
...
<script type="text/javascript">
     $(document).ready(function()
     {
     	 ...
     	 /* $('#subbtn').on('click', function() {
     	  	...
     	  	var inclusions=$("#inclusions iframe").contents().find("body").text();
     	  	alert(inclusions);
     	  });*/
