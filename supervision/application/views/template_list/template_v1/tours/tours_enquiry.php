           ...
           <span>Duration : &nbsp;</span><span>'.$data['durations'].'</span><br/>';
                            ...
                            if($data["agent_remark"]!="" || $data["created_by_name"]!=""){
                                ...
                                if($data["agent_remark"]){
                                    ...
                                    $paxhtml .='<div class="col-md-4"><strong>Agent Remark</strong></div>';
            ...
            <div class="modal-footer">
             <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        ...
                        if(!empty($data['tour_id'])){
                            $package_str = '<a  target="_blank" href="'.base_url().'index.php/tours/voucher/'.$data['tour_id'].'">'.$TOUR_LIST[$data['tour_id']].'</a>';
