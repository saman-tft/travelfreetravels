						    ...
						    <ul class="dropdown-menu sidedis" style="display: none;left: 30px;">
											...
											<a class="sideicbb3 sidedis" data-placement="top"
											 ...
											 <!-- <a class="" data-placement="top" title=""
												href="<?php echo base_url(); ?>index.php/transfers/edit_itinerary/<?php echo $data->id; ?>"
												data-original-title="Edit Itinerary"> <i
													class="glyphicon glyphicon-pencil "></i> Edit Itinerary
											</a><br> <a class='' data-placement='top'
												title='Change Images'
												href='<?php echo base_url(); ?>index.php/transfers/images/<?=$data->id;?>/w'>
													<i class='glyphicon glyphicon-th-large'></i> Edit
													Images
											</a>&nbsp; --><!-- <li><a class="sideicbb4 sidedis" data-placement="top" title=""
												href="<?php echo base_url(); ?>index.php/transfers/view_enquiries/<?php echo $data->id; ?>/w"
