									...
									<div class='' style='margin-bottom: 0;'>
										<div class='box-content'>
											<form class='form form-horizontal validate-form'
												...
												action="<?php echo base_url(); ?>index.php/transfers/add_transfer_vehicle/<?php echo $data->id;?>"
												...
												<div class='form-group'>
													...
													<div class='col-sm-4 controls'>
														<input type="text" name="vehicle_name" id="vehicle_name"
															data-rule-number='true' data-rule-required='true'
															class='form-control'
															value="<?php echo $data->vehicle_name;?>">
													</div>
												</div>
												...
												<div class='form-group'>
													...
													<div class='col-sm-3 controls'>
														<input type="file" title='Image to add to add' class=''
															id='vehicle_image' name='vehicle_image' onchange="showMyImage(this)">
														<input type="hidden"
															name='vehicle_image' value="<?php echo $data->vehicle_image; ?>">
															<?php 
														...
														<img id="thumbnil" <?=$style?>
															src="<?php echo $path.$data->vehicle_image; ?>" name="photo">
													</div>
												</div>
												...
												<div class='form-group'>
													...
													<div class='col-sm-4 controls'>
			                                            <?php $Equipment = $this->db->get_where('add_equipment', array('status' => 1))->result_array();  
			                                            	$equipment_data = json_decode($data->equipment);
												...
												<div class='form-group'>
													...
													<div class='col-sm-4 controls'>
														<input type="text" name="max_passenger" id="max_passenger"
															data-rule-number='true' data-rule-required='true'
															class='form-control'
															value="<?php echo $data->max_passenger;?>">
													</div>
												</div>
												...
												<div class='form-group'>
													...
													<div class='col-sm-4 controls'>
														<input type="text" name="max_luggage" id="max_luggage"
															data-rule-number='true' data-rule-required='true'
															class='form-control'
															value="<?php echo $data->max_luggage;?>">
													</div>
												</div>
												...
												<div class='form-group'>
													...
													<div class='form-group'>
													<label class='control-label col-sm-3'
														for='validation_includes'>Transmission </label>
													<div class='col-sm-4 controls'>
													<?php 
													    $trans='';
													...
													?>
														<select name="transmission" class='form-control'>
															...
															<option value="1" <?php if($trans == '1')echo 'selected';?>>AutoMatic Transmission</option>
															<option value="2" <?php if($trans == '2')echo 'selected';?>>Manual Transmission</option>
														</select>
													</div>
												</div>
												...
												<div class='form-group'>
													...
													<div class='col-sm-4 controls'>
														<input type="text" name="engine_number" id=""
															data-rule-number='true' data-rule-required='true'
															class='form-control'
															value="<?php echo $data->engine_number;?>">
													</div>
												</div>
												...
												<div class='form-group'>
													...
													<div class='col-sm-4 controls'>
														<input type="text" name="mileage" id=""
															data-rule-number='true' data-rule-required='true'
															class='form-control'
															value="<?php echo $data->mileage;?>">
													</div>
												</div>

												<div class='form-group'>
													<label class='control-label col-sm-3'
														for='validation_includes'>Fuel Type </label>
													<div class='col-sm-4 controls'>
														<input type="text" name="fuel_type" id=""
															data-rule-number='true' data-rule-required='true'
															class='form-control'
															value="<?php echo $data->fuel_type;?>">
													</div>
												</div>

												<div class='form-group'>
													<label class='control-label col-sm-3'
														for='validation_includes'>Emision </label>
													<div class='col-sm-4 controls'>
														<input type="text" name="emision" id=""
															data-rule-number='true' data-rule-required='true'
															class='form-control'
															value="<?php echo $data->emision;?>">
													</div>
												</div>
												...
												<div class='form-group'>
													...
													<div class='col-sm-4 controls'>
														<input type="text" name="insurance_company" id=""
															data-rule-number='true' data-rule-required='true'
															class='form-control'
												...
												<div class='form-group'>
													...
													<div class='col-sm-4 controls'>
														<input type="text" name="insurance_begin_date" id="insurance_start_date"
															data-rule-number='true' data-rule-required='true'
															class='form-control'
															value="<?php echo $data->insurance_begin_date;?>">
													</div>
												</div>
												...
												<div class='form-group'>
													...
													<div class='col-sm-4 controls'>
														<input type="text" name="insurance_end_date" id="insurance_expire_date"
															data-rule-number='true' data-rule-required='true'
															class='form-control'
															value="<?php echo $data->insurance_end_date;?>">
													</div>
												</div>
								...
								<div class='form-actions' style='margin-bottom: 0'>
									<div class='row'>
										<div class='col-sm-9 col-sm-offset-3 bbh'>
											<a href="<?php echo base_url(); ?>transfers/view_vehicle_list">
