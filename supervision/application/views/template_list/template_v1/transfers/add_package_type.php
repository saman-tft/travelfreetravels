								...
								<div class=''>
									...
									<div class=''>
										<form class='form form-horizontal validate-form'
											...
											action="<?php echo base_url(); ?>index.php/transfers/save_packages_type"
											method="post" name="frm1" enctype="multipart/form-data">
											<div class='form-group'>
												<label class='control-label col-sm-2' for='validation_name'>Transfer
													Type</label>
												<div class='col-sm-3 controls'>
													<input type="hidden" name="package_types_id"
														value="<?=@$pack_data[0]->package_types_id;?>"> <input
														class='form-control' data-rule-minlength='2'
														data-rule-required='true' id='pname' name='name'
														value="<?=@$pack_data[0]->package_types_name;?>"
														placeholder='Transfer Type' type='text' required> <span id="pacname"
											...
											<div class='form-actions' style='margin-bottom: 0'>
												<div class='row'>
													<div class='col-sm-9 col-sm-offset-2'>
														<a
															href="<?php echo base_url(); ?>index.php/transfers/view_packages_types">
