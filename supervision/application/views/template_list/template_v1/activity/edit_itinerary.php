				...
				<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
					...
					<li role="presentation" class="active"><a href="#fromList"
						aria-controls="home" role="tab" data-toggle="tab">
							<h1>Update Excursion Itinerary</h1>
					</a></li>
								...
								<div class='col-sm-12'>
									<div class='' style='margin-bottom: 0;'>
										<form class='form form-horizontal validate-form'
											...
											action="<?php echo base_url(); ?>activity/update_itinerary/"
											...
											<div class="duration_info" id="duration_info">
												...
												<div class='form-group'>
													...
													<div class='col-sm-3 controls'>
														<input type="file" multiple='multiple' title='Image to add' class=''
															id='image' name='imagelable<?php echo $i; ?>'> <span
															id="pacmimg" style="color: #F00; display: none">Please
															Upload Itinerary Image</span> <img
															src="<?php echo $GLOBALS['CI']->template->domain_upload_acty_images(basename($packdata->itinerary_image)); ?>"
												...
												<div class='row'>
													<div class='col-sm-9 col-sm-offset-3'>
														<?php 
																...
																?>
														<a
															href="<?php echo base_url(); ?>activity/<?=$view_name?>">
