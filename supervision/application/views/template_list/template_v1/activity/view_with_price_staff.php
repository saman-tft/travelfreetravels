                                             ...
                                             <td class="center">
                                              <div class="dropdown2" role="group">
                                               <div class="dropdown slct_tbl pull-left sideicbb">
                                                ...
                                                title=""
                                                href="<?php echo base_url(); ?>index.php/activity/view_activity_details/<?php echo $package->package_id; ?>/staff"
                                                data-original-title="View Package"> <i
                                                class="fa fa-eye"></i> View
                                                </a></li>
                                                  <li> <a class="sideicbb1 sidedis" data-placement="top"
                                                title=""
                                                href="<?php echo base_url(); ?>index.php/activity/edit_with_price/<?php echo $package->package_id; ?>/staff"
