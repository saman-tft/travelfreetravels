<?php
	...
	$activity_details = $data['activity_info'];
	extract($booking_details);
	extract($activity_details);
    ...
    $travel_date = explode("|",$travel_date);
   	$path = $GLOBALS['CI']->template->domain_upload_acty_images();
	// debug ($activity_details); exit;
...
<div class="search-result">
	...
	<div class="bakrd_color">
		...
		<div class="cancellation_page">
					...
					<div class="bookcol">
						<div class="hotelistrowhtl">
							<div class="col-md-4 nopad">
								<div class="imagehotel"><img src="<?php echo $path.$activity_details->image; ?>" alt="ProductImage"></div>
							</div>
							<div class="col-md-8 padall10 ">
								<div class="hotelhed"><?=$activity_details->package_name?></div>
								<div class="clearfix"></div>
								<div class="bokratinghotl rating-no">
								<?=print_star_rating($activity_details->rating)?>
								</div>
								<div class="clearfix"></div>
								<div class="mensionspl"> <?=$activity_details->package_city?> </div>

								<div class="sckint">
						<div class="">
							<div class="borddo brdrit"> <span class="lblbk_book">
							<span class="fa fa-calendar"></span> Travel Date</span>
								<div class="fuldate_book"> <span class="bigdate_book"><?=app_friendly_absolute_date($date_of_travel)?></span>
						...
						<div class="clearfix"></div>
						<div class="nigthcunt">Total Pax:<?=$booking_details['customer_details'][0]['adult']+$booking_details['customer_details'][0]['child']?></div>
					</div>
			...
			<div class="clearfix"></div>
			<?php if($booking_details['cancltnPlcy_avble']):?>
			<div>
				<h5>Cancellation Policy</h5>
				<p><?php echo $booking_details['cancellationPolicy']?></p>
			</div>
			<div class="clearfix"></div>
			<!-- Cancellation Start-->
			...
			<div class="col-xs-6 nopad">
				<div class="btn_continue">
					<div class="amnt_disply">
						...
						echo roundoff_number($booking_details['basic_fare']+$booking_details['admin_markup']+$booking_details['gst_percentage']+$booking_details['convenience_fee']);
							// if($module=='b2b'){
							// 	echo $grand_total;
							// }else{
			 ...
			 ?>
			 <?php if($booking_details['cancltnPlcy_avble']==1):?>
			 <div class="col-xs-6 nopad">
					<div class="btn_continue">
  ...
  <div class="modal-dialog">
	<div class="modal-content">
	  ...
	  <div class="modal-footer">
		...
		<form method="get" action="<?=base_url().'index.php/activity/cancel_full_booking/'.$app_reference.'/'.$booking_source?>">
