            ...
            <ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
               ...
               <li role="presentation" class="active">
                  <a href="#fromList"
                     ...
                     <h1>View Supplier Excursions</h1>
                  </a>
               </li>
                                       ...
                                       <tbody>
                                             ...
                                             <td class="center">
                                              <div class="dropdown2" role="group">
                                               <div class="dropdown slct_tbl pull-left sideicbb">
                                                ...
                                                title=""
                                                href="<?php echo base_url(); ?>index.php/activity/view_activity_details/<?php echo $package->package_id; ?>/supplier"
                                                data-original-title="View Package"> <i
                                                class="fa fa-eye"></i> View
                                                </a></li>
                                                  <li> <a class="sideicbb1 sidedis" data-placement="top"
                                                title=""
                                                href="<?php echo base_url(); ?>index.php/activity/edit_with_price/<?php echo $package->package_id; ?>/supplier"
                                          ...
                                          <?php
                                           ...
                                           ?>
                                             ...
                                             <td>
                                                <select class="change_publish_status"   data-id="<?php echo $package->package_id; ?>">
                                             ...
                                             <td>
                                                <select class="published_status_approve"   data-id="<?php echo $package->package_id; ?>" >
                                                   <option value="1" <?=$package->approval_status==1 ? "selected" : ""?>>Approve</option>
                                                   <option value="0"  <?=$package->approval_status==0 ? "selected" : ""?>>Pending</option>
                                                   <option value="2" <?=$package->approval_status==2 ? "selected" : ""?>>Reject</option>
                                                </select>
                                             </td>
...
$(".change_publish_status").change(function(){


   var id = $(this).data('id')
   var status = $(this).val()
   var url="<?php echo base_url().'index.php/activity/change_publish_status'; ?>" ;
   $.ajax({
       url :url,
       type: 'POST',
       data: {id,status},
...
$(".published_status_approve").change(function(){


   var id = $(this).data('id')
   var status = $(this).val()
   var url="<?php echo base_url().'index.php/activity/published_status_approve'; ?>" ;
   $.ajax({
       url :url,
       type: 'POST',
       data: {id,status},
