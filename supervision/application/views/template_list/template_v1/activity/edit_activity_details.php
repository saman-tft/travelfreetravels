...
$( ".dates_div" ).each(function() {
  ...
  nationality_price +=`<th>Nationality</th>`;
        ...
        nationality_price +=`<td><div class='form-group senior_price_div' `+shw_hid_senior+`>
                ...
                <div class='col-sm-12'>
                    ...
                    data-rule-required='true' name="nationality1[`+k+`]" id="nationality`+k+`[`+id+`]"  required> 
                    
                    <option value='0'>Select Nationality Group</option>
                    <?php
                    foreach ($nationality_group as $coun) {
                                  if($coun->origin==$activity_price[$i]['nationality_id']){
                                    $selected = 'selected';
                                  }else{
                                    $selected = '';
                                  }
                                  ?>
                                     ...
                                     nationality_price +="<option value='<?=$coun->origin?>' <?=$selected?> ><?=$coun->name?></option>";
                            <?php
                               }
                               ?>
                    </select>
...
function add_nationality_price(id,shw_hid_adult,shw_hid_child,shw_hid_infant,shw_hid_senior){
       ...
       trans_ary [i] =  $(this).val();
        i++;
          ...
          $('.nationality_option_cls_'+id).each(function(e) {
       trans_ary [i] =  $(this).val();
        i++;
    });
     var options = '';
