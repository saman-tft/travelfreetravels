...
<div id="Package" class="bodyContent col-md-12">
    <div class="panel panel-default">
            ...
            <div class="panel-title">
                <ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
                    ...
                    <li role="presentation" class="active" id="add_package_li"><a
                            ...
                            data-toggle="tab">Edit Excursion Theme  </a></li>          
                </ul>
            </div>
        </div>
        <!-- PANEL HEAD START -->
        <div class="panel-body">
            <!-- PANEL BODY START -->
            <form
                action="<?php echo base_url(); ?>index.php/activity/edit_activity_subtheme_save"
                            ...
                            <div class='form-group'>
                                ...
                                <div class='col-sm-8 controls'>
                                    <input type="text" name="activity_subtheme" id="activity_subtheme"
                                           ...
                                           class='form-control add_pckg_elements' required value="<?php echo string_replace_encode($activity_subtheme_details['activity_subtheme']);?>">
                                </div>
                            </div>
                            ...
                            <div class='' style='margin-bottom: 0'>
                                <div class='row'>
                                    <div class='col-sm-9 col-sm-offset-3'>  
                                        <input type="hidden" name="id" value="<?= $activity_subtheme_details['id'] ?>">                       
