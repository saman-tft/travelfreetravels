          ...
          <div class='col-sm-12'>
            ...
            <div class='box'>
              ...
              <div class='box-content'>
                ...
                <form action="<?php echo base_url(); ?>index.php/activity/add_package_new" method="post"  enctype="multipart/form-data" class='form form-horizontal validate-form'>
                ...
                <div class='form-group'>
                  ...
                  <label class='control-label col-sm-3'>Minimum Pax <span style = "color:red">*</span></label>

                  <div class='col-sm-1 controls'>

                    <input type="number" placeholder="Enter Minimum Pax" name="min_pax" min="0" class='form-control add_pckg_elements' required value="2">
                ...
                <div class="form-group clearfix cutoff">

                  <label class="control-label col-sm-3">Type Of Tour</label>

                  <div class='col-sm-6 col-md-6 controls'>

                    <span><input type="checkbox" name="half_day" value="H" id="repeat_sight" class="subject-list">Half Day</span>

                    <span><input type="checkbox" name="full_day" value="F"  class="day subject-list" >Full Day</span>

                    <span><input type="checkbox" name="night" value="N"   class="subject-list day">Night</span>

                    <div class="repeat_session" style="display: none;">

                      <span><input type="checkbox" name="morning" value="M" class="subject-list1" >Morning</span>

                      <span><input type="checkbox" name="evening" value="E" class="subject-list1">After Noon</span>
              ...
              <a href="<?php echo base_url(); ?>add_with_price/view_with_price"><button class='btn btn-primary' type='button'>
   ...
   myid=$("input[type='text']#"+current_id).attr('myid');
    ...
    $('#validation_country').on('change', function(){
        ...
        $.ajax({
            ...
            url: "<?php echo base_url(); ?>add_with_price/get_cities/"+country,
