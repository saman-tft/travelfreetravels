...
<div id="general_user" class="bodyContent clearfix">
	<div class="panel panel-default clearfix"><!-- PANEL WRAP START -->
		...
		<?php
			...
			if($dd=="b2b_credit_request")
			{
				?>
				<a href="<?php echo base_url(); ?>index.php/management/export_all_credit_request/excel<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>" class="btn btn-success">Export All credit request</a>
		...
		?>
		<a href="<?php echo base_url(); ?>index.php/management/export_all_balance_manager/excel<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>" class="btn btn-success">Export All balance manager</a>
		<?php
		}
