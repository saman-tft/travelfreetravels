	...
	<div class="panel panel-default clearfix"><!-- PANEL WRAP START -->
		<?php if(valid_array($agent_details) == true){ ?>
			...
			<div class="panel-body"><!-- PANEL BODY START -->
				...
				<a href="<?php echo base_url(); ?>index.php/management/export_account_ledger/excel<?= !empty($_SERVER["QUERY_STRING"])?'?'.$_SERVER["QUERY_STRING"]:''?>" class="btn btn-success">All Invoice download</a>
