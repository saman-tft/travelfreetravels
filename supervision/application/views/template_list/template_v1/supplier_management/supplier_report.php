...
$this->current_page->auto_adjust_datepicker ( array (
        ...
        <table class="table table-condensed table-bordered" id="holiday_table">
          ...
          echo $packagehtml;
                ...
                <tr>
                    ...
                    <td><?=app_friendly_absolute_date($attributes['departure_date'])?></td>
                    ...
                    <td>
                        ...
                        <?=$data['booking_details']['basic_fare'].' '.$data['booking_details']['currency_code']?></td>
                    <td>
  ...
  $currency_symbol = $currency_obj->get_currency_symbol($currency_obj->to_currency);
                        ...
                        <?=get_converted_currency_value($currency_obj->force_currency_conversion($data['booking_details']['basic_fare'])).' '.$currency_symbol?></td>
                    <td>
                      <?php
  ...
  $currency_symbol = $currency_obj->get_currency_symbol($currency_obj->to_currency);
                        ...
                        <?=get_converted_currency_value($currency_obj->force_currency_conversion($data['booking_details']['basic_fare'])),' '.$currency_symbol?>   
                      
                     </td>
                    
                    <td>
                        
                        <?=changeDateFormat($data['booking_details']['booked_datetime']) ?></td>
