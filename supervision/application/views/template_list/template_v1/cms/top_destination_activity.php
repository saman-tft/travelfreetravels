                     ...
                     <div class="form-group">
						...
						<div class="col-sm-6">
							<select id="nationality" name="nationality" class="form-control" required="">
								<option value="INVALIDIP">Please Nationality</option>
...
<a>Edit</a>
							<?php echo get_status_label($v['top_destination_activity']).get_status_toggle_button($v['top_destination_activity'], $v['origin']) ?></td>
					</tr>
				<?php
					endforeach;
				} else {
...
{
	if (intval($home_status) == ACTIVE) {
		return '<a role="button" href="'.base_url().'index.php/cms/deactivate_top_destination_activity_home/'.$origin.'" class="text-danger">Deactivate</a>';
	} else {
		return '<a role="button" href="'.base_url().'index.php/cms/activate_top_destination_activity_home/'.$origin.'" class="text-success">Activate</a>';
	}
}
