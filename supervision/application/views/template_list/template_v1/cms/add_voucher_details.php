<?php
   ...
   // debug($get_data);exit;
 	if(isset($get_data) && valid_array($get_data)){
 		$action = base_url().'index.php/cms/add_voucher_content';
 	}
 	else{
 		$action = base_url().'index.php/cms/add_voucher_content';
 	}
      ...
      <div class="panel-body">
         <form class="form-horizontal" role="form" enctype="multipart/form-data" method="POST" action="<?= $action; ?>" autocomplete="off" name="home_page_heading">
            <fieldset form="promo_codes_form_edit">
               <legend class="form_legend">Add Voucher Content</legend>
               <div class="form-group">
                  <label form="promo_codes_form_edit" for="header_title" class="col-sm-3 control-label">Note</label>
                  	<div class="col-sm-6">
                  		<textarea class="form-control" rows ="6" value="" cols="100" name="note" required><?php echo @$note;?></textarea>
                ...
                <div class="form-group">
                  <label form="promo_codes_form_edit" for="phone" class="col-sm-3 control-label">Phone Number</label>
                     <div class="col-sm-6">
