	...
	<div class="panel <?=PANEL_WRAPPER?>"><!-- PANEL WRAP START -->
		...
		<div class="panel-body"><!-- PANEL BODY START -->
			<fieldset><legend><i class="fa fa-hotel"></i> City List</legend>
				<form action="/supervision/index.php/cms/car_inner_top_destinations" enctype="multipart/form-data" class="form-horizontal" method="POST" autocomplete="off">
			...
			<table class="table table-condensed">
				...
				?>
					<tr>
						...
						<td><?php echo get_status_label($v['car_inner_top_destination']).get_status_toggle_button($v['car_inner_top_destination'], $v['origin']) ?></td>
					</tr>
				<?php
					endforeach;
				} else {
