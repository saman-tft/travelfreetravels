            ...
            <fieldset form="promo_codes_form_edit">
               ...
               <div class="form-group">
                  <label form="promo_codes_form_edit" for="header_title" class="col-sm-3 control-label">Title</label>
                  	<div class="col-sm-6">
                  		<input type="text"  id="header_title" class="form-control" placeholder="Title" name="header_title" value="<?php echo @$title?>" required maxlength="145">
                  	</div>
               </div>
              	<div class="form-group">
                  <label form="promo_codes_form_edit" for="header_icon" class="col-sm-3 control-label">Description</label>
                  	<div class="col-sm-6">
                  		<input type="text"  id="header_icon" class="form-control" placeholder="Description" name="header_icon" value="<?php echo @$icon?>" required maxlength="145">
                  	</div>
               </div>
              </fieldset>
            <div class="form-group">
