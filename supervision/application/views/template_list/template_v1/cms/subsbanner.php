	...
	<div class="panel <?=PANEL_WRAPPER?>"><!-- PANEL WRAP START -->
		<div class="panel-heading"><!-- PANEL HEAD START -->
			...
			<div class="panel-title">
				<i class="fa fa-edit"></i> Subscription Banner 
			</div>
			...
			<span style="color:#dd4b39"><?php if(isset($message)){ echo $message; } ?></span>
				<form action="<?=$_SERVER['PHP_SELF']?>" enctype="multipart/form-data" class="form-horizontal" method="POST" autocomplete="off">
					...
					<div class="form-group">
						<label form="user" for="title" class="col-sm-3 control-label"><span class="">Subscription  Text  </span></label>
						<div class="col-sm-5">
					...
					<div class="form-group">
						<label form="user" for="title" class="col-sm-3 control-label"><span class=""> youtube ID </span></label>
						<div class="col-sm-5">
						<input type="text" autocomplete="off" name="link" class="normalinput auto-focus valid_class  form-control b-r-0" id="to" placeholder="youtube ID" value="" required />
					...
					<div class="form-group">
						<label form="user" for="title" class="col-sm-3 control-label"> Subscribe Image<span class="text-danger">*</span></label>
						<div class="col-sm-6">
			...
			<table class="table table-condensed">
				...
				?>
					<tr>
						...
						<a role="button" href="<?php echo base_url() ?>index.php/cms/delete_subs/<?php echo $v['id'] ?>"><button class="btn btn-sm">Delete</button></a>
