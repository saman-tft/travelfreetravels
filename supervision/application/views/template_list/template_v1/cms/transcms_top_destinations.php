	...
	<div class="panel <?=PANEL_WRAPPER?>"><!-- PANEL WRAP START -->
		<div class="panel-heading"><!-- PANEL HEAD START -->
			...
			<div class="panel-title">
				<i class="fa fa-edit"></i> Top Destinations In Transfer
			</div>
...
<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						 <input type="text" autocomplete="off" name="from_airport" class="normalinput auto-focus valid_class fromflight form-control b-r-0" id="from" placeholder="Type Departure City" value="" required />
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
						 <input type="text" autocomplete="off" name="to_airport" class="normalinput auto-focus valid_class departflight form-control b-r-0" id="to" placeholder="Type Departure City" value="" required />
			...
			<table class="table table-condensed">
				...
				?>
					<tr>
						...
						<a role="button" href="<?php echo base_url() ?>index.php/cms/delete_transfercms_top_destination/<?php echo $v['origin'] ?>"><button class="btn btn-sm">Delete</button></a>
...
{
	if (intval($status) == ACTIVE) {
		return '<a role="button" href="'.base_url().'index.php/cms/deactivate_transfercms_top_destination/'.$origin.'" class="text-danger">Deactivate</a>';
	} else {
		return '<a role="button" href="'.base_url().'index.php/cms/activate_transfercms_top_destination/'.$origin.'" class="text-success">Activate</a>';
	}
}
...
{
	if (intval($home_status) == ACTIVE) {
		return '<a role="button" href="'.base_url().'index.php/cms/deactivate_transfercms_top_destination_home/'.$origin.'" class="text-danger">Deactivate</a>';
	} else {
		return '<a role="button" href="'.base_url().'index.php/cms/activate_transfercms_top_destination_home/'.$origin.'" class="text-success">Activate</a>';
	}
}
