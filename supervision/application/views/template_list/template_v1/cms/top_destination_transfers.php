	...
	<div class="panel <?=PANEL_WRAPPER?>"><!-- PANEL WRAP START -->
		<div class="panel-heading"><!-- PANEL HEAD START -->
			<div class="panel-title">
				<i class="fa fa-edit"></i> Top Destinations In Transfers
			</div>
			...
			<table class="table table-condensed">
				...
				?>
					<tr>
						...
						<td><?php echo get_status_label1($v['home_status_transfer']).get_status_toggle_button1($v['home_status_transfer'], $v['origin']); ?></td>
						<td><?php echo get_status_label($v['top_destination_transfers']).get_status_toggle_button($v['top_destination_transfers'], $v['origin']) ?></td>
					</tr>
				<?php
					endforeach;
				} else {
...
{
	if (intval($home_status_transfer) == ACTIVE) {
		return '<a role="button" href="'.base_url().'index.php/cms/deactivate_top_destination_transfers_home/'.$origin.'" class="text-danger">Deactivate</a>';
	} else {
		return '<a role="button" href="'.base_url().'index.php/cms/activate_top_destination_transfers_home/'.$origin.'" class="text-success">Activate</a>';
	}
}
