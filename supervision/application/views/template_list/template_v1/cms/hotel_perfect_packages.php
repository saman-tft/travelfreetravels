	...
	<div class="panel <?=PANEL_WRAPPER?>"><!-- PANEL WRAP START -->
		<div class="panel-heading"><!-- PANEL HEAD START -->
			<div class="panel-title">
				<i class="fa fa-edit"></i> Perfect Hotels Packages
			</div>
		</div><!-- PANEL HEAD START -->
		<div class="panel-body"><!-- PANEL BODY START -->
			<fieldset><legend><i class="fa fa-hotel"></i> City List</legend>
				<form action="<?php echo base_url()?>index.php/cms/hotel_perfect_packages" enctype="multipart/form-data" class="form-horizontal" method="POST" autocomplete="off">
			...
			<table class="table table-condensed">
				...
				?>
					<tr>
						...
						<td><?php echo get_status_label1($v['perfect_packages_status']).get_status_toggle_button1($v['perfect_packages_status'], $v['origin']); ?></td>
						<td><a role="button" href="<?php echo base_url()?>index.php/cms/delete_hotel_perfect_packages/<?php echo $v['origin'] ?>" class="text-danger">Delete</a></td>
					</tr>
				<?php
					endforeach;
				} else {
...
{
	if (intval($home_status) == ACTIVE) {
		return '<a role="button" href="'.base_url().'index.php/cms/deactivate_hotel_perfect_packages/'.$origin.'" class="text-danger">Deactivate</a>';
	} else {
		return '<a role="button" href="'.base_url().'index.php/cms/activate_hotel_perfect_packages/'.$origin.'" class="text-success">Activate</a>';
	}
}
