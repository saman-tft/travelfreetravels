 ...
 * FORM START
 */
$user_type = (isset($_GET['q']) ? $_GET['q'] : $GLOBALS['CI']->entity_user_type);
$form_configuration['inputs'] = array(
	...
	'user_type' 	   => array('type' => 'select',   'label_line_code' => 34, 'source' => 'custom', 'source_location'  => 'db_cache_api::get_user_type', 'params' => $user_type)
);
...
'form_header' => $form_attributes,
		'sections' => array(
			array('elements' => array('user_id', 'title', 'first_name', 'last_name', 'country_code', 'phone', 'address', 'status', 'language_preference','image'),
				'fieldset' => 'FFL003'
			),
...
$form_configuration['form']['user_edit'] = array(
		'form_header' => $form_attributes,
		'sections' => array(
			array('elements' => array('user_id', 'title', 'first_name', 'last_name', 'country_code', 'phone', 'address', 'language_preference','image'),
				'fieldset' => 'FFL003'
			),
