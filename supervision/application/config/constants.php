...
define('PROJECT_AGENT_PREFIX', 'TFT');
 define('CURRENT_DOMAIN_KEY', 'TMX6244821650276433'); //FIXME :: Auto Set
//define('CURRENT_DOMAIN_KEY', 'TMX3644721637051232'); //FIXME :: Auto Set
 //define('CURRENT_DOMAIN_KEY', 'TMX3372451534825527'); //FIXME :: Auto Set
/*if(ENVIRONMENT == 'testing')
{

	define('CURRENT_DOMAIN_KEY', 'TMX1004111597231027'); // FIXME//Vc8Z7XLsyys9TEQdFPkV
}
else
{
...
/*
 ...
 |--------------------------------------------------------------------------
 */
define('UNIVERSAL_DEFAULT_CURRENCY', 'NPR'); // USD
...
define('META_AIRLINE_PJ_COURSE', 'VHCID1420613785');
...
define('META_CAR_PC_COURSE','TMCAR1433491850');
...
define('PROVAB_TRANSFER_SOURCE_CRS','PTBSID0000000008');
...
define('PROVAB_TRIPXML_BOOKING_SOURCE', 'PTBSID0000000021');
...
define('EXPORT_CHUNK_COUNT', 500);
define('DOMAIN_ZIP_DIR', '../extras/custom/'.CURRENT_DOMAIN_KEY.'/temp_booking_data_zip/');
// number of data to add in one pdf if data size is too large for booking report export
define('EXPORT_CHUNK_COUNT_BOOKING_REPORT_FLIGHT', 500);
// number of data to add in one pdf if data size is too large for invoices export
define('EXPORT_CHUNK_COUNT_INVOICE_FLIGHT', 100);
