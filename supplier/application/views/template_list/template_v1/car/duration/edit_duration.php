	...
	<div class="panel panel-default clearfix">
		...
		<!-- PANEL HEAD START -->
			...
			<div class="panel-body">
				<form method="post" id="tax" name="tax" action="<?php echo site_url()."/duration/update_duration/".base64_encode(json_encode($duration_list[0]->duration_id)); ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
					<fieldset form="user_edit">
				<legend class="form_legend">Edit Duration</legend>

							<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Duration Name</label>									
									<div class="col-sm-5"> 
										 <input type="text" class="form-control" name="duration_name" id="duration_name" data-validate="required" data-message-required="Please Enter the Seasons Name" value="<?php if(isset($duration_list[0]->duration_name)){ echo $duration_list[0]->duration_name; }?>"/>
								...
								<div class="form-group">
									...
									<div class="col-sm-5"> 
										 <input type="text" class="form-control" id="duration_date_range" name="duration_date_range" readonly  data-validate="required" data-message-required="Please Select the Date Range" value="<?php 
										 if(isset($duration_list[0]->duration_from_date)){
										  if($duration_list[0]->duration_from_date != "0000-00-00"){ 										   
										    echo date('d/m/Y',strtotime($duration_list[0]->duration_from_date)) ." - ".date('d/m/Y',strtotime($duration_list[0]->duration_to_date));
										  }
									    }
									    ?>" />
