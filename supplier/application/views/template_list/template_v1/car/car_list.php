...
<div class="tab-content">
			...
			<form action="<?php echo base_url(); ?>index.php/car_supplier/car_list/<?=$ID?>"
							...
							<div class='form-group'>
								<label class='control-label col-sm-3' for='validation_current'>								Applicable for Outsource </label>
								<div class='col-sm-4 controls'>
									<div class="controls">
										<select class='select2 form-control'
										data-rule-required='true' name='outsource' id="outsource" required>	
                                            ...
                                            <?php
                                                ...
                                                if($outsource)
                                                    ...
                                                    $false = 'selected';
                                            ?>
											<option <?=$true?> value="1">Yes</option>
											<option <?=$false?> value="0">No</option>
										</select>
									</div>
								</div>
							</div>
<!--							<div class='form-group' id="outsource_control" style="display: none">-->
<!--								<label class='control-label col-sm-3' for='validation_current'>								Add Outsource Details </label>-->
<!--								<div class='col-sm-4 controls'>-->
<!--									Country: <select class='select2 form-control'-->
<!--											data-rule-required='true' name='outsource_from_country' id="outsource_from_country" required>-->
<!--									</select>-->
<!--									From City: <select class='select2 form-control'-->
<!--											data-rule-required='true' name='outsource_from_city' id="outsource_from_city" required>-->
<!--									</select>-->
<!--									To City: <select class='select2 form-control'-->
<!--											data-rule-required='true' name='outsource_to_city' id="outsource_to_city" required>-->
<!--									</select>-->
<!--									Note: Plase Provide total price for the trip.<br/>-->
<!--									Weekdays Price<input type="numeric" name="outsource_weekdays_price" id="outsource_weekdays_price"-->
<!--										data-rule-number="true" data-rule-required='true' placeholder="Price" value="--><?php //echo isset($outsource_weekdays_price)?$outsource_weekdays_price:'';?><!--" -->
<!--										class='form-control add_pckg_elements numeric' required="">-->
<!--										<span class="error">--><?php //echo form_error('outsource_weekdays_price')?><!--</span>-->
<!--									Weekend Price<input type="numeric" name="outsource_weekend_price" id="outsource_weekend_price"-->
<!--										data-rule-number="true" data-rule-required='true' placeholder="Price" value="--><?php //echo isset($outsource_weekend_price)?$outsource_weekend_price:'';?><!--" -->
<!--										class='form-control add_pckg_elements numeric' >-->
<!--										<span class="error">--><?php //echo form_error('outsource_weekend_price')?><!--</span>-->
<!--								</div>-->
<!--							</div>-->
							<div class='form-group'>
								<label class='control-label col-sm-3' for='validation_current'>								Applicable for Drive Me </label>
								<div class='col-sm-4 controls'>
									<div class="controls">
										<select class='select2 form-control'
										data-rule-required='true' name='localuse' id="localuse" required>
                                            <?php
                                            $true = '';
                                            $false = '';
                                            if($localuse)
...
<!--							<div class='form-group' id="localuse_control" style="display: none">-->
<!--								<label class='control-label col-sm-3' for='validation_current'>	Add Localuse Details </label>-->
<!--								<div class='col-sm-4 controls'>-->
<!--									Country: <select class='select2 form-control'-->
...
<!--									</select>-->
<!--									Note: Plase Provide price per k/m for the trip.<br/>-->
<!--									4Hours Price<input type="numeric" name="localuse_halfday_price" id="localuse_halfday_price"-->
<!--										data-rule-number="true" data-rule-required='true' placeholder="Price" value="--><?php //echo isset($localuse_halfday_price)?$localuse_halfday_price:'';?><!--" -->
<!--										class='form-control add_pckg_elements numeric' required="">-->
<!--										<span class="error">--><?php //echo form_error('localuse_halfday_price')?><!--</span>-->
<!--									8Hours Price<input type="numeric" name="localuse_fullday_price" id="localuse_fullday_price"-->
<!--										data-rule-number="true" data-rule-required='true' placeholder="Price" value="--><?php //echo isset($localuse_fullday_price)?$localuse_fullday_price:'';?><!--" -->
<!--										class='form-control add_pckg_elements numeric' >-->
<!--										<span class="error">--><?php //echo form_error('localuse_fullday_price')?><!--</span>-->
<!--								</div>-->
<!--							</div>-->
							<div class='form-group'>
								<label class='control-label col-sm-3' for='validation_current'>								Applicable for Airport Taxi </label>
								<div class='col-sm-4 controls'>
									<div class="controls">
										<select class='select2 form-control'
										data-rule-required='true' name='transfers' id="transfers" required>
                                            <?php
                                            $true = '';
                                            $false = '';
                                            if($transfers)
...
<!--							<div class='form-group' id="transfers_control" style="display: none">-->
<!--								<label class='control-label col-sm-3' for='validation_current'>								Add Transfers Details </label>-->
<!--								<div class='col-sm-4 controls'>-->
<!--									Country: <select class='select2 form-control'-->
<!--											data-rule-required='true' name='localuse_from_country' id="localuse_from_country" required>-->
<!--									</select>-->
...
<!--											data-rule-required='true' name='localuse_from_city' id="localuse_from_city" required>-->
<!--									</select>-->
<!--									Note: Please Provide price per k/m for the trip.<br/>-->
<!--									Weekdays Price<input type="numeric" name="transfers_weekdays_price" id="transfers_weekdays_price"-->
<!--										data-rule-number="true" data-rule-required='true' placeholder="Price" value="--><?php //echo isset($transfers_weekdays_price)?$transfers_weekdays_price:'';?><!--" -->
<!--										class='form-control add_pckg_elements numeric' required="">-->
<!--										<span class="error">--><?php //echo form_error('transfers_weekdays_price')?><!--</span>-->
<!--									Weekend Price<input type="numeric" name="transfers_weekend_price" id="transfers_weekend_price"-->
<!--										data-rule-number="true" data-rule-required='true' placeholder="Price" value="--><?php //echo isset($transfers_weekend_price)?$transfers_weekend_price:'';?><!--" -->
<!--										class='form-control add_pckg_elements numeric' >-->
...
<!--							</div>-->
							...
							<div class="form-group" id="ref_cancell_div">
								...
								<div class='col-sm-2 controls'>
									...
									<label class='control-label col-sm-4 cancl_plcy' for='adult'>Cancellation Policy</label>
							...
							<div class='form-group'>
								<label class='control-label col-sm-3' for='validation_company'>Car Image</label>
								...
								<!--<div class='form-group' id='policy_status'  >
								<label class='control-label col-sm-3' for='adult'>Cancellation Policy</label>
								<div class='col-sm-4 controls'>
								<?php echo $hp_policy;?>
								</div>
								</div>-->	
...
<script>
$('#outsource').on('change', function(e) {
	var val = $(this).val();
	if(val == 1){
		$('#outsource_control').css('display','block');
	}else{
		$('#outsource_control').css('display','none');
	}
});

$('#transfers').on('change', function(e) {
	var val = $(this).val();
	if(val == 1){
		$('#transfers_control').css('display','block');
	}else{
		$('#transfers_control').css('display','none');
	}
});

$('#localuse').on('change', function(e) {
	var val = $(this).val();
	if(val == 1){
		$('#localuse_control').css('display','block');
	}else{
		$('#localuse_control').css('display','none');
	}
});
</script>
<script>
function get_car_details(car_id){
	$.ajax({
		url: '<?= base_url() ?>index.php/car_mapping/get_mapping_car_details/' + car_id,
		// dataType: 'json',
		success: function(result) {
			// $('#myModal').removeClass('fade').addClass('fade in');
			$('#car_details_data').html(result);
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    <span class="close"><a href="#" onclick="close_modal()" >X</a></span>
    <p id="car_details_data">
    	<div class="col-sm-3">
