			...
			<div class="tab-content">
				...
				<div role="tabpanel" class="tab-pane active" id="">
							...
							<!-- <div class='form-group'>
								<label class='control-label col-sm-3' for='validation_current'>								Branch Name </label>
								<div class='col-sm-4 controls'>
									<div class="controls">
										<select id="branch_id" name="branch_id" class="form-control">
											<?php foreach($branch_user_list as $b_key=>$b_val):?>
											<option value="<?=$b_key['user_id']?>"><?=$b_val['agency_name']?></option>
										<?php endforeach;?>
										</select>
									</div>
								</div>
