	...
	<div class="panel panel-default clearfix">
		...
		<!-- PANEL HEAD START -->
			...
			<div class="panel-body">
				<form method="post" name="board_type" id="room_type" action="<?php echo site_url()."/hotel/update_board_types/".base64_encode(json_encode($board_types_list[0]->id)); ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
					<fieldset form="user_edit">
				<legend class="form_legend">Edit Board Type</legend>
				<input name="user_id" id="user_id" class=" user_id hiddenIp" required="" value="<?php  echo $this->entity_user_id; ?>" type="hidden">
				<div class="form-group">
					<label class="col-sm-3 control-label" for="title" form="user_edit">Board Type Name<span class="text-danger">*</span></label>
					<div class="col-sm-6">
						<input type="text" class="form-control" id="field-1" name="board_type_name" value="<?php echo $board_types_list[0]->name; ?>" data-validate="required" data-message-required="Please enter the Board Type Name">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label">Board Type Status</label>									
					<div class="col-sm-5">
						<div id="label-switch" class="make-switch" data-on-label="Active" data-off-label="InActive">
							<input type="checkbox" name="status" value="<?php echo $board_types_list[0]->status; ?>" id="status" <?php if($board_types_list[0]->status == "ACTIVE"){ echo "checked"; } ?>>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-5">
						<button type="submit" class="btn btn-success">Update Board Type</button>
					</div>
				</div>
				</form>
			</div>
