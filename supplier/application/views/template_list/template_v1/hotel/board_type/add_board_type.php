	...
	<div class="panel panel-default clearfix">
		...
		<!-- PANEL HEAD START -->
			...
			<div class="panel-body">
				...
				<form method="post" name="board_type" id="room_type" action="<?php echo site_url()."/hotel/save_board_type_data"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">		
					<fieldset form="user_edit">
				<legend class="form_legend"> Add Board Type</legend>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" id="field-1" name="board_type_name" placeholder="Board Type Name" data-validate="required" data-message-required="Please enter the Board Type Name">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<button type="submit" class="btn btn-success">Add Board Type</button>
					</div>
				</div>
				</form>
			</div>
