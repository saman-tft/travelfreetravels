	...
	<div class="panel panel-default clearfix">
		...
		<!-- PANEL HEAD START -->
			...
			<div class="panel-body">
				<form method="post" id="post_form" name="tax" action="<?php echo base_url()."index.php/hotel/add_seasons"?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
