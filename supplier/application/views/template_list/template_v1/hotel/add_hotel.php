...
<div class="bodyContent">
	<div class="panel panel-default clearfix">
		...
		<!-- PANEL HEAD START -->
          ...
          <div class="clearfix"></div>
				<form method="post"  id="hotel" name="hotel" action="<?php echo base_url()."index.php/hotel/save_hotel_data"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
      ...
      uploadField.onchange = function() {
		...
		function select_city(country_id){
		 ...
		 if (country_id != '') {         	  
          ...
          $.ajax({
            url: '<?php echo base_url(); ?>index.php/hotel/get_city_name/'+country_id,
