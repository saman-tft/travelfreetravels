	...
	<div class="panel panel-primary clearfix">
		...
		<!-- PANEL HEAD START -->
			...
			<div class="panel-body">
				<form method="post" name="hotel_type" id="hotel_type" action="<?php echo base_url()."index.php/hotel/save_hotel_type_data"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">		
					<fieldset form="user_edit">
				<legend class="form_legend"> Add Hotel Type</legend>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" id="field-1" name="hotel_type_name" placeholder="Hotel Type Name" data-validate="required" data-message-required="Please enter the Hotel Type Name">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<button type="submit" class="btn btn-success">Add Hotel Type</button>
					</div>
				</div>
				</form>
			</div>
