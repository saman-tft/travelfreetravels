...
<div class="bodyContent">
	<div class="panel panel-primary clearfix">
		...
		<a href="<?php echo base_url()."index.php/hotel/hotel_crs_list"; ?>" class="btn btn-primary addnwhotl pull-right">Hotel List</a>
		<a href="<?php echo base_url()."index.php/hotel/add_room_details/{$hotel_id}"; ?>" class="btn btn-primary addnwhotl pull-right">Add Room</a>
		<!-- PANEL HEAD START -->
						...
						<tr>
							...
							<td class="center">
								...
								if($list->status == "ACTIVE")
									{ 
								?>
									<a href="<?php echo base_url()."index.php/hotel/inactive_room/".$list->hotel_id.'/'.$list->id; ?>" class="pad" title="Inactivate"><i class="fa fa-times" aria-hidden="true"></i></a>
								<?php 
								}
								else
								{ ?>
									<a href="<?php echo base_url()."index.php/hotel/active_room/".$list->hotel_id.'/'.$list->id; ?>" class="pad" title="Activate"><i class="fa fa-check" aria-hidden="true"></i></a>
								<?php 
								} 
								?>
							<a href="<?php echo base_url()."index.php/hotel/edit_room/".$list->hotel_id.'/'.$list->id; ?>" class=" pad" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>	<br>
							...
							{
							?>
								<a href="<?php echo base_url()."index.php/hotel/room_price_list/".$list->hotel_id.'/'.$list->id; ?>" class=" pad" title="Price Info List"><i class="fa fa-database" aria-hidden="true"></i></a>
								<?php } else { ?>
									<a id="season_add" class=" pad" title="Price Info List"><i class="fa fa-money" aria-hidden="true"></i></a>
								<?php } ?>


								<a href="<?php echo base_url()."index.php/hotel/room_cancellation_list/".$list->hotel_id.'/'.$list->id; ?>" class=" pad" title="Cancellation Policy List"><i class="fa fa-handshake" aria-hidden="true"></i></a>
							</td>
						</tr>
					<?php 
					}
...
<script type="text/javascript">
    ...
    window.location.href='<?=base_url("hotel/season_list/{$this->uri->segment(3)}")?>';
