    ...
    <!-- PANEL HEAD START -->
      ...
      <div class="panel-body">
        ...
        <div class="col-md-12 hide">
          ...
          <div class="clearfix"></div>
        <form method="post"  id="hotel" name="hotel" action="<?php echo base_url()."index.php/hotel/update_room_price_data/".$data->id; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
        ...
        <legend class="form_legend">Edit Room Price Info</legend>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                  <label for="field-1" class="col-sm-3 control-label">1 Adult Price (NPR)<span class="text-danger">*</span></label>                 
                  <div class="col-sm-5">
            ...
            <div class="form-group">
                  <label for="field-1" class="col-sm-3 control-label">2 Adult Price (NPR)<span class="text-danger">*</span></label>                 
                  <div class="col-sm-5">
            ...
            <div class="form-group">
                  <label for="field-1" class="col-sm-3 control-label">3 Adult Price (NPR)<span class="text-danger">*</span></label>                 
                  <div class="col-sm-5">
                ...
                <div class="form-group">
                  <label for="field-1" class="col-sm-3 control-label">Child Price (NPR)<span class="text-danger">*</span></label>                 
                  <div class="col-sm-5">
