	...
	<div class="panel panel-primary clearfix">
		...
		<div class="panel-heading">
			...
			<div class="panel-title">
				<i class="fa fa-credit-card"></i> Room Cancellation Policy List
			</div>
		</div>
<a href="<?php echo base_url()."index.php/hotel/room_crs_list/{$hotel_id}"; ?>" class="btn btn-primary addnwhotl pull-right">Back</a>
		<a href="<?php echo base_url()."index.php/hotel/add_cancellation_policy/{$hotel_id}/{$room_id}"; ?>" class="btn btn-primary addnwhotl pull-right">Add Cancellation Policy</a>
				...
				<form action="" method="POST" autocomplete="off">
					<table class="table table-bordered">
						...
						<tr>
							<th>Sl No</th>
							<th>Room Code</th>
							<th>Cancel Before (Days)</th>
							<th>Cancel To (Days)</th>
							<th>Penality Type</th>
							<th>Penality</th>
				...
				<?php if(!empty($price_list))
					...
					?>
						<tr>
							...
							<td><?php echo $list->cancel_before; ?></td>
							<td><?php echo $list->cancel_to; ?></td>
							<td><?php echo $list->penality_type == 1 ? "Amount" : "Percentage"; ?></td>
							<td><?php echo $list->penality; ?></td>
							...
							<td class="center">
								...
								if($list->status == "ACTIVE")
									{ 
								?>
									<a href="<?php echo base_url()."index.php/hotel/inactive_room_cancel/".$list->id; ?>" class="btn btn-orange btn-sm btn-icon icon-left my-inactve"><i class="entypo-eye"></i>InActive</a>
								<?php 
								}
								else
								{ ?>
									<a href="<?php echo base_url()."index.php/hotel/active_room_cancel/".$list->id; ?>" class="btn btn-green btn-sm btn-icon icon-left my-actve"><i class="entypo-check"></i>Active</a>
								<?php 
								} 
								?>
							...
							<td>
							    <a href="<?php echo base_url()."index.php/hotel/edit_cancellation_policy/".$list->id; ?>" class="btn btn-primary btn-sm btn-icon icon-left my-actve"><i class="entypo-edit"></i>Edit</a>
							</td>
						</tr>
					<?php 
					}
