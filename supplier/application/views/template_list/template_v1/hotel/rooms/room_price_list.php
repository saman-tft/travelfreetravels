...
<div class="bodyContent">
	<div class="panel panel-primary clearfix">
		...
		<a href="<?php echo base_url()."index.php/hotel/add_room_price/{$hotel_id}/{$room_id}"; ?>" class="btn btn-primary addnwhotl pull-right">Add Room Price</a>
		<!-- PANEL HEAD START -->
						...
						<tr>
							...
							<td class="center">
								...
								if($list->status == "ACTIVE")
									{ 
								?>
									<a href="<?php echo base_url()."index.php/hotel/inactive_room_price/".$list->hotel_id.'/'.$list->id; ?>" class="btn btn-orange btn-sm btn-icon icon-left my-inactve"><i class="entypo-eye"></i>InActive</a>
								<?php 
								}
								else
								{ ?>
									<a href="<?php echo base_url()."index.php/hotel/active_room_price/".$list->hotel_id.'/'.$list->id; ?>" class="btn btn-green btn-sm btn-icon icon-left my-actve"><i class="entypo-check"></i>Active</a>
								<?php 
								} 
								?>
							...
							<td>
							    <a href="<?php echo base_url()."index.php/hotel/edit_room_price/".$list->id; ?>" class="btn btn-primary btn-sm btn-icon icon-left my-actve"><i class="entypo-edit"></i>Edit</a>
							</td>
						</tr>
					<?php 
					}
