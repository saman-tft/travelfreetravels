...
<div class="bodyContent">
    ...
    <a href="<?php echo base_url()."index.php/hotel/room_crs_list/{$hotel_id}"; ?>" class="btn btn-primary addnwhotl pull-right">Back</a>
  </div>
		<!-- PANEL HEAD START -->
          ...
          <div class="clearfix"></div>
				<form method="post"  id="hotel" name="hotel" action="<?php echo base_url()."index.php/hotel/save_room_details_data"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
