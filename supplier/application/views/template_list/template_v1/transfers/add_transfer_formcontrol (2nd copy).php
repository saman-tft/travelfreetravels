				...
				<div class="tab-content">
					...
					<div role="tabpanel" class="tab-pane active" id="add_package">
						<div class="col-md-12">
							...
							<!-- <div class='form-group'>
								<label class='control-label col-sm-3' for='validation_current'>Pick up time
								</label>
								<div class="col-sm-4 controls ">
									<input type="text" name="pick_up_time_from" data-rule-number='true'
										data-rule-required='true'
										class="form-control add_pckg_elements" maxlength='20'
										minlength='1' id="time" size="40"
                        ...
                        <?php }?>
							...
							<div class='form-group'>
								...
								<div class='col-sm-4 controls'>
									<input type="text" class="normal AlphabetsOnly" id="textbox" name="cityname" style="width:450px;" required></td>
								</div>
							</div>
							<div class='form-group'>
								...
								<div class='col-sm-4 controls'>
									<input type="text" name="location" id="location"
										placeholder="Enter Location" data-rule-required='true'
						...
						<div class="col-md-12">
							<div class="duration_info_class clearfix" id="">
								<div class='form-group clearfix'>
									<label class='control-label col-sm-3' for='validation_desc'>Vehicle Type</label>
									<div class='col-sm-4 controls'>
								...
								<!-- <div class='form-group clearfix'>
									<label class='control-label col-sm-3' for='validation_desc'>Vehicle type Code</label>
									<div class='col-sm-4 controls'>
										<input type="text" name="vehicle_type_code" id="days"
											data-rule-required='true' placeholder="Vehicle Type Code"
											class='form-control vehicle_elements' required>
									</div>
								</div> -->
								<div class='form-group clearfix'>
									<label class='control-label col-sm-3' for='validation_desc'>Vehicle Name</label>
									<div class='col-sm-4 controls'>
								...
								<div class='form-group clearfix'>
									<label class='control-label col-sm-3' for='validation_desc'>Vehicle Number</label>
									<div class='col-sm-4 controls'>
										<input type="text" name="vehicle_number" id=""
											data-rule-required='true' placeholder="Vehicle Number"
											class='form-control vehicle_elements' required>
									</div>
								</div>
								<div class='form-group clearfix'>
									<label class='control-label col-sm-3' for='validation_company'>Vehicle Image</label>
									<div class='col-sm-3 controls'>
										<input type="file" title='Image to add'
											class='vehicle_elements' data-rule-required='true' id='vehicle_image'
											name='vehicle_image' required> <span id="pacmimg"
											style="color: #F00; display: none">Please Upload Vehicle
											Image</span>
									</div>
								</div>
								<div class='form-group clearfix'>
									<label class='control-label col-sm-3' for='validation_company'>Equipment</label>
									<div class='col-sm-4 controls'>
								...
								<div class='form-group clearfix'>
									<label class='control-label col-sm-3' for='validation_name'>Max Passenger
									</label>
									<div class='col-sm-4 controls'>
										<input type="text" name="max_passenger" id="days"
											data-rule-required='true' placeholder="Max Passenger"
											class='form-control vehicle_elements' required>
									</div>
								</div>
								<div class='form-group'>
									<label class='control-label col-sm-3' for='validation_name'>Max Luggage
									</label>
									<div class='col-sm-4 controls'>
										<input type="text" name="max_luggage" id="Place"
											data-rule-required='true' placeholder="Max Luggage"
											class='form-control vehicle_elements' required>
									</div>
								</div>
								...
								<div class="driver_div">
									<div class="driver_details">
										...
										<div class='form-group'>
											...
											<div class='col-sm-4 controls'>
												<input type="text" name="driver[0][driver_name]" id="driver_name"
										...
										<div class='form-group'>
											...
											<div class="col-md-8 col-sm-8 col-xs-12">
                                               <input class='form-control checkbox' id='monday_0' name='driver[0][driver_shift_days][]' value="1" type='checkbox'>&nbsp;
	                                           <label for="monday_0">Mon</label>
	                                           &nbsp;&nbsp;
	                                           <input class='form-control checkbox' id='tuesday_0' name='driver[0][driver_shift_days][]' value="2" type='checkbox'>&nbsp;
	                                           <label for="tuesday_0">Tue</label>
	                                           &nbsp;&nbsp;
	                                           <input class='form-control checkbox' id='wednesday_0' name='driver[0][driver_shift_days][]' value="3" type='checkbox'>&nbsp;
	                                           <label for="wednesday_0">Wed</label>
	                                            &nbsp;&nbsp;
	                                           <input class='form-control checkbox' id='thursday_0' name='driver[0][driver_shift_days][]' value="4" type='checkbox'>&nbsp;
	                                           <label for="thursday_0">Thu</label>
	                                            &nbsp;&nbsp;
	                                           <input class='form-control checkbox' id='friday_0' name='driver[0][driver_shift_days][]' value="5" type='checkbox'>&nbsp;
	                                           <label for="friday_0">Fri</label>
	                                            &nbsp;&nbsp;
	                                           <input class='form-control checkbox' id='saturday_0' name='driver[0][driver_shift_days][]' value="6" type='checkbox'>&nbsp;
	                                           <label for="saturday_0">Sat</label>
	                                            &nbsp;&nbsp;
	                                           <input class='form-control checkbox' id='sunday_0' name='driver[0][driver_shift_days][]' value="7" type='checkbox'>&nbsp;
										...
										<div class='form-group'>
											...
											<div class='col-sm-2 controls'>
												<input type="text" name="driver[0][driver_shift_from]" id="driver_shift_from_1"
											...
											<div class='col-sm-2 controls'>
												<input type="text" name="driver[0][driver_shift_to]" id="driver_shift_to_1"
										...
										<div class='form-group'>
											...
											<div class='col-sm-4 controls'>
												<input type="file" title='File to add'
													class='vehicle_elements' data-rule-required='true' id='driver_license_1'
													name="driver_license_1" required> <span id="pacmimg"
							    ...
							    <div class="add_driver_btn"><span class="btn btn-primary pull-right" style="margin-right: 294px;">Add Driver</span></div>

								<!-- <div class='form-group'>
									<label class='control-label col-sm-3' for='validation_name'>Price
									</label>
									<div class='col-sm-4 controls'>
										<input type="text" name="price" id="Place"
								  ...
								  <div class='form-group'>
									...
									<table class="table table-bordered table-striped table-highlight">
										...
										<!-- <div class='col-sm-2 controls'>
											<label>Days</label>
											<select class='form-control price_elements'
												data-rule-required='true' name='' id="" required>
												<option value="">--Select Days--</option>
												<option value="0">Monday</option>
												<option value="1">Tuesday</option>
												<option value="2">Wednesday</option>
										...
										<div class='col-sm-2 controls'>
											<button type="button" class="btn btn-default btn-sm remove_price" style="margin-top:26px;color: red;">
									          <span class="glyphicon glyphicon-remove"></span> 
									    </button>
										</div> -->
									</div>
   ...
   myid=$("input[type='text']#"+current_id).attr('myid');
    ...
    $(document).ready(function(){
    	$('.add_driver_btn').on('click',function(){
    		var count = $('.driver_details').length +1;
    		var driver_div = '';
    		...
    		driver_div +=`<div class="driver_details">
								...
								<div class='form-group'>
									...
									<div class='col-sm-4 controls'>
										<input type="text" name="driver[${length}][driver_name]" id="driver_name"
											data-rule-required='true' placeholder="Driver Name"
											class='form-control vehicle_elements' required>
									</div>
								</div>
								<div class='form-group'>
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
                                       <input class='form-control checkbox' id='monday_${length}' name='driver[${length}][driver_shift_days][]' value="1" type='checkbox'>&nbsp;
                                       <label for="monday_${length}">Mon</label>
                                       &nbsp;&nbsp;
                                       <input class='form-control checkbox' id='tuesday_${length}' name='driver[${length}][driver_shift_days][]' value="2" type='checkbox'>&nbsp;
                                       <label for="tuesday_${length}">Tue</label>
                                       &nbsp;&nbsp;
                                       <input class='form-control checkbox' id='wednesday_${length}' name='driver[${length}][driver_shift_days][]' value="3" type='checkbox'>&nbsp;
                                       <label for="wednesday_${length}">Wed</label>
                                        &nbsp;&nbsp;
                                       <input class='form-control checkbox' id='thursday_${length}' name='driver[${length}][driver_shift_days][]' value="4" type='checkbox'>&nbsp;
                                       <label for="thursday_${length}">Thu</label>
                                        &nbsp;&nbsp;
                                       <input class='form-control checkbox' id='friday_${length}' name='driver[${length}][driver_shift_days][]' value="5" type='checkbox'>&nbsp;
                                       <label for="friday_${length}">Fri</label>
                                        &nbsp;&nbsp;
                                       <input class='form-control checkbox' id='saturday_${length}' name='driver[${length}][driver_shift_days][]' value="6" type='checkbox'>&nbsp;
                                       <label for="saturday_${length}">Sat</label>
                                        &nbsp;&nbsp;
                                       <input class='form-control checkbox' id='sunday_${length}' name='driver[${length}][driver_shift_days][]' value="7" type='checkbox'>&nbsp;
                                       <label for="sunday_${length}">Sun</label>
								...
								<div class='form-group'>
									...
									<div>
									<div class='col-sm-2 controls'>
										<input type="text" name="driver[${length}][driver_shift_from]" id="driver_shift_from_${count}"
											data-rule-required='true' placeholder="Driver Shift From"
											class='form-control vehicle_elements' required readonly>
									</div>
									<span style="margin-left: -166px; font-weight: bold;"> to </span>
									<div class='col-sm-2 controls'>
										<input type="text" name="driver[${length}][driver_shift_to]" id="driver_shift_to_${count}"
											data-rule-required='true' placeholder="Driver Shift To"
											class='form-control vehicle_elements' required readonly>
									</div>
									</div>
    	...
    	$('.add_price_btn').on('click',function(){
			...
			// price_div +=`<div class="price_details">
			// 				<div class='form-group'>
			// 				<label class='control-label col-sm-3' for='validation_name'>
			// 				</label>
