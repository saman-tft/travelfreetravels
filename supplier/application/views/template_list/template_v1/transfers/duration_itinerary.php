...
<div class='form-group clearfix'>
	...
	<div class='col-sm-4 controls'>
		<input type="text" name="days[]" id="days<?php echo $i + 1; ?>"
			data-rule-required='true' readonly value="<?php echo $i + 1; ?>"
...
<div class='form-group clearfix'>
	...
	<div class='col-sm-4 controls'>
		<input type="text" name="place[]" id="Place<?php echo $i + 1; ?>"
			data-rule-required='true' class='form-control itenary_elements'
...
<div class='form-group clearfix'>
	...
	<div class='col-sm-3 controls'>
		<input type="file" title='Image to add' class='itenary_elements'
			data-rule-required='true' id='image<?php echo $i + 1; ?>'
			name='image[]' multiple required> <span id="pacmimg"
			style="color: #F00; display: none">Please Upload Itinerary Image</span>
	</div>
</div>
<hr>
<?php } ?>