						...
						<div class=''>
							...
							<div class=''>
								<form class='form form-horizontal validate-form'
									...
									action="<?php echo base_url(); ?>index.php/transfers/save_price_category"
									...
									<div class='form-group'>
										...
										<input type="hidden" id="price_id" name="activity_types_id" value="<?=$id;?>">
											<input class='form-control' data-rule-minlength='2'
												...
												placeholder='Nationality Group' type='text' required> <span id="pacname"
									...
									<div class='form-actions' style='margin-bottom: 0'>
										<div class='row'>
											<div class='col-sm-9 col-sm-offset-4'>
												<a
													href="<?php echo base_url(); ?>index.php/transfers/view_price_category">
