                                       ...
                                       <table>
                                          <tbody>
                                             <tr>
                                                ...
                                                <td class="text-center" style="border-right: 1px solid #ccc;border-left: 1px solid #ccc;width: 50%;"><?=$booking_details['currency'].' '.($booking_details['grand_total']-$booking_details['reward_amount']); ?></td>
                                             </tr>
                                             <tr>
