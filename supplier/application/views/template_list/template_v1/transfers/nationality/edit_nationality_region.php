...
<div id="Package" class="bodyContent col-md-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <!-- PANEL BODY START -->
            <form
                action="<?php echo base_url(); ?>index.php/transfers/edit_nationality_region_save"
                            ...
                            <div class='' style='margin-bottom: 0'>
                                <div class='row'>
                                    <div class='col-sm-9 col-sm-offset-3'>  
                                        ...
                                        <a href="<?php echo base_url(); ?>index.php/transfers/nationality_region" class='btn btn-primary' style="color:white;"> Region</a>
