			...
			<div class="panel-title">
				<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
					...
					<li role="presentation" class="active"><a href="#fromList"
						aria-controls="home" role="tab" data-toggle="tab"><h1>Car Size
								Types</h1></a></li>
						...
						<div class='row'>
							<div class='' style='margin-bottom: 0;'>
								<div class=''>
									<div class='actions'>
										<a
											href="<?php echo base_url(); ?>index.php/privatecar/add_size_type">
											<button class='btn btn-primary' style='margin-bottom: 5px'>
												<i class='icon-male'></i> + Add Car Size Types
											</button>
														...
														<td>
															<div class=''>
																<a class="btn btn-primary btn-xss has-tooltip"
																	...
																	href="<?php echo base_url(); ?>index.php/privatecar/add_size_type/<?php echo $k->c_size_id; ?>"
																	...
																	href='<?php echo base_url(); ?>index.php/privatecar/delete_size_type/<?=$k->c_size_id;?>'>
