			...
			<div class="panel-title">
				<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
					...
					<li role="presentation" class="active"><a href="#fromList"
						aria-controls="home" role="tab" data-toggle="tab"><h1>Packages
								Types</h1></a></li>
						...
						<div class='row'>
							<div class='' style='margin-bottom: 0;'>
								<div class=''>
									<div class='actions'>
										<a
											href="<?php echo base_url(); ?>index.php/privatecar/add_package_type">
											<button class='btn btn-primary' style='margin-bottom: 5px'>
												<i class='icon-male'></i> + Add Packages Types
											</button>
                                      ...
                                      <tr>
														...
														<td>
															<div class=''>
																	...
																	href="<?php echo base_url(); ?>index.php/privatecar/add_priced_coverage/<?php echo $k->package_id; ?>"
																	data-original-title="Edit Tour"> <i class="icon-edit"></i>Add PricedCoverage
																</a> &nbsp;
																<a class="btn btn-primary btn-xss has-tooltip"
																	data-placement="top" title=""
																	href="<?php echo base_url(); ?>index.php/privatecar/add_package_type/<?php echo $k->package_id; ?>"
																	...
																	href='<?php echo base_url(); ?>index.php/privatecar/delete_package_type/<?=$k->package_id;?>'>
