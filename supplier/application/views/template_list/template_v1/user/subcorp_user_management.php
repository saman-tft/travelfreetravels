...
<ul class="nav nav-tabs" role="tablist" id="myTab">
	...
	<i class="fa fa-users"></i> <?=(isset($_GET['user_status']) == true ? empty($_GET['user_status']) == true ? 'Inactive' : 'Active' : '')?> Sub corporate List </a>
	</li>
...
{
	return '<a role="button" href="'.base_url().'index.php/user/subcorp_user?'.$_SERVER['QUERY_STRING'].'&	eid='.$id.'" class="btn btn-sm btn-primary">
