...
<span class="error_msg"><?php  if(isset($message)){ echo $message; }?></span>
...
<div class="tab-content">
   <div id="fromList" class="clearfix tab-pane  active " role="tabpanel">
      <div class="panel-body">
         <form class="form-horizontal" role="form" enctype="multipart/form-data" method="POST" action="<?=base_url().'index.php/general/email_configuration' ?>" autocomplete="off" name="home_page_heading">
            <fieldset form="promo_codes_form_edit">
               ...
               <div class="form-group">
                  ...
                  <label form="promo_codes_form_edit" for="header_icon" class="col-sm-3 control-label">Password</label>
                  	<div class="col-sm-6">
                  		<input type="text" id="password" class="form-control" placeholder="Password" name="password" required value="<?php echo $password; ?>" >
                  	</div>
               </div>
                  <div class="form-group">
