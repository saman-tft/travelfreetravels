...
<tbody>
 ...
 <tr>
                              ...
                              <tr>
                                <td align="center" height="50" style="color: #666;font-family: arial;font-size: 26px;font-weight: bold;line-height: 36px;padding: 10px 0 0px; text-align: center;" valign="middle"><?=@domain_name()?>
                                !</td>
                              </tr>
         <tr>
...
<p class="" style="color:#666;margin:0 10px;">Dear <strong><?php echo $first_name.''.$last_name;?>,</strong></p>
<br/>
<p class="color:#666;"style="margin:0 10px">Welcome to <?php echo domain_name();?> Your login information is mentioned below.Please keep your Username and Password secure.

</p>
<br/>
<table width="100%" style=" background-color:#eaeaea; font-size: 13px; color: #656565; font-family: arial;" cellpadding="5">
   <tr>
                           <td colspan="2" height="20" style="font-size:1px; line-height:1px; mso-line-height-rule: exactly;">&nbsp;</td>
                        </tr>
   <tr>
      <td colspan="2" style=" color: #666;font-family: arial;font-size: 16px;text-align: center;font-weight: normal;">Login</td>
     <td></td>
   </tr>
   <tr>
      <td style=" color: #666;font-family: arial;font-size: 16px;text-align: right;width: 50%;font-weight: normal;">Username :</td>
