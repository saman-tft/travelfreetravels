  ...
  ?>
      <header class="main-header">
        ...
        <a href="<?php echo base_url()?>" class="logo bg-white">
          ...
          <span class="logo-mini"><img src="<?php echo $GLOBALS['CI']->template->domain_images('TMX3644721637051232logo-loginpg.png'); ?>" alt="logo" class="img-responsive center-block"></span>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img src="<?php echo $GLOBALS['CI']->template->domain_images($GLOBALS['CI']->entity_image) ?>" class="user-image" alt="User Image"/>
                  <span class="hidden-xs"><?php echo $GLOBALS['CI']->entity_name?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <!-- <img src="<?=$GLOBALS['CI']->template->template_images('face.png')?>" class="img-circle" alt="User Image"/> -->
                    <img src="<?php echo $GLOBALS['CI']->template->domain_images($GLOBALS['CI']->entity_image); ?>" class="img-circle" alt="User Image"/>
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
                <?php
                if(!empty($GLOBALS['CI']->entity_image))
                {
                  $logo_img = $GLOBALS['CI']->template->domain_images($GLOBALS['CI']->entity_image);  
                }
                else
                {
                 $logo_img = base_url()."../extras/system/template_list/template_v1/images/face.png";   
                }
                ?>
              <img src="<?php echo $logo_img;?>" class="img-circle" alt="Supplier Profile Image" />
            </div>
