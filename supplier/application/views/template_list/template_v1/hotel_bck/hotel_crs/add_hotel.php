...
<div class="bodyContent">
	<div class="panel panel-default clearfix">
		...
		<!-- PANEL HEAD START -->
          ...
          <div class="clearfix"></div>
				<form method="post"  id="hotel" name="hotel" action="<?php echo site_url()."/hotels/save_hotel_data"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
				...
				<?php if($supplier_rights == 1) { ?>
                    ...
                    <?php echo form_error('city_name',  '<span for="field-1" class="validate-has-error">', '</span>'); ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control"  id="phone_number" name="phone_number" maxlength="15" placeholder="Phone Number" data-validate="required" placeholder="Postal Code" data-rule-number="true" data-message-required="Please enter the Phone Number">
									</div>
								</div>
                <div class="form-group">
                  <label for="field-1" class="col-sm-3 control-label">Fax Number</label>                  
                  <div class="col-sm-5">
                    <input type="text" class="form-control"   name="fax_number" maxlength="15" placeholder="Fax Number"  >
                  </div>
                </div>
								<div class="form-group">
