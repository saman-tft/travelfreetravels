	...
	<div class="panel panel-default clearfix">
		...
		<!-- PANEL HEAD START -->
			...
			<div class="panel-body">
				<form method="post" id="hotel11" name="hotel11" action="<?php echo site_url()."/hotels/upload_hotel_image"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
...
<input type="hidden" name="hotel_id" value="<?= $hotel_data->id?>">
								...
								<div class="form-group">
									...
									<a href="<?php echo site_url().'/hotels/room_crs_list/'.$hotel_data->id;?>" class="btn btn-info addnwhotl">Go to Rooms</a>
									</div>
								</div>
				</form>
			</div>
						...
						<tr>
							...
							<td class="center">
								...
								if($list->status == "ACTIVE")
									{ 
								?>
									<a href="<?php echo site_url()."/hotels/inactive_hotel_image/".$list->hotel_id."/".$list->id; ?>" class="btn btn-orange btn-sm btn-icon icon-left my-inactve"><i class="entypo-eye"></i>InActive</a>
								<?php 
								}
								else
								{ ?>
									<a href="<?php echo site_url()."/hotels/active_hotel_image/".$list->hotel_id."/".$list->id; ?>" class="btn btn-green btn-sm btn-icon icon-left my-actve"><i class="entypo-check"></i>Active</a>
								<?php 
								} 
								?>
									 <a href="<?php echo site_url()."/hotels/delete_hotel_images/".$list->hotel_id."/".$list->id; ?>"  class="btn btn-danger btn-sm btn-icon icon-left"><i class="entypo-cancel"></i>Delete</a>
							</td>
						</tr>
					<?php 
					}
