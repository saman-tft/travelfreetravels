...
<div class="bodyContent">
	<div class="panel panel-default clearfix">
		...
		<!-- PANEL HEAD START -->
          ...
          <div class="clearfix"></div>
				<form method="post"  id="hotel" name="hotel" action="<?php echo site_url()."/hotels/update_hotel_datas/{$hotel_id}"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
      ...
      uploadField.onchange = function() {
		...
		function select_city(country_id,selected){
		 ...
		 if (country_id != '') {         	  
          ...
          $.ajax({
            url: '<?php echo site_url(); ?>/hotels/get_city_name/'+country_id+'/'+selected,
