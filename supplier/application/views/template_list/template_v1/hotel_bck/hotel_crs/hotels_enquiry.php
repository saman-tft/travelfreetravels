    ...
    <div id="Package" class="bodyContent col-md-12">
        <div class="panel panel-default">
            ...
            <div class="table-responsive scroll_main">
                <table class="table table-bordered r table-striped table-condensed sstabl">
                    <thead>
                    <tr>
                        <th>SN</th>
                        <th>Action</th>
                    ...
                    $sn = 1;
                    foreach ($hotels_enquiry as $key => $data) {
                        //debug($data);
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function()
        {
            ...
            $('.remark_submit').click(function(){
                ...
                $.ajax({
                    url:'<?php echo base_url('index.php/hotels/add_agent_remark')?>',
                    method:'post',
