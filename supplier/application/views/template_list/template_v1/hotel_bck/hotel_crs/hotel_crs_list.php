					...
					?>
						<tr>
							...
							<td class="center">
								...
								<a href="<?php echo site_url()."/hotels/edit_hotel/".base64_encode(json_encode($list->id)); ?>" class="btn btn-default btn-sm btn-icon icon-left"><i class="entypo-pencil"></i>Edit</a>	
								<a href="<?php echo site_url()."/hotels/hotel_crs_images/{$list->id}";?>" class="btn btn-default btn-sm btn-icon icon-left"><i class="entypo-pencil"></i>Images</a>	
								<a href="<?php echo site_url()."/hotels/room_crs_list/{$list->id}";?>" class="btn btn-default btn-sm btn-icon icon-left"><i class="entypo-pencil"></i>Rooms</a>	
