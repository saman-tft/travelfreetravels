...
<!-- <div class="col-md-5 col-md-offset-3">
								<input type="radio" name="default_price" value="default" id="default_price" class="">&nbsp;&nbsp;<span>Default Price</span>
                                </div>
<div class="col-md-12" id="default_price_div" style="display: none;">
	<div class="row">
		<div class="panel panel-default">
			<div class="panel-heading"><span>Default Price In AED</span>
			</div>
			<div class="panel-body">
				<table class=" table table-bordered table-striped">
					<thead>
						<tr>
							<th><span>Infant Price/ Person (0-2)</span></th>
							<th><span>Child Price/ Person (3-18)</span></th>
							<th><span>Single Adult Price</span></th>
							<th><span>Double Adult Price</span></th>
							<th><span>Triple Adult Price</span></th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td><input type="text" class="form-control price_elements" data-rule-required='true' placeholder="Enter Price" name="infant_price"></td>
							<td><input type="text" class="form-control price_elements" data-rule-required='true' placeholder="Enter Price" name="child_price"></td>
							<td><input type="text" class="form-control price_elements" data-rule-required='true' placeholder="Enter Price" name="single_adult_price"></td>
							<td><input type="text" class="form-control price_elements" data-rule-required='true' placeholder="Enter Price" name="double_adult_price"></td>
							<td><input type="text" class="form-control price_elements" data-rule-required='true' placeholder="Enter Price" name="triple_adult_price"></td>
						</tr>
					</tbody>
				</table>
			</div>
