	...
	<div class="page-container <?php if(isset($header) && $header == 'header_top'){ echo "horizontal-menu"; } ?> <?php if(isset($header) && $header == 'header_right'){ echo "right-sidebar"; } ?>  <?php if(isset($sidebar)){ echo $sidebar; } ?>">
		...
		<div class="main-content">
			...
			<ol class="breadcrumb bc-3">						
				...
				<li><a href="<?php echo site_url()."/roomrate"; ?>">Room Rate Management</a></li>
				...
				<div class="col-md-12">					
					<div class="panel panel-primary" data-collapsed="0">					
						...
						<div class="panel-body">							
							<form id="room_rate_details11" method="post" action="<?php echo site_url()."/roomrate/update_hotel_room_rate/".base64_encode(json_encode($room_rate_id)); ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">				
							<?php if($supplier_rights == 1) { ?>
							...
							<?php } ?>
								...
								<div class="form-group">
									<div class="col-md-3">
										<h5 style="color:red">Note : Currency is in <?= get_application_currency_preference() ?></h5>
									</div>
								</div>
								<!--
								<?php 
								...
								<div class="form-group">
									...
									<!--
									<?php 
									  //if(isset($service_charge)) { echo $service_charge; }
									?>	
									-->							
									<div class="col-sm-3">
									...
									<?php if($settings[0]->child_group_c != ''){ ?>
										<div class="col-sm-2">
											<label for="field-1" class="col-sm-12 control-label">Child Price/ Person (<?php echo $settings[0]->child_group_c; ?>)</label>									
											 <input type="text" class="form-control" maxlength="7" id="child_price_ge_c" name="child_price_ge_c" value="<?php if(isset($child_price_ge_c)) { echo $child_price_ge_c;} ?>" data-message-required="Please Enter the Child Price" />
										</div>
									<?php } ?>
									<?php if($settings[0]->child_group_d != ''){ ?>
										<div class="col-sm-2">
											<label for="field-1" class="col-sm-12 control-label">Child Price/ Person (<?php echo $settings[0]->child_group_d; ?>)</label>									
											 <input type="text" class="form-control" maxlength="7" id="child_price_ge_d" name="child_price_ge_d" value="<?php if(isset($child_price_ge_d)) { echo $child_price_ge_d;} ?>"  data-message-required="Please Enter the Child Price" />
										</div>
									<?php } ?>
									<?php if($settings[0]->child_group_e != ''){ ?>
										<div class="col-sm-2">
											<label for="field-1" class="col-sm-12 control-label">Child Price/ Person (<?php echo $settings[0]->child_group_e; ?>)</label>									
											 <input type="text" class="form-control" maxlength="7" id="child_price_ge_e" value="<?php if(isset($child_price_ge_e)) { echo $child_price_ge_e;} ?>" name="child_price_ge_e" data-message-required="Please Enter the Child Price" />
										</div>
									<?php } ?>										
		...
		*/
		...
		function removeLastRoom1(v){		  
			...
			if(hotel_blockout_id > 0){
				...
				if(conval == true){
					$.ajax({
            			url: '<?php echo base_url(); ?>roomrate/delete_blockout_date/' + hotel_blockout_id,
            			success: function (data, textStatus, jqXHR) {                     	            	            	              			
