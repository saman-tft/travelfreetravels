...
<div class="bodyContent">
    ...
    <a href="<?php echo site_url()."/hotels/room_crs_list/{$data->hotel_id}"; ?>" class="btn btn-primary addnwhotl pull-right">Back</a>
		<!-- PANEL HEAD START -->
          ...
          <div class="clearfix"></div>
				<form method="post"  id="hotel" name="hotel" action="<?php echo site_url()."/hotels/update_cancellation_policy_data/{$data->id}"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
