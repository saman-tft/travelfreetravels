...
<div class="bodyContent">
    ...
    <a href="<?php echo site_url()."/hotels/room_crs_list/{$hotel_id}"; ?>" class="btn btn-primary addnwhotl pull-right">Back</a>
		<!-- PANEL HEAD START -->
          ...
          <div class="clearfix"></div>
				<form method="post"  id="hotel" name="hotel" action="<?php echo site_url()."/hotels/save_room_details_data"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
				...
				<legend class="form_legend">Add Room</legend>
						...
						<div class="form-group">
								...
								<div class="form-group">							  	   	
									...
									<div class="col-sm-5">
										 <select id="ammenities" name="room_amenities[]" class="ddssselect2" multiple style="width:300px" data-validate="required" data-message-required="Please enter the amenities">										 
