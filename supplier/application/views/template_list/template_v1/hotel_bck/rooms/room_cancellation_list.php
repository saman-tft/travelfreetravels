...
<a href="<?php echo site_url()."/hotels/room_crs_list/{$hotel_id}"; ?>" class="btn btn-primary addnwhotl pull-right">Back</a>
		<a href="<?php echo site_url()."/hotels/add_cancellation_policy/{$hotel_id}/{$room_id}"; ?>" class="btn btn-primary addnwhotl pull-right">Add Cancellation Policy</a>
						...
						<tr>
							...
							<td class="center">
								...
								if($list->status == "ACTIVE")
									{ 
								?>
									<a href="<?php echo site_url()."/hotels/inactive_room_cancel/".$list->id; ?>" class="btn btn-orange btn-sm btn-icon icon-left my-inactve"><i class="entypo-eye"></i>InActive</a>
								<?php 
								}
								else
								{ ?>
									<a href="<?php echo site_url()."/hotels/active_room_cancel/".$list->id; ?>" class="btn btn-green btn-sm btn-icon icon-left my-actve"><i class="entypo-check"></i>Active</a>
								<?php 
								} 
								?>
							...
							<td>
							    <a href="<?php echo site_url()."/hotels/edit_cancellation_policy/".$list->id; ?>" class="btn btn-primary btn-sm btn-icon icon-left my-actve"><i class="entypo-edit"></i>Edit</a>
							</td>
						</tr>
					<?php 
					}
