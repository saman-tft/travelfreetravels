...
<div class="bodyContent">
	<div class="panel panel-default clearfix">
		...
		<!-- PANEL HEAD START -->
          ...
          <div class="clearfix"></div>
				<form method="post"  id="hotel" name="hotel" action="<?php echo site_url()."/hotels/save_room_price_data"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
				...
				<legend class="form_legend">Add Room Price Info</legend>
						...
						<div class="form-group">
									...
									<div class="col-sm-5">
									<input type="number" name="one_adult" id="one_adult" class="form-control" data-validate="required" data-message-required="Please Select 1 adult price" />	
									</div>
								</div>
						...
						<div class="form-group">
									...
									<div class="col-sm-5">
									<input type="number" name="two_adult" id="two_adult" class="form-control" data-validate="required" data-message-required="Please Select 2 adult price" />	
									</div>
								</div>
						...
						<div class="form-group">
									...
									<div class="col-sm-5">
									<input type="number" name="three_adult" id="three_adult" class="form-control" data-validate="required" data-message-required="Please Select 3 adult price" />	
									</div>
								</div>
						...
						<div class="form-group">
									...
									<div class="col-sm-5">
									<input type="number" name="four_adult" id="four_adult" class="form-control" data-validate="required" data-message-required="Please Select 4 adult price" />	
									</div>
								</div>
						...
						<div class="form-group">
									...
									<div class="col-sm-5">
									<input type="number" name="one_child" id="one_child" class="form-control" data-validate="required" data-message-required="Please Select 1 child price" />	
									</div>
								</div>
						...
						<div class="form-group">
									...
									<div class="col-sm-5">
									<input type="number" name="two_child" id="two_child" class="form-control" data-validate="required" data-message-required="Please Select 2 child price" />	
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<a href="<?=base_url("hotels/room_crs_list/{$hotel_id}")?>"  class="btn btn-primary " >Back to Room List</a>
