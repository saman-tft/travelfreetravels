				...
				<legend class="form_legend">Add Room</legend>
							...
							<input type="hidden" name="hotel_id" id="hotel_id" value="<?php echo $hotel_id; ?>" />
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										 <select id="hotel_type" name="hotel_type" class="form-control" data-validate="required" data-message-required="Please Select the Hotel Room Type">										 
						...
						<div class="form-group">
									<label for="field-1" class="col-sm-3 control-label">Maximum Passengers<span class="text-danger">*</span></label>									
									<div class="col-sm-5">
								...
								<div class="form-group">							  	   	
									...
									<div class="col-sm-5">
										 <select id="ammenities" name="ammenities[]" class="ddssselect2" multiple style="width:300px" data-validate="required" data-message-required="Please enter the ammenities">										 
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select id="star_rating" name="status" class="form-control" data-validate="required" data-message-required="Please Select the Status">
												...
												<option value="DEACTIVE" data-iconurl="">DEACTIVE</option>
