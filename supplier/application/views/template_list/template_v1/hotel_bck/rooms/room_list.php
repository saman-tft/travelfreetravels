...
<div class="bodyContent">
	<div class="panel panel-primary clearfix">
		...
		<a href="<?php echo site_url()."/hotels/hotel_crs_list"; ?>" class="btn btn-primary addnwhotl pull-right">Hotel List</a>
		<a href="<?php echo site_url()."/hotels/add_room_details/{$hotel_id}"; ?>" class="btn btn-primary addnwhotl pull-right">Add Room</a>
		<!-- PANEL HEAD START -->
						...
						<tr>
							...
							<td class="center">
								...
								if($list->status == "ACTIVE")
									{ 
								?>
									<a href="<?php echo site_url()."/hotels/inactive_room/".$list->hotel_id.'/'.$list->id; ?>" class="btn btn-orange btn-sm btn-icon icon-left my-inactve"><i class="entypo-eye"></i>InActive</a><br>
								<?php 
								}
								else
								{ ?>
									<a href="<?php echo site_url()."/hotels/active_room/".$list->hotel_id.'/'.$list->id; ?>" class="btn btn-green btn-sm btn-icon icon-left my-actve"><i class="entypo-check"></i>Active</a><br>
								<?php 
								} 
								?>
							<a href="<?php echo site_url()."/hotels/edit_room/".$list->hotel_id.'/'.$list->id; ?>" class="btn btn-default btn-sm btn-icon icon-left"><i class="entypo-pencil"></i>Edit</a>	<br>
								<a href="<?php echo site_url()."/hotels/room_price_list/".$list->hotel_id.'/'.$list->id; ?>" class="btn btn-default btn-sm btn-icon icon-left"><i class="entypo-pencil"></i>Price Info List</a><br>
								<!--<a href="<?php echo site_url()."/hotels/add_room_price/".$list->hotel_id.'/'.$list->id; ?>" class="btn btn-default btn-sm btn-icon icon-left"><i class="entypo-pencil"></i>Add Price Info</a>-->
								<a href="<?php echo site_url()."/hotels/room_cancellation_list/".$list->hotel_id.'/'.$list->id; ?>" class="btn btn-default btn-sm btn-icon icon-left"><i class="entypo-pencil"></i>Cancellation Policy List</a>
								<!--<a href="<?php echo site_url()."/hotels/add_cancellation_policy/".$list->hotel_id.'/'.$list->id; ?>" class="btn btn-default btn-sm btn-icon icon-left"><i class="entypo-pencil"></i>Add Cancellation Policy</a></td>-->
							</td>
						</tr>
					<?php 
					}
