	...
	<div class="panel panel-default clearfix">
		...
		<!-- PANEL HEAD START -->
			...
			<div class="panel-body">
				<form method="post" name="hotel_type" id="hotel_type" action="<?php echo site_url()."/hotels/update_hotel_type/".base64_encode(json_encode($hotel_types_list[0]->id)); ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
