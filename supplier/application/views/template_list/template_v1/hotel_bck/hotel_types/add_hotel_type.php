	...
	<div class="panel panel-primary clearfix">
		...
		<!-- PANEL HEAD START -->
			...
			<div class="panel-body">
				<form method="post" name="hotel_type" id="hotel_type" action="<?php echo site_url()."/hotels/save_hotel_type_data"; ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">		
