	...
	<div class="panel panel-default clearfix">
		...
		<!-- PANEL HEAD START -->
			...
			<div class="panel-body">
				<form method="post" id="hotel_ammenity" name="hotel_ammenity" action="<?php echo site_url()."/hotels/update_hotel_ammenity/".base64_encode(json_encode($ammenities_list[0]->id)); ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
