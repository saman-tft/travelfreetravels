	...
	<div class="panel panel-default clearfix">
		...
		<!-- PANEL HEAD START -->
			...
			<div class="panel-body">
				<form method="post" name="room_type" id="room_type" action="<?php echo site_url()."/hotels/update_room_types/".base64_encode(json_encode($room_types_list[0]->id)); ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
