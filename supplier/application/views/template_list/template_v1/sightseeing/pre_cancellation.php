<?php
	...
	// $grand_total=$booking_details['product_total_price']+$booking_details['gst']+$booking_details['convinence_amount']-$booking_details['discount'];
	...
	// $grand_total=$booking_details['fare']+$booking_details['gst']+$booking_details['admin_markup'];
 //    debug($booking_details['fare']);
 //    debug($booking_details['gst']);
 //    debug($booking_details['admin_markup']);
					...
					<div class="amnt_disply">
						...
						<div class="amnt_paid"><?php echo $booking_details['currency'];?>
							...
							if($module=='b2b'){
								...
								echo ceil($booking_details['product_total_price']+$booking_details['convinence_amount']+$booking_details['gst']-$booking_details['discount']);
								//echo $grand_total;
							}
						?>
