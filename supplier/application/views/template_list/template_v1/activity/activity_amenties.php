<style>.table.dataTable thead .sorting{background-image:none;}</style>
...
<div id="Package" class="bodyContent col-md-12 yhgjk">
	<div class="panel panel-default">
			...
			<div class="panel-title">
				<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
					...
					<li role="presentation" class="active" id="add_package_li"><a
						...
						data-toggle="tab">Excursion Amenities </a></li>
		...
		<div class="panel-body">
			<!-- PANEL BODY START -->
			<form
				action="<?php echo base_url(); ?>index.php/activity/activity_amenties_save"
	...
	<!-- PANEL WRAP END -->
        ...
        foreach ($activity_amenties as $key => $data) {
        if($data['status']==1)
        {
        ...
        echo '<tr>
				...
				<div class="dropdown2" role="group">
				   <div class="dropdown slct_tbl pull-left sideicbb">
					   <i class="fa fa-ellipsis-v"></i>  
					    <ul class="dropdown-menu sidedis" style="display: none;">
				           <li><a class="sidedis sideicbb1" data-placement="top" href="'.base_url().'index.php/activity/edit_activity_amenties/'.$data['id'].'"
				data-original-title="Edit Excursion Amenities"> <i class="glyphicon glyphicon-pencil"></i> Edit
				</a> </li>
              ...
              <td>'.$data['activity_amenties'].'</td>';
        //echo '<td>'.$galleryImages.'</td>';
        echo '<td>'.$status.'</td>';
        if($data['status']==1)
        {
        echo '<td>
              <a class="" data-placement="top" href="'.base_url().'index.php/activity/activation_activity_amenties/'.$data['id'].'/0"
              data-original-title="Deactivate Excursion Amenities"> <i class="glyphicon glyphicon-th-large"></i></i> De-activate
              </a>
              </td>
              </tr>';
        }
        ...
        {
        echo '<td>
              <a class="" data-placement="top" href="'.base_url().'index.php/activity/activation_activity_amenties/'.$data['id'].'/1"
              data-original-title="Activate Excursion Amenities"> <i class="glyphicon glyphicon-th-large"></i></i> Activate
              </a>
              </td>
              </tr>';
        } 
		...
		$(document).ready(function()
		{
          ...
          $(".callDelete").click(function() { 
            $id = $(this).attr('id'); //alert($id);
		        ...
		        if($response==true){ window.location='<?=base_url()?>index.php/activity/delete_activity_amenties/'+$id; } else{}
           });
		});
        </script>
       <?php
...
function manage_details(id,operation)
{
      ...
      var theme_tbl = 'activity_amenties';
