            ...
            <div class="col-md-12">
              ...
              <div class='form-group clearfix'>
                ...
                <div class='col-sm-4 controls'>
                  ...
                  <input type='radio' id='refundable_no' name='refundable' value='N'>&nbsp;<label for='sunday_0'>Non-Refundable</label><span id="refundable_msg" style="display: none;color: red;float:left;">(The current excursion will not available for excursion canellation policy)</span>
                  <!-- <input type="text" name="excludes" id="excludes" data-rule-required='true' class='form-control'> -->
