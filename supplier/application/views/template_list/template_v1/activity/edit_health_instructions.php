...
<div id="Package" class="bodyContent col-md-12">
    <div class="panel panel-default">
            ...
            <div class="panel-title">
                <ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
                    ...
                    <li role="presentation" class="active" id="add_package_li"><a
                            ...
                            data-toggle="tab">Edit Health Restriction  </a></li>          
                </ul>
            </div>
        </div>
        <!-- PANEL HEAD START -->
        <div class="panel-body">
            <!-- PANEL BODY START -->
            <form
                action="<?php echo base_url(); ?>index.php/activity/edit_health_instructions_save"
                            ...
                            <div class='form-group'>
                                ...
                                <div class='col-sm-8 controls'>
                                    <input type="text" name="health_instructions" id="health_instructions"
                                           ...
                                           class='form-control add_pckg_elements' required value="<?php echo string_replace_encode($health_instructions_details['health_instructions']);?>">
                                </div>
                            </div>
                            ...
                            <div class='' style='margin-bottom: 0'>
                                <div class='row'>
                                    <div class='col-sm-9 col-sm-offset-3'>  
                                        <input type="hidden" name="id" value="<?= $health_instructions_details['id'] ?>">                       
                                        <button class='btn btn-primary' type='submit'>Update</button>
                                        <a href="<?php echo base_url(); ?>index.php/activity/health_instructions" class='btn btn-primary' style="color:white;">Back</a>
