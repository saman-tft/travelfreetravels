...
<div id="Package" class="bodyContent col-md-12">
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<!-- PANEL BODY START -->
			<form
				action="<?php echo base_url(); ?>index.php/activity/region_save"
	...
	<!-- PANEL WRAP END -->
        ...
        {
        echo '<td>
              <a class="" data-placement="top" href="'.base_url().'index.php/activity/activation_nationality_region/'.$data['id'].'/0"
        ...
        {
        echo '<td>
              <a class="" data-placement="top" href="'.base_url().'index.php/activity/activation_nationality_region/'.$data['id'].'/1"
        ...
        echo '<td class="center">
              ...
              <li><a class="sidedis sideicbb1" data-placement="top" href="'.base_url().'index.php/activity/edit_nationality_region/'.$data['id'].'"
		...
		$(document).ready(function()
		{
          ...
          $(".callDelete").click(function() { 
            $id = $(this).attr('id'); //alert($id);
		        ...
		        if($response==true){ window.location='<?=base_url()?>index.php/activity/delete_nationality_region/'+$id; } else{}
           });
		});
        </script>
       <?php
