												...
												<form action='' method="post" enctype="multipart/form-data"
													...
													<div class='form-group'>
														<label class='control-label col-sm-3'
															for='validation_company'>Add  Display Image</label>
										...
										<div class='box-content box-no-padding'>
											...
											<tr>
																...
																<td><a data-id="<?php echo $travel->traveller_image; ?>" data-toggle="modal" class='openimg' href="#openModalx">  <img
																		width="50" title="" alt=""
																		src="<?php echo $GLOBALS['CI']->template->domain_upload_acty_images($travel->traveller_image); ?>"></a></td>
																<td>
                                      ...
                                      <?php } else { ?>
                                          <select
																	onchange="activate(this.value);">
																		<option
																			value="<?php echo base_url() ?>activity/update_traveller_image_status/<?php echo $travel->package_id; ?>/<?php echo $travel->img_id; ?>/1">Activate</option>
																		<option
																			value="<?php echo base_url() ?>activity/update_traveller_image_status/<?php echo $travel->package_id; ?>/<?php echo $travel->img_id; ?>/0"
																			selected>De-activate</option>
																</select>
                                      <?php } ?>
                        </td>
																<td class="center"><a
																	href="<?php echo base_url() ?>activity/delete_traveller_img/<?php echo $travel->img_id; ?>/<?php echo $travel->package_id; ?>"
