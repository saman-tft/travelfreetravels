...
<div id="Package" class="bodyContent col-md-12 yhgjk" >
    <div class="panel panel-default">
            ...
            <div class="panel-title">
                <ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
                    ...
                    <li role="presentation" class="active" id="add_package_li"><a
                            ...
                            data-toggle="tab">Add Sub Excursion Type  </a></li>          
                </ul>
            </div>
        </div>
        <!-- PANEL HEAD START -->
        <div class="panel-body">
            <!-- PANEL BODY START -->
            <form
                action="<?php echo base_url(); ?>index.php/activity/add_sub_category_save"
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane active" id="add_package">
                        <div class="col-md-12">
                            ...
                            <div class='form-group'>
                                <label class='control-label col-sm-3' for='validation_current'>Sub Excursion Type
                                </label>
                                <div class='col-sm-4 controls'>
        ...
        <div class="dropdown2" role="group" style="float:right">
            ...
            <tbody>     
                <?php
        $sn = 1;
        // debug($sub_category_details);exit;
        foreach ($sub_category_details as $key => $data) {
        if($data['status']==1)
        {
                ...
                <div class="dropdown2" role="group">
                   <div class="dropdown slct_tbl pull-left sideicbb">
                       <i class="fa fa-ellipsis-v"></i>  
                        <ul class="dropdown-menu sidedis" style="display: none;">
                           <li><a class="sidedis sideicbb1" data-placement="top" href="'.base_url().'index.php/activity/edit_sub_activity/'.$data['id'].'/'.$data['activity_type_id'].'"
        data-original-title="Edit Sub Excursion Type"> <i class="glyphicon glyphicon-pencil"></i> Edit
        </a> </li>
                           <li> <a class="sidedis sideicbb3 callDelete" id="'.$data['id'].'" href="'.base_url().'index.php/activity/delete_sub_activity/'.$data['id'].'/'.$data['activity_type_id'].'"> 
                <i class="glyphicon glyphicon-trash"></i> Delete</a></li>
                       </ul>
                    </div>
                </div>
              </td>
              <td>'.$data['activity_sub_category'].'</td>';
        ...
        {
        echo '<td>
              <a class="" data-placement="top" href="'.base_url().'index.php/activity/activation_sub_activity/'.$data['id'].'/0/'.$data['activity_type_id'].'"
        ...
        {
        echo '<td>
              <a class="" data-placement="top" href="'.base_url().'index.php/activity/activation_sub_activity/'.$data['id'].'/1/'.$data['activity_type_id'].'"
...
function manage_details(id,operation)
{
      ...
      if(checkval=='')
      {
        alert('Please Select Any Sub Excursion Type!!')
        return false;
      }
      if(operation=='delete'){
     var result = confirm("Are you sure to delete?");
      ...
      var theme_tbl = 'activity_sub_category';
