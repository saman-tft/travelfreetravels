							...
							<table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #9a9a9a;">
								<tbody>
									...
									<tr>
										...
										<td><span> <?php echo number_format(($Tax+$booking_details['admin_markup']+$booking_details['agent_markup']+$GST+($booking_details['convinence_amount'])), 2)?></span></td>
									</tr>
									<?php if($GST > 0){?>
	                                 <!-- <tr>
	                                    <td><span>GST</span></td>
									...
									<tr>
										...
										<td style="border-top:1px solid #ccc"><span style="font-size:13px"><?=(@$booking_details['grand_total'])?></span></td>
									</tr>
								</tbody>
							</table>
						</td>
