                  ...
                  <tbody>
                     <tr>
                      ...
                      ?></strong>                              </td>
                                       ...
                                       <table width="100%" cellpadding="5" style="padding: 10px;font-size: 13px;padding:5px;">
                                          <tbody>
                                             ...
                                             <?php $url=base_url(); 
                                                    ...
                                                    // echo $imgurl."extras/custom/TMX1512291534825461/images/".;
                                                   // $ss=$imgurl.$GLOBALS['CI']->template->domain_upload_pckg_images($transfer_image);
                                                    //debug($ss);exit;

                                              ?>
                                                <td style="padding:10px 0">
                                                <?php if($transfer_image):?>
                                                   <img style="width:160px;height:107px;" src="<?=$imgurl.$GLOBALS['CI']->template->domain_upload_pckg_images($transfer_image)?>"></td>
                                                <?php else:?>
                                 ...
                                 <tr>
                                    <td style="background-color:#00a9d6;border: 1px solid #00a9d6; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?=DOMAIN_LINK_URL.SYSTEM_IMAGE_DIR.'hotel_v.png'?>" /> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Transfers Details</span></td>
                                 </tr>
                                 <tr>
