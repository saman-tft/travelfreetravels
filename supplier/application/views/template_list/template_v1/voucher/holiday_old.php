...
<div class="table-responsive" id="tickect_hotel">
	...
	<table class="table" style="border-collapse: collapse; background: #f5f5f5; border: 15px solid #fff; font-size: 13px; line-height: 18px; margin:0 auto 15px; font-family: arial; max-width:900px"
...
<tr>
                          ...
                          echo $base_fare;
												...
												<tr><td style="width: 50%;">Taxes</td>
													<td style="font-size:13px; width: 20%; text-align: right; font-weight:normal;line-height:18px;">
													<?php 
													echo sprintf("%.2f", $attributes['total_markup']+$attributes['gst'])." ".$CurrencyCode;
													 }
													 ?>
												...
												<tr>
												<td style="font-size:13px; width: 20%; font-weight:normal;line-height:18px;">Convenience Fee</td>
													<td style="font-size:13px; width: 20%; text-align: right; font-weight:normal;line-height:18px;">
													<?php

                         echo $discount = sprintf("%.2f", $convinence_amount)." ".$CurrencyCode;
													?>
												...
												<tr>
												<td style="font-size:13px; width: 20%; font-weight:normal;line-height:18px;">Discount</td>
													<td style="font-size:13px; width: 20%; text-align: right; font-weight:normal;line-height:18px;">
													<?php
													$minus ='';
													if(!empty($attributes['promocode_discount'])){

														$minus = '-';
													}

                         echo $minus.' '.$discount = sprintf("%.2f", $attributes['promocode_discount'])." ".$CurrencyCode;
													?>
												...
												<tr>
													...
													<td style="font-size:13px; width:50%;  font-weight:normal;line-height:18px;text-align:right;"><strong>
													<?php 
													$grand_total=$attributes['tour_totalamount']+$attributes['total_markup']+$attributes['gst']+$attributes['cv']-$attributes['promocode_discount'];
													echo $grand_total;
													 ?></strong></td>
												</tr>
											</table>
