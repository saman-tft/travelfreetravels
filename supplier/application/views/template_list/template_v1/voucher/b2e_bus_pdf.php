                           ...
                           <tbody>
                                       ...
                                       <tbody>
                                          <tr>
                                             <td style="padding:0;border: 1px solid #00a9d6;"><table border="0" cellspacing="0" cellpadding="5" style="font-size:9pt;background-color:#00a9d6;border: 1px solid #00a9d6; padding:0;">
                                                   <tbody>
                                                      <tr>
                                                         <td style=" color:#fff"><img width="16" src="<?=$img_url.SYSTEM_IMAGE_DIR.'bus_v.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Reservation Ticket (<?php echo ucfirst($booking_details['departure_from']).' To '.ucfirst($booking_details['arrival_to']);?>)</span></td>
                                                      </tr>
                                                   </tbody>
                                                </table>
                                             </td>
                              ...
                              <tr>
                                 <td style="padding:0;"><table border="0" cellspacing="0" cellpadding="5" style="font-size:9pt;background-color:#666666;border: 1px solid #666666; padding:0;">
                                       <tbody>
                                          <tr>
                                             <td style=" color:#fff"><img width="16" src="<?=$img_url.SYSTEM_IMAGE_DIR.'people_group.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Traveler(s) Information</span></td>
                                          </tr>
                                       </tbody>
                                    </table>
                                 </td>
                              ...
                              <tr>
                                 <td style="padding:0;">
                                 <table cellspacing="0" cellpadding="5" width="100%" style="font-size:9px; padding:0;">
                                       <tbody>
                                          <tr>
                                             <td width="50%" style="padding:0;padding-right:14px;">
                                             <table cellspacing="0" cellpadding="5" width="100%" style="font-size:9px; padding:0;border:1px solid #9a9a9a;">
<tbody>
<tr>
...
<td style="padding:5px"><span><?=@round($booking_details['fare'])?></span></td>
</tr>
<tr>
<td style="padding:5px"><span>Taxes &amp; Fees</span></td>
<td style="padding:5px"><span><?=@round($booking_details['gst']+$booking_details['admin_markup']);//@$total_markup;?></span></td>
</tr>

<?php
// debug($booking_details);exit;
if($booking_details['convinence_amount'] > 0){?>
<tr>
<td style="padding:5px"><span>Convenience Fees</span></td>
<td style="padding:5px"><span><?=@round($booking_details['convinence_amount'])?></span></td>
</tr> 
<?php } ?>
<?php if($booking_details['discount']!= 0){?>
<tr>
<td style="padding:5px"><span>Discount</span></td>
<td style="padding:5px"><?php  if($booking_details['discount']!= 0){echo "-";}?> <span><?=@round($booking_details['discount'])?></span></td>
</tr>
<?php }?>
<tr>
<td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px">Total Fare</span></td>
<td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?=@round($booking_details['fare']+$booking_details['gst']+$booking_details['admin_markup']+$booking_details['convinence_amount']-$booking_details['discount'])?></span></td>
</tr>
</tbody>
</table>
                                             </td>
