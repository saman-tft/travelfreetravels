...
<div class="table-responsive" style="width:100%; position:relative" id="tickect_hotel">
   <table class="table" cellpadding="0" cellspacing="0" width="100%" style="font-size:13px; font-family: 'Open Sans', sans-serif; max-width:900px; margin:0px auto;background-color:#fff; padding:50px 45px;">
      <tbody>
         <tr>
                  ...
                  <tr>
                     <td style="padding: 0px;">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
                                 ...
                                 <table width="100%" cellpadding="5" style="padding: 10px;font-size: 13px;padding:5px;">
                                    ...
                                    <tr>
                                       <?php if($booking_details['thumb_image']):?>
                                          <td style="padding:10px 0"><img style="width:160px;height:107px;" src="<?=$image_baseurl.'/'.$booking_details['thumb_image'];?>" /></td>
                                       <?php else:?>
                                       ...
                                       <?php endif;?>
                                       <td valign="top" style="padding:10px;"><span style="line-height:30px;font-size:16px;color:#00a9d6;vertical-align:middle;font-weight: 600;"><?php echo $booking_details['hotel_name']; ?></span>
                                       <br>
                                       <span style="display: block;line-height:22px;font-size: 13px;"><?php echo $booking_details['hotel_address']; ?> </span>
                                       <br>
                                       
                                       <span style="display: block;line-height:22px;font-size: 13px;"><img style="width:70px;" src="<?php echo $GLOBALS['CI']->template->template_images('star_rating-'.(empty($booking_details["star_rating"]) ? 0 : $booking_details["star_rating"]).'.png'); ?>" /></span></td>

                                       <td width="32%" style="padding:10px 0;text-align: center;"><span style="font-size:14px; border:2px solid #808080; display:block"><span style="color:#00a9d6;padding:5px; display:block;text-transform:uppercase">Booking ID</span><span style="font-size:14px;line-height:35px;padding-bottom: 5px;display:block;font-weight: 600;"><?php echo $booking_details['pnr_no']; ?></span></span></td>
                                    </tr>
                                    </tbody>
                                 </table>
                              </td>
                              ...
                              <td  width="100%" style="border: 1px solid #00a9d6; padding:0px;">
                                 <table width="100%" cellpadding="5" style="padding: 10px;font-size: 13px;padding:5px;">
                                   ...
                                   <td style="background-color:#d9d9d9;padding:5px;color: #333333;">Check-In</td>
                                    ...
                                    <tr>
                                       <td style="padding:5px"><span style="width:100%; float:left"> <?=@date("d M Y",strtotime($itinerary_details['check_in_date']))?></span></td>
                                       <td style="padding:5px"><span style="width:100%; float:left"> 	<?=@date("d M Y",strtotime($itinerary_details['check_out_date']))?></span></td>
                                       <td style="padding:5px" align="center"><?php echo $itinerary_details['room_count']; ?></span></td>
                                       <td style="padding:5px"  width="13%"><?php echo $itinerary_details['room_type_name']; ?></td>
                                       <td style="padding:5px" align="center"><?php echo $adult_count; ?></td>
                                       <td  style="padding:5px" align="center"><?php echo $child_count; ?></td>
                                    </tr>
                                 </table>
                              </td>
                           </tr>
                           <tr><td style="line-height:12px;">&nbsp;</td></tr>
                           <tr>
                              <td style="background-color:#666666;border: 1px solid #666666; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?=SYSTEM_IMAGE_DIR.'people_group.png'?>" /> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Guest Details</span></td>
                           </tr>
                           <tr>
													...
													<table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #9a9a9a;">
														<tbody>
															...
															<tr>
																...
																<td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?php echo $booking_details['admin_currency']; ?> <?php echo number_format($booking_details['total_room_price'], 2); ?></span></td>
															</tr>
														</tbody>
													</table>
												</td>
 ...
 -->							<tr><td style="line-height:12px;">&nbsp;</td></tr>
  ...
  onclick="document.getElementById('printOption').style.visibility = 'hidden'; print(); return true;"
