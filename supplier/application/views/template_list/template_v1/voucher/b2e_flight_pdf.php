                           ...
                           <table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;border:1px solid #9a9a9a;">
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td style="line-height: 13px;"><span> <?php echo number_format(($Tax + $booking_details['admin_markup'] - $booking_details['admin_commission'] + $booking_details['admin_tds'])+$GST, 2)?></span></td>
                                 </tr>
                                 <?php if($GST > 0){?>
                                 <!-- <tr>
                                    <td><span>GST</span></td>
