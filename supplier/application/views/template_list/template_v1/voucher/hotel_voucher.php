                     ...
                     <td style="padding: 0px;">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
                              ...
                              <td>
                                 ...
                                 <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tr>
                                       ...
                                       <td style="padding: 0px;"><img style="width:200px;" src="<?='https://travelfreetravels.com/extras/custom/'.CURRENT_DOMAIN_KEY.'/images/TMX3644721637051232logo-loginpg.png'?>" alt=""></td>
                                 ...
                                 <table width="100%" cellpadding="5" style="padding: 10px;font-size: 13px;padding:5px;">
                                    ...
                                    <tr>
                                       ...
                                       <?php if($attributes['HotelImage'] != '/'):?>
                                          ...
                                          <td class="htldefaimg" style="padding:10px 0"><img style="width:160px;" src="<?=$attributes['HotelImage'];?>" alt="" /></td>

                                       <?php else:?>

                                          <td class="htldefaimg" style="padding:10px 0"><img style="width:160px;" src="<?=$GLOBALS['CI']->template->template_images("default_hotel_img.jpg");?>" alt="" /></td>

                                       <?php endif;?>

                                       <td valign="top" style="padding:10px;"><span style="line-height:30px;font-size:16px;color:#2196f3;vertical-align:middle;font-weight: 600;"><?php echo $booking_details['hotel_name']; ?></span><br><span style="display: block;line-height:22px;font-size: 13px;"><?php echo $booking_details['hotel_address']; ?> </span><br><span style="display: block;line-height:22px;font-size: 13px;"><img style="width:70px;" src="<?php echo 'https://travelfreetravels.com/extras/system/template_list/template_v1/images/star_rating-'.$attributes["StarRating"].'.png'; ?>" alt="" /></span></td>
                           ...
                           <tr>
                              ...
                              <td style="background-color:#666666;border: 1px solid #666666; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?=base_url().SYSTEM_IMAGE_DIR.'people_group.png'?>" alt="" /> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Guest(s) Details</span></td>
...
<script type="text/javascript">
    ...
    function printDiv(divName) {
     ...
     document.title = "Hotel Ticket-Alkhaleej";
