                                    ...
                                    <table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;border:1px solid #9a9a9a;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="border-bottom:1px solid #ccc"><span style="font-size:8pt">Amount ( <?php echo $currency_icon ?> )</span>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="line-height: 13px;"><span> <?php echo number_format(($currency_conversion_rate * $Tax + $booking_details['admin_markup'] - $booking_details['admin_commission'] + $booking_details['admin_tds'])+$GST, 2) ?></span></td>
                                            </tr>
                                           <!--  <?php if ($GST > 0) { ?>
                                                <tr>
                                                    <td><span>GST</span></td>
                                            ...
                                            <?php } ?> -->
                                            <tr>
                                            <td><span>Convienience Fees</span></td>
                                            <td><span> <?php echo round($booking_details['convinence_amount'],2)?></span></td>
                                            </tr>
...
# Checking Cabin Baggage
                                    ...
                                    if (is_int($segment_details_v['cabin_baggage'])) {
                                        ...
                                        $BaggageSegment_cabin .= 'Cabin Baggage : ' . @$segment_details_v['from_airport_code'] . ' To ' . @$segment_details_v['to_airport_code'] . ' (Per Adult :' . $segment_details_v['cabin_baggage']/$adult_count . ' & Per Child : '.$segment_details_v['cabin_baggage']/$adult_count.')<br />';
                                        $TotalBaggageCabin = $segment_details_v['cabin_baggage'];
                                    }
