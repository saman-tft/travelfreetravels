                        ...
                        <td><table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;border:1px solid #9a9a9a;">
                            <tbody>
                              <tr>
                                ...
                                <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?php echo roundoff_number($booking_details['fare']); ?></span></td>
                             </tr> 
                             <?php if($booking_details['gst'] > 0){?>
                             <tr>
                                <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px">Taxes & Fees</span></td>
                                <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?php echo roundoff_number($booking_details['gst']+$booking_details['admin_markup']); ?></span></td>
                             </tr> 
                             <?php } ?>                                                        
                              <tr>
