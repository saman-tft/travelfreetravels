                                          ...
                                          <tr>
                                                ...
                                                <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #9a9a9a;">
                                                   <tbody>
                                                      ...
                                                      <tr>
                                                         ...
                                                         <!-- <td style="padding:5px"><span><?=@$booking_details['fare'];?></span></td> -->
                                             ...
                                             <?php }?>
                                                      <tr>
                                                         ...
                                                         <!-- <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?=@$booking_details['fare']+$booking_details['gst']+$booking_details['admin_markup']+$booking_details['convinence_amount']-$booking_details['discount']?></span></td> Commented -->


                                                         <!-- <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?=@$booking_details['fare']+$GST+$booking_details['admin_markup']+$booking_details['agent_markup']?></span></td> -->
