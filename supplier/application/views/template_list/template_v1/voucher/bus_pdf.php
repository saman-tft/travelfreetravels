                    ...
                    if($total_markup > 0 ){
                        ...
                        if($gst_details['status'] == true){
                            if($gst_details['data'][0]['gst'] > 0){
                                $GST = ($total_markup/100) * $gst_details['data'][0]['gst'];
                            }
                        }
                    }
...
{
?>
<img style="width:200px;" src="<?=$img_url.$GLOBALS['CI']->template->domain_images('logo.png')?>" /></td>
<?php
...
?>
      ...
      <img style="width:200px;" src="<?=$img_url.$GLOBALS['CI']->template->domain_images($data['logo'])?>" /></td>
      ...
      ?>
                                       ...
                                       <tbody>
                                          <tr>
                                             <td style="padding:0;border: 1px solid #00a9d6;"><table border="0" cellspacing="0" cellpadding="5" style="font-size:9pt;background-color:#00a9d6;border: 1px solid #00a9d6; padding:0;">
                                                   <tbody>
                                                      <tr>
                                                         <td style=" color:#fff"><img width="16" src="https://<?php echo $_SERVER['HTTP_HOST'];?><?=SYSTEM_IMAGE_DIR.'bus_v.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Reservation Ticket (<?php echo ucfirst($booking_details['departure_from']).' To '.ucfirst($booking_details['arrival_to']);?>)</span></td>
                                                      </tr>
                                                   </tbody>
                                                </table>
                                             </td>
                              ...
                              <tr>
                                 <td style="padding:0;"><table border="0" cellspacing="0" cellpadding="5" style="font-size:9pt;background-color:#666666;border: 1px solid #666666; padding:0;">
                                       <tbody>
                                          <tr>
                                             <td style=" color:#fff"><img width="16" src="https://<?php echo $_SERVER['HTTP_HOST'];?><?=SYSTEM_IMAGE_DIR.'people_group.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Traveler(s) Information</span></td>
                                          </tr>
                                       </tbody>
                                    </table>
                                 </td>
                                       ...
                                       <tbody>
                                          <tr>
                                             <td width="50%" style="padding:0;padding-right:14px;"><table cellspacing="0" cellpadding="5" width="100%" style="font-size:9px; padding:0;border:1px solid #9a9a9a;">
                                                   <tbody>
                                                      <tr>
                                                         <td style="border-bottom:1px solid #ccc;padding:5px;"><span style="font-size:10px">Payment Details</span></td>
                                                         <td style="border-bottom:1px solid #ccc;padding:5px;"><span style="font-size:9px">Amount (<?=$currency_icon?>)</span></td>
                                                      </tr>
                                                      <tr>
                                                         <td style="padding:5px"><span>Base Fare</span></td>
                                                         <td style="padding:5px;"><span><?= round($booking_details['fare']+$total_markup)?></span></td>
                                                      </tr>


                                                        <tr>
                                                         <td style="padding:5px"><span>Taxes &amp; Fees</span></td>
                                                         <td style="padding:5px"><span><?= round($GST);//@$total_markup;?></span></td>
                                                      </tr>
                                                      <?php if($booking_details['convinence_amount'] > 0){?>
                                                      <tr> 
                                                        <td style="padding:5px"><span>Convienience Fees</span></td>
                                             ...
                                             <tr class="">
                                                ...
                                                <td style="padding:5px"><span><?php if($booking_details['discount'] !=0){echo "-";}?><?php echo round($booking_details['discount']); ?></span></td>
                                             </tr>
                                             <?php }?>
                                                      <tr>
                                                         <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:10px">Total Fare</span></td>
                                                         <td style="border-top:1px solid #ccc;padding:5px"><!-- <span style="font-size:10px"><?=@$booking_details['fare']+$GST+$booking_details['admin_markup']+$booking_details['agent_markup']?></span> --><span style="font-size:13px"><?=@$booking_details['grand_total'] ?></span></td>
                                                      </tr>
                                                   </tbody>
                                                </table>
                                             </td>
