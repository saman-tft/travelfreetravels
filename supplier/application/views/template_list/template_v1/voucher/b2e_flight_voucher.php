...
{
?>
<img style="width:200px;" src="<?=$GLOBALS['CI']->template->domain_images('logo.png')?>" />
<?php
...
?>
		...
		<img style="width:200px;" src="<?=$GLOBALS['CI']->template->domain_images($data['logo'])?>" />
							...
							<table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #9a9a9a;">
								<tbody>
									...
									<tr>
										...
										<td><span> <?php echo number_format(($Tax + $booking_details['admin_markup'] - $booking_details['admin_commission'] + $booking_details['admin_tds'])+$GST, 2)?></span></td>
									</tr>
									<?php if($GST > 0){?>
	                                 <!-- <tr>
	                                    <td><span>GST</span></td>
