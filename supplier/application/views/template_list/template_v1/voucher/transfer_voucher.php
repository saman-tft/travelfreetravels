                                                   ...
                                                   <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #9a9a9a;">
                                                      <tbody>
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td style="padding:5px"><span><?php echo roundoff_price($booking_details['admin_markup'] + $booking_details['gst']); ?></span></td>
                                                         </tr>
                                                        <!--  <tr>
                                                            <td style="padding:5px"><span>GST</span></td>
                                                            <td style="padding:5px"><span><?=$booking_details['gst']?></span></td>
                                                         </tr> -->
                                                        ...
                                                        <?php } ?>
                                                         <?php if($booking_details['discount'] !=0){?>
                                                          <tr class="">
                                                            ...
                                                            <td style="padding:5px"><span><?php if($booking_details['discount'] !=0){echo "-";}?><?php echo roundoff_price($booking_details['discount']); ?></span></td>
                                                          </tr>
                                                          <?php }?>
                                                         <?php

//$grand_total=$booking_details['gst']+$booking_details['fare']+$booking_details['convinence_amount']+$booking_details['admin_markup']-$booking_details['discount'];
                                                         ?>
