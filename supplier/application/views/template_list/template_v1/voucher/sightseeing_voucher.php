                                             ...
                                             <tr>
                                                <td style="padding:10px 0">
                                                  <?php if($attributes['ProductImage']):?>
                                                    <img style="width:100%;height:107px;" src="<?=$attributes['ProductImage']?>">
                                                  <?php else:?>
                                                      ...
                                                      <tbody>
                                                        ...
                                                        <tr>
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td style="padding:5px"><span><?php echo ceil($booking_details['product_total_price']); ?></span></td>
                                                         </tr>
                                                         <tr>
                                                            <td style="padding:5px"><span>Taxes</span></td>
                                                            <td style="padding:5px"><span><?= ceil($itinerary_details['gst'])?></span></td>
                                                         </tr>
                                                        <?php if($booking_details['convinence_amount'] > 0){?>
                                                         <tr>
                                                            <td style="padding:5px"><span>Convenience Fees</span></td>
                                                            <td style="padding:5px"><span><?php echo ceil($booking_details['convinence_amount']); ?></span></td>
                                                         </tr>
                                                        <?php } ?>
                                                         <?php if($booking_details['discount'] !=0){?>
                                                          <tr class="">
                                                            <td style="padding:5px"><span>Discount</span></td>
                                                            <td style="padding:5px"><span><?php if($booking_details['discount'] !=0){echo "-";}?><?php echo ceil($booking_details['discount']); ?></span></td>
                                                          </tr>
                                                          <?php }?>
                                                         <tr>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px">Total Fare</span></td>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?php echo ceil($booking_details['product_total_price']+$itinerary_details['gst']+$booking_details['convinence_amount']-$booking_details['discount']); ?></span></td>
                                                         </tr>
                                                         <?php endif;?>
                                                      </tbody>
                                                   </table>
