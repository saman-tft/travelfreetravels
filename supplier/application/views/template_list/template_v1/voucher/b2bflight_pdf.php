...
// error_reporting(E_ALL);
   // debug($data['address']);exit;
   $booking_details = $data ['booking_details'] [0];

   $img_url = str_replace(PROJECT_FOLDER.'/supervision','',base_url());
   $GLOBALS['CI']->db->select('currency_icon');
   $GLOBALS['CI']->db->where('currency_symbol',$booking_details['currency']);
   $GLOBALS['CI']->db->or_where('country',$booking_details['currency']);
   $currency_icon=$GLOBALS['CI']->db->get('currency_converter')->result_array();
   // echo $this->db->last_query();
   // debug($currency_icon);exit;
   if(isset($currency_icon['0']['currency_icon']) && !empty($currency_icon['0']['currency_icon']))
   {
   $currency_icon='<img style="width:6px;" src="'.$img_url.SYSTEM_TEMPLATE_LIST.'/template_v3/images/icons/'.$currency_icon['0']['currency_icon'].'" />';;
   // debug($currency_icon);exit;
   }else{
   $currency_icon=$booking_details['currency'];
   }
   ...
   if(isset($airline_contact_no['data'][0])){
      $airline_number = '<span><img style="vertical-align:middle" src='.$img_url.SYSTEM_IMAGE_DIR.'phone.png /><span style="font-size:12pt;color:#00a9d6;vertical-align:middle;font-weight: 600;">'.$airline_contact_no['data'][0]['phone_number'].'</span></span> ';
   }
   else{
      $airline_number ='';
   }
...
{
?>
<!-- <img style="width:150px;" src="<?=$GLOBALS['CI']->template->domain_images('logo.png')?>" /> -->
<img style="width:150px;" src="<?php echo $img_url.PROJECT_FOLDER.'/extras/custom/'.CURRENT_DOMAIN_KEY.'/images/logo.png';?>" />
<?php
}
else
{
?>
<!-- <img style="width:150px;" src="<?=$GLOBALS['CI']->template->domain_images($data['logo'])?>" /> -->
<img style="width:150px;" src="<?php echo $img_url.PROJECT_FOLDER.'/extras/custom/'.CURRENT_DOMAIN_KEY.'/images/'.$data['logo'];?>" />
<?php
}
?>
</td>
         ...
         <tr>
            <td style="padding:10px 0; vertical-align:middle;"><img style="width:40px;" src="<?=$img_url.SYSTEM_IMAGE_DIR.'airline_logo/'.$itinerary_details[0]['airline_code'].'.gif'?>" /></td>
         ...
         <tr>
            <td colspan="4" style="padding:0;">
               <table border="0" cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #00a9d6;font-size:9pt; padding:0;">
                  <tbody>
                     <tr>
                     <td colspan="2" style="background-color:#00a9d6; color:#fff"><img width="9" src="<?=$img_url.SYSTEM_IMAGE_DIR.'flight.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Onward Flight Details</span></td>                
                        ...
                        if (isset ( $booking_transaction_details ) && $booking_transaction_details != "") {
                              ...
                              foreach ( $itinerary_details as $segment_details_k => $segment_details_v ) { 
                                 ...
                                 if(in_array($segment_details_v['segment_indicator'], $seg_in_array) && !empty($seg_in_array) && ($seg_counts == 0) && ($trip_type != 'multicity')){ 
                                    ...
                                    ?>
                     <tr>
                        <td colspan="2" style="background-color:#00a9d6; color:#fff"><img width="9" src="<?=$img_url.SYSTEM_IMAGE_DIR.'flight.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Return Flight Details</span></td> 
                        <td align="right" colspan="2" style="background-color:#00a9d6; color:#fff;line-height:normal;vertical-align:middle;"><span style="font-size:8pt;">*Please verify flight times with the airlines prior to departure</span></td>
                     </tr>
                     <?php }
                     ...
                     # Checking CheckIN Baggage
                                    ...
                                    if (is_int($segment_details_v['checkin_baggage'])) {
                                        $BaggageSegment_checkin .= 'Checkin Baggage : ' . @$segment_details_v['from_airport_code'] . ' To ' . @$segment_details_v['to_airport_code'] . ' (Per Adult :' . (int) $segment_details_v['checkin_baggage']/$adult_count . ' Kg & Per Child :'.(int) $segment_details_v['checkin_baggage']/$adult_count .' Kg)<br />';
                                        $TotalBaggageCheckIN = (int) $segment_details_v['checkin_baggage'];
                                    } else {
                                        $BaggageSegment_checkin .= 'Checkin Baggage : ' . @$segment_details_v['from_airport_code'] . ' To ' . @$segment_details_v['to_airport_code'] . ' (Per Adult :' . $segment_details_v['checkin_baggage']/$adult_count . ' Kg & Per Child :'.$segment_details_v['checkin_baggage']/$adult_count .' Kg)<br />';
...
# Checking Cabin Baggage
                                    ...
                                    if (is_int($segment_details_v['cabin_baggage'])) {
                                        $BaggageSegment_cabin .= 'Cabin Baggage : ' . @$segment_details_v['from_airport_code'] . ' To ' . @$segment_details_v['to_airport_code'] . ' (Per Adult :' . (int) $segment_details_v['cabin_baggage']/$adult_count . ' Kg & Per Child :'.(int) $segment_details_v['cabin_baggage']/$adult_count.')<br />';
                                        $TotalBaggageCabin = (int) $segment_details_v['cabin_baggage'];
                                    } else {
                                        $BaggageSegment_cabin .= 'Cabin Baggage : ' . @$segment_details_v['from_airport_code'] . ' To ' . @$segment_details_v['to_airport_code'] . ' (Per Adult :' . $segment_details_v['cabin_baggage']/$adult_count . ' Kg & Per Child : '.$segment_details_v['cabin_baggage']/$adult_count.' Kg)<br />';
                     ...
                     <tr>
                        ...
                        <td style="background-color:#d9d9d9;color:#555555"><img width="15" style="vertical-align:middle" src="<?=$img_url.SYSTEM_IMAGE_DIR.'flight_up.png'?>">&nbsp;<span style="vertical-align:middle">Departing</span></td>
                        <td style="background-color:#d9d9d9;color:#555555"><img width="15" style="vertical-align:middle" src="<?=$img_url.SYSTEM_IMAGE_DIR.'flight_down.png'?>">&nbsp;<span style="vertical-align:middle">Arriving</span></td>
         ...
         <tr>
            <td colspan="4" style="padding:0;">
               <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #666666;font-size:9pt; padding:0;">
                  <tbody>
                     <tr>
                        <td colspan="4" style="background-color:#666666; color:#fff"><img width="12" style="vertical-align:middle" src="<?=$img_url.SYSTEM_IMAGE_DIR.'people_group.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Passenger(s) Details</span></td>
                     </tr>
                     <tr>
                           ...
                           <table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;border:1px solid #9a9a9a;">
                              <tbody>
                                 <tr>
                                    ...
                                    <td style="border-bottom:1px solid #ccc"><span style="font-size:8pt">Amount ( <?php echo $currency_icon?>
                                       )</span>
                                    </td>
                                 </tr>
                                 <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td style="line-height: 13px;"><span> <?php echo number_format(($Tax+$booking_details['admin_markup']+$booking_details['agent_markup']+$GST+($booking_details['convinence_amount'])), 2)?></span></td>
                                 </tr>
                                 <?php if($GST > 0){?>
                                 <!-- <tr>
                                    <td><span>GST</span></td>
         ...
         <tr>
            ...
            <tr>
               <td colspan="4" style="font-size:9pt; color:#555">
                 <ul style="line-height:15px" class="ul-style">
...
// debug($airline_contact_no);exit;
if(isset($airline_contact_no['data'][0])){
   $airline_number = '<span><img style="vertical-align:middle" src='.$img_url.SYSTEM_IMAGE_DIR.'phone.png /><span style="font-size:16px;color:#00a9d6;vertical-align:middle;font-weight: 600;"> &nbsp;'.$airline_contact_no['data'][0]['phone_number'].'</span></span> ';
}
else{
   $airline_number ='';
}
...
<div style="background:#ccc; width:100%; position:relative">
   <table class="pag_brk" cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:9pt; font-family: 'Open Sans', sans-serif; max-width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate; color: #000;">
      <tbody>
         ...
         <tr>
            <td style="padding:10px 0; vertical-align:middle;"><img style="width:40px;" src="<?=$img_url.SYSTEM_IMAGE_DIR.'airline_logo/'.$return_segment_details[0]['airline_code'].'.gif'?>" /></td>
         ...
         <tr>
            <td colspan="4" style="padding:0;">
               <table border="0" cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #00a9d6;font-size:9pt; padding:0;">
                  <tbody>
                     <tr>
                        <td colspan="2" style="background-color:#00a9d6; color:#fff"><img width="9" src="<?=$img_url.SYSTEM_IMAGE_DIR.'flight.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt"><?php echo $Return;?>Flight Details</span></td>
                        <td align="right" colspan="2" style="background-color:#00a9d6; color:#fff;line-height:normal;vertical-align:middle;"><span style="font-size:8pt;">*Please verify flight times with the airlines prior to departure</span></td>
                     </tr>
                     <?php 
                        if (isset ( $booking_transaction_details ) && $booking_transaction_details != "") {
                              ...
                              foreach ( $return_segment_details as $segment_details_k => $segment_details_v ) {
                                 ...
                                 // $cabin_baggage += (int) $segment_details_v['cabin_baggage'];  
                                  if (is_int($segment_details_v['checkin_baggage'])) {
                                        ...
                                        @$BaggageSegment_checkin1 .= 'Checkin Baggage : ' . @$segment_details_v['from_airport_code'] . ' To ' . @$segment_details_v['to_airport_code'] . ' (Adult :' . $segment_details_v['checkin_baggage'] . ' Kg & Child :'.$segment_details_v['checkin_baggage'] .' Kg)<br />';
...
# Checking Cabin Baggage
                                    ...
                                    if (is_int($segment_details_v['cabin_baggage'])) {
                                        @$BaggageSegment_cabin1 .= 'Cabin Baggage : ' . @$segment_details_v['from_airport_code'] . ' To ' . @$segment_details_v['to_airport_code'] . ' (Adult :' . (int) $segment_details_v['cabin_baggage'] . ' Kg & Child :'.(int) $segment_details_v['cabin_baggage'].' Kg)<br />';
                                        $TotalBaggageCabin1 = (int) $segment_details_v['cabin_baggage'];
                                    } else {
                                        @$BaggageSegment_cabin1 .= 'Cabin Baggage : ' . @$segment_details_v['from_airport_code'] . ' To ' . @$segment_details_v['to_airport_code'] . ' (Adult :' . $segment_details_v['cabin_baggage'] . ' Kg & Child : '.$segment_details_v['cabin_baggage'].' Kg)<br />';
                  ...
                  <tbody>
                     <tr>
                        <td style="padding:0; vertical-align:top">
                           ...
                           <?php } else {
                           ?>
                           <td colspan="4"><span>Cabin Baggage :  Per Passenger - 7 Kg</span></td>
                           <?php } ?>
                           </tr>
                           <tr>
