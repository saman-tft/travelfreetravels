...
// debug($booking_details);exit();
  $img_url = str_replace(PROJECT_FOLDER.'/supervision','',base_url());
   $GLOBALS['CI']->db->select('currency_symbol as currency_icon');
...
{
?>
<img style="width:200px;" src="https://<?php echo $_SERVER['HTTP_HOST'];?><?=$GLOBALS['CI']->template->domain_images('logo.png')?>" /></td>
<?php
...
{
?>
          <img style="width:150px;" src="https://<?php echo $_SERVER['HTTP_HOST'];?><?=$GLOBALS['CI']->template->domain_images($data['logo'])?>"></td>
          <?php
        }
          ?>
           ...
           <tr>
            ...
            <tr><td style="line-height:6px;">&nbsp;</td></tr>                  
                           <tr>
                              <td style="padding:0;"><table width="100%" cellpadding="5" style="padding: 10px;font-size: 10pt;padding:5px;">
                                    ...
                                    <tr>
                                       ...
                                       <?php else:?>
                                          <td style="padding:10px 0"><img style="width:130px; height:107px;>" src="https://<?php echo $_SERVER['HTTP_HOST'];?><?=$GLOBALS['CI']->template->template_images("no_image_available.jpg");?>" /></td>
                                       <?php endif;?>
                                        <td width="40%" valign="top" style="padding:10px;line-height:15px;"><span style="font-size:11pt;color:#00a9d6;vertical-align:middle;font-weight: 600;"><?=$booking_details['product_name']?></span><br><span style="display: block;font-size: 10pt;"><?=$attributes['Destination']?> </span><br><br><span style="display: block;font-size: 10pt;"><img style="width:50px;" src="https://<?php echo $_SERVER['HTTP_HOST'];?><?php echo $GLOBALS['CI']->template->template_images('star_rating-'.$attributes["StarRating"].'.png'); ?>"></span></td>
					...
					<td style="padding: 10px;"><table cellpadding="5" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
                           <tr>
                              <td style="background-color:#00a9d6;border: 1px solid #00a9d6; color:#fff; font-size:10pt; padding:5px; line-height:normal;"><img width="12" src="https://<?php echo $_SERVER['HTTP_HOST'];?><?=SYSTEM_IMAGE_DIR.'hotel_v.png'?>" /> <span style="font-size:10pt;color:#fff;line-height:12px;"> &nbsp;Activity Details</span></td>
                           </tr>
							<tr>
                ...
                ?>
                           ...
                           <tr>
                              <td style="background-color:#666666;border: 1px solid #666666; color:#fff; font-size:9pt; padding:5px;"><img width="12" style="vertical-align:middle" src="https://<?php echo $_SERVER['HTTP_HOST'];?><?=SYSTEM_IMAGE_DIR.'people_group.png'?>" /> <span style="font-size:9pt;color:#fff;vertical-align:middle;"> &nbsp;Traveller(s) Details</span></td>
                           </tr>
                           <tr>
                        ...
                        <td><table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;border:1px solid #9a9a9a;">
                            <tbody>
                              <tr>
                                ...
                                <td style="border-bottom:1px solid #ccc;padding:5px;"><span style="font-size:9pt">Amount (<?=$currency_icon?>)</span></td>
                              </tr>
                                 <?php if($this->uri->segment(2)=='b2b_sightseeing_voucher'):?>
                                                        <tr>
                                                            ...
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?php echo $booking_details['grand_total']-$booking_details['gst']; ?></span></td>
                                                         </tr> 
                                                         <?php if($booking_details['gst'] > 0){?>
                                                         <tr>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px">GST</span></td>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?php echo $booking_details['gst']; ?></span></td>
                                                         </tr> 
                                                         <?php } ?>
                                                          <tr>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px">Total Fare</span></td>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?php echo $booking_details['grand_total']; ?></span></td>
                                                         </tr>


                                                          <?php elseif($this->uri->segment(2)=='sightseeing'):?>
                                                            <tr>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px">Base Fare</span></td>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?php echo $booking_details['fare']; ?></span></td>
                                                         </tr>
                                                         <tr>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px">Tax</span></td>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?php echo $booking_details['admin_markup'] + $booking_details['gst']; ?></span></td>
                                                         </tr>  
                                                         <!-- <?php if($booking_details['gst'] > 0){?>
                                                         <tr>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px">GST</span></td>
                                                         ...
                                                         <?php } ?> -->
                                                          <tr>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px">Total Fare</span></td>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?php echo $booking_details['fare']+$booking_details['gst']+$booking_details['admin_markup']; ?></span></td>
                                                         </tr>

                                                         <?php else: ?>
                                                         <tr>
                                                            <td style="padding:5px"><span>Base Fare</span></td>
                                                            <td style="padding:5px"><span><?php echo $booking_details['product_total_price']; ?></span></td>
                                                         </tr>
                                                         <tr>
                                                            <td style="padding:5px"><span>Taxes</span></td>
                                                            <td style="padding:5px"><span><?=@$itinerary_details['gst']?></span></td>
                                                         </tr>
                                                          <?php if($booking_details['convinence_amount'] > 0){?>
                                                         <tr>
                                                            <td style="padding:5px"><span>Convenience Fees</span></td>
                              ...
                              <tr class="">
                                ...
                                <td style="padding:5px"><span><?php if($booking_details['discount'] !=0){echo "-";}?><?php echo $booking_details['discount']; ?></span></td>
                              </tr>
                              <?php }?>
                                                         <tr>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px">Total Fare</span></td>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?php echo $booking_details['product_total_price']+$itinerary_details['gst']+$booking_details['convinence_amount']-$booking_details['discount']; ?></span></td>
                                                         </tr>
                                                         <?php endif;?>
                            </tbody>
                          </table>
