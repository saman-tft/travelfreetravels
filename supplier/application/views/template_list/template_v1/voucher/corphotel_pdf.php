                      ...
                      <tr>
                        <td><table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;border:1px solid #9a9a9a;">
                            <tbody>
                              ...
                              <tr>
                                <td style="padding:5px"><span>Tax &amp; Other charges</span></td>
                                <td style="padding:5px"><span><?php echo $booking_details['admin_markup']+$booking_details['gst']; ?></span></td>
                              </tr>
                             
                              
                              <tr>
                                <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:10pt">Total Fare</span></td>
                                <td style="border-top:1px solid #ccc;padding:5px;font-size:10pt;"><span style=""><?php echo round($booking_details['fare']+$booking_details['gst']+$booking_details['admin_markup']); ?></span></td>
                              </tr>
                            </tbody>
                          </table>
                        </td>
