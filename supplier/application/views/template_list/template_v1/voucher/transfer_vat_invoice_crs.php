                     ...
                     <tr>
                        <td style="padding: 0px;">
                           <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
                              <tbody>
                                 <tr>
                                    <td style="font-size:22px; line-height:30px; width:100%; display:block; font-weight:600; text-align:center">Transfer Invoice</td>
                                 </tr>
                                 <tr>
                                    <td>
                                       <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                                                   ...
                                                   <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #9a9a9a;">
                                                      <tbody>
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td style="padding:5px"><span><?php echo roundoff_number($itinerary_details['total_fare']+$itinerary_details['admin_markup']); ?></span></td>
                                                         </tr>
                                                          <tr>
                                                            <td style="padding: 5px;"><span>Tax and Services</span></td>
                                                            <td style="padding:5px"><span><?php echo roundoff_number($itinerary_details['agent_markup']+$itinerary_details['search_level_markup']+$itinerary_details['gst']); ?></span></td>
                                                         </tr>
                                                          <!-- <tr>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td style="padding:5px"><span><?php echo roundoff_number($itinerary_details['convenience_fee']); ?></span></td>
                                                         </tr>
                                                         <tr>
                                                            ...
                                                            echo $booking_details['grand_total']-$booking_details['reward_amount'];  ?></span></td>
                                                         </tr>
