        ...
        <tbody>
            ...
            <tr>
                <td colspan="2" style="padding-bottom:10px">
                    ...
                    <!-- <img style="width:200px;" src="<?= $GLOBALS['CI']->template->domain_images($data['logo']) ?>" /></td> -->
                <?php
if($data['logo']=='')
{
?>
<img style="width:200px;" src="<?=$GLOBALS['CI']->template->domain_images('logo.png')?>" /></td>
<?php
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span> <?php echo number_format(($currency_conversion_rate * $Tax + $booking_details['admin_markup'] - $booking_details['admin_commission'] + $booking_details['admin_tds'])+$GST, 2) ?></span></td>
                                                </tr>
    ...
    if (isset($booking_transaction_details_value['extra_service_details']['meal_details']) == true && valid_array($booking_transaction_details_value['extra_service_details']['meal_details']) == true) {
        ...
        foreach ($meal_details['meal_source_destination_label'] as $meal_lk => $meal_lv) {
            ...
            <tr>
                ...
                <ul style="padding-bottom:10px" class="ul-style">
    ...
    <?php } ?>
                ...
                <tr>
                    <td colspan="4" align="right" style="padding-top:10px">
                        <?php echo strtoupper($data['domainname']) ?><br>ContactNo :  <?php echo $data['phone_code'] ?><?php echo $data['phone'] ?><br><?php echo $data['address'] ?></td>
                </tr>
            </tbody>
        </table>
    </div>
