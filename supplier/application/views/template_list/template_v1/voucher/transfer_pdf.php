                                ...
                                <td style="border-bottom:1px solid #ccc;padding:5px;"><span style="font-size:9pt">Amount (<?=$currency_icon?>)</span></td>
                                 ...
                                 <?php if($this->uri->segment(2)=='b2b_transfers_voucher'):?>
                                                        <tr>
                                                            ...
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?php echo roundoff_price($booking_details['grand_total']-$booking_details['gst']); ?></span></td>
                                                         </tr> 
                                                         <?php if($booking_details['gst'] > 0){?>
                                                         <tr>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px">GST</span></td>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?php echo roundoff_price($booking_details['gst']); ?></span></td>
                                                         </tr> 
                                                         <?php } ?>
                                                          <tr>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px">Total Fare</span></td>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?php echo roundoff_price($booking_details['grand_total']); ?></span></td>
                                                         </tr>

                                                         <?php else: ?>
                                                         <tr>
                                                            <td style="padding:5px"><span>Base Fare</span></td>
                                                            <td style="padding:5px"><span><?php echo roundoff_price($booking_details['admin_net_fare']); ?></span></td>
                                                         </tr>
                                                         <tr>
                                                            <td style="padding:5px"><span>Taxes & Services</span></td>
                                                            <td style="padding:5px"><span><?=$booking_details['admin_markup'] + $booking_details['gst']?></span></td>
                                                         </tr>
                                                      <?php if($booking_details['convinence_amount'] > 0){?>
                                                      <tr>
                                                      <td style="padding:5px"><span>Convenience Fees</span></td>
                                                      <td style="padding:5px"><span><?php echo roundoff_price($booking_details['convinence_amount']); ?></span></td>
                                                      </tr>
                                                      <?php } ?> 
                                                         
                                                        <!--  <tr>
                                                            <td style="padding:5px"><span>GST</span></td>
                                                            <td style="padding:5px"><span><?php echo roundoff_price($booking_details['gst']); ?></span></td>
                                                         </tr> -->
                                                         <?php

//$grand_total=$booking_details['gst']+$booking_details['fare']+$booking_details['admin_markup']+$booking_details['convinence_amount'];
                                                         ?>
                                                         <tr>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px">Total Fare</span></td>
