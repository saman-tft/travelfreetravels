...
?>
                           ...
                           <tr>
                              <td style="padding:0;"><table width="100%" cellpadding="5" style="padding: 10px;font-size: 10pt;padding:5px;">
                                    ...
                                    <tr>
                                       ...
                                       <?php else:?>
                                          <td style="padding:10px 0"><img style="width:130px; height:107px;>" src="<?=$img_url.$GLOBALS['CI']->template->template_images("default_hotel_img.jpg");?>" /></td>
                                       <?php endif;?>
                                       <td width="40%" valign="top" style="padding:10px;line-height:18px;"><span style="font-size:12pt;color:#00a9d6;vertical-align:middle;font-weight: 600;"><?php echo $booking_details['hotel_name']; ?></span><br><span style="display: block;font-size: 10pt;"><?php echo $booking_details['hotel_address']; ?> </span><br><br><span style="display: block;font-size: 10pt;"><img style="width:50px;" src="<?php echo $img_url.$GLOBALS['CI']->template->template_images('star_rating-'.$booking_details['star_rating'].'.png'); ?>" /></span></td>
          ...
          <td style="padding: 10px;"><table cellpadding="5" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
                           <tr>
                              <td style="background-color:#00a9d6;border: 1px solid #00a9d6; color:#fff; font-size:10pt; padding:5px; line-height:normal;"><img width="12" src="<?=$img_url.SYSTEM_IMAGE_DIR.'hotel_v.png'?>" /> <span style="font-size:10pt;color:#fff;line-height:12px;"> &nbsp;Hotel Details</span></td>
                           </tr>
              <tr>
              ...
              <tr><td style="line-height:2px;">&nbsp;</td></tr>
                           ...
                           <tr>
                              <td style="background-color:#666666;border: 1px solid #666666; color:#fff; font-size:9pt; padding:5px;"><img width="12" style="vertical-align:middle" src="<?=$img_url.SYSTEM_IMAGE_DIR.'people_group.png'?>" /> <span style="font-size:9pt;color:#fff;vertical-align:middle;"> &nbsp;Guest(s) Details</span></td>
                           </tr>
                           <tr>
                    ...
                    <tbody>
                      <tr>
                        <td><table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;border:1px solid #9a9a9a;">
                            ...
                            <td style="padding:5px"><span><?php echo round($booking_details['fare']); ?></span></td>
                            </tr>               
                            <tr>
                            <td style="padding:5px"><span>Taxes & Service fee</span></td>
                            <td style="padding:5px"><span><?php echo $booking_details['gst']+$booking_details['admin_markup']; ?></span></td>
                            </tr>                          
                            <tr>
