                                             ...
                                             <tr>
                                                ...
                                                <td style="padding: 0px;">
                                                   <table width="100%" style="font-size:13px; font-family: 'Open Sans', sans-serif;border-collapse: collapse;text-align: right; line-height:15px;" cellpadding="0" cellspacing="0" border="0">
                                                    <tbody>
                                                         <tr>
                                                            <td style="padding-bottom:10px;line-height:20px" align="right"><span>Travel Date: <?=date("l\, jS F Y",strtotime($booking_details['travel_date']));?></span><br><span>Booking Reference: <?=$booking_details['app_reference']?></span><br><span>Excursion Code: <?=$booking_details['product_code']?></span></td>
                                                         </tr>
                                                      </tbody>
                                                   </table>
                                                </td>
                                                   ...
                                                   <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #9a9a9a;">
                                                      <tbody>
                                                         ...
                                                         <!-- <tr>
                                                          ...
                                                          <tr>
                                                            <td style="padding:5px"><span>Agent Markup</span></td>
                                                            <td style="padding:5px"><span><?php echo roundoff_number($booking_details['agent_markup']); ?></span></td>
                                                         </tr>
                                                         <tr>
                                                         ...
                                                         <tr>
                                                            <td style="padding:5px"><span>Base Fare</span></td>
                                                            <td style="padding:5px"><span><?php echo roundoff_number($booking_details['fare']+$booking_details['admin_markup']); ?></span></td>
                                                         </tr>
                                                          <tr>
                                                            <td style="padding: 5px;"><span>Tax and Services</span></td>
                                                            <td style="padding:5px"><span><?php echo roundoff_number($booking_details['agent_markup']+$booking_details['gst']); ?></span></td>
                                                         </tr>
                                                          <!-- <tr>
                                                            <td style="padding:5px"><span>VAT</span></td>
                                                            <td style="padding:5px"><span><?php echo roundoff_number($booking_details['gst']); ?></span></td>
                                                         </tr> -->
                                                          <tr>
                                                            <td style="padding:5px"><span>Convenience Fee</span></td>
                                                         ...
                                                         <tr>
                                                            ...
                                                            echo $booking_details['grand_total'];  ?></span></td>
                                                         </tr>
                                             </tr>
                                          </tbody>
                                       </table>
