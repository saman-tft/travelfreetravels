                           ...
                           <table class="table table-bordered table-responsive tbl-ap" style="border:1px solid #ddd;border-top: 0px;margin-bottom: 0px;text-align: center;">
                             ...
                             <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td class="text-left">
                                          <?=$transfer_details->transfer_name?>
                                    </td>
                                    <td class="bgc-blue text-left" style="border-top: 1px solid;border-right:  1px solid #ccc;" width="20%">Source </td>
                                    <td class="text-left"><?=$transfer_details->source?></td>
                                 </tr>
                                 <tr>
                                   <td class="bgc-blue text-left" style="border-top: 1px solid;border-right:  1px solid #ccc;" width="20%">Destination</td>
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td class="text-left" width="25%">    
                                        <?=$booking_details['itinerary_details'][0]['total_fare']?>
                                    </td>
                                    <td class="bgc-blue text-left" style="border-top: 1px solid;border-right:  1px solid #ccc;" width="25%">
                                       Total Selling Rate
                                    </td>
                                    <td class="text-left" width="25%">
                                       <?php 
                                              $total=$booking_details['itinerary_details'][0]['total_fare']+ $booking_details['itinerary_details'][0]['admin_markup']+$booking_details['itinerary_details'][0]['agent_markup']+ $booking_details['itinerary_details'][0]['search_level_markup'];
                                              ?>
                                        <?= $total-$booking_details['reward_amount'];?>
                                    </td>
                                 </tr>
                                 <tr>
                                    <td class="bgc-blue text-left" style="border-top: 1px solid;border-right:  1px solid #ccc;" width="25%">
                                    Net Rate</td>
                                    <td class="text-left" width="25%" ><?=$booking_details['itinerary_details'][0]['total_fare']?></td>
                                    <td class="bgc-blue text-left" style="border-top: 1px solid;border-right:  1px solid #ccc;" width="25%">  Net Rate</td>
                                    <td class="text-left" width="25%"><?=$total-$booking_details['reward_amount']; ?></td>
                                 </tr>
