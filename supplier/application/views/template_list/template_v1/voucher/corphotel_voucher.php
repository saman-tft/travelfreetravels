													...
													<table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #9a9a9a;">
														<tbody>
															...
															<tr>
																...
																<td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?php echo round($booking_details['fare']+$booking_details['admin_markup']+$booking_details['gst']); ?></span></td>
															</tr>
														</tbody>
													</table>
												</td>
