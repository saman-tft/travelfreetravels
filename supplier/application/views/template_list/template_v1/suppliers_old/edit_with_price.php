      ...
      <input type="text" name="duration" class="form-control" id="duration" value ="<?php echo $packdata->duration;?>" onchange="show_duration_info(this.value)" size="40" disabled>                          
                      ...
                      <input type="text" name="location" id="location" data-rule-required='true' class='form-control' value ="<?php echo $packdata->package_location;?>">
                         ...
                         <!--  <input type="hidden" value="<?php echo $packdata->image; ?>" name="photo"> -->
                          ...
                          <div class='col-sm-3 controls'>
                            <textarea name="Description" data-rule-required='true' class="form-control ckeditor" id="editor" cols="80" rows="10" placeholder="Description" required><?php echo $packdata->package_description?></textarea>                             <!--   <span id="dorigin_error" style="color:#F00;  display:none;"></span> -->
                           </div> 
                           </div>
                ...
                <option><?php echo $packdata->rating;?></option>
                     ...
                     <div class='box-header blue-background'>
                      ...
                      <!-- <input type="text" name="excludes" id="excludes" data-rule-required='true' class='form-control'> -->
                       ...
                       <?php
if($packdata->top_destination==1)
  $chk="checked";
else
  $chk="";
                       ?>
                       <div class="hide">
                       <input type='checkbox' checked="<?php echo $chk?>" value=<?php echo $packdata->top_destination;?> name='top_dest'>Top destination
                        </div>
                          </div>
                          </div>
                     ...
                     <div class='form-actions' style='margin-bottom:0'>
                          <div class='row'>
                            <div class='col-sm-9 col-sm-offset-3'>
                              <a href="<?php echo base_url(); ?>index.php/supplier/view_with_price">
