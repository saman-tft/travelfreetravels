...
<form class='form form-horizontal validate-form' style='margin-bottom: 0;' action="<?php echo base_url(); ?>index.php/supplier/update_answers/" method="post">
                      ...
                      <div class='form-actions' style='margin-bottom:0'>
                          <div class='row'>
                            <div class='col-sm-9 col-sm-offset-3'>
                              <a href="<?php echo WEB_URL; ?>index.php/supplier/quesans_view/<?php echo $packdata->package_id;?>">
