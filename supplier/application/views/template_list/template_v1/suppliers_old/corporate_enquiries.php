			...
			<div class="panel-title">
				<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
					...
					<li role="presentation" class="active"><a href="#fromList"
						aria-controls="home" role="tab" data-toggle="tab"><h1>View CORPORATE Enquiries </h1></a></li>
                       ...
                       <td>
                        ...
                        <td> <textarea data-id="<?php echo $package->id; ?>" class="comments" maxlength="50" style="resize: none;"><?php echo $package->comments; ?></textarea></td>
                         <td class="center">                       
                                   ...
                                   <a href="<?php echo base_url(); ?>index.php/supplier/delete_enquiry/<?php echo $package->id; ?>/<?php echo $package->package_id; ?>"  data-original-title="Delete"  onclick="return confirm('Do you want delete this record');" class="btn btn-danger btn-xs has-tooltip" data-original-title="Delete"> 
...
$(document).ready(function(){
    ...
    $('.status').on('change',function(){
       ...
       var enquiry_id = $(this).attr('data-id');
        ...
        $.ajax({
        method: "POST",
        url: "<?php echo base_url(); ?>index.php/supplier/enquiry_status",
    ...
    $('.comments').on('change',function(){
        ...
        $.ajax({
        method: "POST", 
        url: "<?php echo base_url(); ?>index.php/supplier/update_comments",
