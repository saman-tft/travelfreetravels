                            ...
                            <tr>
                              ...
                              <td>
                                <select onchange="activate(this.value);">
                                  ...
                                  <option
                                    value="<?php echo base_url(); ?>index.php/supplier/update_status/<?php
                                  ...
                                  <?php } else { ?>
                                  <option
                                    value="<?php echo base_url(); ?>index.php/supplier/update_status/<?php echo $package->package_id; ?>/1">Active</option>
                                  <option
                                    value="<?php echo base_url(); ?>index.php/supplier/update_status/<?php echo $package->package_id; ?>/0"
                              ...
                              <td>
                                <select
                                  ...
                                  <option
                                    value="<?php echo base_url(); ?>index.php/supplier/update_tstatus/<?php
                                      echo $package->package_id;
                                      ?>/1"
                                    selected>Active</option>
                                  <option
                                  ...
                                  <?php } else { ?>
                                  <option
                                    value="<?php echo base_url(); ?>index.php/supplier/update_tstatus/<?php echo $package->package_id; ?>/1">Active</option>
                                  <option
                                    value="<?php echo base_url(); ?>index.php/supplier/update_tstatus/<?php echo $package->package_id; ?>/0"
                                    selected>In-Active</option>
                                </select>
                                <?php } ?>
                              </td>
