			...
			<div class="panel-title">
				<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
					...
					<li role="presentation" class="active"><a href="#fromList"
						aria-controls="home" role="tab" data-toggle="tab"><h1>View B2C Enquiries </h1></a></li>
...
$(document).ready(function(){
    ...
    $('.status').on('change',function(){
       ...
       var enquiry_id = $(this).attr('data-id');
        $.ajax({
        method: "POST",
        url: "<?php echo base_url(); ?>supplier/enquiry_status",
    ...
    $('.comments').on('change',function(){
        ...
        $.ajax({
        method: "POST", 
        url: "<?php echo base_url(); ?>supplier/update_comments",
