									...
									<div class='' style='margin-bottom: 0;'>
										<div class='box-content'>
											<form class='form form-horizontal validate-form'
												...
												action="<?php echo base_url(); ?>index.php/supplier/update_package/<?php echo $packdata->package_id;?>"
												method="post" enctype="multipart/form-data">
												<input type="hidden" name="w_wo_d" value="w">

												<div class='form-group'>
													<label class='control-label col-sm-3'
														for='validation_current'>Activity Name </label>
												...
												<div class='form-group'>
													...
													<div class='col-sm-4 controls'>
														<select class='select2 form-control'
															...
															value="<?php echo $packdata->package_country;?>"disabled>
                              ...
                              <?php foreach ($countries as $country) {?><option
                                 ...
                                 <?php }?>
										...
										<!-- 		<div class='form-group'>
												...
												<div class='form-group'>
													<label class='control-label col-sm-3'
														for='validation_company'>Activity Main Image</label>
											...
											<div class='form-group'>
													<label class='control-label col-sm-3'
														for='validation_number'>Adult Price </label>
													<div class='col-sm-3 controls'>
												...
												<div class='form-group'>
													<label class='control-label col-sm-3'
														for='validation_number'>Child Price </label>
													<div class='col-sm-3 controls'>
															<input type="text" name="child_price" id="child_price"
															
															class='form-control'
															value="<?php echo $packdata->child_price;?>">
													</div>
												</div>
												<div class='form-group'>
													<label class='control-label col-sm-3'
														for='validation_number'>Infant Price </label>
													<div class='col-sm-3 controls'>
															<input type="text" name="infant_price" id="infant_price"
															
															class='form-control'
															value="<?php echo $packdata->infant_price;?>">
													</div>
												</div>
												<div class='form-group'>
