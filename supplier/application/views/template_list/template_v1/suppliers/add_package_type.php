									...
									<div class=''>
										<form class='form form-horizontal validate-form'
											...
											<div class='form-group'>
												<label class='control-label col-sm-2' for='validation_name'>Activity
													Type</label>
												<div class='col-sm-3 controls'>
													<input type="hidden" name="package_types_id"
														...
														placeholder='Activity Type' type='text' required> <span id="pacname"
											...
											<div class='form-actions' style='margin-bottom: 0'>
												<div class='row'>
													<div class='col-sm-9 col-sm-offset-16'>
														<a
