					...
					<div role="tabpanel" class="tab-pane active" id="add_package">
						<div class="col-md-12">
							...
							<div class='form-group'>
								<label class='control-label col-sm-3' for='validation_name'>Activity type</label>
                        ...
                        <?php
							...
							<div class='form-group'>
								<label class='control-label col-sm-3' for='validation_current'>Activity Name </label>
					        ...
					        <label class='control-label col-sm-3' for='validation_current'>Contract Start Date <span style = "color:red">*</span>
					        </label>
					        <div class='col-sm-4 controls'>
							...
							<div class='form-group ' id="select_date">
					        <label class='control-label col-sm-3' for='validation_current'>Contract Expiry Date <span style = "color:red">*</span>
					        </label>
					        <div class='col-sm-4 controls'>
							...
							<div class='form-group'>
								<label class='control-label col-sm-3' for='adult'>Adult Price<span style = "color:red">*</span></label>
							...
							<div class='form-group'>
								<label class='control-label col-sm-3' for='adult'>Child Price</label>
								<div class='col-sm-4 controls'>
									<input type="text" name="child_price" id="child_price"
										
										placeholder="Child Price"
										class='form-control add_pckg_elements numeric' value="0" maxlength='10'
										>
								</div>
							</div>
							<div class='form-group'>
								<label class='control-label col-sm-3' for='adult'>Infant Price</label>
								<div class='col-sm-4 controls'>
							...
							<div class='form-group'>
								...
								<div class="col-sm-4 controls ">
									<input type="text" name="duration" data-rule-number='true'
										...
										placeholder="Enter Number Of Days" title="No Of Days" required> 
								</div>
								<span>Days</span>
							</div>
							<div class='form-group'>
                        ...
                        <?php }?>
							...
							<div class='form-group'>
								...
								<div class='col-sm-4 controls'>
									<input type="text" class="form-control" id="textbox" name="cityname" style="width:450px;" required></td>
								</div>
							</div>
						<!-- 	<div class='form-group'>
