<?php
   ...
   $segment_3 = $GLOBALS['CI']->uri->segment(6);
// debug($segment_3);
// die;
    ...
    // debug($booking_details['net_fare']);
    // debug($booking_details['admin_markup']);
    // debug($booking_details['gst']);
    // die;
    // $grand_total=$booking_details['net_fare']+$booking_details['admin_markup']+$booking_details['gst'];
            ...
            <div class="col-xs-6 nopad">
            	<div class="btn_continue">
                	<div class="amnt_disply">
                        ...
                        if($segment_3=='corporate')
                        {
                            $grand_total=$fare+$admin_markup+$gst;
                        }
                        echo round($grand_total)?></div>
                    </div>
                </div>
             </div>
