...
// echo $pdf_btn;exit;
								...
								?>
									<tr>
										...
										<td><?php echo roundoff_price($fare)?></td>
										<td><?php echo roundoff_price($net_commission)?></td>
										<td><?php echo roundoff_price($net_commission_tds)?></td>
										<td><?php echo roundoff_price($net_fare)?></td>										
										<td><?php echo roundoff_price($admin_markup)?></td>		
										<td><?php echo roundoff_price($gst);?></td>										
										<td><?php echo roundoff_price($convinence_amount)?></td>
										<td><?php echo roundoff_price($discount)?></td>
										<td><?php echo roundoff_price($grand_total)?></td>
