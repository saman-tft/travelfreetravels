...
{
	return '<a href="'.transfers_crs_voucher_url($app_reference, $booking_source, $status,$module).'/show_voucher" target="_blank" class="btn btn-sm btn-info btn-primary"><i class="far fa-file"></i> Voucher</a>';
}
...
{
	return '<a href="'.transfers_crs_invoice_url($app_reference, $booking_source, $status,$module).'/show_invoice" target="_blank" class="btn btn-sm btn-info btn-primary"><i class="far fa-file"></i> Invoice</a>';
}
...
{
	return '<a href="'.transfers_crs_vat_invoice_url($app_reference, $booking_source, $status,$module).'/show_vat_invoice" target="_blank" class="btn btn-sm btn-info btn-primary"><i class="far fa-file"></i>VAT Invoice</a>';
}
...
{
	return '<a href="'.transfers_amendment_url($app_reference, $booking_source, $status,$module).'/show_amendment" target="_blank" class="btn btn-sm btn-info btn-primary"><i class="far fa-file"></i> Amendment</a>';
}
...
{
	return '<a href="'.transfers_booking_view_url($app_reference, $booking_source, $status,$module).'/show_details" target="_blank" class="btn btn-sm btn-info btn-primary"><i class="far fa-eye"></i> View</a>';
}
...
function transfers_pdf_crs($app_reference, $booking_source='', $status='', $module='')
{
	...
	return '<a href="'.transfers_crs_voucher_url_crs($app_reference, $booking_source, $status, $module).'/show_pdf" target="_blank" class="btn btn-sm btn-info btn-primary"><i class="far fa-file-pdf"></i> Pdf</a>';
}
...
function transfer_voucher_email($app_reference, $booking_source,$status,$recipient_email)
{
	...
	return '<a class="btn btn-sm btn-info btn-primary send_email_voucher" data-app-status="'.$status.'"   data-app-reference="'.$app_reference.'" data-booking-source="'.$booking_source.'"data-recipient_email="'.$recipient_email.'"><i class="far fa-envelope"></i> Email Voucher</a>';
}
function get_cancellation_details_button($app_reference, $booking_source, $master_booking_status)
{
	...
	if($master_booking_status == 'BOOKING_CANCELLED'){
		...
		return '<a target="_blank" href="'.base_url().'index.php/transferv1/cancellation_refund_details?app_reference='.$app_reference.'&booking_source='.$booking_source.'&status='.$master_booking_status.'" class="col-md-12 btn btn-sm btn-info btn-primary "><i class="far fa-info"></i> Cancellation Details</a>';
	}
...
function cancel_booking($app_reference, $booking_source, $status)
{
	...
	return '<a href="'.cancel_booking_url($app_reference, $booking_source, $status).'"   onclick="'.$confirm.'" class="btn btn-sm btn-info btn-primary "><i class="fa fa-arrows-alt"></i> Cancel</a>';
...
{
  return '<a href="'.transfer_vat_booking_details_url($app_reference, $booking_source, $status).'/show_transfer_details" target="_blank" class="btn btn-sm btn-info btn-primary"><i class="fa fa-file"></i>Transfer View Details</a>';
