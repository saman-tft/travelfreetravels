...
foreach ($master_module_list as $k => $v) {
	...
	?>
		<li role="presentation" class="<?=$act_tab?>"><a href="<?=base_url()?>index.php/report/corporate_<?=($v).'_report'?><?= $append_query_string ?>"><i class="<?=get_arrangement_icon($k)?>"></i> <?='Corporate '.$demo.' Report'?></a></li>
	<?php
	}
}
