	...
	<div class="panel panel-default clearfix"><!-- PANEL WRAP START -->
			...
			<div id="show-search" class="collapse">
				<form method="GET" autocomplete="off">
					...
					<a href="<?php echo base_url().'index.php/report/b2b2b_bus_report?' ?>" id="clear-filter" class="btn btn-primary">Clear Filter</a>
					</div>
				</form>
			</div>
		</div>
						...
						<?php
							if (isset($table_data) == true and valid_array($table_data['booking_details']) == true) {
								...
								foreach($booking_details as $parent_k => $parent_v) {
									...
									$action.='<br/>';
									$action .= bus_voucher_email2($app_reference, $booking_source, $status,$parent_v['email']);
...
function bus_voucher_email2($app_reference, $booking_source,$status,$recipient_email)
{
