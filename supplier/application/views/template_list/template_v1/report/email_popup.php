<!-- Mail - Voucher  starts-->
<div class="modal fade" id="mail_voucher_modal" tabindex="-1"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div id="email_voucher_parameters">
					...
					<input type="email" id="voucher_recipient_email"
						class="form-control" value="" required="required"
						placeholder="Enter Email">
					<p>Copy of Voucher will be sent to the above Email Id</p>
					<div class="row">
						<div class="col-md-4">
				...
				<input type="hidden" name="tour__id" id="tour__id">
			</div>
		</div>
	</div>
</div>
