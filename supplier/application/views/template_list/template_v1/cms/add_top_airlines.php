...
<ul class="nav nav-tabs" role="tablist" id="myTab">
	...
	<li role="presentation" class="<?=$tab1?>">
		<a id="fromListHead" href="#fromList" aria-controls="home" role="tab"	data-toggle="tab">Manage Testimonials</a>
	</li>
         ...
         <form class="form-horizontal" role="form" enctype="multipart/form-data" method="POST" action="<?= $action; ?>" autocomplete="off" name="home_page_heading">
            <fieldset form="promo_codes_form_edit">
               ...
               <div class="form-group">
                  <label form="promo_codes_form_edit" for="airline_name" class="col-sm-3 control-label">Testimonial Title</label>
                  	<div class="col-sm-6">
                     <?php
                      ...
                      if($airline_list['status'] == true){?>
                        ...
                        <input name='airline_name' value="<?php echo $airline_name;?>" class='form-control'>
                        <?php  } ?>
                  	</div>
               </div>
                ...
                <div class="form-group">
                  <label form="promo_codes_form_edit" for="airline_name" class="col-sm-3 control-label">Description</label>
                     <div class="col-sm-6">
                     
                    <input  type='text' max='200' value='<?php echo $description;?>' size="72" name='description' required>
               ...
               <?php } ?>
                  ...
                  <label form="promo_codes_form_edit" for="airline_logo" class="col-sm-3 control-label">Logo</label>
                  	<div class="col-sm-6">
                  		<input type="file"  id="airline_logo" class="form-control" name="airline_logo" value="" <?php if(!isset($logo)){?>required<?php } ?>>
                  	</div>
               </div>
              </fieldset>
            <div class="form-group">
