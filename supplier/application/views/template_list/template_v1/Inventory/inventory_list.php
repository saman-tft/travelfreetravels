...
<div class="tab-content">
			...
			<form action="<?php echo base_url(); ?>index.php/car_supplier/vehical_list/<?=$ID?>/<?=$CAR_ID?>"
							...
							<div class='form-group'>
								...
								<div class='col-sm-4 controls'>
									<div class="controls">
										<textarea  class="form-control" name="pick_up_information" id="pick_up_information" rows="5" cols="45">
										<?php echo isset($pickup_information) ? $pickup_information : '';?>
										 </textarea>
							...
							<div class='form-group'>
								...
								<div class='col-sm-4 controls'>
									<div class="controls">
										<input type="text" value="<?php echo (isset($insurance_begin) && !empty($insurance_begin) && (intval(strpos(date("m/d/Y",strtotime($insurance_begin)), '1970'))<=0)) ? date("m/d/Y",strtotime($insurance_begin)) : date("m/d/Y");?>" name="insurance_begin" id="insurance_begin"
							...
							<div class='form-group'>
								...
								<div class='col-sm-4 controls'>
									<div class="controls">
										<input type="text"  value="<?php echo (isset($insurance_end) && !empty($insurance_end) && ((intval(strpos(date("m/d/Y",strtotime($insurance_end)), '1970'))<=0))) ? date("m/d/Y",strtotime($insurance_end)) : date("m/d/Y");?>" name=" insurance_end" id="insurance_end"
								...
								<div class='col-sm-4 controls'>
									<div class="controls">
										<!--<input type="text" value="<?php echo isset($purchase_date) ? date("m/d/Y",strtotime($purchase_date)) : '';?>" name="purchase_date" id="purchase_date"
											...
											class='form-control add_pckg_elements date-class' readonly>-->
											<input type="text"  value="<?php echo (isset($purchase_from) && !empty($purchase_from) && ((intval(strpos(date("m/d/Y",strtotime($purchase_from)), '1970'))<=0))) ? date("m/d/Y",strtotime($purchase_from)) : date("m/d/Y");?>" name="purchase_from" id="purchase_from"	 placeholder="Purchase From"
											class='form-control add_pckg_elements date-class' onkeypress="return alphanumeric(event)" readonly >
