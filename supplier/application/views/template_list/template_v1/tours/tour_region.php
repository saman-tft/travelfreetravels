			...
			<div class="panel-title">
				<ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
					...
					<li role="presentation" class="active" id="add_package_li"><a
						...
						data-toggle="tab">Tour Regions </a></li>
					...
					<div role="tabpanel" class="tab-pane active" id="add_package">
						   <div class="col-md-12">
							...
							<div class='form-group'>
								<label class='control-label col-sm-3' for='validation_current'>Tour Region
								</label>
								<div class='col-sm-8 controls'>
									<input type="text" name="tour_region" id="tour_region"
										placeholder="Enter Tour Region" data-rule-required='true'
