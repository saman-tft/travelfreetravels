...
<?php /* ?>
         ...
         ?>
						...
						<!-- 	<div class='form-group' <?php 
							...
							?> id="sim_price_div">
								...
								<div class="org_row">
								<div class='col-sm-6'>
								<input class='form-control'  name='sim_price' id="sim_price" required type="text"  value="<?=$tour_data['sim_price']?>" />                                                          
							...
							<div class="form-group">
								...
								<div class="col-sm-8 controls">
								<textarea name="optional_tours" class="form-control" cols="70" rows="5" placeholder="Optional Tours"><?=string_replace_encode($tour_data['optional_tours'])?></textarea>
								</div>
							</div>	
       ...
       <div class="form-group">
								...
								<div class="col-sm-8 controls">
								<textarea name="trip_notes" class="form-control" cols="70" rows="5" placeholder="Trip Notes"><?=string_replace_encode($tour_data['trip_notes'])?></textarea>
								</div>
							</div>	
							...
							<div class='form-group'>
                                ...
                                <div class='col-sm-4 controls'>
                                    ...
                                    <input type="checkbox" name="inclusions_checks[]" value="Car" <?php if(in_array('Car',$inclusions_checks)){ echo 'checked';}?> >  
