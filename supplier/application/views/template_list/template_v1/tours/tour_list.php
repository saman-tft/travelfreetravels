        ...
        <ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
          ...
          <li role="presentation" class="active" id="add_package_li"><a
            ...
            <li aria-controls="home"> &nbsp;&nbsp;
              <button onclick="location.href='<?php echo base_url(); ?>index.php/tours/add_tour';" class='btn btn-primary add-tour-btn '><a style="color:white;">Add Tour</a></button>
            </li>     
          ...
          <th>Publish Status</th>
            ...
            <tbody>
              ...
              else
              {
                ...
                // debug($tour_dep_dates_list_published_wd);
                foreach ($tour_dep_dates_list_published_wd[$data['id']] as $date_value) {


                  // debug($date_value['publish_status']);exit();
                  if($date_value['publish_status'] == 1)
                  {
                    $publish_status = '<span style="color:green;">Published</span>';
                    $checked = 'checked';
                  }
                  else
                  {
                    $checked ='';
                       $publish_status = '<span style="color:red;">UnPublished</span>';
                  }
                }
              }
              if($ij==0){
              ...
              // <td>'.$data['expire_date'].'</td>
               ...
               if($data['status']==1)
               {
                ...
                data-original-title="Price Management"><i class="fa fa-money"></i> Price Management
              </a> &nbsp; <br>
