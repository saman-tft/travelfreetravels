						...
						<div class='row'>
							<div class=''
								...
								<div class=''>
									<div class='actions'>
										<!--<a
											href="<?php echo base_url(); ?>index.php/tours/nationality_country">
                                       			...
                                       			<td>
													<div class=''>
														<!--<a class="btn btn-primary btn-xs has-tooltip"
															...
															href="<?php echo base_url(); ?>index.php/tours/nationality_country/<?php echo $k['origin'] ?>"
														...
														<!-- <a class='btn btn-danger btn-xs has-tooltip'
															...
															href='<?php echo base_url(); ?>index.php/tours/delete_package_type/<?=$k->id;?>'>
