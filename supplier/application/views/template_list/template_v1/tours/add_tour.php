	...
	<div class="panel panel-default">
		...
		<div class="panel-heading">
			...
			<div class="panel-title">
				<ul class="nav nav-tabs nav-justified btnal" role="tablist" id="myTab">
			...
			<form
				...
				<div class="tab-content">
					...
					<!-- 		 <div class='form-group'>
								...
								<div class="org_row">
								<div class='col-sm-6'>
								<input class='form-control numeric'  name='sim_quantity' id="sim_quantity" required type="number"  min="1" max="99" />
...
<link href="/extras/system/template_list/template_v1/css/bootstrap-duallistbox-master/src/bootstrap-duallistbox.css" rel="stylesheet">

<script src="/extras/system/template_list/template_v1/javascript/bootstrap-duallistbox-master/src/jquery.bootstrap-duallistbox.js"></script>
...
<script type="text/javascript">
		function sim_price_check()
		{
			...
			if(sim_type =="Free")
			{
					...
					$("#sim_price").val(""+"0");
					$("#sim_price").attr('required',false);
			}
			else
			{
					$("#sim_price_div").css("display","block"); 
					$("#sim_price").val("");
					$("#sim_price").attr('required',true);
			}
		}
