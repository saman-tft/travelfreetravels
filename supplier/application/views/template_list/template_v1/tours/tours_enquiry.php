...
if(isset($tours_itinerary) && !empty($tours_itinerary)){
...
?>
    ...
    <div id="Package" class="bodyContent col-md-12">
        ...
        <div class="modal-dialog">
         ...
         <div class="modal-content">
          ...
          <div class="modal-body clearfix"><h5 class="modal-title"><b>Passenger Profile</b></h5>';
                            $c_code = explode("_",$data['pn_country_code']);
           ...
           <span>Duration : &nbsp;</span><span>'.$data['durations'].'</span><br/>';
                            ...
                            if($data["agent_remark"]!="" || $data["created_by_name"]!=""){
                                ...
                                if($data["agent_remark"]){
                                    $paxhtml .='<h5 class="modal-title"><b>Details</b></h5>';
                                    $agent_remark = json_decode($data["agent_remark"],TRUE);
                                    $remarks = explode("|", $agent_remark["agent_remark"]);
                                    $remarks_date = explode("|", $agent_remark["created_date"]);
                                    $remarks_updated_by = explode("|", $agent_remark["updated_by"]);
                                    $count_remarks = count($remarks);
                                    $paxhtml .='<div class="col-md-12">';
                                    $paxhtml .='<div class="col-md-4"><strong> Remark</strong></div>';
                                    $paxhtml .='<div class="col-md-4"><strong>Updated Date</strong></div>';
                                    $paxhtml .='<div class="col-md-4"><strong>Updated By</strong></div>';
                                    $paxhtml .='</div>';
                                    for($i=0;$i<$count_remarks;$i++){
                                        $paxhtml .='<div class="col-md-12">';
                                        $paxhtml .='<div class="col-md-4">'.$remarks[$i].'</div>';
                                        $paxhtml .='<div class="col-md-4">'.$remarks_date[$i].'</div>';
                                        $paxhtml .='<div class="col-md-4">'.$remarks_updated_by[$i].'</div>';
                                        $paxhtml .='</div>';
                                    }
                                    $paxhtml .='<br/>';
                                }
         ...
         <div class="modal-dialog">
          ...
          <div class="modal-content">
           ...
           <div class="modal-body">';
                        ...
                        $remarks .='<input type="text" placeholder="Please Enter Remark" class="form-control vali" required="required" name="agent_remark" id="agent_remark_'.$data["id"].'" /
           ><input  type="hidden" name="remark_id" value="'.$data["id"].'" id="remark_id_'.$data["id"].'" />';
            ...
            <div class="modal-footer">
             <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
             <button type="submit"  id="current_'.$data["id"].'"   class="btn btn-primary remark_submit">Update</button>
            ...
            <div class="modal-footer">
             <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        ...
                        if(!empty($data['tour_id'])){
                            ...
                            $package_str = $TOUR_LIST[$data['tour_id']];
                        }else{
       ...
       <td>'.$sn.'</td> ';
                        ...
                        if($data['status']==1)
                        {
                            echo ' <a href="#" data-toggle="modal" data-target="#remarks_'.$data["id"].'"><i class="fa fa-file-o"></i> Update Remarks</a><br>';
        ...
        //                     }
                            ...
                            echo '<a href="#" data-toggle="modal" data-target="#remarks_'.$data["id"].'"><i class="fa fa-file-o"></i> Reply to Admin
      </a><br>';
    ...
    <a class="callDelete" id="'.$data['id'].'"> 
     ...
     <td class="hide">'.$c_code[0]." ".$data['phone'].'</td>   
     <td  class="hide">'.$data['email'].'</td>             
     <td>'.$package_str.'
     </td> 
     <td>'.$data['date'].'</td>   
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function()
        {
            ...
            $('.remark_submit').click(function(){
                ...
                if(remark_text=='')
                {
                    alert('Please fill the remark details');
                }
                else{
                $.ajax({
                    url:app_base_url+'index.php/tours/add_agent_remark',
                    type:'POST',
