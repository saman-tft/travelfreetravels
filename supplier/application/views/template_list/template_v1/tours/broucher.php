...
<?php  if($menu == true){ ?>
  <div class="container">
    <div class="col-xs-11 text-center mt10">
  ...
  <div class="well max_wd20">
   <!--  <h4 style="text-align: center;">Send Email</h4> -->
    <form name="agent_email" method="post" action="<?php echo base_url () . 'index.php/tours/voucher/'.$tour_id.'/show_broucher/mail';?>">
      ...
      <div class="row">
        <!-- <label>Email Id </label> --><input id="email" placeholder="Please Enter Email" class="airlinecheckbox validate_user_register form-control" type="text" checked name="email">
      </div>
  ...
  <table cellspacing="0" cellpadding="10" border="0" style="border-collapse: collapse; width: 100%; margin: 0px auto; font-family: Aller, sans-serif; color:#405364;">
    <tbody>
        ...
        $pathd = DOMAIN_IMAGE_UPLOAD_DIR."keWD7SNXhVwQmNRymfGNQIA%20logo%20final.png";
         ...
         $final_path = str_replace("/var/www/", "https://", $path)
          ?>
            ...
            <img style="margin-bottom:-30px; height:100% !important;width:auto;" src="<?=$final_path?>" alt="logo"></span>
      ...
      <tr>
        ...
        <span style="width:100%; float:left"><img  style="width:290px; height:160px;" src="<?=$this->template->domain_images($tour_data[0]->banner_image);?>" alt="img" /></span>
      ...
      <tr>
        <td style="padding:0px 10px 20px 0px">
          ...
          <h3 style="margin:0 0 8px ">Tour Quote (<?=$quotation_details['currency_code']?>)</h3>
          <?php 
      ...
      <tr>
        <td style="padding:0px 10px 20px 0px">
          <h3 style="margin:0 0 8px ">Tour Quote (<?=$booking_details['currency_code']?>)</h3>
          <?php 
      ...
      foreach ($tours_itinerary_dw as $key => $itinary) {
        ...
        <tr>
          <td style="padding:0px 10px 10px 0">
            ...
            <p>
              ...
              {
                ?>
                <img src="http://www.trimia.com.au/extras/custom/keWD7SNXhVwQmNRymfGN/images/star_rating_<?=$itinary['rating']?>.png">
                <?php
              }
              ?>
            </p>
            <span style="margin:0 0 2px; font-weight:bold">
              <?php foreach ($accommodation as  $accom) {
                if ($accom === end($accommodation)){
                   if($accom){
                       echo "Meal Plan:".$accom;
                     }
                    }else{
                      if($accom){
                       echo "Meal Plan:".$accom.'|';
       ...
       <?php  if($en_note){ ?>
        <tr>
          <td style="padding:0px 10px 5px 0">
            <h2 style="margin:5px 0;font-size: 16.5px; line-height:20px; font-weight:600">Important Notes:</h2>
            <p style="margin:0;white-space: normal;"><?php echo $en_note; ?></p>
          </td>
        </tr>
        <?php } ?>
          ...
          <tr style="border-bottom: 3px solid #b2b2b2;" class="front_end_link">
            <td style="padding:20px 20px 22px 0">
              <table>
                <tbody>
                  <tr>
                    <td align="center" style="width: 85px;"><a href="http://www.tripmia.com.au/index.php/general/index/flight?default_view=VHCID1420613784" style="color:#f48730 !important;"><span style="display:block"><img style="margin-bottom:10px; height:40px;" 
                      src=" https://tripmia.com.au/extras/system/template_list/template_v1/images/flight_icon.png" alt="logo"></span>

                     


                      <!-- http://www.tripmia.com.au/extras/custom/keWD7SNXhVwQmNRymfGN/images/flight_icon.png -->
                    <span style="display:block; font-weight:bold;">FLIGHTS</span></a></td>

            <!--   <td align="center" style="width: 85px;"><a href="http://www.tripmia.com.au/index.php/general/index/flight?default_view=VHCID1420613784" style="color:#f48730 !important;"><span style="display:block"><img style="margin-bottom:10px; height:40px;" 
                      src="<?=$this->template->template_images('flight_icon.png');?>" alt="logo"></span>

                      <!-- https://tripmia.com.au/extras/system/template_list/template_v1/images/flight_icon.png -->
                   ...
                   <!--  <span style="display:block; font-weight:bold;">FLIGHTS</span></a></td> -->
                    ...
                    <td align="center" style="width: 85px;"><a href="http://www.tripmia.com.au/index.php/general/index/hotel?default_view=VHCID1420613748" style="color:#f48730 !important;"><span style="display:block"><img style="margin-bottom:10px; height:40px;" src="https://tripmia.com.au/extras/system/template_list/template_v1/images/hotel_icon.png" alt="logo"></span>
                    <span style="display:block; font-weight:bold;">HOTELS</span></a></td>
                    <td align="center" style="width: 85px;"><a href="http://www.tripmia.com.au/index.php/general/index/car?default_view=VHCID1433498954" style="color:#f48730 !important;"><span style="display:block"><img style="margin-bottom:10px; height:40px;" src="https://tripmia.com.au/extras/system/template_list/template_v1/images/car_icon1.png" alt="logo"></span>
                    <span style="display:block; font-weight:bold;">CARS</span></a></td>
                    <td align="center" style="width: 85px;"><a href="http://www.tripmia.com.au/" style="color:#f48730 !important;"><span style="display:block"><img style="margin-bottom:10px; height:40px;" src="https://tripmia.com.au/extras/system/template_list/template_v1/images/holiday_icon.png" alt="logo"></span>
              ...
              <table style="width:100%">
                <tbody>
                  ...
                  <tr style="border-top: 1px solid #b2b2b2;">
                    <td align="left"><a href="https://www.facebook.com/tripmiaa" style="color:#f48730 !important;"><span><img style="margin-top:10px; height:36px;" src="https://tripmia.com.au/extras/system/template_list/template_v1/images/fb.png" alt="logo"></span></a>
                    <a href="https://twitter.com/tripmiaa" style="color:#f48730 !important;"><span><img style="margin-top:10px; height:36px;" src="https://tripmia.com.au/extras/system/template_list/template_v1/images/twt.png" alt="logo"></span></a>
                    <a href="https://www.instagram.com/tripmiaa" style="color:#f48730 !important;"><span><img style="margin-top:10px; height:36px;" src="https://tripmia.com.au/extras/system/template_list/template_v1/images/intgm.png" alt="logo"></span></a></td>
                  </tr>
                </tbody>
              </table>
              </td>
          ...
          <tr style="border-bottom: 1px solid #b2b2b2;">
            <td style="padding:10px 20px 10px 0">
              <table>
                <tbody>
                  <tr>
                    <td colspan="3" width="100%"><span style="margin:5px 0;line-height:20px;">&copy; 2018 tripmia.com.au All rights reserved.
</span></td>
                  </tr>
                </tbody>
              </table>
