<div class="price_mgnt">
 ...
 <div class="form-group modl">
                    ...
                    <div class="col-md-7 col-xs-8 eml n_psngr"> <select class="normalsel form-control normalinput holyday_selct" id="nationality" name="nationality"
                            required>
                ...
                <div class="form-group modl">
                    ...
                    <div class="col-md-7 col-xs-8 eml"><i class="fa fa-money" aria-hidden="true"></i><input type="text"
                            ...
                            placeholder="Infant Price" aria-required="true" required="required"></div>
                </div>
                <!-- <div class="form-group modl">
...
$('select[name^="currency_sel"] option[value="NPR"]').attr("selected","selected");
//$("#currency").val("NPR");
