...
$form_configuration['inputs'] = array(
	...
	'sales_person' 	   => array('type' => 'text',     'label_line_code' => 131, 'mandatory' => true, 'DT' => 'PROVAB_SOLID_V45'),
	...
	'corporate_id' 	   => array('type' => 'text',     'label_line_code' => 37, 'DT' => 'PROVAB_SOLID_V45'),
	'last_name' 	   => array('type' => 'text',     'label_line_code' => 5, 'DT' => 'PROVAB_SOLID_V45'),
	'agency_name' 	   => array('type' => 'text',     'label_line_code' => 257, 'mandatory' => true, 'DT' => 'PROVAB_SOLID_V45'),
...
$form_configuration['form']['corporate_user'] = array(
'form_header' => $form_attributes,
		'sections' => array(
			array('elements' => array('corporate_id','agency_name','pan_number','office_phone','image','sales_person'),
					'fieldset' => 'FFL0049'
			),
 ...
 * Update FORM
 */
$form_configuration['form']['corporate_user_edit'] = array(
		'form_header' => $form_attributes,
		'sections' => array(
			array('elements' => array('agency_name', 'pan_number','office_phone','image','sales_person'),
					'fieldset' => 'FFL0049'
			),
			array('elements' => array('user_id', 'title', 'first_name', 'last_name', 'date_of_birth', 'country_code', 'phone','country_name','city','address', 'status', 'language_preference'),
				'fieldset' => 'FFL003'
...
*/
$disabled['corporate_user_edit'] = array('email');
...
$auto_validator['sales_person'] = 'trim|required|min_length[2]|max_length[45]|xss_clean';
...
//$auto_validator['email'] = 'trim|required|valid_email|min_length[5]|max_length[45]|is_unique[user.email_test]|xss_clean';
$auto_validator['email'] = 'trim|required|valid_email|min_length[5]|max_length[45]|callback_b2b_username_check|xss_clean';
