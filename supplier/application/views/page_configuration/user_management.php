...
$form_configuration['inputs'] = array(
	...
	'phone' 		   => array('type' => 'text',   'label_line_code' => 20, 'maxlength' => '15', 'DT' => 'PROVAB_SOLID_I10'),
...
$form_configuration['form']['user_edit'] = array(
		'form_header' => $form_attributes,
		'sections' => array(
			array('elements' => array('user_id', 'title', 'first_name', 'last_name', 'date_of_birth', 'country_code', 'phone', 'address',  'language_preference','company_reg_id','travel_licence_no','postal_code','comp_website_link','comp_email','status','image'),
				'fieldset' => 'FFL003'
...
$auto_validator['postal_code'] = 'trim|required|min_length[3]|max_length[6]|numeric';
