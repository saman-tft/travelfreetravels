...
$form_configuration['inputs'] = array(
	...
	'gst_no' 	   => array('type' => 'text',     'label_line_code' => 2226, 'mandatory' => true, 'maxlength' => 15),
...
'form_header' => $form_attributes,
		'sections' => array(
			array('elements' => array('agency_name','pan_number','gst_no','office_phone','image'),
					'fieldset' => 'FFL0049'
			),
...
$auto_validator['gst_no'] = 'trim|required';
