...
define('STATIC_ADDRESS','Sahamati Marga, House no. 17 Gairidhara, Kathmandu-02,Nepal');
...
define('CURRENT_DOMAIN_KEY', 'TMX6244821650276433'); //Live
//define('CURRENT_DOMAIN_KEY', 'TMX1512291534825461'); //TEST
//define('CURRENT_DOMAIN_KEY', 'TMX1512291534825461'); //TEST
...
define('PROJECT_FOLDER', $project_parent_folder);
...
define('B2B_LOGINLINK',APP_ROOT_DIR.'/agent');
define('SUPPLIER_LINK','https://travelfreetravels.com/');
/*
 |--------------------------------------------------------------------------
 | RESOURCE FOLDERS
 |--------------------------------------------------------------------------
...
define('DOMAIN_PAN_UPLOAD_DIR', realpath('../extras').'/custom/'.CURRENT_DOMAIN_KEY.'/pandata/');

// if($project_parent_folder == '') {

// define('DOMAIN_PCKG_UPLOAD_DIR', CUSTOM_RESOURCE_DIR.'/'.CURRENT_DOMAIN_KEY.'/uploads/packages/');
// }else{

// 	define ('DOMAIN_PCKG_UPLOAD_DIR', '../extras/custom/'.CURRENT_DOMAIN_KEY.'/uploads/packages/',true);
// }
...
define('DOMAIN_USER_IMAGE_DIR', 'extras/system/template_list/template_v1/images/');
...
// define('UNIVERSAL_DEFAULT_CURRENCY', 'MYR'); // INR
// define('COURSE_LIST_DEFAULT_CURRENCY', 36); // INR
// define('COURSE_LIST_DEFAULT_CURRENCY_VALUE', 'MYR');
// define('COURSE_LIST_DEFAULT_CURRENCY_SYMBOL', 'MEX$');
...
define('UNIVERSAL_DEFAULT_CURRENCY', 'AED'); // INR
define('COURSE_LIST_DEFAULT_CURRENCY', 1); // INR
define('COURSE_LIST_DEFAULT_CURRENCY_VALUE', 'AED');
define('COURSE_LIST_DEFAULT_CURRENCY_SYMBOL', '');
...
define('CAR_BRANCH_USER', 7);
define('SUPPLIER', 8);
define('CAR_SUPPLIER', 8);
// define('BRANCH', 9);
// define('MANAGER', 10);
define('EMPLOYEE', 11);
define('SUB_AGENT', 12);
define('SUB_CORPORATE', 13);
define('MARKUP_CURRENCY', 'INR');

define('HOTEL_SUPPLIER',11);
define('ACIVITY_SUPPLIER',12);
define('TOUR_SUPPLIER',13);


define('CAR_VENDOR',9);
define('CAR_DRIVER',10);
...
define ( 'RECORDS_RANGE_4', 100 );
define ( 'RECORDS_RANGE_5', 500 );
define ( 'RECORDS_RANGE_6', 1000 );
