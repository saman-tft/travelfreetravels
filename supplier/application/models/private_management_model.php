...
Class Private_Management_Model extends Abstract_Management_Model
{
	...
	{
		$response['data'] = '';
		$response['data']['specific_markup_list'] = $this->specific_domain_markup('corporate_holiday');
		$response['data']['generic_markup_list'] = $this->generic_domain_markup('corporate_holiday');
		return $response;
	}
	/**
	 * Balu A
	 ...
	 * @param number $amount		amount to be added or deducted(-100 or +100)
	 */
	function update_b2b_balance($origin, $amount,$type)
	{
		...
		{
			//echo "SDSDS";
		$details = $this->custom_db->single_table_records('corporate_user_details', 'balance,due_amount,credit_limit', $cond);		
		}
