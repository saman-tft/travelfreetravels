$(document).ready(function() {
    ...
    $(".open_register").click(function() {
        ...
        //"" == t || "" == s ? $("#login-status-wrapper").text(message).show() : ($("#login_auth_loading_image").show(), $(".data-utility-loader", $("#myModal_1")).show(), $("#login-status-wrapper").text("Please Wait!!!").hide(), $.post(app_base_url + "index.php/auth/login/", {
            ...
            $("#login_auth_loading_image").hide(), e.status ? ($("#myModal_1").hide(), $(".my_account_dropdown").hide(),$("#show_log").hide(), window.location.reload()) : $("#login-status-wrapper").text(e.data).show(), $(".data-utility-loader", $("#myModal_1")).hide()
        }))
    ...
    $("#reset-password-trigger").on("click", function(e) {
        ...
        if($("#recover_phone_book").val()==""){
            ...
            else
            {
                ...
                $("#forgot_pasword_mobile_id_booking").text("Please enter mobile number");
        ...
        if($("#recover_phone_book").val() !="" && $("#recover_email_book").val() !="")
        {
