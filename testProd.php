<?php 
 ...
 //  debug($booking_details['admin_commission']);exit;
...
if (($booking_details['is_domestic'] == true || $booking_details['booking_source'] == PLAZMA_BOOKING_SOURCE) && count($booking_transaction_details) == 2) {
   ...
   if(isset($airline_contact_no['data'][0])){
      $airline_number = '<span><img style="vertical-align:middle" src=https://travelfreetravels.com/extras/system/library/images/phone.png /><span style="font-size:12pt;color:#00a9d6;vertical-align:middle;font-weight: 600;">'.$airline_contact_no['data'][0]['phone_number'].'</span></span> ';
   }
   else{
      $airline_number ='';
   }
      ...
      <tbody>
         <tr>
            <td colspan="2" valign="bottom">
               <img style="width:150px;" src="https://travelfreetravels.com/extras/custom/TMX6244821650276433/images/<?=$data['logo']?>" /> 
               
            </td>
            <td valign="bottom" colspan="2" align="right"><span>Booking ID : <?=@$booking_details['app_reference']?></span><br>
               <span>Booked on : <?=app_friendly_absolute_date(@$booking_details['booked_date'])?></span></td>
         </tr>
         ...
         <tr>
            <td style="padding:10px 0; vertical-align:middle;"><img style="width:40px;" src="<?='https://travelfreetravels.com/extras/system/library/images/airline_logo/'.$itinerary_details[0]['airline_code'].'.gif'?>" /></td>
            ...
            <td style="padding:10px 0; vertical-align:middle; padding-left: 10%; line-height:normal;"><span style="font-size:11pt;">Travel Free Travels customer service</span><br><br><span style="font-size:9pt;color:#00a9d6;vertical-align:middle;font-weight: 600;"><img valign="bottom" style="vertical-align:middle;width:12px;line-height:normal;" src="<?=''?>" />&nbsp; <span style="line-height:normal;"><?php echo @$data['email'] ?></span></span></td>

            <?php

            if((!empty($gds_pnr)) || (!empty($airline_pnr))){?>
            <td style="padding:10px 0;text-align: center;">
            <span style="font-size:10pt; border:2px solid #808080; display:block">
            ...
            <span style="font-size:12pt;line-height:15px;padding-bottom: 5px;display:block;font-weight: 600;"><?=@$airline_pnr?></span>
            <?php } ?>
         ...
         <tr>
            <td colspan="4" style="padding:0;">
               <table border="0" cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #00a9d6;font-size:9pt; padding:0;">
                  <tbody>
                     <tr>
                     <td colspan="2" style="background-color:#00a9d6; color:#fff"><img width="9" src="<?='https://travelfreetravels.com/extras/system/library/images/flight.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Onward Flight Details</span></td>                
                        ...
                        if (isset ( $booking_transaction_details ) && $booking_transaction_details != "") {
                              ...
                              foreach ( $itinerary_details as $segment_details_k => $segment_details_v ) { 
                                 ...
                                 if(in_array($segment_details_v['segment_indicator'], $seg_in_array) && !empty($seg_in_array) && ($seg_counts == 0) && ($trip_type != 'multicity')){ 
                                    ...
                                    ?>
                     <tr>
                        <td colspan="2" style="background-color:#00a9d6; color:#fff"><img width="9" src="<?='https://travelfreetravels.com/extras/system/library/images/flight.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Return Flight Details</span></td> 
                        <td align="right" colspan="2" style="background-color:#00a9d6; color:#fff;line-height:normal;vertical-align:middle;"><span style="font-size:8pt;">*Please verify flight times with the airlines prior to departure</span></td>
                     </tr>
                     <?php }
...
# Checking Cabin Baggage
                     ...
                     <tr>
                        ...
                        <td style="background-color:#d9d9d9;color:#555555"><img width="15" style="vertical-align:middle" src="<?='https://travelfreetravels.com/extras/system/library/images/flight_up.png'?>">&nbsp;<span style="vertical-align:middle">Departing</span></td>
                        <td style="background-color:#d9d9d9;color:#555555"><img width="15" style="vertical-align:middle" src="<?='https://travelfreetravels.com/extras/system/library/images/flight_down.png'?>">&nbsp;<span style="vertical-align:middle">Arriving</span></td>
         ...
         <tr>
            <td colspan="5" style="padding:0;">
               <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #00a9d6;font-size:9pt; padding:0;">
                  <tbody>
                     <tr>
                        <td colspan="5" style="background-color:#00a9d6; color:#fff"><img width="12" style="vertical-align:middle" src="<?='https://travelfreetravels.com/extras/system/library/images/people_group.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Passenger(s) Details</span></td>
                     </tr>
                     <tr>
                     <td style="background-color:#d9d9d9;border-left:1px solid #666666; color:#555555">Sr No.</td>
                     <td style="background-color:#d9d9d9; color:#555555">Passenger(s) Name</td>
                     <td style="background-color:#d9d9d9; color:#555555">Passenger(s) Nationality</td>
                     <td style="background-color:#d9d9d9; color:#555555">Type</td>
                     <td style="background-color:#d9d9d9;border-right:1px solid #666666; color:#555555">E-ticket No</td>
                     </tr>
                     <?php
                        $booking_transaction_details_value = $booking_transaction_details [0];
                        // debug($booking_transaction_details_value);exit;
                     ...
                     <tr>
                        ...
                        <td style="line-height: 13px;"><span><?=@$booking_details['ticket'];?></span></td>
                     </tr>
                     <?php
                        }
                     }
         ...
         <tr>
            <td colspan="4" style="padding:0;"><table cellspacing="0" cellpadding="0" width="100%" style="font-size:9pt; padding:0;"><tbody><tr><td width="50%" style="padding:0;padding-right:14px;">
                           <table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;border:1px solid #00a9d6;"><tbody><tr>
                                    <td style="border-bottom:1px solid #ccc;background-color: #00a9d6;color: #fff;"><span style="font-size:10pt">Payment Details</span></td>
                                    <td style="border-bottom:1px solid #ccc;background-color: #00a9d6;color: #fff;"><span style="font-size:8pt">Amount ( <?php echo $booking_details['currency']?>
                                       )</span>
                                    </td>
                                 </tr>
                                 <tr>
                                    <?php $name1=number_format($BaseFare,2);
                                          $result1 = str_replace(',', '', $name1);
                                          $airfare = $result1; ?>
                                    <td style="line-height: 13px;"><span>Air Fare</span></td>
                                    <td style="line-height: 13px;"><span> <?php echo number_format($BaseFare+$booking_details['admin_commission'],2)?></span></td>
                                 </tr>
                                 <?php if($this->uri->segment(2)=='b2c_flight_voucher'):?>
                                    <tr>
                                       <?php $name2 = number_format(($Tax+$booking_details['admin_markup']+$booking_details['agent_markup']), 2);
                                          $result2 = str_replace(',', '', $name2);
                                          $taxfee = $result2; ?>
                              ...
                              <?php } ?>
                                 ...
                                 <?php if(isset($baggage_price) && $baggage_price !=0){?>
                                    <?php $name4 = number_format($baggage_price,2);
                                          $result4 = str_replace(',', '', $name4);
                                          $bagpric = $result4; ?>
                                 <tr>
                                 ...
                                 <?php if(isset($meal_price) && $meal_price!=0){?>
                                    <?php 
                                          $name5 = number_format($meal_price,2);
                                          $result5 = str_replace(',', '', $name5);
                                          $mealpric = $result5; ?>
                                 <tr>
                                 ...
                                 <?php if(isset($seat_price) && $seat_price!=0){?>
                                    <?php $name6 = number_format($seat_price,2);
                                          $result6 = str_replace(',', '', $name6);
                                          $seatpric = $result6; ?>
                                 <tr>
                                 ...
                                 <?php }if($booking_details['discount']!=0){ ?>
                                    <?php $name7 = number_format($booking_details['discount'],2);
                                          $result7 = str_replace(',', '', $name7);
                                          $disct = $result7; ?>
                                 <tr>
                                 ...
                                 <?php if($booking_details['segment_discount']!=0){ ?>
                                    <tr>
                                    <td><span>Discount (-)</span></td>
                                    <td><span> <?php echo number_format($booking_details['segment_discount']+$booking_details['reward_amount'],2)?></span></td>
                                    </tr>
                                 <?php } ?>
                                 <tr>
                                    <!-- <td style="border-top:1px solid #ccc;line-height: 13px;"><span style="font-size:10pt">Grand Total</span></td>
                                    <td style="border-top:1px solid #ccc;line-height: 13px;"><span style="font-size:10pt"> <?=number_format(@$booking_details['grand_total']-$booking_details['discount'],2)?></span></td> -->
                                    <td style="border-top:1px solid #ccc;line-height: 13px;"><span style="font-size:10pt">Grand Total</span></td>
                                     <?php
                                    ...
                                    <td style="border-top:1px solid #ccc;line-height: 13px;"><span style="font-size:10pt"><?= round($grand_total-$discount+ @$booking_details['pg_convenience']);  ?></span></td>
                                 </tr>
                              </tbody>
                               <!-- changes start infant fare info: added condition with info -->
                               <?php
                                if($booking_details['is_domestic'] == true && $booking_details['booking_source'] == PLAZMA_BOOKING_SOURCE && $infant_count > 0) {
                                    $PassengerFareBreakdown_org = json_decode(provab_decrypt(json_decode($booking_transaction_details[0]['attributes'], true)['TokenValue']), true)['PassengerFareBreakdown'];
                                ?>
                                    <tfoot>
                                        <tr>
                                            <td colspan="2" style="border-top:1px solid #00a9d6; line-height: 13px; margin-top: 0; color: #666;">
                                                <strong>Please note:</strong> * An infant fare (10% of adult fare = <?php echo ($PassengerFareBreakdown_org['ADT']['BaseFare']/$PassengerFareBreakdown_org['ADT']['PassengerCount']*0.1); ?>) will be collected per infant at the airport.
                                            </td>
                                        </tr>
                                    </tfoot>
                                <?php
                                ...
                                ?>
                                <!-- changes end infant fare info: added condition with info -->
                           </table>
                        </td>
                        <td width="50%" style="padding:0;padding-left:14px; vertical-align:top">
                          <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #00a9d6;font-size:9pt; padding:0;">
                                        <tbody>
                                            <tr>
                                                <td colspan="4" style="border-bottom:1px solid #00a9d6;background-color: #00a9d6;color: #fff;"><span style="font-size:10pt">Flight Inclusions</span></td>
                                            </tr>
...
<?php if ($TotalBaggageCabin != '' && $TotalBaggageCabin != 0) { ?>
                                            ...
                                            <tr>
                                                <td colspan="4" style="border-top:1px solid #ccc"><span style="font-size:10pt; color:#666; line-height:20px;">* Flight inclusions are subject to change with Airlines.</span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                        </td>
         ...
         <tr>
          ...
          <tr>
                ...
                <td colspan="4"><span style="line-height:23px; font-size:10pt;">Note:</span></td></tr>

            <tr>

                <td colspan="4" style="border-bottom:1px solid #999999; line-height:20px; font-size:9px; color:#555;font-weight: 600">
         ...
         <tr>
            <td colspan="4" align="right" style="padding-top:10px; line-height:16px"><?php echo strtoupper($data['domainname'])?><br>Email : <?php echo $data['voucher_email'] ?><br>Phone : <?php echo $data['voucher_phone'] ?><br>Address : <?php
...
// debug($airline_contact_no);exit;
if(isset($airline_contact_no['data'][0])){
   $airline_number = '<span><img style="vertical-align:middle" src=https://travelfreetravels.com/extras/system/library/images/phone.png /><span style="font-size:16px;color:#00a9d6;vertical-align:middle;font-weight: 600;"> &nbsp;'.$airline_contact_no['data'][0]['phone_number'].'</span></span> ';
}
else{
   $airline_number ='';
}
...
<div style="background:#ccc; width:100%; position:relative">
   <table class="pag_brk" cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:9pt; font-family: 'Open Sans', sans-serif; max-width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate; color: #000;">
      <tbody>
         ...
         <tr>
            <td style="padding:10px 0; vertical-align:middle;"><img style="width:40px;" src="<?='https://travelfreetravels.com/extras/system/library/images/airline_logo/'.$booking_transaction_details[0]['segment_details'][1][1]['airline_code'].'.gif'?>" /></td>
            ...
            <td style="padding:10px 0; vertical-align:middle; padding-left: 10%; line-height:normal;"><span style="font-size:11pt;">Travel Free Travels customer service</span><br><br><span style="font-size:9pt;color:#00a9d6;vertical-align:middle;font-weight: 600;"><img valign="bottom" style="vertical-align:middle;width:12px;line-height:normal;" src="<?='https://travelfreetravels.com/extras/system/library/images/envelope.png'?>" />&nbsp; <span style="line-height:normal;"><?php echo @$data['email']?></span></span></td>
            <?php if((!empty($return_gds_pnr)) || (!empty($return_airline_pnr))){?>
            <td style="padding:10px 0;text-align: center;">
            <span style="font-size:10pt; border:2px solid #808080; display:block">
            <?php if($booking_transaction_details[1] ['status'] == 'BOOKING_CONFIRMED') { ?>
            <span style="color:#00a9d6;padding:5px; display:block">AIRLINE PNR</span>
            <span style="font-size:12pt;line-height:15px;padding-bottom: 5px;display:block;font-weight: 600;"><?=@$return_airline_pnr?></span>
            <?php } ?>
         ...
         <tr>
            <td colspan="4" style="padding:0;">
               <table border="0" cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #00a9d6;font-size:9pt; padding:0;">
                  <tbody>
                     <tr>
                        <td colspan="2" style="background-color:#00a9d6; color:#fff"><img width="9" src="<?='https://travelfreetravels.com/extras/system/library/images/flight.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt"><?php echo $Return;?>Flight Details</span></td>
                        <td align="right" colspan="2" style="background-color:#00a9d6; color:#fff;line-height:normal;vertical-align:middle;"><span style="font-size:8pt;">*Please verify flight times with the airlines prior to departure</span></td>
                     </tr>
                     <?php 
                        if (isset ( $booking_transaction_details ) && $booking_transaction_details != "") {
...
# Checking Cabin Baggage
         ...
         <tr>
            <td colspan="4" style="padding:0;">
               <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #666666; font-size:9pt; padding:0;">
                  <tbody>
                     <tr>
                        <td colspan="4" style="background-color:#666666; color:#fff"><img width="12" style="vertical-align:middle" src="<?='https://travelfreetravels.com/extras/system/library/images/people_group.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:10pt">Passenger(s) Details</span></td>
                     </tr>
                     <tr>
    ...
    <?php } else {
        ?>
         ...
         <tr><td colspan="4" style="line-height:8px;padding:0;">&nbsp;</td></tr>
         <tr>
            <td colspan="4" align="right" style="padding-top:10px; line-height:16px"><?php echo strtoupper($data['domainname'])?><br>Email : <?php echo $domain_details['email'] ?><br>Phone : <?php echo $domain_details['phone'] ?><br>Address : <?php
                 // echo $domain_details['address'];
                echo STATIC_ADDRESS;
                 ?>
                 <br/><?php echo STATIC_COUNTRY; ?></td>
