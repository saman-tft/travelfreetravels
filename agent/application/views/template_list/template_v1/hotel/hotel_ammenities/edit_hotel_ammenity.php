	...
	<div class="panel panel-default clearfix">
		...
		<div class="panel-heading">
			...
			<div class="panel-title">
				<i class="fa fa-credit-card"></i> Edit Hotel Amenities
			</div>
		</div>
		<!-- PANEL HEAD START -->
			...
			<div class="panel-body">
				<form method="post" id="hotel_ammenity" name="hotel_ammenity" action="<?php echo base_url()."index.php/hotel/update_hotel_ammenity/".base64_encode(json_encode($ammenities_list[0]->id)); ?>" class="form-horizontal form-groups-bordered validate" enctype= "multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" required id="" name="hotel_ammenity_name" value="<?php echo $ammenities_list[0]->name; ?>" data-validate="required" data-message-required="Please enter the Hotel Amenity Name">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<button type="submit" class="btn btn-success">Update Hotel Amenity</button>
					</div>
				</div>
				</form>
			</div>
