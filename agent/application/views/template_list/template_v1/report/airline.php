						...
						<?php
							if(valid_array($table_data['booking_details']) == true) {
					        	...
					        	foreach($booking_details as $parent_k => $parent_v) {
									...
									$tdy_date = date ( 'Y-m-d' );
								//	echo "Journedy".$jrny_date;
								//	echo "tdy_date".$tdy_date;
								...
								?>
									<tr>
										...
										<td><?=@$to_loc?></td>
										<td><?=@$trip_type?></td>
										<td><?php echo round($agent_buying_price - ($segment_discount+$reward_amount))?></td>
										<td><?php echo $agent_commission?></td>
										<td><?=$segment_discount+$reward_amount?></td>
										<td><?php echo $agent_markup?></td>
										<td><?php echo ($agent_tds)?></td>
										<td><?php echo ($gst)?></td>
										
										<td><?php echo round($grand_total - ($segment_discount+$reward_amount))?></td>
