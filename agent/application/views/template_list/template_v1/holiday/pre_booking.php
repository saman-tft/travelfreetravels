...
.toalnright{}
.table-condensed.tblemd>tbody>tr>td {
...
// debug($gst_value);exit();
      $grand_total=$grand_total+ $gst_value;
     // debug($grand_total);exit();
...
$total_price=$total_price+$Markup+$gst_value;
// debug($total_price);exit();
/*debug($Markup);
debug($gst_value);
debug($total_price);
...
<div class="alldownsectn" ng-app="myApp" ng-controller="myCtrl">
  ...
  <div class="bktab1 xlbox <?=$review_tab_details_class?>">
   ...
   <!--  rightpart sttrt -->
     <div class="col-xs-4 full_room_buk rhttbepa sidebuki frmbl" id="slidebarscr">
            ...
            <div class="col-xs-7 celoty nopad">
              <div class="insidechs">
                ...
                <div class="havealrdy">
                  ...
                  <label for="alreadyacnt" class="haveacntd">I have a QuaQua Account</label>
                </div>
                <div class="clearfix"></div>
                <div class="twotogle">
                <div class="cntgust">
...
$get_ctry= array('212');
$passport_issuing_country_options = generate_options($country_list, $get_ctry);
    ...
    <div class="col-xs-2 nopadding">
     ...
     <div class="inptalbox">
      ...
      <div class="col-xs-4 spllty">
          <!-- <input value="<?=@$first_name?>" required="required" type="text" name="first_name[]" id="passenger-first-name-<?=$pax_index?>" class="clainput alpha <?=$traveller_class?>"  minlength="2" maxlength="45" placeholder="Enter First Name" data-row-id="<?=($pax_index);?>"/> -->
          <input value="" required="required" type="text" name="first_name[]" id="passenger-first-name-<?=$pax_index?>" class="clainput alpha <?=$traveller_class?>"  minlength="2" maxlength="45" placeholder="Enter First Name" data-row-id="<?=($pax_index);?>"/>
          <input type="hidden" class="hide"  maxlength="45" name="middle_name[]">
      </div>
      <div class="col-xs-4 spllty">
        <!-- <input value="<?=@$last_name?>" required="required" type="text" name="last_name[]" id="passenger-last-name-<?=$pax_index?>" class="clainput alpha last_name" minlength="2" maxlength="45" placeholder="Enter Last Name" /> -->
        <input value="" required="required" type="text" name="last_name[]" id="passenger-last-name-<?=$pax_index?>" class="clainput alpha last_name" minlength="2" maxlength="45" placeholder="Enter Last Name" />
       </div>
    </div>
    </div>
  </div>
...
?>
        ...
        <div class="contbk">
          ...
          <input value="" type="text" name="passenger_contact" id="passenger-contact" placeholder="Mobile Number" class="newslterinput nputbrd _numeric_only" maxlength="15" required="required">
          </div>
          <div class="clearfix"></div>
        ...
        <div class="comon_backbg mt20">
          ...
          <div class="sectionbuk billingnob">
            <div class="payrow1">
              <div class="col-md-6">
                <div class="paylabel">Unit No / Street Number*</div>
                <input type="text" class="form-control" style="font-size: 13px; height: 45px;padding: 7px;width: 100% !important;" name="billing_address_1" id="street_address2"  placeholder="" value="" required/>
              </div>
              <div class="col-md-6">
                <div class="paylabel">Street Address <sup class="text-danger">*</sup>
                </div>
                <input type="text" class="form-control" name="address2" id="validationCustom01" style="border-radius: 3px;color:  #333333; display: block;font-size: 13px; height: 45px;overflow: hidden;padding: 7px;width: 100% !important;"   placeholder="" value="" required >
              </div><!-- id="address2" -->
            </div>
            <div class="payrow1">
              <div class="col-md-6">
                <div class="paylabel">Suburb / City <sup class="text-danger">*</sup>
                </div>
                <!-- <input type="text" required="" value="" class="payinput" name="billing_city" id="city" aria-required="true"> -->
               <!--  id="billing_city_x" -->
                <input type="text"  name="billing_city_x" style="border-radius: 3px;color:  #333333; display: block;font-size: 13px; height: 45px;overflow: hidden;padding: 7px;width: 100% !important;" class="form-control alpha"  value="" id="validationCustom02" required >
              </div>
              <div class="col-md-6">
                <div class="paylabel">State / Province <sup class="text-danger">*</sup>
                </div><!-- id="billing_state"  -->
                <input type="hidden" name="billing_state" class="payinput alpha" value=""  >
                <fieldset id="state_holder">
                 <!--  id="state" -->
                  <input type="text"   class="form-control alpha" style="border-radius: 3px;color:  #333333; display: block;font-size: 13px; height: 45px;overflow: hidden;padding: 7px;width: 100% !important;"  name="state" id="validationCustom03"  aria-required="true" placeholder="" value="" required >
                </fieldset>
              </div>
              <div class="col-md-6">
                <div class="paylabel">Country <sup class="text-danger">*</sup>
                </div>
                <div class="selectedwrap"><!-- id="country" -->
                  <select   name="billing_country"  class="form-control valid"  style="border-radius: 3px;color:  #333333; display: block;font-size: 13px; height: 45px;overflow: hidden;padding: 7px;width: 100% !important;" aria-required="true" id="validationCustom04" aria-invalid="false" required >
            ...
            <div class="payrow1">
              <div class="col-md-6">
                <div class="paylabel">Postal Code <sup class="text-danger">*</sup>
                </div>
                <input type="text"   class="form-control numeric" name="billing_zipcode" maxlength="7" aria-required="true" placeholder="" style="border-radius: 3px;color:  #333333; display: block;font-size: 13px; height: 45px;overflow: hidden;padding: 7px;width: 100% !important;" value="" id="validationCustom05" required > <!-- id="zip" -->
              </div>
              <div class="col-md-6">
                <div class="paylabel">Email Address <sup class="text-danger">*</sup>
                </div>
                <!-- <input type="email" required="required" value="<?=@$this->entity_email?>" class="form-control" name="billing_email"  aria-required="true" style="border-radius: 3px;color:  #333333; display: block;font-size: 13px; height: 45px;overflow: hidden;padding: 7px;width: 100% !important;" id="validationCustom06" placeholder=""> -->
                <input type="email" required="required" value="" class="form-control" name="billing_email"  aria-required="true" style="border-radius: 3px;color:  #333333; display: block;font-size: 13px; height: 45px;overflow: hidden;padding: 7px;width: 100% !important;" id="validationCustom06" placeholder=""> <!-- id="billing-email" -->
              </div>
              <div class="col-md-6">
                <div class="paylabel">Mobile/Cell <sup class="text-danger">*</sup>
                </div>
                ...
                ?>
                  ...
                  <!-- <input type="text"   value="<?=@$phone_number?>" class="form-control col-md-6 mobile numeric" minlength="10" maxlength="15" name="passenger_contact"  style="border-radius: 3px;color:  #333333; display: block;font-size: 13px; height: 45px;overflow: hidden;padding: 7px;width: 100% !important;"   id="passenger-contact" aria-required="true" required > -->
                  <input type="text"   value="" class="form-control col-md-6 mobile numeric" minlength="10" maxlength="15" name="passenger_contact"  style="border-radius: 3px;color:  #333333; display: block;font-size: 13px; height: 45px;overflow: hidden;padding: 7px;width: 100% !important;"   id="passenger-contact" aria-required="true" required >
...
<!-- right part start -->
    <div class="col-xs-4 rhttbepa" id="slidebarscr">
     ...
     <!--           <td class="grandtotal" style="font-size: 18px !important">
           ...
           <td class="grandtotal" style="font-size: 18px !important">
                  <?=$this->currency->get_currency_symbol($currency_obj->to_currency)?>&nbsp;
                  <span class="tot_amt" id="total_booking_amount_show"><?=number_format($grand_total+$pre_booking_params['sim_total_price'],2)?></span> 
</td>
              </tr>
                          </tbody>
...
$("#redeem_points").change(function(){
    ...
    if($(this). prop("checked") == true){
      ...
      $("#available_rewards").text('<?php echo round($reward_usable)?> Points');
        $(".tot_amt").html('');
       $(".tot_amt").html('<?=$this->currency->get_currency_symbol($currency_obj->to_currency)?> <?=(number_format($grand_total+$pre_booking_params['sim_total_price']-$reducing_amount,2))?>');
      ...
      $(".discount_total").text('<?php echo (ceil($price['api_total_display_fare']+$convenience_fees)); ?>');
       $(".tot_amt").html('');
      $(".tot_amt").html('<?=$this->currency->get_currency_symbol($currency_obj->to_currency)?> <?=(number_format($grand_total+$pre_booking_params['sim_total_price'],2))?>');
