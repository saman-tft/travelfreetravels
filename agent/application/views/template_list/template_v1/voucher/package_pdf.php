...
contact@tripmia.com.au</p>
												...
												</td><td style="text-align: right;width: 60%"><img style="width: 150px;"
													src="<?=$GLOBALS['CI']->template->domain_images($GLOBALS['CI']->template->get_domain_logo())?>"></td>
											</tr>
										</table>
									</td>
								</tr>
    ...
    padding: 3px 10px !important;    border-radius: 4px!important;" class="<?php echo booking_status_label($cus_v['status'])?>">
								...
								<tr>
									<td width="100%"
										style="background-color:#666;color:#fff;padding: 10px; border: 1px solid #cccccc; font-size: 14px; font-weight: bold;">Price
										Summary</td>
								...
								<td style="border: 1px solid #cccccc;" width="100%">
										<table width="100%" cellpadding="5"
											...
											<td style="width: 50%;  white-space: nowrap;text-align:left; "><strong>Discount</strong></td>
												<td style="width: 50%;  white-space: nowrap;text-align:left; "><?=$price[0]['currency']." ".$price[0]['discount']?>
