<div class="fulloading result-pre-loader-wrapper bus_preloader">
	...
	<div class="loadcity2"></div>
		<!--<div class="clodnsun"></div>-->
		<div class="alkhaleej-gif"></div>

        <div class="relativetop">
            <div class="tmxloader hide"><img class="loadvgif"
                    src="<?php echo $GLOBALS['CI']->template->domain_images('tm_bus_loader.gif'); ?>" alt="Logo" />
            </div>
