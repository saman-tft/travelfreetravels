...
<?php
   ...
   ?>
<style>
	.dfg{padding:5px 10px 5px 8px;}</style>
<form name="activity_search" id="activity_search" autocomplete="on" action="<?php echo base_url().'index.php/general/pre_activity_search' ?>">
   <div class="intabs tabspl">
      <div class="outsideserach" style="float: left; width: 100%; margin-bottom: 15px;">
         <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 fiveh padfive">
            ...
            <div class="relativemask plcemark">
               ...
               <!--<input type="text" value="" name="city" id="city" class="ft hotelCityIp ui-autocomplete-input" placeholder="Region, City, Area (Worldwide)" autocomplete="off">
                  ...
                  <input type="text" id="activity_destination_search_name" class="ft activity_city normalinput form-control b-r-0" placeholder="Enter City" name="city" required value="<?php echo @$activity_search_params['location']?>"/>
         ...
         <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12 nopad aftremarg padfive">
            ...
            <div class="col-xs-3 col-xs-12 padfive">
 ...
 oninput="setCustomValidity('')"   class="normalsel normalinput holyday_selct" name="nationality" required>
                              ...
                              <div class="col-xs-6 nopad">
                                 ...
                                 <div class="col-xs-6 fiveh padfive child-ages">
                                    <div class="selectedwrap child_ageId<?=$c?> <?=$classname?>">
                                       <select class="flyinputsnor marginbotom10 selectpicker <?=$classname?>" <?=$disable?> id="child_ageId<?=$c?>" name="child_ages[]">
                                          <?php 
                                             for ($j=2; $j<=12; $j++) {
         ...
         <div class="col-xs-1 fiveh padfive pull-right">
            ...
            <!--<div class="col-md-4 col-sm-4 col-xs-4 mobile_width padfive">
				...
				<div class="col-md-3 col-sm-3 col-xs-3 mobile_width padfive">
					<div class="lablform">Value</div>
					<div class=""> 
						<input type="text" id="markup_value" name="markup_value" maxlength="5" class="normalinput form-control numeric padboxno" />
					</div>
				</div>-->

          <div class="col-md-12 col-sm-12 col-xs-12 mobile_width padfive">
