...
<form name="hotel_search" id="hotel_search" autocomplete="on" action="<?php echo base_url().'index.php/general/pre_hotel_search' ?>">
 ...
 oninput="setCustomValidity('')"  class="normalsel normalinput holyday_selct"  name="nationality"
															     	...
															     	if($country['iso_country_code']!="")
						{
							...
							if(isset($hotel_search_params['nationality']))
							{
				
				   ?>
                            <option value="<?php echo $country['iso_country_code']; ?>" <?php if($country['iso_country_code']==$hotel_search_params['nationality']){ echo "selected"; } ?>><?php echo $country['nationality']; ?>
                            </option>
                            <?php 
                        }
                        else
			...
			<div class="col-lg-2 col-md-2 col-sm-6 col-xs-12 padfive full_clear">
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 nopad full_clear">
			...
			<div class="col-md-5 col-xs-12 nopad">
				...
				<div class="col-md-5 col-sm-4 col-xs-4 mobile_width padfive">
					...
					<div class="totlall" id="data_traveler_all_hotel" data-tip="text">
									...
									<div class="roomrow">
										...
										<div class="celroe col-xs-8">
											<div class="input-group countmore pax-count-wrapper">
												...
												<input type="text" name="adult[]" class="form-control input-number centertext adultc" value="<?=intval(@$room_adult_config[$room-1])?>" min="1" max="4"  id="adult_text_<?=$room-1?>"/>
												<span class="input-group-btn">
									...
									<div class="roomrow">
										...
										<div class="celroe col-xs-8">
											<div class="input-group countmore pax-count-wrapper">
												...
												<input type="text" name="child[]" class="form-control input-number centertext childc" value="<?=$current_room_child_count?>" min="0" max="2">
												<span class="input-group-btn">
...
if(t!=3)
{
  ...
  $("#hotel-pax-summary3g").mouseover(function(){

	  var hotel_pax_value=$("#hotel-pax-summary3g").text();
