...
<form name="hotel_search" id="hotel_search2c" autocomplete="on" action="<?php echo base_url().'general/pre_hotel_crs_search' ?>">
	...
	<input class="hide loc_id_holder" name="booking_source" type="hidden" value="PTBSID0000000011" >
					</div>
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-7 nopad full_clear">
				...
				<div class="col-md-6 col-xs-6 padfive">
					...
					<div class="plcetogo datemark sidebord">
						...
						<input  type="text" class="form-control b-r-0 normalinput" data-date="true" readonly name="hotel_checkin_1" id="hotel_checkin_1"  placeholder="Check-In" required value="<?php echo @$hotel_search_params['from_date']?>"/>
				...
				<div class="col-md-6 col-xs-6 padfive">
					...
					<div class="plcetogo datemark sidebord">
						...
						<input type="text" class="normalinput form-control b-r-0" data-date="true" readonly name="hotel_checkout_1" id="hotel_checkout_1" placeholder="Check-Out" required value="<?php echo @$hotel_search_params['to_date']?>"/>
			...
			<div class="col-md-5 col-xs-12 nopad">
				...
				<div class="col-md-5 col-sm-4 col-xs-4 mobile_width padfive">
					...
					<div class="totlall" id="data_traveler_all_hotel" data-tip="">
						...
						<span class="remngwd" id="hotel-pax-summary2g"><span class="a2g">2</span> Adults, <span class="c2g">1</span>  Child </span>
										...
										<div class="celroe col-xs-8">
											...
											<div class="input-group countmore pax-count-wrapper">
												...
												<span class="input-group-btn">
													...
													<button type="button" class="btn btn-default btn-number cabm" data-type="minus" data-field="adult[]">
												...
												<input type="text" name="adult[]" class="form-control input-number centertext cadultc" value="<?=intval(@$room_adult_config[$room-1])?>"   id="adult_text_<?=$room-1?>" min="1" max="4" readonly />

												<span class="input-group-btn">

													<button type="button" class="btn btn-default btn-number cabp" data-type="plus" data-field="adult[]">
										...
										<div class="celroe col-xs-8">
											...
											<div class="input-group countmore pax-count-wrapper">
												...
												<span class="input-group-btn">
													...
													<button type="button" class="btn btn-default btn-number ccbm" data-type="minus" data-field="child[]">
												...
												<input type="text" name="child[]" class="form-control input-number centertext cchildc" value="<?=$current_room_child_count?>" min="0" max="4" readonly >

												<span class="input-group-btn">

													<button type="button" class="btn btn-default btn-number ccbp" data-type="plus" data-field="child[]">
							...
							?>
								...
								<div class="add_remove">
									...
									<div class="col-xs-6 nopad">
										...
										<button class="remove_roomscrs comnbtn_room" style="display:none"> <span class="fa fa-minus-circle"></span>Remove room </button>

									</div>

									<div class="col-xs-6 nopad">

										<button class="add_roomscrs comnbtn_room"> <span class="fa fa-plus-circle"></span>Add room </button>
...
function validate_roomscrs2(room) {
  ...
  $("#hotel-pax-summary2g").mouseover(function(){

	  var hotel_pax_value=$("#hotel-pax-summary2g").text();
