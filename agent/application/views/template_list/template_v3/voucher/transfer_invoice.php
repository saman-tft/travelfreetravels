...
$base_fare = $itinerary_details['agent_buying_price']+$agent_markup+$itinerary_details['search_level_markup']-$itinerary_details['gst'];
      ...
      <?php } ?>
                     ...
                     <tr>
                      ...
                      ?></strong>                              </td>
                                 ...
                                 <tr>
                                    <td style="background-color:#00a9d6;border: 1px solid #00a9d6; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?=SYSTEM_IMAGE_DIR.'hotel_v.png'?>" /> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Transfer Details</span></td>
                                 </tr>
                                 <tr>
                                                   ...
                                                   <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #9a9a9a;">
                                                      <tbody>
                                                         ...
                                                         <!-- <tr>
                                                            ...
                                                            <td style="padding:5px"><span><?php echo roundoff_number($base_fare); ?></span></td>
                                                         </tr> -->
                                                        <!--  <tr>
                                                         ...
                                                         <tr>
                                                            ...
                                                            echo $booking_details['fare']+ $booking_details['admin_markup']+ $booking_details['agent_markup'];?></span></td>
                                                         </tr>
