...
$booking_transaction_details = $booking_details ['booking_transaction_details'];
    ...
    $mobile_code = $this->db_cache_api->get_mobile_code($data['country_code']);
    //debug($mobile_code);die;
...
if (isset($airline_contact_no['data'][0])) {
    $airline_number = '<span><img style="vertical-align:middle" src=' . SYSTEM_IMAGE_DIR . 'phone.png  alt=""/><span style="font-size:11pt;color:#00a9d6;vertical-align:middle;font-weight: 600;"> &nbsp;' . $airline_contact_no['data'][0]['phone_number'] . '</span></span> ';
} else {
    $airline_number = '';
}
...
// debug($fare_details);exit;
 $logo = $GLOBALS['CI']->template->get_domain_logo();
...
<div style="background:#ccc; width:100%; position:relative">
   <table cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:9pt;font-family: 'Open Sans', sans-serif; max-width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate; color: #000;">
        <tbody>
            ...
            <tr>
                <td colspan="2" style="padding-bottom:10px"><img style="width:120px;" src="<?= $GLOBALS['CI']->template->domain_images($logo) ?>" alt=""/></td>
            ...
            <tr>
                <td align="right" colspan="4" style="line-height:25px;font-size:9pt;border-top:2px solid #00a9d6; border-bottom:1px solid #00a9d6;"><span style="font-size:9pt;">Status: </span><strong class="<?php echo booking_status_label($booking_transaction_details[0]['status'])?>" style=" font-size:9pt;">
<?php
...
?></strong></td>
                ...
                <tr>
                    <td colspan="4" style="font-size: 15pt;font-weight: 600;text-align: center;padding: 10px 0 0;">E-Ticket <?php echo $Onward; ?></td>
                </tr>
                        <?php } ?>
            <tr>
                <td style="padding:10px 0"><img style="width:50px;" src="<?= SYSTEM_IMAGE_DIR . 'airline_logo/' . $itinerary_details[0]['airline_code'] . '.gif' ?>" alt=""/></td>
                <td style="padding:10px 0; line-height:25px;"><span style="display: block;border-right: 1px solid #999;"><span style="font-size:11pt;"><?= @$itinerary_details[0]['airline_name'] ?></span><br><?php echo $airline_number ?></span></td>
                <td style="padding:10px 0; padding-left: 10%; line-height:25px;"><span style="font-size:11pt;">Agency</span><br><span><img style="vertical-align:middle" src="<?= SYSTEM_IMAGE_DIR . 'phone.png' ?>" alt=""/> <span style="font-size:9pt;color:#00a9d6;vertical-align:middle;font-weight: 600;"> &nbsp;<?php echo $data['phone'] ?></span></span></td>
<?php if ((!empty($gds_pnr)) || (!empty($airline_pnr))) { ?>
    ...
    <?php if ($booking_transaction_details[0] ['status'] == 'BOOKING_CONFIRMED') { ?>
                                ...
                                <span style="font-size:12pt;line-height:35px;padding-bottom: 5px;display:block;font-weight: 600;"><?= @$airline_pnr ?></span>
                    <?php } ?>
            ...
            <tr>
                <td colspan="4" style="padding:0;">
                    <table  border="0" cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #00a9d6;font-size:9pt; padding:0;">
                        <tbody>
                            <tr>
                                <td colspan="2" style="background-color:#00a9d6; color:#fff"><img style="vertical-align:middle" src="<?= SYSTEM_IMAGE_DIR . 'flight.png' ?>" alt=""> &nbsp;<span style="vertical-align:middle;font-size:13px">Onward Flight Details</span></td>
                                <td align="right" colspan="2" style="background-color:#00a9d6; color:#fff"><span style="font-size:9pt">*Please verify flight times with the airlines prior to departure</span></td>
                            </tr>
...
if (isset($booking_transaction_details) && $booking_transaction_details != "") {
    ...
    foreach ($itinerary_details as $segment_details_k => $segment_details_v) {
        ...
        if (in_array($segment_details_v['segment_indicator'], $seg_in_array) && !empty($seg_in_array) && ($seg_counts == 0) && ($trip_type != 'multicity')) {
            ...
            ?>
                                        <tr>
                                            <td colspan="2" style="background-color:#00a9d6; color:#fff"><img style="vertical-align:middle" src="<?= SYSTEM_IMAGE_DIR . 'flight.png' ?>" alt=""> &nbsp;<span style="vertical-align:middle;font-size:11pt">Return Flight Details</span></td>
                                            <td align="right" colspan="2" style="background-color:#00a9d6; color:#fff"><span style="font-size:9pt">*Please verify flight times with the airlines prior to departure</span></td>
                                        </tr>
...
# Checking Cabin Baggage
                                    ...
                                    if (valid_array($segment_details_v) == true) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="background-color:#d9d9d9; color:#555555"><img style="vertical-align:middle" src="<?= SYSTEM_IMAGE_DIR . 'flight_up.png' ?>" alt="">&nbsp;<span style="vertical-align:middle">Departing</span></td>
            ...
            <tr>
                <td colspan="4" style="border:1px solid #00a9d6; padding:0;">
                    <table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;">
                        <tbody>
                            <tr>
                                <td colspan="5" style="background-color:#00a9d6; color:#fff"><img style="vertical-align:middle" src="<?= SYSTEM_IMAGE_DIR . 'people_group.png' ?>" alt=""> &nbsp;<span style="vertical-align:middle;font-size:11pt">Passenger(s) Details</span></td>
                            </tr>
                        ...
                        <tbody>
                            <tr>
                                <td width="50%" style="padding:0;padding-right:14px;display: block;width: 100%;">
                                    <table cellspacing="0" cellpadding="5" width="100%" style="font-size:11pt; padding:0;border:1px solid #00a9d6;">
                                        <tbody>
                                            <tr>
                                                <td style="border-bottom:1px solid #00a9d6;background-color: #00a9d6;color: #fff;"><span style="font-size:11pt">Payment Details</span></td>
                                                <td style="border-bottom:1px solid #00a9d6;background-color: #00a9d6;color: #fff;"><span style="font-size:11pt">Amount ( <?php echo $booking_details['currency'] ?>
                                                        )</span></td>
                                            </tr>
                                            <tr>
                                                <td><span>Air Fare</span></td>
                                                <td><span> <?php echo round($BaseFare) ?></span></td>
                                            </tr>
...
<?php } ?>
                                            <tr>
                                                <td style="border-top:1px solid #ccc"><span style="font-size:11pt">Grand Total</span></td>
                                                <td style="border-top:1px solid #ccc"><span style="font-size:11pt"> <?= round(@$booking_details['grand_total'] + $seat_price + $meal_price + $baggage_price - ($segment_discount+$booking_details['reward_amount']) ) ?></span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
                                ...
                                <td width="50%" style="padding:0;padding-left:14px; vertical-align:top">
                                    <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #00a9d6;font-size:9pt; padding:0;">
                                        <tbody>
                                            <tr>
                                                <td colspan="4" style="border-bottom:1px solid #00a9d6;background-color: #00a9d6;color: #fff;"><span style="font-size:11pt">Flight Inclusions</span></td>
                                            </tr>
...
<?php if ($TotalBaggageCabin != '' && $TotalBaggageCabin != 0) { ?>
                                             ...
                                             <tr>
                                                <td colspan="4" style="border-top:1px solid #ccc"><span style="font-size:9pt; color:#666; line-height:20px;">* Flight inclusions are subject to change with Airlines.</span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
...
<?php if (isset($booking_transaction_details_value['extra_service_details']) == true && valid_array($booking_transaction_details_value['extra_service_details']) == true) { ?>
    ...
    if (isset($booking_transaction_details_value['extra_service_details']['meal_details']) == true && valid_array($booking_transaction_details_value['extra_service_details']['meal_details']) == true) {
        ...
        foreach ($meal_details['meal_source_destination_label'] as $meal_lk => $meal_lv) {
            ...
            <tr><td colspan="5" style="border-bottom:1px solid #999999;padding-bottom:15px"><span style="font-size:11pt; color:#555;">Customer Contact Details | E-mail : <?= $booking_details['email'] ?> | Contact No :<?= $booking_details['phone_code'] ?> <?= $booking_details['phone'] ?></span></td></tr>

            <tr><td style="line-height:15px;padding:0;">&nbsp;</td></tr>
            <tr>
                <td colspan="5"><span style="line-height:20px; font-size:11pt;">Important Information</span></td></tr>
            <tr>
                <td colspan="5" style="border-bottom:1px solid #999999; line-height:15px; font-size:9pt; color:#555">
            ...
            <tr>
                ...
                <td colspan="4"><span style="line-height:20px; font-size:11pt;">Note:</span></td></tr>

            <tr>

                <td colspan="4" style="border-bottom:1px solid #999999; line-height:20px; font-size:9pt; color:#555;font-weight: 600">
            ...
            <tr><td colspan="4" style="line-height:8px;padding:0;">&nbsp;</td></tr>
            <tr>
                <td colspan="4" align="right" style="padding-top:10px;font-size:9pt;line-height:16px"><img src="https://travelfreetravels.com/extras/system/template_list/template_v3/images/order1.png"
                                        alt="" width="300" align="left"> <?=strtoupper($data['domainname'])?><br>Phone : <?=$data['voucher_phone']?><br>Email : <?=$data['voucher_email']?><br>Address : <?=STATIC_ADDRESS;?><br><?=STATIC_COUNTRY;?></td>
              </tr> 
            <!-- <tr>
                <td colspan="4" align="right" style="padding-top:10px"><?php echo strtoupper($data['domainname']) ?><br>ContactNo :<?php echo $mobile_code ?> <?php echo $data['phone'] ?><br><?php echo $data['address'] ?></td>
            </tr> -->
        </tbody>
    </table>
</div>
...
// debug($airline_contact_no);exit;
    ...
    ?>
    <div style="background:#fff; width:100%; position:relative;margin-bottom:20px;">
        <table class="pag_brk" cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:11pt; font-family: 'Open Sans', sans-serif; width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate;color: #000;box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.15);">
            <tbody>
                <tr>
                    <td colspan="4" style="font-size: 11px;font-weight: 600;text-align: center;padding: 10px 0 12px;">E-Ticket <?php echo $Return; ?></td>
                </tr>
                <tr>
                    <td align="right" colspan="4" style="line-height:26px; border-top:1px solid #00a9d6; border-bottom:1px solid #00a9d6;"><span style="font-size:9pt;">Status: </span><strong class="<?php echo booking_status_label($booking_transaction_details[1]['status']) ?>" style=" font-size:11pt;">
    <?php
    ...
    ?></strong></td>
                ...
                <tr>
                    <td style="padding:10px 0"><img style="width:60px;" src="<?= SYSTEM_IMAGE_DIR . 'airline_logo/' . $return_segment_details[0]['airline_code'] . '.gif' ?> alt=''" /></td>
                    <td style="padding:10px 0; line-height:25px;"><span style="display: block;border-right: 1px solid #999;"><span style="font-size:11pt;"><?= @$return_segment_details[0]['airline_name'] ?></span><br><?php echo $airline_number ?></span></td>
                    <td style="padding:10px 0; padding-left: 10%; line-height:25px;"><span style="font-size:11pt;">Agency</span><br><span><img style="vertical-align:middle" src="<?= SYSTEM_IMAGE_DIR . 'phone.png' ?>" alt=''/> <span style="font-size:11pt;color:#00a9d6;vertical-align:middle;font-weight: 600;"> &nbsp;<?php echo $data['phone'] ?></span></span></td>
    <?php if ((!empty($return_gds_pnr)) || (!empty($return_airline_pnr))) { ?>
                        <td style="padding:10px 0;text-align: center;">
                            <span style="font-size:11pt; border:2px solid #808080; display:block">
        <?php if ($booking_transaction_details[1] ['status'] == 'BOOKING_CONFIRMED') { ?>
                                    <span style="color:#00a9d6;padding:5px; display:block">AIRLINE PNR</span>
                                    <span style="font-size:15pt;line-height:35px;padding-bottom: 5px;display:block;font-weight: 600;"><?= @$return_airline_pnr ?></span>
        <?php } ?>
                ...
                <tr>
                    <td colspan="4" style="border:1px solid #00a9d6; padding:0;">
                        <table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;">
                            <tbody>
                                <tr>
                                    <td colspan="2" style="background-color:#00a9d6; color:#fff"><img style="vertical-align:middle" src="<?= SYSTEM_IMAGE_DIR . 'flight.png' ?>" alt=''> &nbsp;<span style="vertical-align:middle;font-size:11pt"><?php echo $Return; ?> Flight Details</span></td>
                                    <td align="right" colspan="2" style="background-color:#00a9d6; color:#fff"><span style="font-size:9pt">*Please verify flight times with the airlines prior to departure</span></td>
                                </tr>
...
# Checking Cabin Baggage
            ...
            if (valid_array($segment_details_v) == true) {
                ?>
                                            <tr>
                                                ...
                                                <td style="background-color:#d9d9d9; color:#555555"><img style="vertical-align:middle" src="<?= SYSTEM_IMAGE_DIR . 'flight_up.png' ?>" alt="">&nbsp;<span style="vertical-align:middle">Departing</span></td>
                                                <td style="background-color:#d9d9d9; color:#555555"><img style="vertical-align:middle" src="<?= SYSTEM_IMAGE_DIR . 'flight_down.png' ?>" alt="">&nbsp;<span style="vertical-align:middle">Arriving</span></td>
                                                <td style="background-color:#d9d9d9; color:#555555">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td><span><?= @$segment_details_v['airline_name'] ?><br><?php echo $segment_details_v['airline_code'] . ' - ' . $segment_details_v['flight_number']; ?><br>Cabin: <?php echo $booking_details['cabin_class']; ?></span></td>
                    ...
                    <td colspan="4" style="border:1px solid #666666; padding:0;">
                        <table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;">
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="4" style="background-color:#666666; color:#fff"><img style="vertical-align:middle" src="<?= SYSTEM_IMAGE_DIR . 'people_group.png' ?>" alt=""> &nbsp;<span style="vertical-align:middle;font-size:11pt;">Passenger(s) Details</span></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding:0; vertical-align:top">
                                        <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #9a9a9a;font-size:9pt; padding:0;">
                                            <tbody>
                                                <tr>
                                                    <td colspan="4" style="border-bottom:1px solid #ccc"><span style="font-size:11pt">Flight Inclusions</span></td>
                                                </tr>
                                             <tr>
                                    ...
                                    <tr>
                                        <td style="padding:10px 0 0 0;vertical-align:top">
                                            <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #9a9a9a;font-size:9pt; padding:0;">
                                                <tbody>
                                                    <tr>
                                                        <td colspan="4" style="border-bottom:1px solid #ccc"><span style="font-size:9pt">Flight Extra Information</span></td>
                                                    </tr>
        <?php
        if (isset($booking_transaction_details_value['extra_service_details']['baggage_details']) == true && valid_array($booking_transaction_details_value['extra_service_details']['baggage_details']) == true) {
            $baggage_details = $booking_transaction_details_value['extra_service_details']['baggage_details'];
    ...
    <?php } ?>
                ...
                <tr><td colspan="4" style="border-bottom:1px solid #999999;padding-bottom:15px"><span style="font-size:9pt; color:#555;">Customer Contact Details | E-mail : <?= $booking_details['email'] ?> | Contact No :<?= $booking_details['phone_code'] ?> <?= $booking_details['phone'] ?></span></td></tr>

                <tr><td style="line-height:15px;padding:0;">&nbsp;</td></tr>
                <tr>
                    <td colspan="4"><span style="line-height:20px; font-size:11pt;">Important Information</span></td></tr>
                <tr>
                    <td colspan="4" style="border-bottom:1px solid #999999; line-height:15px; font-size:9pt; color:#555">
                    <?php echo $data['terms_conditions'];?>
                        <!-- <ul style="padding-bottom:10px">
                            <li>All Guests, including children and infants, must present valid identification at check-in.</li>
                            <li>Check-in begins 2 hours prior to the flight for seat assignment and closes 45 minutes prior to the scheduled departure.</li>
                ...
                <td colspan="4" align="right" style="padding-top:10px;font-size:9pt;line-height:16px"><img src="https://travelfreetravels.com/extras/system/template_list/template_v3/images/order1.png"
                                        ...
                                        <?=strtoupper($data['domainname'])?><br>Phone : <?=$data['phone']?><br>Email : <?=$data['email']?><br>Address : <?=STATIC_ADDRESS;?><br><?=STATIC_COUNTRY;?></td>
              </tr> 
                <!-- <tr>
                    <td colspan="4" align="right" style="padding-top:10px"><?php echo strtoupper($data['domainname']) ?><br>ContactNo :<?php echo $mobile_code ?> <?php echo $data['phone'] ?><br><?php echo $data['address'] ?></td>
                </tr> -->
...
<!-- <?php 
    ...
    if(!$email_send_check){
    ?>
 <div class="dwnprnt" style="text-align: center; margin-top: 20px;">
