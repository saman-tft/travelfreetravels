                           ...
                           <table class="table table-bordered table-responsive tbl-ap" style="border:1px solid #ddd;border-top: 0px;margin-bottom: 0px;text-align: center;">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td class="text-left"><?= $total_travell_count?>
                                    </td>
                                 </tr>
                              </tbody>
                           </table>
                                       ...
                                       <table>
                                          <tbody>
                                             <tr>
                                                ...
                                                <td class="text-center" style="border-right: 1px solid #ccc;border-left: 1px solid #ccc;width: 50%;"><?=$booking_details['currency'].' '.($total_fare-$booking_details['reward_amount']); ?></td>
                                             </tr>
                                             <tr>
