<?php 
  ...
  // $customer_details = $data['booking_details'][0]['customer_details'][0];
  // $mobileno=$customer_details['phone'];
  // $phone = $mobileno;
    $itinerary_details = $data['booking_details'][0]['itinerary_details'][0];
  //debug($itinerary_details); die;
    $total_fare = $itinerary_details['agent_buying_price']-$itinerary_details['agent_markup'];
...
?>
 <?php $url=base_url(); 
  ...
  // $baseurls=str_replace('agent/', '', $url);
   ...
   //$path1=$baseurls."extras/custom/".CURRENT_DOMAIN_KEY."/images/".$GLOBALS['CI']->template->get_domain_logo();
   //$path=$baseurl.$GLOBALS['CI']->template->domain_images($GLOBALS['CI']->template->get_domain_logo());
  //  debug($baseurl);
 //debug($path1);
//debug($path);exit;
              ?>
                                       ...
                                       <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                                          <tbody>
                                             <tr>
                                               ...
                                               <!--<td style="padding: 0px;"><img style="width:200px;">
                                                <span><img src="<?php echo $baseurl."extras/custom/".CURRENT_DOMAIN_KEY."/images/".$GLOBALS['CI']->template->get_domain_logo();?>" alt="logo">
                                              </td></span>-->
                                                 <?php 
                                            if($baseurl.$GLOBALS['CI']->template->domain_images($GLOBALS['CI']->template->get_domain_logo())!= ''){ ?>
                                                <td style="padding: 0px;"><span><img style="width:200px;" src="<?=$baseurl.$GLOBALS['CI']->template->domain_images($GLOBALS['CI']->template->get_domain_logo())?>" alt="logo"></span></td>
                                              <?php }else{ ?>
                ...
                ?>
                                                ...
                                                <!--<td width="100%" style="padding:0;">
                                                   <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #9a9a9a;">
                                                      <tbody>
                                                        ...
                                                        <!-- <tr>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px">Total Fare</span></td>
                                                            <td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?php echo roundoff_number($itinerary_details['agent_buying_price']+$itinerary_details['gst']+$booking_details['convinence_amount']-$booking_details['discount']); ?></span></td>
                                                         </tr>
                                 ...
                                 <tr>
                                    <td colspan="4" style="line-height:20px; padding-bottom:15px; font-size:12px; color:#555">
                                      <span style="line-height: 23px;font-size: 13px;font-weight: 500;color: #333;">Tour Description</span><br><li class="txtal"><?=$desc?></li><br>
                                      <span style="line-height: 23px;font-size: 13px;font-weight: 500;color: #333;">Information</span>
                                      <ul>
                                      <?php foreach($additional_info as $ad):?><li class="txtal"><?=$ad?></li><?php endforeach;?></ul>
