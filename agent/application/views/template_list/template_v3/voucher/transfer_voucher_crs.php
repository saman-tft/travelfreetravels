...
<?php 
  ...
  $total_fare = $booking_details['fare']+ $booking_details['admin_markup']+ $booking_details['agent_markup'];
...
<div class="table-responsive" style="width:100%; position:relative" id="tickect_hotel">
   ...
   <table class="table" cellpadding="0" cellspacing="0" width="100%" style="    font-size: 13px;
               ...
               <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                     ...
                     <tr>
                                       ...
                                       <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                                          ...
                                          <tbody>
                                            ...
                                            <?php  } ?>
                                                            ...
                                                            <td colspan="2" style="padding-bottom:10px;line-height:20px" align="right"><span>Travel Date: <?=date("l\, jS F Y",strtotime($booking_details['date_of_travel']));?></span><br><span>Booking Reference: <?=$booking_details['app_reference']?></span><!-- <br><span>Activity Code: <?=$booking_details['product_code']?></span> --></td>
                      ...
                      ?></strong>                              </td>
                                 ...
                                 <tr>
                                    ...
                                    <td style="background-color:#00a9d6;border: 1px solid #00a9d6; color:#fff; font-size:14px; padding:5px;" class="remote-left"><!-- <img style="vertical-align:middle" src="<?=SYSTEM_IMAGE_DIR.'car_v.png'?>" /> --> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Transfer Details</span></td>
                ...
                ?>
                                 ...
                                 <tr>
                                    ...
                                    <td style="background-color:#666666;border: 1px solid #666666; color:#fff; font-size:14px; padding:5px;" class="remote-left"><img style="vertical-align:middle" src="<?=SYSTEM_IMAGE_DIR.'people_group.png'?>"> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Traveller(s) Details</span></td>
                                                   ...
                                                   <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #9a9a9a;">
                                                      ...
                                                      <tbody>
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td style="border-bottom:1px solid #ccc;padding:5px;"><span style="font-size:11px">Amount (<?="NPR"?>)</span></td>
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td style="padding:5px"><span><?php echo roundoff_number($total_fare-$booking_details['reward_amount']); ?></span></td>
                                 ...
                                 <tr>
                                    ...
                                    <td colspan="4" style="line-height:20px; font-size:12px; color:#555" class="remote-left"><?=$attributes['TM_Cancellation_Policy']?></td>
                                 ...
                                 <tr>
                                    ...
                                    <td colspan="4" class="remote-left"><span style="line-height:26px;font-size: 15px;font-weight: 500;">Travel Information</span></td>
...
<div class="dwnprnt" style="text-align: center;">
                      <button class="btn-sm btn-primary print" style="margin: 0px 3px;border:1px solid #009edb;background-color: #009edb;" onclick="w=window.open();w.document.write(document.getElementById('tickect_hotel').innerHTML);w.print();w.close(); return true;">Print</button>

        <?php if(is_logged_in_user()){ ?>

      <a href="<?=base_url().'index.php/report/transfers_crs/0'?>"><button type="button" style="margin: 0px 3px;border:1px solid #009edb;background-color: #009edb;"
