...
<!-- onclick="w=window.open();w.document.write(document.getElementById('tickect_bus').innerHTML);w.print();w.close(); return true;" -->
...
<tbody>
   <tr>
    <td align="center"><input style="background: #00a9d6;padding: 6px 20px;border-radius:4px;border:none;color:#fff;margin: 0;" type="button" value="Print" onClick="printDiv('tickect_bus')" />
