               ...
               <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                     ...
                     <tr>
                                       ...
                                       <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                                          ...
                                          <tbody>
                                            ...
                                            <?php $url=base_url(); 
                                                ...
                                                $baseurl=str_replace('/voyages/agent/', '', $url);
                                            ...
                                            if($baseurl.$GLOBALS['CI']->template->domain_images($GLOBALS['CI']->template->get_domain_logo())!= ''){ ?>
                                                ...
                                                <td style="padding: 0px;"><img style="width:200px;" src="https://travelfreetravels.com/extras/custom/TMX6244821650276433/images/TMX3644721637051232logo-loginpg.png" alt="logo"></td>
                      ...
                      ?></strong>                              </td>
                                 ...
                                 <tr>
                                    ...
                                    <td style="background-color:#00a9d6;border: 1px solid #00a9d6; color:#fff; font-size:14px;" class="remote-left"><img src="<?='https://travelfreetravels.com/'.SYSTEM_IMAGE_DIR.'hotel_v.png'?>" /> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Excursion Details</span></td>
                                       ...
                                       <table width="100%" cellpadding="5" style="font-size: 13px;">
                                          ...
                                          <tbody>
                                             ...
                                             <tr>
                                                ...
                                                <td><span style="width:100%; float:left"> <?=$pack_details->package_name?></span></td><!-- <td style="padding:5px"><span style="width:100%; float:left"> <?=$attributes['SupplierName']?></span></td> -->
                ...
                ?>
                                 ...
                                 <tr>
                                    ...
                                    <td style="background-color:#666666;border: 1px solid #666666; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?='https://travelfreetravels.com/'.SYSTEM_IMAGE_DIR.'people_group.png'?>"> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Traveller(s) Details</span></td>
                             ...
                             <tr>
                                                   ...
                                                   <table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #9a9a9a;">
                                                      ...
                                                      <tbody>
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td style="border-bottom:1px solid #ccc;padding:5px;" class="remote-left"><span style="font-size:13px">Payment Details</span></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            echo roundoff_number($grand_total-$booking_details['reward_amount']); //echo roundoff_number($booking_details['product_total_price']+$itinerary_details['gst']+$booking_details['convinence_amount']-$booking_details['discount']); ?></span></td>
                                                    ...
                                                    <table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #9a9a9a;font-size:12px; padding:0;">
                                                      ...
                                                      <tbody>
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td style="background-color:#d9d9d9;border-bottom:1px solid #ccc;padding:5px; color:#333;" class="remote-left"><span style="font-size:13px">Activity Inclusions</span></td>
                                                     ...
                                                     <?php else:?>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td style="padding:5px">Activity Only</td>
                                 ...
                                 <tr>
                                    ...
                                    <td align="center" colspan="4" style="border-bottom:1px solid #999999;padding-bottom:15px" class="remote-left"><span style="font-size:13px; color:#555;">Customer Contact Details | E-mail : <?=$booking_details['lead_pax_email']?> | Contact No : <?=$booking_details['phone']?></span></td>
                                 ...
                                 <tr>
                                    ...
                                    <td colspan="4" class="remote-left"><span style="line-height:26px;font-size: 15px;font-weight: 500;">Cancellation Policy</span></td>

                                 </tr>

                                 <tr>

                                    <td colspan="4" style="line-height:20px; font-size:12px; color:#555" class="remote-left"><?=$booking_details['cancellationPolicy']?></td>
                                 ...
                                 <tr>
                                    ...
                                    <td colspan="4" class="remote-left"><span style="line-height:26px;font-size: 15px;font-weight: 500;">Information</span></td>
                                 ...
                                 <tr>
                                    ...
                                    <td colspan="4" style="line-height:20px; font-size:12px; color:#555" class="remote-left"><?=$pack_details->infor_travellers?></td>
                                 ...
                                 <tr>
                                     ...
                                     <td colspan="4" style="line-height:20px; padding-bottom:15px; font-size:12px; color:#555" class="remote-left">

                                        <tr>

                                            <td colspan="4" class="remote-left"><span style="line-height:26px;font-size: 15px;font-weight: 500;" >Description</span>
                                         ...
                                         <tr>
                                            ...
                                            <td colspan="4" style="line-height:20px; font-size:12px; color:#555" class="remote-left"><?=$pack_details->package_description?>
                                      ...
                                      <span style="line-height: 23px;font-size: 13px;font-weight: 500;color: #333;"></span>
                                 ...
                                 <?php if($pack_details->inclusion_policy){ ?>
                                    ...
                                    <td colspan="4" class="remote-left"><span style="line-height:26px;font-size: 15px;font-weight: 500;">Inclusions</span></td>

                                 </tr>

                                 <tr>

                                    <td colspan="4" style="line-height:20px; font-size:12px; color:#555" class="remote-left"><?=$pack_details->inclusion_policy?></td>
                                 ...
                                 <tr>
                                  ...
                                  <?php if($pack_details->inclusion_policy){ ?>
                                    ...
                                    <td colspan="4" class="remote-left"><span style="line-height:26px;font-size: 15px;font-weight: 500;" >Exclusions</span></td>

                                 </tr>

                                 <tr>

                                    <td colspan="4" style="line-height:20px; font-size:12px; color:#555" class="remote-left"><?=$pack_details->exclusion_policy?></td>
                                  ...
                                  <?php } ?>
                                   ...
                                   <?php if($pickup_location != "" && $pickup_location != "-"){ ?>

                                    <tr>

                                    <td colspan="4" class="remote-left"><span style="line-height:26px;font-size: 15px;font-weight: 500;">Traveller Pickup Location</span></td>

                                 </tr>

                                 <tr>

                                    <td colspan="4" style="line-height:20px; font-size:12px; color:#555" class="remote-left"><?=$pickup_location?></td>
                                 ...
                                 <tr>
                                    ...
                                    <td colspan="4" class="remote-left"><span style="line-height:26px;font-size: 15px;font-weight: 500;" >Terms and Conditions</span></td>

                                 </tr>

                                 <tr>

                                    <td colspan="4" style="line-height:20px; border-bottom:1px solid #999999; padding-bottom:15px; font-size:12px; color:#555" class="remote-left">1.Please ensure that operator BookingID is filled, otherwise the ticket is not valid.</td>
