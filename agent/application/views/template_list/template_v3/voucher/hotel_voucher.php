...
<div style="width:100%; position:relative;background-color: #fff" id="tickect_hotel">
   ...
   <table class="htlvoch" cellpadding="0" cellspacing="0" width="100%" style="font-size:13px; font-family: 'Open Sans', sans-serif; width:900px; box-shadow:0 0 5px 0 rgba(0,0,0,.11); margin:30px auto; border-radius:8px;background-color:#fff; padding:50px 45px;">

      <tbody>

         <tr>

            <td class="hotelvochpad" style="border-collapse: collapse; padding:50px 35px;" >
               ...
               <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                  ...
                  <tr>
                     ...
                     <td style="padding: 0px;">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
                                       ...
                                       <td style="padding: 0px;">
                                          ...
                                          <table width="100%" style="font-size:13px; font-family: 'Open Sans', sans-serif;border-collapse: collapse;text-align: right; line-height:15px;" cellpadding="0" cellspacing="0" border="0">
                                            ...
                                            if($GLOBALS['CI']->template->domain_images($GLOBALS['CI']->template->get_domain_logo())!= ''){ ?>
                                                ...
                                                <td colspan="2"  align="left" style="padding: 0px;"><img style="width:200px;" src="<?=$GLOBALS['CI']->template->domain_images($GLOBALS['CI']->template->get_domain_logo())?>"></td>

                                              <?php }else{ ?>

                                                <td colspan="2" align="left" style="padding: 0px;"><img style="width:200px;" src="<?=$GLOBALS['CI']->template->domain_images($agent_image['image'])?>"></td>

                                            <?php  } ?>

                                                <td colspan="2" style="padding-bottom:10px;line-height:20px" align="right"><span>Booking Reference: <?php echo $booking_details['app_reference']; ?></span><br><span>Booked Date : <?php echo date("d M Y",strtotime($booking_details['created_datetime'])); ?></span></td>
                                 ...
                                 <table width="100%" cellpadding="5" style="padding: 10px;font-size: 13px;padding:5px;">
                                    ...
                                    <tr>
                                       ...
                                       <?php if($attributes['HotelImage'] != '/'):?>
                                          ...
                                          <td class="htldefaimg" style="padding:10px 0"><img style="width:160px;height: 100px;" src="<?=$attributes['HotelImage'];?>" alt="" /></td>

                                       <?php else:?>

                                          <td class="htldefaimg" style="padding:10px 0"><img style="width:160px;height: 100px;" src="<?=$GLOBALS['CI']->template->template_images("default_hotel_img.jpg");?>" alt="" /></td>

                                       <?php endif;?>

                                       <td valign="top" style="padding:10px;"><span style="line-height:30px;font-size:16px;color:#2196f3;vertical-align:middle;font-weight: 600;"><?php echo $booking_details['hotel_name']; ?></span><br><span style="display: block;line-height:22px;font-size: 13px;"><?php echo $booking_details['hotel_address']; ?> </span><br><span style="display: block;line-height:22px;font-size: 13px;"><img style="width:70px;" src="<?php echo $GLOBALS['CI']->template->template_images('star_rating-'.$attributes["StarRating"].'.png'); ?>" alt="" /></span></td>
                           ...
                           <tr>
                              ...
                              <td style="background-color:#00a9d6;border: 1px solid #00a9d6; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?=base_url().SYSTEM_IMAGE_DIR.'hotel_v.png'?>" alt="" /> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Hotel Details</span></td>
                           ...
                           <tr>
                              ...
                              <td style="background-color:#00a9d6;border: 1px solid #00a9d6; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?=base_url().SYSTEM_IMAGE_DIR.'people_group.png'?>" alt="" /> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Guest(s) Details</span></td>
                           ...
                           <tr>
                              <td style="background-color:#00a9d6;border: 1px solid #00a9d6; color:#fff; font-size:14px; padding:5px;"><img style="vertical-align:middle" src="<?=SYSTEM_IMAGE_DIR.'people_group.png'?>" /> <span style="font-size:14px;color:#fff;vertical-align:middle;"> &nbsp;Supplier Details</span></td>
                           </tr>
                           <tr>
                              <td  width="100%" style="border: 1px solid #00a9d6; padding:0px;">
                                 <table width="100%" cellpadding="5" style="padding: 10px;font-size: 13px;">
                           ...
                           <tr><td style="line-height:12px;">&nbsp;</td></tr>
										...
										<tbody>
													...
													<table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #00a9d6;">
														...
														<tbody>
															...
															<tr>
																...
																<td style="border-bottom:1px solid #00a9d6;background-color: #00a9d6;color: #fff;padding:5px;"><span style="font-size:13px">Payment Details</span></td>

																<td style="border-bottom:1px solid #00a9d6;background-color: #00a9d6;color: #fff;padding:5px;"><span style="font-size:11px">Amount (<?=$booking_details['currency']?>)</span></td>
															...
															<tr>
																...
																<td style="padding:5px"><span><?php echo round($booking_details['fare']+$booking_details['admin_markup']+$booking_details['admin_commission']); ?></span></td>
                                            ...
                                            <!-- <?php } ?> -->
															...
															<tr>
																...
																<td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px">Grand Total</span></td>

																<td style="border-top:1px solid #ccc;padding:5px"><span style="font-size:13px"><?php echo round($booking_details['grand_total']+$booking_details['admin_commission']); ?></span></td>
													...
													<table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #00a9d6;font-size:12px; padding:0;">
														...
														<tbody>
															...
															<tr>
																...
																<td style="background-color:#00a9d6;border-bottom:1px solid #ccc;padding:5px; color:#fff"><span style="font-size:13px">Room Inclusions</span></td>
							...
							<td colspan="4"><span style="line-height:26px;font-size: 14px;font-weight: bold;">Cancellation Policy</span></td></tr>
							...
							<td colspan="4"><span style="line-height:26px;font-size: 14px;font-weight: bold;">Terms and Conditions</span></td></tr>

							<tr>

								<td colspan="4" style="line-height:20px; border-bottom:1px solid #999999; padding-bottom:15px; font-size:12px; color:#555;font-weight: 600;"><?php echo $data['terms_conditions']; ?>
                     ...
                     <td colspan="4"><span style="line-height:26px;font-size: 14px;font-weight: bold;">Note</span></td></tr>

                     <tr>

                        <td colspan="4" style="line-height:20px; border-bottom:1px solid #999999; padding-bottom:15px; font-size:12px; color:#555;font-weight: 600;"><?php echo $data['note']; ?>
                     ...
                     <tr>
                                 <td colspan="4" align="right" style="padding-top:10px;font-size:13px;line-height:20px;"> <img src="https://www.travelsoho.com/travel-free-travels/extras/system/template_list/template_v3/images/order1.png"
