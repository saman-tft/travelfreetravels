...
<table
	style="border-collapse: collapse; background: #ffffff; font-size: 14px; margin: 0 auto; font-family: arial; box-shadow: 0px 0px 8px rgb(0 0 0 / 15%);"
	width="100%" cellpadding="0" cellspacing="0" border="0">
	<tbody>
	
	<tr>
						<td
							style="font-size: 22px; line-height: 30px; width: 100%; display: block; font-weight: 600; text-align: center">Car Voucher</td>
					</tr>
					...
					<tr>
						<td>
							<table width="100%" style="border-collapse: collapse;"
								...
								<tr>
                <td colspan="4" align="right" style="padding-top:10px;font-size:9pt;line-height:16px"><?=strtoupper($data['domainname'])?><br>Phone : <?=$data['phone']?><br>Email : <?=$data['email']?><br>Address : <?=STATIC_ADDRESS;?><br><?=STATIC_COUNTRY;?></td>
              </tr> 
							</table>
						</td>
					</tr>
...
<?php if(!$email_send_check){ ?>
   ...
   <table id="printOption"
      ...
      <tbody>
         <tr>
            <td align="center"><input style="background:#418bca; height:34px; padding:10px; border-radius:4px; border:none; color:#fff; margin:0 2px;" type="button" value="Print" onClick="printDiv('tickect_hotel')" />
         </tr>
      </tbody>
   </table>
   <?php } ?>
