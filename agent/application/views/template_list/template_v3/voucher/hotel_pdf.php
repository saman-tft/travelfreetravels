   ...
   <td style="border-collapse: collapse; padding:10px 20px 20px" ><table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
			     ...
			     <tr>
					...
					<td style="padding: 10px;width:65%;"><img style="width:150px;" src="<?=$GLOBALS['CI']->template->domain_images($data['logo'])?>" alt=""></td>
            ...
            <tr><td style="line-height:6px;">&nbsp;</td></tr>                  
                              ...
                              <td style="padding:0;"><table width="100%" cellpadding="5" style="padding: 10px;font-size: 10pt;padding:5px;">
                                    ...
                                    <tr>
                                       ...
                                       <?php if($attributes['HotelImage'] != '/'):?>
                                          ...
                                          <td width="26%" style="padding:10px 0"><img style="width:130px; height:107px;" src="<?=$attributes['HotelImage'];?>" alt=""/></td>

                                       <?php else:?>

                                          <td style="padding:10px 0"><img style="width:130px; height:107px;" src="<?=$GLOBALS['CI']->template->template_images("default_hotel_img.jpg");?>" alt="" /></td>
					...
					<td style="padding: 10px;"><table cellpadding="5" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
                           ...
                           <tr>
                              ...
                              <td style="background-color:#00a9d6;border: 1px solid #00a9d6; color:#fff; font-size:10pt; padding:5px; line-height:normal;"><img width="12" src="<?=SYSTEM_IMAGE_DIR.'hotel_v.png'?>" alt=""/> <span style="font-size:10pt;color:#fff;line-height:12px;"> &nbsp;Hotel Details</span></td>
                           ...
                           <tr>
                              ...
                              <td style="background-color:#00a9d6;border: 1px solid #00a9d6; color:#fff; font-size:9pt; padding:5px;"><img width="12" style="vertical-align:middle" src="<?=SYSTEM_IMAGE_DIR.'people_group.png'?>" alt=""/> <span style="font-size:9pt;color:#fff;vertical-align:middle;"> &nbsp;Guest(s) Details</span></td>
                ...
                <td width="100%" style="padding:0"><table width="100%" cellspacing="-9" cellpadding="5" style="padding: 0;font-size: 9pt;"><tbody><tr><td><table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;border:1px solid #00a9d6;"><tbody><tr><td style="border-bottom:1px solid #00a9d6;color:#fff;padding:5px;background-color: #00a9d6;"><span style="font-size:10pt">Payment Details</span></td>

                                <td style="border-bottom:1px solid #00a9d6;padding:5px;color: #fff;background-color: #00a9d6"><span style="font-size:9pt">Amount (<?=$booking_details['currency']?>)</span></td>
                        ...
                        <td><table cellspacing="0" cellpadding="5" width="100%" style="border:1px solid #00a9d6;font-size:10pt; padding:0;">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td style="background-color:#00a9d6;border-bottom:1px solid #00a9d6;border-left:1px solid #00a9d6;padding:5px; color:#fff"><span style="font-size:10pt">Room Inclusions</span></td>
              ...
              <tr>
                ...
                <td style="border-bottom:1px solid #999999; padding-bottom:15px; font-size:9pt; color:#555;line-height:16px;font-weight: 600;"><?php echo $data['terms_conditions']; ?>
              ...
              <td><span style="font-size: 10pt;line-height:12px;font-weight: 500;">Note</span></td></tr>

              <tr>

                <td style="border-bottom:1px solid #999999; padding-bottom:15px; font-size:9pt; color:#555;line-height:16px;font-weight: 600;"><?php echo $data['note']; ?>

                    </td>

              </tr>
             <!--  <tr>
                <td colspan="4" align="right" style="padding-top:0px; line-height:16px"><img src="https://www.alkhaleejtours.com/extras/custom/TMX9604421616070986/images/alk.gif" width="100px" height="50px" class=""></td>
            </tr> -->
