            ...
            <td style="border-collapse: collapse; padding:50px 35px;">
               <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                     ...
                     <tr>
                        <td style="padding: 0px;">
                           <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-collapse: collapse;">
                              <tbody>
                                 <tr>
                                    <td style="font-size:22px; line-height:30px; width:100%; display:block; font-weight:600; text-align:center">Excursion Voucher</td>
                                 </tr>
                                 <tr>
                                    <td>
                                       <table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0">
                                          <tbody>
                                             <tr>
                                                <?php 
                                            if($booking_details['domain_logo']!=''){ ?>
                                                <td style="padding: 0px;"><img style="width:200px;" src="<?=$GLOBALS['CI']->template->domain_images($booking_details['domain_logo'])?>"></td>
                                              <?php }else{ ?>
                ...
                ?>
                                 ...
                                 <tr><?php 
                                 if(!empty($attributes['TM_Cancellation_Policy'])){
                                  $canc_policy = $attributes['TM_Cancellation_Policy'];
                                 }
                                 else{
                                  $canc_policy = 'Non-Refundable';
                                 }
                                 ?>
                                    <td colspan="4" style="line-height:20px; font-size:12px; color:#555"><?=$canc_policy?></td>
                                 </tr>
                                 <tr>
                                    <td style="line-height:12px;">&nbsp;</td>
                                 </tr>
