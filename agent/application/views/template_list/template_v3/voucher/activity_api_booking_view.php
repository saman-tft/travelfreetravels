...
<section class="content"  id="tickect_hotel">
                  ...
                  <table class="table table-bordered table-responsive tbl-ap" style="border:1px solid #ddd;border-top: 0px;margin-bottom: 0px;text-align: center;">
                     <tbody>
                           ...
                           <table class="table table-bordered table-responsive tbl-ap" style="border:1px solid #ddd;border-top: 0px;margin-bottom: 0px;text-align: center;">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td class="text-left"><?= date('d-M-Y',strtotime($booking_details['travel_date'] ))?>
                                    </td>
                                 </tr>
                              </tbody>
                           </table>
                        ...
                        <tr>
                           ...
                           <table class="table table-bordered table-responsive tbl-ap" style="border:1px solid #ddd;border-top: 0px;margin-bottom: 0px;text-align: center;">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    <td class="bgc-blue text-left" style="border-top: 1px solid;border-right:  1px solid #ccc;" width="20%">Supplier Name</td>
                                    <td class="text-left"><?=$attributes['SupplierName']?></td>
                                    <!-- <?php
                                    ...
                                    <td class="text-left"><?=$booking_details['destination_name']?></td>
                                 </tr>
                                 <tr>
                                    <!-- <td class="bgc-blue text-left" style="border-top: 1px solid;border-right: 1px solid #ccc;" width="20%">Rating</td>
                                    <td class="text-left">
                  	...
                  	<!-- 	<input type="hidden" id="agent_currency" value="<?=$booking_details['agent_currency']?>">
                                  ...
                                  ?>
                                    ...
                                    <span class="<?= $room_section_class; ?>">
                                             ...
                                             <tr>
                                               ...
                                               <td style="padding:5px;"><?=$name['pax_type']?></td> 
                                                <td style="padding:5px;"><?=$name['email']?></td> 
                                                 <td style="padding:5px;"><?=$name['phone']?></td>
                                    ...
                                    <td class="">
                                       <table>
                                          <tbody>
                                             <tr>
                                              <?php 
                                              $total=$booking_details['fare']+ $booking_details['admin_markup'];
                                              ?>
                                                <td class="text-center" style="border-right: 1px solid #ccc;border-left: 1px solid #ccc;width: 50%;">Total Rate</td>
                                                <td class="text-center" style="border-right: 1px solid #ccc;border-left: 1px solid #ccc;width: 50%;"><?=$total;?></td>
                                             </tr>
                                             <tr>
                        ...
                        <tr>
                           <button class="btn-sm btn-primary print" style="margin: 3px 3px" onclick="w=window.open();w.document.write(document.getElementById('tickect_hotel').innerHTML);w.print();w.close(); return true;">Print</button>
