        ...
        <td style="padding:0px;">
          <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
                    ...
                    <tr bgcolor="#f5f5f5">
                            ...
                            <span style="color:#f5aa1c; margin-top: 9px; font-size: 9px; margin-bottom: 0px;">Address : <?=STATIC_ADDRESS;?></span>
                            <span style="color:#f5aa1c; margin-top: 9px; font-size: 9px; margin-bottom: 0px;"><?=STATIC_COUNTRY;?></span>
                  ...
                  ?>
                   <?php 
                     ...
                     <tr>
                      <td style="padding: 0px;" colspan="6" align="left" class="logocvr">
                       <!--  <h4 style="padding: 14px 14px; color: #374c5d; margin: 0px; line-height: 20px; text-align: left; font-weight: bold; font-size: 14px;">Accommodation Voucher</h4> -->
                        <span style="font-size: 11px;">Cancelled and guaranteed</span>
                      </td>
                    </tr>
                    <?php 
                  } 
