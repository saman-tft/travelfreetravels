<?php
// debug($package_traveller_photos);exit();
                ...
                <div class="alsidex">
                    ...
                    <div class="siddwn">
                        ...
                        <div class="col-xs-6 nopad">
                            ...
                            <span class="snote">*Per person on twin sharing basis</span>
                        ...
                        <form  role="form" id="package"
                                    enctype="multipart/form-data" method="POST" action="<?php echo base_url(); ?>index.php/tours/book_packages"
                                    autocomplete="off" name="package">
                                    <input type="hidden" name="package_id" value="<?php echo $package->package_id?>" />
                            <input type="submit" class="booknowhtl" id="book" value="Book" style="width: 150px;" />
                            </form>
                        </div>
                        <div class="col-xs-6">                        
                ...
                <div class="col-md-8 col-xs-12 nopad fulatnine">
                    <div class="detailtab">
                        <ul class="nav nav-tabs trul">
                          ...
                          <li class="tfacility"><a href="#tandc" data-toggle="tab">Inclusions & Exclusion</a></li>
                       ...
                       <!-- Over View-->
                        ...
                        <div class="tab-pane" id="tandc">
                            <div class="innertabs">
                                ...
                                <div class="col-md-12 nopad">
                                    <div class="col-md-12">
                                    <h3 class="hedft">Terms and Condition: </h3>
                                    <ul class="checklist checklistxl">
<!--                                         <li><?php echo isset($package_cancel_policy->cancellation_advance)?($package_cancel_policy->cancellation_advance):""; ?></li> -->
                                        <a href="<?=base_url('index.php/packageholiday-terms-condition')?>">Detail of terms and condition</a>
                                    </ul>
                                </div>
                                <div class="linebrk"></div>
                                <div class="col-md-12 nopad">
                                    <div class="col-md-12">
                                    <h3 class="hedft">Add Ons: </h3>
                                    <ul class="checklist checklistxl">
...
<div id="subtqry" class="wellme minwnwidth" style="display: none;">
    ...
    <div class="signdiv">
      ...
      <div class="col-md-10 col-xs-12">
        ...
        <div class="col-md-6 col-xs-12"><input type="submit"  value="Send Enquiry" class="btn colorsave" id="startCancelProc"/></div>
        </div>
      </div>
      </form>
    </div>
...
<div id="subtqry1" class="wellme minwnwidth" style="display: none;">
    <div class="popuperror" style="display:none;"></div>
    <div  class="pophed"> Send Enquiry For <?php echo $package->package_name; ?></div>
    <div class="signdiv">
      <form action="<?php echo base_url(); ?>index.php/tours/enquiry" method="post">
        ...
        <div class="rowlistwish">
            <div class="col-md-4">
                <span class="qrylbl">Namedsfdsfdsf<span class="dfman">*</span></span>
            </div>
            <div class="col-md-8">
                <input type="text" class="fulwishxl alpha" id="first_name"  name="first_name" required/>
                <span id="verificationCodeErr" style="color:red; font-size: small"></span>
