...
$data = json_decode($quotation_details[0]->attributes);
// debug($data->total);
// debug($app_reference);
    $booking = ['no_adults'=>$data->adult_count,'no_child'=>$data->child_count,'no_infant'=>$data->infant_count,'pack_id'=>$package->package_id];
// debug($booking); 
// $package = unset($package['price']);
// debug($package);die;
...
if ($childe_percentage==0) {
  $child_price=$data->total;
}
else{
  $child_price=($data->total)-(($childe_percentage/100) * ($data->total));
}
//$child_price=($childe_percentage/100) * ($data->total);

// $total= (($booking['no_adults']) *  $data->total+$booking['no_child'] *$child_price ); 
$total= $data->total; 
//debug($total);exit;?>
<?php
...
.pack_price { font-size: 15px; color:#ff9800;  }
...
.confirm_bboki { background-color: #ff9800 !important;
            ...
            <div class="row prebooking"> 
              ...
              <div class="col-md-12 col-sm-12 col-xs-12 butsele">
                  ...
                  <form action="<?php echo base_url()?>index.php/activities/pre_booking_itinary/<?php echo  $package->package_id; ?>" method="post" autocomplete='off'>
                    <div class="row">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                        <input type="hidden" name="enquiry_reference_no" value="<?=$app_reference?>">
                ...
                <option value="male" <?php if($gender == "male") echo "selected"; ?>>Male</option>
                      ...
                      <?php $default_country = (isset($this->entity_country_code)) ? $this->entity_country_code : '12'; ?>
            ...
            <input type="hidden" name="no_child" value="<?php echo  $booking['no_child']; ?>" />
             ...
             <input type="submit" class="confirm_bboki" value="CONFIRM BOOKING" />
              ...
              <!-- Personal Information--> 
                  ...
                  <div class="col-md-5 col-sm-5 col-xs-5 text-right"><span class="pack_price">AUD <?php  echo  $data->total; ?></span>
                  </div>
                                      ...
                                      <div class="col-md-8 col-xs-8 nopadding_right">
                                        ...
                                        <div class="cartprc">
                                         ...
                                         <input type="text" placeholder="Enter Promo" name="code" id="code" class="promocode" aria-required="true" />
                                            ...
                                            <input type="hidden" name="module_type" id="module_type" class="promocode" value="<?=md5('Activity')?>" />
