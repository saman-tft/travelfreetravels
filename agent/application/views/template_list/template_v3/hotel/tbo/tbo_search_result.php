					...
					<div class="sidepricewrp">
						...
						<div class="priceflights">
							...
							<div class="prcstrtingt">Avg / Night</div>
								...
								<?php
if($hd['booking_source']==CRS_HOTEL_BOOKING_SOURCE)
{
  $booking_source=$hd['booking_source'];
  $urils='hotelcrs';
}
if($hd['booking_source']==PROVAB_HOTEL_BOOKING_SOURCE || $hd['booking_source']==PROVAB_RESVOYAGE_BOOKING_SOURCE)
{
...
else
{
	...
	$css="tmx_htl";
						...
						<form action="<?php echo base_url().'index.php/'.$urils.'/hotel_details/'.($search_id)?>">
							...
							<input type="hidden"  name="SessionId" value="<?=$hd['SessionId']?>" class="operation">
