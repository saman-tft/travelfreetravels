...
<style>
    ...
    .farehd{margin: 0 15px 15px 15px!important;}
</style>
<div class="fldealsec">
    <div class="container">
...
<!--changes end agent booking page and sidebar: commented code block-->
                                    ...
                                    <div class="loginspld">
                                        <div class="collogg">
                                            ...
                                            ?>
                                            <!--changes start agent booking page and sidebar: added style display none in this line-->
                                            <div class="row <?= $payment_option_visibility ?>" style="display:none !important">
                                            <!--changes end agent booking page and sidebar: added style display none in this line-->
<?php if (in_array(PAY_NOW, $active_payment_options)) { ?>
                                                <!--changes start agent booking page and sidebar: added: class form-inline and styles for class form-group, style for input field, moved input field above label, made input field checked by default-->
                                                    <!--<div class="col-md-3">-->
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group form-inline" style="font-size: large; color: black;">
                                                            <input <?= $default_payment_option ?> name="payment_method" type="radio" required="required" value="<?= PAY_NOW ?>" id="payment-mode-<?= PAY_NOW ?>" class="form-control b-r-0" style="width:15px; height:15px!important; scale:1.2; border-color:black;" placeholder="Payment Mode" checked>
                                                            <label for="payment-mode-<?= PAY_NOW ?>">
                                                                Pay Now
                                                            </label>
                                                        </div>
                                                    </div>
                                                <!--changes end agent booking page and sidebar: added: class form-inline and styles for class form-group, style for input field, moved input field above label, made input field checked by default-->
<?php } ?>
<!--changes start agent booking page and sidebar: commented code block-->
...
<?php if ($hold_ticket == true) { ?>
    ...
    ?>
                                                <div class="continye col-sm-3 col-xs-6">
                                                    <!--changes start agent booking page and sidebar: changed name of button from Continue to Book-->
                                                    <button type="submit" id="" name="flight" class="bookcont continue_booking_button">Book Now</button>
                                                    <!--changes end agent booking page and sidebar: changed name of button from Continue to Book-->
                                                </div>
<?php } ?>
...
function get_fare_summary($FareDetails, $PassengerFareBreakdown, $discount) {
    ...
    $total_payable = $FareDetails['_TotalPayable'] - $discount;
    ...
    $pax_base_fare_details .= '<div class="reptallt">
                                ...
                                <div class="col-xs-4 nopadding">
                                    <div class="amnter arimobold">' . $currency_symbol . ' ' .round($FareDetails['_BaseFare']). ' </div>
                                </div>
                            </div>';
    ...
    $pax_tax_details .= '<div class="reptallt">
                                ...
                                <div class="col-xs-4 nopadding">
                                 <div class="amnter arimobold discountorg" style="display:none">' . $discount . ' </div>
                                    <div class="amnter arimobold test">' . $currency_symbol . '<span class="discounts">' . $discount . '</span></div>
                                </div>
