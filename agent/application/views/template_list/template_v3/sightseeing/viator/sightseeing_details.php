...
<div class="col-xs-12">
  ...
  <?php foreach($product_details['ProductPhotos'] as $photos):?>
    ...
    <?php endif; ?>                                                                                                  
        ...
        <li><img src="https://www.travelsoho.com/alkhaleej_tours/extras/system/template_list/template_v3/images/free_cancellation.svg" alt="icon" />Free Cancelation - <?=$product_details['Cancellation_day']?> days prior</li>
        <?php else:?>
          <li><img src="https://www.travelsoho.com/alkhaleej_tours/extras/system/template_list/template_v3/images/non-refundable.svg" alt="icon" />Non Refundable</li>
        <?php endif;?>
        <?php if($product_details['VoucherOption']):?>
          <li><img src="https://www.travelsoho.com/alkhaleej_tours/extras/system/template_list/template_v3/images/show_mobile.svg" alt="icon" /> <?=$product_details['VoucherOption']?></li>
        <?php endif;?>
        <?php if($product_details['Duration']):?>
          <li><img src="https://www.travelsoho.com/alkhaleej_tours/extras/system/template_list/template_v3/images/duration.svg" alt="icon" /><?php echo $product_details['Duration']?> Duration</li>
        <?php endif;?>
        <?php if($product_details['Product_Tourgrade'][0]['langServices']):?>
          <?php if(valid_array($product_details['Product_Tourgrade'])):?>
            ...
            <li><img src="https://www.travelsoho.com/alkhaleej_tours/extras/system/template_list/template_v3/images/language.svg" alt="icon" /><?=$lan_val?></li>
          <?php endforeach;?>
          <?php endif;?>
        <?php endif;?>
       <?php if($product_details['MaxTravellerCount']):?>          
           <li><img src="https://www.travelsoho.com/alkhaleej_tours/extras/system/template_list/template_v3/images/join_group.svg" alt="icon" /> Maximum Traveller - <b style="color:#0096ce"><?=$product_details['MaxTravellerCount']?></b></li>
        <?php endif;?>
