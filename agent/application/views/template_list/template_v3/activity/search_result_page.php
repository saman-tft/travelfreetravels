...
var load_products = function(loader, offset, filters){
    ...
    _lazy_content = $.ajax({
        type: 'GET',
        url: app_base_url+'index.php/ajax/activity_list/'+offset+'?booking_source=<?=$active_booking_source[0]['source_id']?>&search_id=<?=$sight_seen_search_params['search_id']?>&op=load'+url_filters+'&enquiry_origin=<?= $enquiry_origin;?>',
        async: true,
        cache: true,
        dataType: 'json',
        ...
        <div class="resultalls open">
            <div class="coleft">
                <div class="flteboxwrp">
                    <div class="filtersho">
                        <div class="avlhtls"><strong id="filter_records"></strong> <span class="hide"> of <strong id="total_records"><?php echo $mini_loading_image?></strong> </span> Excursions found
                               ...
                               <!--  <div class="rangebox sight_modify">
                                ...
                                <div class="rangebox">
                                    ...
                                    <div id="hotelsearch-refine" class="in">
                                        <div class="boxins">
                                            <div class="relinput">
                                                <input type="text" class="srchhtl form-control" placeholder="Excursions Names" id="tour-name" />
                                                ...
                                                <div class="insidemyt">
                                                    <ul class="sortul">
                                                        <li class="sortli threonly" data-sort="hn">
                                                            <a class="sorta name-l-2-h asc" data-order="asc"><i class="fa fa-user"></i> <strong>Name</strong></a>
