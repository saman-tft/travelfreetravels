...
var load_products = function(loader, offset, filters){
	...
	_lazy_content = $.ajax({
		...
		url: app_base_url+'index.php/ajax/transferv1_list/'+offset+'?booking_source=<?=PROVAB_TRANSFERV1_SOURCE_CRS?>&search_id=<?=$sight_seen_search_params['search_id']?>&op=load'+url_filters,
