  ...
  <?php foreach($product_details['ProductPhotos'] as $photos):?>
    ...
    <?php endif; ?>                                                                                                  
        ...
        <ul class="list-inline">
          <?php 
          $path=$GLOBALS['CI']->template->template_images(); 
          $icon_path=str_replace("//alkhaleej_tours", "", $path);
          ?>
        <?php if($product_details['Cancellation_available']):?>
        <li><img src="<?php echo $icon_path.'free_cancellation.svg';
        ...
        <!-- <li><img src="<?php echo $GLOBALS['CI']->template->template_images('meet_up.svg'); ?>" alt="icon" /> Meet Up At Location</li> -->
            ...
            <form id="check_tourgrade" action="">
                ...
                <div class="mobile_adult_icon">Travellers<i class="fa fa-male"></i></div>
                  ...
                  <?php endforeach;?>           
                  <a class="done1 comnbtn_room1" id="pax_done_btn"><span class="fa fa-check"></span> Apply</a>
               ...
               <div class="lettrfty short-text">
                ...
                <?php endif;?>
                 ...
                 <?php if(isset($product_details['AdditionalInfo'])): ?>
                  ...
                  <div class="mvm">                      
                      <div class="strong">Additional Info</div>
                      <ul>
           ...
           <div class="booking-price">
             ...
             <span class="currency-sign"><?php echo $currency_obj->get_currency_symbol($currency_obj->to_currency); ?></span>
               ...
               <div class="datediv">           
                ...
                <?php $path=$GLOBALS['CI']->template->template_images(); 
                     $icon_path=str_replace("//alkhaleej_tours", "", $path);  ?>
                <?php if($product_details['Cancellation_available']):?>
                    <li><img src="<?php echo $icon_path.'free_cancellation.svg';
                    //$GLOBALS['CI']->template->template_images('free_cancellation.svg'); ?>" alt="icon" />Free Cancellation - <?=$product_details['Cancellation_day']?> days prior</li>
                    <?php else:?>
                      <li><img src="<?php echo $icon_path.'non-refundable.svg';
                      //$GLOBALS['CI']->template->template_images('non-refundable.svg'); ?>" alt="icon" />Non Refundable</li>
                <?php endif;?>
...
$(document).ready(function(){
    ...
    $('html,body').animate({
        scrollTop: $(".basic_info").offset().top},
        'slow');
   });
