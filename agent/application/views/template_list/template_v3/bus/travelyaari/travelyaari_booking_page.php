							...
							<div class="fredivs">
							   ...
							   <div class="clearfix"></div>
							    <div class="reptalltftr">
									...
									<div class="col-xs-4 nopadding">
										<div class="amnterbig arimobold grandtotal"><?=$default_currency_symbol?> <?=roundoff_number($details['Fare']['_CustomerBuying']-$details['Fare']['_GST'])?> </div>
									</div>
								</div>
								<div class="clearfix"></div>
								...
								<div class="reptalltftr">
									...
									<div class="col-xs-4 nopadding">
										<div class="amnterbig arimobold grandtotal"><?=$default_currency_symbol?> <?=roundoff_number($details['Fare']['_GST'])?> </div>
									</div>
								</div>
								<?php } ?>
								<div class="reptalltftr">
									...
									<div class="col-xs-4 nopadding">
										<div class="amnterbig arimobold"><?=$default_currency_symbol?> <?=roundoff_number($details['Fare']['_CustomerBuying'])?> </div>
									</div>
								</div>
							</div>
						</div>
			...
			<form action="<?=base_url().'index.php/bus/pre_booking/'.$search_data['search_id']?>" method="POST" autocomplete="off" id="pre-booking-form">
			 <div class="flitab1">
				...
				<div class="contbk">
					...
					<input value="<?=@$agent_data['phone'] == 0 ? '' : @$agent_data['phone'];?>" type="text" name="passenger_contact" id="passenger-contact" placeholder="Mobile Number" class="newslterinput nputbrd _numeric_only numeric"  required="required">
