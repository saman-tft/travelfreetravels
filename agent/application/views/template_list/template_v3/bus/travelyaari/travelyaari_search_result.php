    ...
    $busses .= '
		...
		<div class="col-xs-3 nopad full_bus_prices">
			...
			<div class="col-xs-7 nopad">
				<div class="inpadbus">
					<div class="bustprice"><strong>' . $cur_Currency . '</strong>' . $b2b_price_details['_CustomerBuying'] . '</div>
					<div style="display:none" class="net-fare-tag snf_hnf" title="C ' . $bus_net_fare_commission . '(' . ($b2b_price_details['_Commission']-$b2b_price_details['_tdsCommission']) . ')+M ' . $b2b_price_details['_AgentMarkup'] . ' = ' . $b2b_price_details['_AgentEarning'] . '">' . $cur_Currency . ' <span>' . $b2b_price_details['_AgentBuying'] . '</div>
					<div class="bookbuss">
						<form action="" method="GET" class="book-form">
								<input type="hidden" name="route_schedule_id" class="route-schedule-id" value="' . $route_id . '">
