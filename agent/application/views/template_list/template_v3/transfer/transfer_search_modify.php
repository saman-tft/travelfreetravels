...
<form autocomplete="off" name="trasfer" id="trasfer" action="<?=base_url()?>index.php/general/pre_transfer_search"
    ...
    <div class="tabspl moditran">
        <div class="tabrow">
                ...
                <div class="smalway">
                    <label class="wament hand-cursor" style="display: none;">
                        <input class="" type="radio" name="transfer_type"
                            ...
                            id="oneway-trp" value="oneway" /> One Way
                    </label>
            ...
            <div id="onw_rndw_fieldset" class="col-md-9 col-xs-12 nopad">
                <!-- Oneway/Roundway Fileds Starts-->
                <div class="col-md-3 col-sm-12 col-xs-12 padfive full_smal_tab">
                    <div class="lablform">Nationality</div>
                    <div class="selectedwrap nationlty sidebord">
                        <select class="normalsel holyday_selct" id="native_country" name="native_country"
                            ...
                            <option value="<?php echo $country->country_list; ?>"
                                <?php if(isset($scountry)){ if($scountry == $country->country_list) echo "selected"; }?>>
                    ...
                    <div class="col-xs-6 padfive">
                        ...
                        <div class="plcetogo plcemark sidebord">
                            <input type="text" autocomplete="off" name="transfer_from"
                                class="normalinput auto-focus hotelin valid_class fromtransfer form-control b-r-0"
                    ...
                    <div class="col-xs-6 padfive">
                        ...
                        <div class="plcetogo plcemark sidebord">
                            <input type="text" autocomplete="off" name="transfer_to"
                                class="normalinput hotelin auto-focus valid_class departtransfer form-control b-r-0"
            ...
            <div class="col-md-3 col-xs-12 nopad srch">
                <div class="col-md-7 col-xs-4 padfive pasngr1">
