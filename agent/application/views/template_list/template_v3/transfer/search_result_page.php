...
// echo $this->template->isolated_view('transfer/search_panel_summary');
// echo $GLOBALS['CI']->template->isolated_view('transfer/transfer_search');
echo $GLOBALS['CI']->template->isolated_view('transfer/transfer_search_modify');
...
var load_products = function(loader, offset, filters){
    ...
    _lazy_content = $.ajax({
        type: 'GET',
        url: app_base_url+'index.php/ajax/transfer_list/'+offset+'?booking_source=<?=$active_booking_source[0]['source_id']?>&search_id=<?= $transfer_search_params['search_id'] ?>&op=load'+url_filters+'&enquiry_origin=<?= $enquiry_origin;?>',
        async: true,
        cache: true,
        dataType: 'json',
    ...
    <div class="container-fluid"  id="page-parent">
        ...
        <div class="container-fluid ">
           ...
           // echo $GLOBALS['CI']->template->isolated_view('transfer/search_panel_summary');
            ...
            // echo $GLOBALS['CI']->template->isolated_view('share/transfer_search') ?>
...
<!--                                <div class="rangebox">
                                        ...
                                        <div class="boxins sight_seen_types">
                                            <ul class="" id="hotel-amenitie-wrapper">
                                               <li>
                                                  ...
                                                  <label class="lbllbl" for="wifi-hotels-view">Transfers Types</label></li>
    ...
    <div id="empty-search-result" class="jumbotron container" style="display:none">
        ...
        <p>No Transfers were found in this location today.</p>
        <p>
    ...
    $(function(){
            $("#collapse3 .collapse ul li button.cate-btn-click").on("click",function(){
             ...
             $(document).on("click", ".madgrid", function () {
                ...
                window.location ='<?php echo base_url()?>index.php/transfer/transfer_details?op=get_details&search_id='+search_id+'&booking_source='+booking_source+'&price_id='+price_id+'&result_token='+result_token;
