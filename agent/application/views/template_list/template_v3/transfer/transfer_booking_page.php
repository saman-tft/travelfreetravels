  ...
  <div class="ovrgo sight_book_page">
			...
			<div class="bookcol">
			  <div class="hotelistrowhtl">
				...
				<div class="col-md-12 col-sm-8 col-xs-8 padall10 xcel">
				  <div class="hotelhed">Title: <?=$value->ProductName?></div>
				  <div class="hotelhed1">Tour Code: <?=$value->ProductCode?></div>
	...
	<div class="bktab2 xlbox <?=@$travellers_tab_details_class?>">
	  <div class="col-xs-12 col-md-8 nopad">
		<div class="col-xs-12 topalldesc " style="padding: 0px!important;margin-top: 0px!important;">
			<div class="col-xs-12 nopad">
				<div class="bookcol" style="margin: 2px 10px;">
			  <div class="hotelistrowhtl">
				...
				<div class="col-md-8 padall10 xcel">
				  ...
				  <div class="bokkpricesml">
				  	<div class="totlbkamnt grandtotal"> <span class="ttlamtdvot" style="color: #0095ce;"><?=$transfer_name?></div>
					<div class="travlrs"><span class="travlrsnms">Travelers:</span><span class="fa fa-male"></span> <?=$total_pax?></div>
					<div class="totlbkamnt grandtotal"> <span class="ttlamtdvot">Total Amount</span><?=$this->currency->get_currency_symbol($pre_booking_params['default_currency'])?> <?=round(($pre_booking_params['markup_price_summary']['NetFare']),2)?>/-</div>
					</div>
				</div>
			  </div>
			</div>
...
<div class="clearfix"></div>
				...
				<div class="ontyp" style="display: none;">
										<div class="kindrest">
				...
				<div class="loginspld">
					<div class="collogg">
						...
						<div class="continye col-xs-3">
							<button id="flip" class="bookcont" type="submit" style="margin-top:10px;">Continue</button>
						</div>
						<div class="clearfix"></div>
						<div class="sepertr"></div>
		...
		<div class="col-xs-4 rhttbepa">
			   <div id="nxtbarslider" style="width:370px;">
			 	<table class="table table-condensed tblemd nwtbl">
				 	<tbody>
