	...
	<div class="bktab2 xlbox <?=$travellers_tab_details_class?>">
	  <div class="col-xs-12 col-md-8 nopad">
		<!-- <div class="col-xs-12 topalldesc"> -->
			<div class="">
			<div class="col-xs-12 nopad">
				<div class="bookcol" style="margin: 0px!important;">
			  <div class="hotelistrowhtl">
		...
		<div class="col-xs-8 padpaspotr nopad">
				...
				<div class="col-xs-1 nopadding">
				 ...
				 <div class="inptalbox">
					...
					<div class="col-xs-4 spllty">
						  ...
						  <input value="" required="required" type="text" name="first_name[]" id="passenger-first-name-<?=$name_index?>" class="clainput alpha_space <?=$traveller_class?>"  minlength="2" maxlength="45" placeholder="Enter First Name" data-row-id="<?=($pax_index);?>"/>
					...
					<div class="col-xs-4 spllty">
					 	...
					 	<input value="" required="required" type="text" name="last_name[]" id="passenger-last-name-<?=$name_index?>" class="clainput alpha_space last_name" minlength="2" maxlength="45" placeholder="Enter Last Name" />
					 </div>
					 <?php 
...
<!-- Booking Question  Start-->
		 <?php if(valid_array($pre_booking_params['BookingQuestions'])):?>
                    <?php foreach($pre_booking_params['BookingQuestions'] as $q_key=>$q_value): $requierd='';?>
                      <?php //debug($q_value); ?> <?php if(trim($q_value['stringQuestionId']) !='dateOfBirth_dob' && trim($q_value['stringQuestionId']) !='passport_expiry' && $q_value['stringQuestionId'] !='weights_passengerWeights' && $q_value['stringQuestionId'] !='heights_passengerHeights' && $q_value['stringQuestionId'] !='passport_passportNo' && $q_value['stringQuestionId'] !='passport_nationality'):?>
                        <?php
